...
type
  ...
  TBindNavButtonStyleItem = (nsAllowTimer, nsFocusRect);
...
type
  TFixedBindNavButton = class(TBindNavButton)
  protected
...
begin
  ...
  begin
    Btn := TFixedBindNavButton.Create(Self);
    Btn.Index := I;
...
procedure TFixedBindNavButton.EnabledChanged;
begin
  inherited;
  if FPath <> nil then
    FPath.UpdateEffects;
