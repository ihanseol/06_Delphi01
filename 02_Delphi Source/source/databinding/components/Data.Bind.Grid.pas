...
begin
  FBindGridLink.Free; // Scope component may be holding reference
  inherited;
end;
...
begin
  ...
  begin
    // -1 means use default column width, -2 will hide column
    FWidth := -2;
    FTextWidth := -2;
  end;
  ...
  begin
    ...
    try
      ...
      if LDataSet <> nil then
        ...
        begin
          LLink := GetFormatLink(S);
          if ((LLink = nil) or LLink.Visible) and LManager.CanAddColumn(DataSource, S) then
          begin
