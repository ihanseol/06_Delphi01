...
begin
  if not (csDestroying in FEditorObject.FStringGrid.ComponentState) then
  ...
  begin
    FEditorObject.FIndex := -1;
    if not (csDestroying in FEditorObject.FStringGrid.ComponentState) and
       FEditorObject.FStringGrid.EditorMode then
