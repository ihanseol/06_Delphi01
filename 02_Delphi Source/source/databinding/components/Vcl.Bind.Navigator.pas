...
uses Vcl.Dialogs, WinApi.Windows, Vcl.Themes,
  Data.Bind.Consts, System.UITypes, Vcl.VirtualImageList;
...
var
  BtnTypeName: array[TNavigateButton] of string = ('FIRST', 'PRIOR', 'NEXT',
...
function TCustomBindNavigator.GetButtonImageList: TCustomImageList;
var
  I: TNavigateButton;
...
class destructor TCustomBindNavigator.Destroy;
begin
...
begin
  Result := TNavigatorOrientation(inherited Orientation);
end;

procedure TCustomBindNavigator.SetOrientation(const Value: TNavigatorOrientation);
begin
...
begin
  BtnClick(TNavigateButton(Index));
end;
