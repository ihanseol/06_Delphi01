...
uses
  System.Classes, Data.Bind.Components, System.SysUtils;

type
  TNavigateButton = (nbFirst, nbPrior, nbNext, nbLast,
    nbInsert, nbDelete, nbEdit, nbPost, nbCancel, nbRefresh,
    nbApplyUpdates, nbCancelUpdates);
...
const
  ...
  NavigatorEditButtons = [nbInsert, nbDelete, nbEdit, nbPost, nbCancel,
    nbRefresh, nbApplyUpdates, nbCancelUpdates];
  ...
  NavigatorDefaultButtons = [nbFirst, nbPrior, nbNext, nbLast, nbInsert,
