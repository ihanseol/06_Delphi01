...
uses
  System.Bindings.Evaluator, System.Bindings.Search, System.Generics.Defaults;
...
begin
  ...
  FMap := TMap.Create(TIStringComparer.Ordinal);
...
type
  TMoreSpecificItem = (msFirst, msSecond);
  TMoreSpecific = set of TMoreSpecificItem;
