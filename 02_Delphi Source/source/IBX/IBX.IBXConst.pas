...
{SQLMonitor Strings}
  ...
  StrStartTransaction = ': [Start transaction on default database name %s]';
  ...
  SODS181feature = '%s is an ODS 18.1 feature. Please upgrade the Database to ODS 18.1 to use this functonality';
  ...
  SEncryptionPassword = 'Enter_Password_here';
  ...
  STablespaceAvailable = 'Service API Tablespace support';
