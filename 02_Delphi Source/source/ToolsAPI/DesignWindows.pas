...
begin
  ...
  Reg.WriteInteger(SectionName, ivLeft, TIDEHighDPIService.ConvertToDefaultPPI(Form, L));
  Reg.WriteInteger(SectionName, ivTop, TIDEHighDPIService.ConvertToDefaultPPI(Form, T));
  Reg.WriteInteger(SectionName, ivWidth, TIDEHighDPIService.ConvertToDefaultPPI(Form, Form.Width));
  Reg.WriteInteger(SectionName, ivHeight, TIDEHighDPIService.ConvertToDefaultPPI(Form, Form.Height));
  if M <> nil then
