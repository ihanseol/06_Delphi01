...
type
  ...
  protected
    ...
    function GetOrdValue: NativeInt; virtual;
    function GetOrdValueAt(Index: Integer): NativeInt;
...
function TPropertyEditor.GetOrdValue: NativeInt;
begin
  Result := GetOrdValueAt(0);
end;

function TPropertyEditor.GetOrdValueAt(Index: Integer): NativeInt;
begin
...
procedure TPropertyEditor.SetOrdValue(Value: NativeInt);
var
  I: Integer;
begin
  for I := 0 to FPropCount - 1 do
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if Assigned(FAncestor) and (csAncestor in FLookingFor.ComponentState) then
        begin
          FDoneLooking := False;
...
begin
  with GetTypeData(GetPropType)^ do
    if OrdType = otULong then // unsigned
      Result := IntToStr(UIntPtr(GetOrdValue))
    else
