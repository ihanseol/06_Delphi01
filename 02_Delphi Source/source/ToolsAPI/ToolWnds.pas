...
begin
  ...
  ResizeButtons(False);
  SmallToolbarSize := TIDEHighDPIService.ConvertToDefaultPPI(Self, ToolBar1.Height);
  ResizeButtons(True);
  LargeToolbarSize := TIDEHighDPIService.ConvertToDefaultPPI(Self, ToolBar1.Height);
