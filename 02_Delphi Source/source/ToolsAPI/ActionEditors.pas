...
begin
  ...
  begin
    ...
    TIDETitleBarService.AddTitleBar(Form, nil, True);
    try
...
begin
  ...
  begin
    ...
    if N > 0 then
      Height := (Min(N, 11) + 3) * TIDEHighDPIService.GetFormDPI(nil).ScaleValue(FDefItemHeight)
    else
...
begin
  ...
  if ThemeProperties <> nil then
    FActionListView.StyleName := ThemeProperties.StyleServices.Name;
