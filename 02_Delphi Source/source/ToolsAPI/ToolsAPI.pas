'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTASplashScreenServices280,0x7B78F1BA,0x19C2,0x4A80,0x9F,0xE2,0x6B,0xF6,0xE3,0x16,0x04,0xF6);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAVersionSKUInfoService290,0x0C82B59E,0x5DBE,0x4140,0xA0,0x69,0x33,0x18,0xD7,0x60,0x1B,0x6D);'*)
...
const
  ...
  atBraceHighlight = atHotLink + 7;
  atLineHighlight  = atHotLink + 8;
  atSearchOtherMatchHighlight = atHotLink + 9;
...
//  sAndroidService = 'AndroidService';
 ...
 { Some of the preset identifers that could be passed to
  ...
  pmmpCopyFilePath = pmmpOpenSection + 480;
  ...
  /// <summary>
  ///  Local Editor Menu Categories
  ///  The cEdMenuCat constants listed below define the different action list
  ///  catagories used to build the editor local menu. Use INTAEditorLocalMenu
  ///  to add to the editor local menu and use these constants to control where
  ///  a new action list is added.
  ///
  ///  The order listed below is the order that the editor local menu is created
  ///  with cEdMenuCatIdentifier being first and cEdMenuCatLast begin last.
  ///
  ///  Below is a list of which action are in each menu category.
  ///
  ...
  ///  cEdMenuCatBase: Open Source/Header File, Open File at Cursor,
  ///     Browse Symbol at Cursor, Topic Search, Next Buffer View,
  ///     Prev Buffer View, Next Modification, Previous Modification,
  ///     Next Unsaved Modification, Previous Unsaved Modification
  ///  cEdMenuCatModule: Open Source/Header File, View Messages, Show in Explorer
  ///  cEdMenuCatClipboard: Cut, Copy, Paste
  ///  cEdMenuCatBookMarks: All goto and toggle bookmark items
  ///  cEdMenuCatDebug: Debug, Run To Cursor
  ///  cEdMenuCatDebug: View, Message, Read Only, View as Form
  ///  cEdMenuCatView: View as Form
  ///  cEdMenuCatElide: Fold, Doc Comments, Methods, Nearest, Nested, Regions,
  ///     Name Space, Types, Unfold, All, Nearest
  ///  cEdMenuCatVersionControl: All version plug menu items
  ///  cEdMenuCatRefactor: Find, Find References, Find Local References,
  ///     Find Declaration Symbol, Refactor
  ...
  cEdMenuCatIdentifier = 'Identifier';
  cEdMenuCatBreakPoint = 'BreakPoint';
  cEdMenuCatDebugDebug = 'DebugDebug';
  cEdMenuCatBase = 'Base';
  cEdMenuCatModule = 'Module';
  cEdMenuCatClipboard = 'Clipboard';
  cEdMenuCatBookMarks = 'BookMarks';
  cEdMenuCatDebug = 'Debug';
  cEdMenuCatView = 'View';
  cEdMenuCatElide = 'Elide';
  cEdMenuCatVersionControl = 'VersionControl';
  cEdMenuCatRefactor = 'Refactor';
  cEdMenuCatFormat = 'Format';
  cEdMenuCatRepository = 'Repository';
  cEdMenuCatLast = 'Last';
...
{$ENDIF}
  ...
  IOTAStrings = interface(IInterface)
    ...
    property Data[const Index: Integer]: IntPtr read GetData write SetData;
  ...
  IOTAEditWriter280 = interface(IUnknown)
  ...
  IOTAEditWriter = interface(IOTAEditWriter280)
    ['{8E9E6EEB-85B2-40E4-94F6-30ED6C103187}']
  /// <summary>
  /// Inserts UTF8-encoded string into the editor. Position can be set by CopyTo
  /// </summary>
    procedure Insert(const Text: UTF8String); overload;
  /// <summary>
  /// Inserts a new line at the give line postion in the file. Lines start at 1.
  /// </summary>
    procedure InsertBlankLine(LineNumber: Integer);
  /// <summary>
  /// Inserts the give text in Buffer(a pointer to UTF8 buffer that is zero
  /// terminated). Line numbers start at 1.
  /// start at 1.
  /// </summary>
    procedure InsertLine(LineNumber: Integer; Buffer: PAnsiChar); overload;
  /// <summary>
  /// Inserts the give text in Buffer to the line number provided. Line numbers
  /// start at 1.
  /// </summary>
    procedure InsertLine(LineNumber: Integer; const Buffer: UTF8String); overload;
  /// <summary>
  /// Deletes the line at the specified line number. Line numbers start at 1.
  /// </summary>
    procedure DeleteLine(LineNumber: Integer);
  /// <summary>
  /// Replaces the specifed line with the give PAnsiChar (a pointer to UTF8
  /// buffer that is zero terminated). Line numbers start at 1.
  /// </summary>
    procedure ReplaceLine(LineNumber: Integer; Buffer: PAnsiChar); overload;
  /// <summary>
  /// Replaces the specifed line with the provided UTF8String Buffer. Line
  /// numbers start at 1.
  /// </summary>
    procedure ReplaceLine(LineNumber: Integer; const Buffer: UTF8String); overload;
  end;
  ...
  TOTAEndLine = (cLineEndDefault, // Default is the same as cLineEndCrLf
                 cLineEndCr,
                 cLineEndLf,
                 cLineEndCrLf,
                 cLineEndLfCr,
  ...
  TOTALineInfo = packed record
    lineLength: Integer;   // Length of the give line
    lineText: POTAEdChar;  // The line text in the editor which is NOT #0 terminated
    lineEnd: TOTAEndLine;  // defines what type of line ending
  end;
  POTALineInfo = ^TOTALineInfo;

  ///  <summary>
  ///  Callback type for callback used in IOTARawEditRead.GetLineData
  ///  The callback is called for each line read from the editor.
  ///  </summary>
  TOTALineDataCallback = procedure(ALine: Longint; ALineInfo: POTALineInfo;
    AUserData: Pointer)
    {$IFDEF WIN32} pascal {$ENDIF} ;

  ///  <summary>
  ///  IOTARawEditReader is an api for fast reading of the editor lines.
  ///  The pointers returned are pointers to the real data in the editor and
  ///  can change at any time. The pointers must never be written to as this
  ///  will lead to corruption and crashes.
  ///  </summary>
  IOTARawEditReader = interface(IUnknown)
    ['{56699602-3548-4405-ABFE-3211961F227A}']
  ///  <summary>
  ///  Starting at the line number AFirstLine continue till ARange number of
  ///  lines or the end of file ACallback will be called for each line. The data
  ///  that is returned is from the editor kernal and must never be written to.
  ///  It can also change at anytime so it must be copied/stored once it is
  /// retrieved if it is going to be used later. AUserdata will be passed to
  /// ACallback with each call.
    procedure GetLineData(AFirstLine: Integer; ARange: Integer;
      ACallBack: TOTALineDataCallback; AUserData: Pointer);
  ///  <summary>
  ///  Gets the total number of lines in the edit buffer.
  ///  </summary>
    function GetTotalLinesInBuffer: Integer;

  ///  <summary>
  ///  Returns the total number of lines in the edit buffer.
  ///  </summary>
    property LinesInBuffer: Integer read GetTotalLinesInBuffer;
  end;
  ...
  INTAEditViewNotifier = interface(IOTANotifier)
    ...
    /// <summary>
    /// BeginPaint is deprecated. see <c>ToolsAPI.Editor.INTACodeEditorEvents</c>
    ///
    ...
    /// </summary>
    procedure BeginPaint(const View: IOTAEditView; var FullRepaint: Boolean); deprecated 'Use INTACodeEditorEvents.BeginPaint';
    /// <summary>
    /// PaintLine is deprecated. see <c>ToolsAPI.Editor.INTACodeEditorEvents</c>
    ///
    ...
    procedure PaintLine(const View: IOTAEditView; LineNumber: Integer;
      ...
      const Canvas: TCanvas; const TextRect: TRect; const LineRect: TRect; const CellSize: TSize); deprecated 'Use INTACodeEditorEvents.PaintLine';
    /// <summary>
    /// EndPaint is deprecated. see <c>ToolsAPI.Editor.INTACodeEditorEvents</c>
    ///
    ...
    /// painting lines.
    /// </summary>
    procedure EndPaint(const View: IOTAEditView); deprecated 'Use INTACodeEditorEvents.EndPaint';
  end;
...
{$ENDIF}
  ...
  TOTAProcessType = (optWin32, optOSX32, optWin64, optiOS32, optAndroid, optiOS64, optLinux64, optOSX64, optAndroid64, optOSXArm64, optWin64x);
  ...
  TWizardStateItem = (wsEnabled, wsChecked);
  ...
  /// </summary>
  IOTAEnvironmentOptionsNotifier = interface(IOTANotifier)
  ...
  IOTAEnvironmentOptions280 = interface(IOTAEnvironmentOptions140)
    ...
    /// </summary>
    function AddNotifier(const ANotifier: IOTAEnvironmentOptionsNotifier): Integer;
    /// <summary>
  ...
  INTAServices290 = interface(INTAServices280)
    ['{B838F219-3DA0-411F-9454-F16FEB5FC2B1}']
    /// <summary>
    /// Creates and displays an INTACustomDockableForm w/ optional IDE titlebar support.  Returns the form instance
    /// that was created.
    /// </summary>
    function CreateDockableFormEx(const CustomDockableForm: INTACustomDockableForm; Titlebar: Boolean): TCustomForm;
  end;

  INTAServices = interface(INTAServices290)
...
{$ENDIF}
  ...
  IOTAEditLineTracker = interface(IUnknown)
    ...
    procedure AddLine(Line: Integer; Data: IntPtr);
    procedure Delete(Index: Integer);
    function GetCount: Integer;
    function GetData(Index: Integer): IntPtr;
    function GetEditBuffer: IOTAEditBuffer;
    function GetLineNum(Index: Integer): Integer;
    function IndexOfLine(Line: Integer): Integer;
    function IndexOfData(Data: IntPtr): Integer;
    procedure RemoveNotifier(Index: Integer);
    procedure SetData(Index: Integer; Value: IntPtr);
    procedure SetLineNum(Index: Integer; Value: Integer);

    property Count: Integer read GetCount;
    property Data[Index: Integer]: IntPtr read GetData write SetData;
  ...
  INTAEditorLocalMenu = interface(IUnknown)
    ['{D7B46285-AF21-409E-AEF8-24E8A4C40BF8}']
    /// <summary>
    ///  RegisterActionList registers a new TActionList category that will be
    ///  used when the editor local menu (popup menu) is created. A list of menu
    ///  categories can be found defined above, all start with cEdMenuCat. The
    ///  local menu will be created each time it is used and will call the
    ///  action's OnUpdate before it is shown.
    ///
    ///  To create sub menus you must use a category name for each action. The
    ///  sub menu category will be the parent's with a '.' followed by any name.
    ///  For example if the category for the parent menu item is "ParMenu"
    ///  then the sub menu category will be "ParMenu.sub1". The sub menus must
    ///  be added to the action list as the next actions after their parent. If
    ///  a sub menu is before its parent it will not be shown.
    ///
    ///  If InsertAfter is the defaut value of '' then the action list will be
    ///  added as the first item.
    ///
    ///  NOTE: if a TActionList is registered it must be unregistered before
    ///  your package is unloaded.
    /// </summary>
    procedure RegisterActionList(Actions: TActionList; const MenuCategory: string;
      InsertAfter: string = '');

    /// <summary>
    ///  Removes the actions list associated with the MenuCategory that was
    ///  used in registration. The TActionList that was registered is not freed.
    ///  If your TActionList is in a TDataModule then it will be freed when the
    ///  Data Module is freed.
    /// </summary>
  ...
  IOTAEditorServices280 = interface(IOTAEditorServices80)
    ['{BE733055-5ED8-45B4-BAB1-19C46C237408}']
    function GetEditOptionsIDString(const FileName: String): string;
  end;
  IOTAEditorServices = interface(IOTAEditorServices280)
    ['{CAC82350-3885-4CAE-84AE-F1C3B38A6E91}']
    /// <summary>
    ///  GetEditorLocalMenu returns an interface that can be used to add
    ///  to the editor local menu.
    /// </summary>
    function GetEditorLocalMenu: INTAEditorLocalMenu;
  end;
  ...
  TOTACodeInsightInvocation = record
    InvokeType: TOTAInvokeType;
    CodeInsightType: TOTACodeInsightType;
  end;

  TOTACodeInsightInvocations = array of TOTACodeInsightInvocation;
  ...
  IOTAMultipleCodeInsightInvocation290 = interface(IUnknown)
    ['{38A2C4D1-D48C-41FF-BE73-69F12FDF1399}']
    procedure GetCodeInsightTypes(AChar: Char; AElement: Integer; var ACodeInsightInvocations: TOTACodeInsightInvocations);
  end;

  /// <summary>
  /// IOTAMultipleCodeInsightTypes is used to allow multiple Code Insight invocations on a single key press.
  /// See IOTACodeInsightManager100.GetCodeInsightType for more information
  /// </summary>
  IOTAMultipleCodeInsightInvocation = interface(IOTAMultipleCodeInsightInvocation290)
    ['{2C90F8B7-6258-44F8-8AC9-45EAB241D6CB}']
  end;
  ...
  /// the Code Insight environment options page.
  /// </summary>
  IOTACodeInsightManagerEnvOptions290 = interface(IUnknown)
    ['{5F51E3E5-7CDC-47D4-B795-DB56C9D63F68}']
    function UseVisualAssistCodeCompletion: Boolean;
  end;
  ...
  TOTACompletionAcceptMode = (camInsert, camOverwrite);

  IOTACodeInsightViewer290 = interface(IOTACodeInsightViewer90)
    ['{E3F103D1-98A7-4AC2-9BE1-7F9E83F3539D}']
    function GetCompletionAcceptMode: TOTACompletionAcceptMode;
    property CompletionAcceptMode: TOTACompletionAcceptMode read GetCompletionAcceptMode;
  end;
  ...
  INTAIDEInsightItem280 = interface(INTAIDEInsightItem270)
    ...
    ///  Deprecated prefear INTAIDEInsightItem290.GetGlyphArray
    /// </summary>
    function SetGlyph(const AImageName: string; const AGlyph: TGraphicArray): Boolean; deprecated;
  end;

  INTAIDEInsightItem290 = interface(INTAIDEInsightItem280)
    ['{335692C3-FD41-476D-BB87-3A51972D2DF3}']
    /// <summary>
    ///  Provide an array of multi-resolution glyphs.
    /// </summary>
    function GetGlyphArray(var AImageName: string; var AGlyphArray: TGraphicArray): Boolean;
  end;

  /// <summary>
  ///  Represents a searchable item in the IDE Insight dialog }
  /// </summary>
  INTAIDEInsightItem = interface(INTAIDEInsightItem290)
  ...
  TOTAAlignableStateItem = (asEnabled, asChecked);
  TOTAAlignableState = set of TOTAAlignableStateItem;
  ...
  IOTAAsyncCodeInsightManager290 = interface
    ['{704B0D6A-8152-4BAA-91CC-DCE8D0E0C62A}']
  ...
  IOTAVersionSKUInfoService290 = interface(IOTAVersionSKUInfoService280)
    ['{0C82B59E-5DBE-4140-A069-3318D7601B6D}']
    /// <summary>
    /// Get Current Product SKU Name
    /// </summary>
    function GetSKUName: string;
    property SKUName: string read GetSKUName;
  end;

  IOTAVersionSKUInfoService = interface(IOTAVersionSKUInfoService290)
...
function TOTAStringsAdapter.GetData(const Index: Integer): IntPtr;
begin
  Result := IntPtr(FStrings.Objects[Index]);
end;
...
procedure TOTAStringsAdapter.SetData(const Index: Integer; Value: IntPtr);
begin
