...
uses
  System.Types, System.Classes, System.Actions;
...
type
  ...
  /// <summary>If you want to use Añtions in menu items, then use this interface.</summary>
  IMenuItem290 = interface(IMenuItem2)
    ['{612B1184-1A2F-4341-AF89-4FFB35EEAC40}']
