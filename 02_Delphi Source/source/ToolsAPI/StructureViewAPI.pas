...
uses
  Winapi.Windows, Winapi.CommCtrl, System.SysUtils, System.Classes, System.Actions, Vcl.Menus,
...
type
  ...
  IOTAStructureNode = interface(IDispatch)
    ...
    property Data: IntPtr read Get_Data write Set_Data;
  ...
  /// <summary>
  ///  This interface provide possibility to use actions in Context menu of Structure panel.
  /// </summary>
  IOTAStructureNodeMenuItem290 = interface(IOTAStructureNodeMenuItem)
  ['{86E27C5E-03F1-400C-9503-9B3632FD3675}']
    function GetAction: TBasicAction; safecall;
  ...
  TStructureNodeMenuItem = class(TInterfacedObject, IDispatch, ISupportErrorInfo,
    IOTAStructureNodeMenuItem, IOTAStructureNodeMenuItem290, IInternalStructureMenuItem)
  private
    FMenuItem: TMenuItem;
  protected
    // IDispatch
...
function TStructureNodeMenuItem.GetAction: TBasicAction;
begin
  Result := FMenuItem.Action;
end;
...
var
  I: Integer;
  MenuItem: TStructureMenuItem;
  LStructureNodeMenuItem290: IOTAStructureNodeMenuItem290;
begin
  ...
  if Supports(AStructureNodeMenuItem, IOTAStructureNodeMenuItem290, LStructureNodeMenuItem290) then
    Action := LStructureNodeMenuItem290.Action;
