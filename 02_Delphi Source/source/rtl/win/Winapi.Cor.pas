...
const
  LIBID_ComPlusRuntime_Name = '{BED7F4EA-1A96-11d2-8F08-00A0C9A6186D}';
  LIBID_ComPlusRuntime: TGuid = LIBID_ComPlusRuntime_Name;
  {$EXTERNALSYM LIBID_ComPlusRuntime}

  GUID_ExportedFromComPlus_Name = '{90883F05-3D28-11D2-8F17-00A0C9A6186D}';
  GUID_ExportedFromComPlus: TGuid = GUID_ExportedFromComPlus_Name;
  {$EXTERNALSYM GUID_ExportedFromComPlus}

  GUID_ManagedName_Name = '{0F21F359-AB84-41e8-9A78-36D110E6D2F9}';
  GUID_ManagedName: TGuid = GUID_ManagedName_Name;
  {$EXTERNALSYM GUID_ManagedName}

  GUID_Function2Getter_Name = '{54FC8F55-38DE-4703-9C4E-250351302B1C}';
  GUID_Function2Getter: TGuid = GUID_Function2Getter_Name;
...
//  to CLSID_MetaDataDispenser.
  CLSID_CorMetaDataDispenserRuntime_Name = '{1EC2DE53-75CC-11d2-9775-00A0C9B4D50C}';
  CLSID_CorMetaDataDispenserRuntime: TGuid = CLSID_CorMetaDataDispenserRuntime_Name;
  {$EXTERNALSYM CLSID_CorMetaDataDispenserRuntime}

  GUID_DispIdOverride_Name = '{CD2BC5C9-F452-4326-B714-F9C539D4DA58}';
  GUID_DispIdOverride: TGuid = GUID_DispIdOverride_Name;
  {$EXTERNALSYM GUID_DispIdOverride}

  GUID_ForceIEnumerable_Name = '{B64784EB-D8D4-4d9b-9ACD-0E30806426F7}';
  GUID_ForceIEnumerable: TGuid = GUID_ForceIEnumerable_Name;
  {$EXTERNALSYM GUID_ForceIEnumerable}

  GUID_PropGetCA_Name = '{2941FF83-88D8-4F73-B6A9-BDF8712D000D}';
  GUID_PropGetCA: TGuid = GUID_PropGetCA_Name;
  {$EXTERNALSYM GUID_PropGetCA}

  GUID_PropPutCA_Name = '{29533527-3683-4364-ABC0-DB1ADD822FA2}';
  GUID_PropPutCA: TGuid = GUID_PropPutCA_Name;
  {$EXTERNALSYM GUID_PropPutCA}

//  Used to generate v1 metadata (for v1.0 and v1.1 CLR compatibility).
  CLSID_CLR_v1_MetaData_Name = '{005023CA-72B1-11D3-9FC4-00C04F79A0A3}';
  CLSID_CLR_v1_MetaData: TGuid = CLSID_CLR_v1_MetaData_Name;
  {$EXTERNALSYM CLSID_CLR_v1_MetaData}

//  Used to generate v1 metadata (for v1.0 and v1.1 CLR compatibility).
  CLSID_CLR_v2_MetaData_Name = '{EFEA471A-44FD-4862-9292-0C58D46E1F3A}';
  CLSID_CLR_v2_MetaData: TGuid = CLSID_CLR_v2_MetaData_Name;
  {$EXTERNALSYM CLSID_CLR_v2_MetaData}

// This will can always be used to generate the "latest" metadata available.
  CLSID_CorMetaDataRuntime_Name = '{EFEA471A-44FD-4862-9292-0C58D46E1F3A}';  //CLSID_CLR_v2_MetaData;
  CLSID_CorMetaDataRuntime: TGuid = CLSID_CorMetaDataRuntime_Name;
  {$EXTERNALSYM CLSID_CorMetaDataRuntime}

  MetaDataCheckDuplicatesFor_Name = '{30FE7BE8-D7D9-11D2-9F80-00C04F79A0A3}';
  MetaDataCheckDuplicatesFor: TGuid = MetaDataCheckDuplicatesFor_Name;
  {$EXTERNALSYM MetaDataCheckDuplicatesFor}

  MetaDataRefToDefCheck_Name = '{DE3856F8-D7D9-11D2-9F80-00C04F79A0A3}';
  MetaDataRefToDefCheck: TGuid = MetaDataRefToDefCheck_Name;
  {$EXTERNALSYM MetaDataRefToDefCheck}

  MetaDataNotificationForTokenMovement_Name = '{E5D71A4C-D7DA-11D2-9F80-00C04F79A0A3}';
  MetaDataNotificationForTokenMovement: TGuid = MetaDataNotificationForTokenMovement_Name;
  {$EXTERNALSYM MetaDataNotificationForTokenMovement}

  MetaDataSetUpdate_Name = '{2eee315c-d7db-11d2-9f80-00c04f79a0a3}';
  MetaDataSetUpdate: TGuid = MetaDataSetUpdate_Name;
  {$EXTERNALSYM MetaDataSetUpdate}
  MetaDataSetENC_Name = '{2eee315c-d7db-11d2-9f80-00c04f79a0a3}'; //MetaDataSetUpdate;
  MetaDataSetENC: TGuid = MetaDataSetENC_Name;
...
// delete items or not. The default is yes.
  MetaDataImportOption_Name = '{79700F36-4AAC-11d3-84C3-009027868CB1}';
  MetaDataImportOption: TGuid = MetaDataImportOption_Name;
...
// Use this guid in the SetOption if compiler wants to have MetaData API to take reader/writer lock
  MetaDataThreadSafetyOptions_Name = '{F7559806-F266-42ea-8C63-0ADB45E8B234}';
  MetaDataThreadSafetyOptions: TGuid = MetaDataThreadSafetyOptions_Name;
...
// Use this guid in the SetOption if compiler wants error when some tokens are emitted out of order
  MetaDataErrorIfEmitOutOfOrder_Name = '{1547872D-DC03-11d2-9420-0000F8083460}';
  MetaDataErrorIfEmitOutOfOrder: TGuid = MetaDataErrorIfEmitOutOfOrder_Name;
...
// TCE adapters for COM connection point containers.
  MetaDataGenerateTCEAdapters_Name = '{DCC9DE90-4151-11d3-88D6-00902754C43A}';
  MetaDataGenerateTCEAdapters: TGuid = MetaDataGenerateTCEAdapters_Name;
...
// Use this guid in the SetOption to specifiy a non-default namespace for typelib import.
  MetaDataTypeLibImportNamespace_Name = '{F17FF889-5A63-11d3-9FF2-00C04FF7431A}';
  MetaDataTypeLibImportNamespace: TGuid = MetaDataTypeLibImportNamespace_Name;
...
// Use this guid in the SetOption to specify the behavior of UnmarkAll. See CorLinkerOptions.
  MetaDataLinkerOptions_Name = '{47E099B6-AE7C-4797-8317-B48AA645B8F9}';
  MetaDataLinkerOptions: TGuid = MetaDataLinkerOptions_Name;
...
// Use this guid in the SetOption to specify the runtime version stored in the CLR metadata.
  MetaDataRuntimeVersion_Name = '{47E099B7-AE7C-4797-8317-B48AA645B8F9}';
  MetaDataRuntimeVersion: TGuid = MetaDataRuntimeVersion_Name;
  {$EXTERNALSYM MetaDataRuntimeVersion}

// Use this guid in the SetOption to specify the behavior of the merger.
  MetaDataMergerOptions_Name = '{132D3A6E-B35D-464e-951A-42EFB9FB6601}';
  MetaDataMergerOptions: TGuid = MetaDataMergerOptions_Name;
...
//*****************************************************************************
  ...
  CLSID_Cor_Name = '{bee00000-ee77-11d0-a015-00c04fbbb884}';
  CLSID_Cor: TGuid = CLSID_Cor_Name;
  {$EXTERNALSYM CLSID_Cor}

//  This is the "Master Dispenser", always guaranteed to be the most recent
//  dispenser on the machine.
  CLSID_CorMetaDataDispenser_Name = '{E5CB7A31-7512-11d2-89CE-0080C792E5D8}';
  CLSID_CorMetaDataDispenser: TGuid = CLSID_CorMetaDataDispenser_Name;
...
//  to CLSID_CorMetaDataDispenser.
  CLSID_CorMetaDataDispenserReg_Name = '{435755FF-7397-11d2-9771-00A0C9B4D50C}';
  CLSID_CorMetaDataDispenserReg: TGuid = CLSID_CorMetaDataDispenserReg_Name;
  {$EXTERNALSYM CLSID_CorMetaDataDispenserReg}

// For COM+ Meta Data, Data Driven Registration
  CLSID_CorMetaDataReg_Name = '{87F3A1F5-7397-11d2-9771-00A0C9B4D50C}';
  CLSID_CorMetaDataReg: TGuid = CLSID_CorMetaDataReg_Name;
  {$EXTERNALSYM CLSID_CorMetaDataReg}

  IID_IMetaDataInternal_Name = '{39EE28B3-0181-4d48-B53C-2FFAFFD5FEC1}';
  IID_IMetaDataInternal: TGuid = IID_IMetaDataInternal_Name;
  {$EXTERNALSYM IID_IMetaDataInternal}

//-------------------------------------
//--- IMetaDataError
//-------------------------------------
  IID_IMetaDataError_Name = '{B81FF171-20F3-11d2-8DCC-00A0C9B09C19}';
  IID_IMetaDataError: TGuid = IID_IMetaDataError_Name;
  {$EXTERNALSYM IID_IMetaDataError}

//-------------------------------------
//--- IMapToken
//-------------------------------------
  IID_IMapToken_Name = '{06A3EA8B-0225-11d1-BF72-00C04FC31E12}';
  IID_IMapToken: TGuid = IID_IMapToken_Name;
...
// {809c652e-7396-11d2-9771-00a0c9b4d50c} // Correct GUID
  IID_IMetaDataDispenser_Name = '{809c652e-7396-11d2-9771-00a0c9b4d50c}';
  IID_IMetaDataDispenser: TGuid = IID_IMetaDataDispenser_Name;
  {$EXTERNALSYM IID_IMetaDataDispenser}

//-------------------------------------
//--- IMetaDataEmit
//-------------------------------------
  IID_IMetaDataEmit_Name = '{BA3FEE4C-ECB9-4e41-83B7-183FA41CD859}';
  IID_IMetaDataEmit: TGuid = IID_IMetaDataEmit_Name;
  {$EXTERNALSYM IID_IMetaDataEmit}

//-------------------------------------
//--- IMetaDataEmit2
//-------------------------------------
  IID_IMetaDataEmit2_Name = '{F5DD9950-F693-42e6-830E-7B833E8146A9}';
  IID_IMetaDataEmit2: TGuid = IID_IMetaDataEmit2_Name;
  {$EXTERNALSYM IID_IMetaDataEmit2}

//-------------------------------------
//--- IMetaDataImport
//-------------------------------------
  IID_IMetaDataImport_Name = '{7DAC8207-D3AE-4c75-9B67-92801A497D44}';
  IID_IMetaDataImport: TGuid = IID_IMetaDataImport_Name;
  {$EXTERNALSYM IID_IMetaDataImport}

//-------------------------------------
//--- IMetaDataImport2
//-------------------------------------
  IID_IMetaDataImport2_Name = '{FCE5EFA0-8BBA-4f8e-A036-8F2022B08466}';
  IID_IMetaDataImport2: TGuid = IID_IMetaDataImport2_Name;
  {$EXTERNALSYM IID_IMetaDataImport2}

//-------------------------------------
//--- IMetaDataFilter
//-------------------------------------
  IID_IMetaDataFilter_Name = '{D0E80DD1-12D4-11d3-B39D-00C04FF81795}';
  IID_IMetaDataFilter: TGuid = IID_IMetaDataFilter_Name;
  {$EXTERNALSYM IID_IMetaDataFilter}

//-------------------------------------
//--- IHostFilter
//-------------------------------------
  IID_IHostFilter_Name = '{D0E80DD3-12D4-11d3-B39D-00C04FF81795}';
  IID_IHostFilter: TGuid = IID_IHostFilter_Name;
  {$EXTERNALSYM IID_IHostFilter}

//--------------------------------------
//--- IMetaDataConverter
//--------------------------------------
  IID_IMetaDataConverter_Name = '{D9DEBD79-2992-11d3-8BC1-0000F8083A57}';
  IID_IMetaDataConverter: TGuid = IID_IMetaDataConverter_Name;
  {$EXTERNALSYM IID_IMetaDataConverter}

  IID_IMetaDataAssemblyEmit_Name = '{211EF15B-5317-4438-B196-DEC87B887693}';
  IID_IMetaDataAssemblyEmit: TGuid = IID_IMetaDataAssemblyEmit_Name;
  {$EXTERNALSYM IID_IMetaDataAssemblyEmit}

  IID_IMetaDataAssemblyImport_Name = '{EE62470B-E94B-424e-9B7C-2F00C9249F93}';
  IID_IMetaDataAssemblyImport: TGuid = IID_IMetaDataAssemblyImport_Name;
  {$EXTERNALSYM IID_IMetaDataAssemblyImport}

  IID_IMetaDataValidate_Name = '{4709C9C6-81FF-11D3-9FC7-00C04F79A0A3}';
  IID_IMetaDataValidate: TGuid = IID_IMetaDataValidate_Name;
  {$EXTERNALSYM IID_IMetaDataValidate}

  IID_IMetaDataDispenserEx_Name = '{31BCFCE2-DAFB-11D2-9F81-00C04F79A0A3}';
  IID_IMetaDataDispenserEx: TGuid = IID_IMetaDataDispenserEx_Name;
  {$EXTERNALSYM IID_IMetaDataDispenserEx}

//-------------------------------------
//--- ICeeGen
//-------------------------------------
  IID_ICeeGen_Name = '{7ED1BDFF-8E36-11d2-9C56-00A0C9B7CC45}';
  IID_ICeeGen: TGuid = IID_ICeeGen_Name;
  {$EXTERNALSYM IID_ICeeGen}

//-------------------------------------
//--- ICorModule
//-------------------------------------
  IID_ICorModule_Name = '{2629F8E1-95E5-11d2-9C56-00A0C9B7CC45}';
  IID_ICorModule: TGuid = IID_ICorModule_Name;
  {$EXTERNALSYM IID_ICorModule}

  IID_IMetaDataTables_Name = '{D8F579AB-402D-4b8e-82D9-5D63B1065C68}';
  IID_IMetaDataTables: TGuid = IID_IMetaDataTables_Name;
  {$EXTERNALSYM IID_IMetaDataTables}

  IID_IMetaDataTables2_Name = '{BADB5F70-58DA-43a9-A1C6-D74819F19B15}';
  IID_IMetaDataTables2: TGuid = IID_IMetaDataTables2_Name;
  {$EXTERNALSYM IID_IMetaDataTables2}

  IID_INativeImageDependency_Name = '{814C9E35-3F3F-4975-977A-371F0A878AC7}';
  IID_INativeImageDependency: TGuid = IID_INativeImageDependency_Name;
  {$EXTERNALSYM IID_INativeImageDependency}

  IID_INativeImageEvaluate_Name = '{065AA013-9BDC-447c-922F-FEE929908447}';
  IID_INativeImageEvaluate: TGuid = IID_INativeImageEvaluate_Name;
  {$EXTERNALSYM IID_INativeImageEvaluate}

  IID_INativeImageInstallInfo_Name = '{0EA273D0-B4DA-4008-A60D-8D6EFFDD6E91}';
  IID_INativeImageInstallInfo: TGuid = IID_INativeImageInstallInfo_Name;
...
type
  ...
  IMetaDataAssemblyEmit = interface(IUnknown)
    [IID_IMetaDataAssemblyEmit_Name]
  ...
  IMetaDataAssemblyImport = interface(IUnknown)
    [IID_IMetaDataAssemblyImport_Name]
...
type
  ...
  INativeImageInstallInfo = interface(IUnknown)
    [IID_INativeImageInstallInfo_Name]
