...
function CreateProfile(pszUserSid: LPWSTR; pszUserName: LPWSTR; pszProfilePath: LPWSTR; cchProfilePath: DWORD): HRESULT; stdcall;
...
function ExpandEnvironmentStringsForUser(hToken: THandle; lpSrc: LPWSTR; lpDest: LPWSTR; dwSize: DWORD): BOOL; stdcall;
{$EXTERNALSYM ExpandEnvironmentStringsForUser}
function ExpandEnvironmentStringsForUserA(hToken: THandle; lpSrc: LPSTR; lpDest: LPSTR; dwSize: DWORD): BOOL; stdcall;
{$EXTERNALSYM ExpandEnvironmentStringsForUserA}
function ExpandEnvironmentStringsForUserW(hToken: THandle; lpSrc: LPWSTR; lpDest: LPWSTR; dwSize: DWORD): BOOL; stdcall;
...
function GetProfilesDirectory(lpProfilesDir: LPWSTR; var lpcchSize: DWORD): BOOL; external userenv name 'GetProfilesDirectoryW';
function GetProfilesDirectoryA(lpProfilesDir: LPSTR; var lpcchSize: DWORD): BOOL; external userenv name 'GetProfilesDirectoryA';
function GetProfilesDirectoryW(lpProfilesDir: LPWSTR; var lpcchSize: DWORD): BOOL; external userenv name 'GetProfilesDirectoryW';
...
function CreateProfile(pszUserSid: LPWSTR;pszUserName: LPWSTR; pszProfilePath: LPWSTR; cchProfilePath: DWORD): HRESULT;
  external userenv name 'CreateProfile' delayed;

function GetDefaultUserProfileDirectory(lpProfileDir: LPWSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetDefaultUserProfileDirectoryW';
function GetDefaultUserProfileDirectoryA(lpProfileDir: LPSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetDefaultUserProfileDirectoryA';
function GetDefaultUserProfileDirectoryW(lpProfileDir: LPWSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetDefaultUserProfileDirectoryW';

function GetAllUsersProfileDirectory(lpProfileDir: LPWSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetAllUsersProfileDirectoryW';
function GetAllUsersProfileDirectoryA(lpProfileDir: LPSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetAllUsersProfileDirectoryA';
function GetAllUsersProfileDirectoryW(lpProfileDir: LPWSTR; var lpcchSize: DWORD): BOOL;
  external userenv name 'GetAllUsersProfileDirectoryW';
...
function ExpandEnvironmentStringsForUser(hToken: THandle; lpSrc: LPWSTR; lpDest: LPWSTR; dwSize: DWORD): BOOL;
  external userenv name 'ExpandEnvironmentStringsForUserW';
function ExpandEnvironmentStringsForUserA(hToken: THandle; lpSrc: LPSTR; lpDest: LPSTR; dwSize: DWORD): BOOL;
  external userenv name 'ExpandEnvironmentStringsForUserA';
function ExpandEnvironmentStringsForUserW(hToken: THandle; lpSrc: LPWSTR; lpDest: LPWSTR; dwSize: DWORD): BOOL;
  external userenv name 'ExpandEnvironmentStringsForUserW';
