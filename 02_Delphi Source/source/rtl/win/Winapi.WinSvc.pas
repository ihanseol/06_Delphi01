...
//
  ...
  SERVICE_FAILURE_ACTIONS_FLAG = record
    fFailureActionsOnNonCrashFailures:       DWord;  // Failure actions flag
  end;
...
function StartServiceCtrlDispatcher(
  var lpServiceStartTable: SERVICE_TABLE_ENTRY): BOOL; stdcall; overload;
function StartServiceCtrlDispatcher(
  lpServiceStartTable: LPSERVICE_TABLE_ENTRY): BOOL; stdcall; overload;
{$EXTERNALSYM StartServiceCtrlDispatcherA}
function StartServiceCtrlDispatcherA(
  var lpServiceStartTable: SERVICE_TABLE_ENTRYA): BOOL; stdcall; overload;
function StartServiceCtrlDispatcherA(
  lpServiceStartTable: LPSERVICE_TABLE_ENTRYA): BOOL; stdcall; overload;
{$EXTERNALSYM StartServiceCtrlDispatcherW}
function StartServiceCtrlDispatcherW(
  var lpServiceStartTable: SERVICE_TABLE_ENTRYW): BOOL; stdcall; overload;
function StartServiceCtrlDispatcherW(
  lpServiceStartTable: LPSERVICE_TABLE_ENTRYW): BOOL; stdcall; overload;
...
function StartServiceCtrlDispatcher(var lpServiceStartTable: SERVICE_TABLE_ENTRY): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherW';
function StartServiceCtrlDispatcher(lpServiceStartTable: LPSERVICE_TABLE_ENTRY): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherW';
function StartServiceCtrlDispatcherA(var lpServiceStartTable: SERVICE_TABLE_ENTRYA): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherA';
function StartServiceCtrlDispatcherA(lpServiceStartTable: LPSERVICE_TABLE_ENTRYA): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherA';
function StartServiceCtrlDispatcherW(var lpServiceStartTable: SERVICE_TABLE_ENTRYW): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherW';
function StartServiceCtrlDispatcherW(lpServiceStartTable: LPSERVICE_TABLE_ENTRYW): BOOL; stdcall; overload;
  external advapi32 name 'StartServiceCtrlDispatcherW';
