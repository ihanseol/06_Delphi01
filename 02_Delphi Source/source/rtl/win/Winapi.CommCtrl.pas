...
// Edit Control Extended Styles to use with EM_SETEXTENDEDSTYLE/EM_GETEXTENDEDSTYLE
  {$EXTERNALSYM ES_EX_ALLOWEOL_CR}
  ES_EX_ALLOWEOL_CR = $0001;
  {$EXTERNALSYM ES_EX_ALLOWEOL_LF}
  ES_EX_ALLOWEOL_LF = $0002;
  {$EXTERNALSYM ES_EX_ALLOWEOL_ALL}
  ES_EX_ALLOWEOL_ALL = ES_EX_ALLOWEOL_CR or ES_EX_ALLOWEOL_LF;
  {$EXTERNALSYM ES_EX_CONVERT_EOL_ON_PASTE}
  ES_EX_CONVERT_EOL_ON_PASTE = $0004;

  {$EXTERNALSYM ES_EX_ZOOMABLE}
  ES_EX_ZOOMABLE = $0010;
...
const
  ...
  {$EXTERNALSYM EC_ENDOFLINE_DETECTFROMCONTENT}
  EC_ENDOFLINE_CRLF              = 1;
  {$EXTERNALSYM EC_ENDOFLINE_CRLF}
  EC_ENDOFLINE_CR                = 2;
  {$EXTERNALSYM EC_ENDOFLINE_CR}
  EC_ENDOFLINE_LF                = 3;
  {$EXTERNALSYM EC_ENDOFLINE_LF}

  {$EXTERNALSYM EM_SETEXTENDEDSTYLE}
  EM_SETEXTENDEDSTYLE     = ECM_FIRST + 10;
  {$EXTERNALSYM EM_GETEXTENDEDSTYLE}
  EM_GETEXTENDEDSTYLE     = ECM_FIRST + 11;
  {$EXTERNALSYM EM_SETENDOFLINE}
  EM_SETENDOFLINE         = ECM_FIRST + 12;
  {$EXTERNALSYM EM_GETENDOFLINE}
  EM_GETENDOFLINE         = ECM_FIRST + 13;
  {$EXTERNALSYM EM_ENABLESEARCHWEB}
  EM_ENABLESEARCHWEB      = ECM_FIRST + 14;
  {$EXTERNALSYM EM_SEARCHWEB}
  EM_SEARCHWEB            = ECM_FIRST + 15;
  {$EXTERNALSYM EM_SETCARETINDEX}
  EM_SETCARETINDEX        = ECM_FIRST + 17;
  {$EXTERNALSYM EM_GETCARETINDEX}
  EM_GETCARETINDEX        = ECM_FIRST + 18;
  {$EXTERNALSYM EM_GETZOOM}
  EM_GETZOOM              = WM_USER + 224;
  {$EXTERNALSYM EM_SETZOOM}
  EM_SETZOOM              = WM_USER + 225;
  {$EXTERNALSYM EM_FILELINEFROMCHAR}
  EM_FILELINEFROMCHAR     = ECM_FIRST + 19;
  {$EXTERNALSYM EM_FILELINEINDEX}
  EM_FILELINEINDEX        = ECM_FIRST + 20;
  {$EXTERNALSYM EM_FILELINELENGTH}
  EM_FILELINELENGTH       = ECM_FIRST + 21;
  {$EXTERNALSYM EM_GETFILELINE}
  EM_GETFILELINE          = ECM_FIRST + 22;
  {$EXTERNALSYM EM_GETFILELINECOUNT}
...
type
  ...
  {$EXTERNALSYM EC_SEARCHWEB_ENTRYPOINT}
const
  EC_SEARCHWEB_ENTRYPOINT_EXTERNAL    = 0;
  {$EXTERNALSYM EC_SEARCHWEB_ENTRYPOINT_EXTERNAL}
  EC_SEARCHWEB_ENTRYPOINT_CONTEXTMENU = 1;
  {$EXTERNALSYM EC_SEARCHWEB_ENTRYPOINT_CONTEXTMENU}
