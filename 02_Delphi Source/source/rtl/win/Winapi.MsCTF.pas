...
var
  ...
  MsCTFHandle: THandle deprecated 'MsCTFHandle is moved to Winapi.MsCTF.PkgHelper unit.' = 0;
...
begin
  if not Assigned(SetInputScopeProc) and (Winapi.MsCTF.PkgHelper.MsCTFHandle <> 0) then
    @SetInputScopeProc := GetProcAddress(Winapi.MsCTF.PkgHelper.MsCTFHandle, 'SetInputScope');
