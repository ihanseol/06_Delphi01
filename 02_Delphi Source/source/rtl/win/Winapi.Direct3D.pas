...
var
  DXFileDLL : HMODULE deprecated 'DXFileDLL is moved to Winapi.Direct3D.PkgHelper unit.';
...
var
  I: IInterface;
begin
  Result := Winapi.Direct3D.PkgHelper.DirectXFileCreate(I);
  lplpDirectXFile := I as IDirectXFile;
end;
