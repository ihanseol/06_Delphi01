...
const
  ...
  SID_IApplicationActivationManager           = '{2E941141-7F97-4756-BA1D-9DECDE894A3D}';
...
type
  ...
  ICategorizer = interface(IUnknown)
    ...
    function GetCategory(cidl: UINT; apidl: PCUIDLIST_CHILD_ARRAY;
...
type
  ...
  [SID_IApplicationActivationManager]
    function ActivateApplication(appUserModelId: LPCWSTR; arguments: LPCWSTR; activateOptions: DWORD; var processId: DWORD): HRESULT; stdcall;
    function ActivateForFile(appUserModelId: LPCWSTR; const itemArray: IShellItemArray; verb: LPCWSTR; var processId: DWORD): HRESULT; stdcall;
    function ActivateForProtocol(appUserModelId: LPCWSTR; const itemArray: IShellItemArray; var processId: DWORD): HRESULT; stdcall;
  end;
