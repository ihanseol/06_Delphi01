...
const
  ...
  DWMWA_CLOAK                          = 13; // [set] Cloaks the window such that it is not visible to the user
  {$EXTERNALSYM DWMWA_CLOAK}
  DWMWA_CLOAKED                        = 14; // [get] If the window is cloaked, return a value explaining why
  {$EXTERNALSYM DWMWA_CLOAKED}
  DWMWA_FREEZE_REPRESENTATION          = 15; // [set] Freeze the window's thumbnail image with its current visuals
  {$EXTERNALSYM DWMWA_FREEZE_REPRESENTATION}
  DWMWA_PASSIVE_UPDATE_MODE            = 16;
  {$EXTERNALSYM DWMWA_PASSIVE_UPDATE_MODE}
  DWMWA_USE_HOSTBACKDROPBRUSH          = 17; // [set] Enables a non-UWP window to use host backdrop brushes
  {$EXTERNALSYM DWMWA_USE_HOSTBACKDROPBRUSH}
  DWMWA_USE_IMMERSIVE_DARK_MODE        = 20; // [set] Allows the window frame for this window to be drawn in dark mode colors when the dark mode system setting is enabled
  {$EXTERNALSYM DWMWA_USE_IMMERSIVE_DARK_MODE}
  DWMWA_WINDOW_CORNER_PREFERENCE       = 33; // [set] Specifies the rounded corner preference for a window
  {$EXTERNALSYM DWMWA_WINDOW_CORNER_PREFERENCE}
  DWMWA_BORDER_COLOR                   = 34; // [set] Specifies the color of the window border
  {$EXTERNALSYM DWMWA_BORDER_COLOR}
  DWMWA_CAPTION_COLOR                  = 35; // [set] Specifies the color of the caption
  {$EXTERNALSYM DWMWA_CAPTION_COLOR}
  DWMWA_TEXT_COLOR                     = 36; // [set] Specifies the color of the caption text
  {$EXTERNALSYM DWMWA_TEXT_COLOR}
  DWMWA_VISIBLE_FRAME_BORDER_THICKNESS = 37; // [get] Retrieves the width of the outer border that the DWM would draw around this window
  {$EXTERNALSYM DWMWA_VISIBLE_FRAME_BORDER_THICKNESS}
  DWMWA_SYSTEMBACKDROP_TYPE            = 38; // [get/set] Retrieves or specifies the system-drawn backdrop material of a window, including behind the non-client area
  {$EXTERNALSYM DWMWA_SYSTEMBACKDROP_TYPE}
  DWMWA_LAST                           = 39;
...
const
  DWM_CLOAKED_APP       = 1; // The window was cloaked by its owner application
  {$EXTERNALSYM DWM_CLOAKED_APP}
  DWM_CLOAKED_SHELL     = 2; // The window was cloaked by the Shell
  {$EXTERNALSYM DWM_CLOAKED_SHELL}
  DWM_CLOAKED_INHERITED = 4; // The cloak value was inherited from its owner window
  {$EXTERNALSYM DWM_CLOAKED_INHERITED}
