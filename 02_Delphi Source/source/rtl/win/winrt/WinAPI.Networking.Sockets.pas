...
type
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerMessageWebSocket,Windows.Networking.Sockets.IMessageWebSocketMessageReceivedEventArgs>
  TypedEventHandler_2__IServerMessageWebSocket__IMessageWebSocketMessageReceivedEventArgs_Delegate_Base = interface(IUnknown)
  ['{6E66714B-94D1-5C08-B2B3-10B891D08747}']
    procedure Invoke(sender: IServerMessageWebSocket; args: IMessageWebSocketMessageReceivedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerMessageWebSocket,Windows.Networking.Sockets.IMessageWebSocketMessageReceivedEventArgs>
  TypedEventHandler_2__IServerMessageWebSocket__IMessageWebSocketMessageReceivedEventArgs = interface(TypedEventHandler_2__IServerMessageWebSocket__IMessageWebSocketMessageReceivedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerMessageWebSocket,Windows.Networking.Sockets.IWebSocketClosedEventArgs>
  TypedEventHandler_2__IServerMessageWebSocket__IWebSocketClosedEventArgs_Delegate_Base = interface(IUnknown)
  ['{CAE65204-B986-5CF3-87EA-B67B00FBA78D}']
    procedure Invoke(sender: IServerMessageWebSocket; args: IWebSocketClosedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerMessageWebSocket,Windows.Networking.Sockets.IWebSocketClosedEventArgs>
  TypedEventHandler_2__IServerMessageWebSocket__IWebSocketClosedEventArgs = interface(TypedEventHandler_2__IServerMessageWebSocket__IWebSocketClosedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerStreamWebSocket,Windows.Networking.Sockets.IWebSocketClosedEventArgs>
  TypedEventHandler_2__IServerStreamWebSocket__IWebSocketClosedEventArgs_Delegate_Base = interface(IUnknown)
  ['{B51C5B3B-161B-559E-A553-0059336329CC}']
    procedure Invoke(sender: IServerStreamWebSocket; args: IWebSocketClosedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Networking.Sockets.IServerStreamWebSocket,Windows.Networking.Sockets.IWebSocketClosedEventArgs>
  TypedEventHandler_2__IServerStreamWebSocket__IWebSocketClosedEventArgs = interface(TypedEventHandler_2__IServerStreamWebSocket__IWebSocketClosedEventArgs_Delegate_Base)
