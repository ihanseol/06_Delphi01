...
type
  ...
  Haptics_IKnownSimpleHapticsControllerWaveformsStatics2 = interface;
  PHaptics_IKnownSimpleHapticsControllerWaveformsStatics2 = ^Haptics_IKnownSimpleHapticsControllerWaveformsStatics2;
  ...
  Input_IPenDevice2 = interface;
  PInput_IPenDevice2 = ^Input_IPenDevice2;
  ...
  IVector_1__Boolean = interface;
  PIVector_1__Boolean = ^IVector_1__Boolean;
  ...
  // Windows.Foundation.IReference`1<Windows.Devices.WiFi.WiFiOnDemandHotspotCellularBars>
  IReference_1__WiFi_WiFiOnDemandHotspotCellularBars = interface;
  PIReference_1__WiFi_WiFiOnDemandHotspotCellularBars = ^IReference_1__WiFi_WiFiOnDemandHotspotCellularBars;
  ...
  Display_Core_DisplayPresentStatus = (
    Success = 0,
  ...
  PDisplay_Core_DisplayPresentStatus = ^Display_Core_DisplayPresentStatus;
  ...
  Display_Core_DisplayScanoutOptions = (
    None = 0,
    AllowTearing = 2
  );
  PDisplay_Core_DisplayScanoutOptions = ^Display_Core_DisplayScanoutOptions;

  // Windows.Devices.Display.Core.DisplaySourceStatus
  Display_Core_DisplaySourceStatus = (
    Active = 0,
    PoweredOff = 1,
    Invalid = 2,
  ...
  PDisplay_Core_DisplaySourceStatus = ^Display_Core_DisplaySourceStatus;
  ...
  Printers_IppAttributeErrorReason = (
  ...
  PPrinters_IppAttributeErrorReason = ^Printers_IppAttributeErrorReason;

  // Windows.Devices.Printers.IppAttributeValueKind
  Printers_IppAttributeValueKind = (
    Unsupported = 0,
    Unknown = 1,
    NoValue = 2,
    Integer = 3,
  ...
  PPrinters_IppAttributeValueKind = ^Printers_IppAttributeValueKind;

  // Windows.Devices.Printers.IppResolutionUnit
  Printers_IppResolutionUnit = (
    DotsPerInch = 0,
    DotsPerCentimeter = 1
  );
  PPrinters_IppResolutionUnit = ^Printers_IppResolutionUnit;

  // Windows.Devices.Printers.PageConfigurationSource
  Printers_PageConfigurationSource = (
    PrintJobConfiguration = 0,
    PdlContent = 1
  );
  PPrinters_PageConfigurationSource = ^Printers_PageConfigurationSource;
  ...
  WiFi_WiFiOnDemandHotspotAvailability = (
    Available = 0,
    Unavailable = 1
  );
  PWiFi_WiFiOnDemandHotspotAvailability = ^WiFi_WiFiOnDemandHotspotAvailability;

  // Windows.Devices.WiFi.WiFiOnDemandHotspotCellularBars
  WiFi_WiFiOnDemandHotspotCellularBars = (
    ZeroBars = 0,
    OneBar = 1,
    TwoBars = 2,
    ThreeBars = 3,
  ...
  PWiFi_WiFiOnDemandHotspotCellularBars = ^WiFi_WiFiOnDemandHotspotCellularBars;

  // Windows.Devices.WiFi.WiFiOnDemandHotspotConnectStatus
  WiFi_WiFiOnDemandHotspotConnectStatus = (
    UnspecifiedFailure = 0,
    Success = 1,
    AppTimedOut = 2,
    InvalidCredential = 3,
  ...
  PWiFi_WiFiOnDemandHotspotConnectStatus = ^WiFi_WiFiOnDemandHotspotConnectStatus;
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Input.PointerDeviceUsage>
  IIterable_1__Input_PointerDeviceUsage = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Display.IDisplayMonitor>
  AsyncOperationCompletedHandler_1__Display_IDisplayMonitor_Delegate_Base = interface(IUnknown)
  ['{620F34A8-5DBA-59DF-B719-99B77970344C}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__Display_IDisplayMonitor; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Display.IDisplayMonitor>
  AsyncOperationCompletedHandler_1__Display_IDisplayMonitor = interface(AsyncOperationCompletedHandler_1__Display_IDisplayMonitor_Delegate_Base)
  ['{BD3DD651-96EF-5DB9-A92B-56339D1CDEBD}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Display.IDisplayMonitor>
  IAsyncOperation_1__Display_IDisplayMonitor_Base = interface(IInspectable)
  ['{28C0E623-4E46-58C3-AD82-502BDECC4345}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Display.IDisplayMonitor>
  IAsyncOperation_1__Display_IDisplayMonitor = interface(IAsyncOperation_1__Display_IDisplayMonitor_Base)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.Gpio.GpioChangeRecord>
  IIterator_1__Gpio_GpioChangeRecord = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Gpio.GpioChangeRecord>
  IIterable_1__Gpio_GpioChangeRecord = interface(IInspectable)
  ...
  ['{D30AB625-1264-539E-ACEF-306DD214DC3B}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IVector`1<Windows.Devices.Gpio.GpioChangeRecord>
  IVector_1__Gpio_GpioChangeRecord = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.Gpio.Provider.IGpioControllerProvider>
  IIterator_1__Gpio_Provider_IGpioControllerProvider = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Gpio.Provider.IGpioControllerProvider>
  IIterable_1__Gpio_Provider_IGpioControllerProvider = interface(IInspectable)
  ...
  // Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2
  [WinRTClassNameAttribute(SWindows_Devices_Haptics_KnownSimpleHapticsControllerWaveforms)]
  Haptics_IKnownSimpleHapticsControllerWaveformsStatics2 = interface(IInspectable)
  ['{A7D24C27-B79D-510A-BF79-FF6D49173E1D}']
    function get_BrushContinuous: Word; safecall;
    function get_ChiselMarkerContinuous: Word; safecall;
    function get_EraserContinuous: Word; safecall;
    function get_Error: Word; safecall;
    function get_GalaxyPenContinuous: Word; safecall;
    function get_Hover: Word; safecall;
    function get_InkContinuous: Word; safecall;
    function get_MarkerContinuous: Word; safecall;
    function get_PencilContinuous: Word; safecall;
    function get_Success: Word; safecall;
    property BrushContinuous: Word read get_BrushContinuous;
    property ChiselMarkerContinuous: Word read get_ChiselMarkerContinuous;
    property EraserContinuous: Word read get_EraserContinuous;
    property Error: Word read get_Error;
    property GalaxyPenContinuous: Word read get_GalaxyPenContinuous;
    property Hover: Word read get_Hover;
    property InkContinuous: Word read get_InkContinuous;
    property MarkerContinuous: Word read get_MarkerContinuous;
    property PencilContinuous: Word read get_PencilContinuous;
    property Success: Word read get_Success;
  end;
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Haptics.VibrationAccessStatus>
  AsyncOperationCompletedHandler_1__Haptics_VibrationAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Haptics.VibrationAccessStatus>
  IAsyncOperation_1__Haptics_VibrationAccessStatus = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.I2c.Provider.II2cControllerProvider>
  IIterator_1__I2c_Provider_II2cControllerProvider = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.I2c.Provider.II2cControllerProvider>
  IIterable_1__I2c_Provider_II2cControllerProvider = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Devices.I2c.Provider.II2cControllerProvider>>
  AsyncOperationCompletedHandler_1__IVectorView_1__I2c_Provider_II2cControllerProvider = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Devices.I2c.Provider.II2cControllerProvider>>
  IAsyncOperation_1__IVectorView_1__I2c_Provider_II2cControllerProvider = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Object>
  TypedEventHandler_2__Input_IPenButtonListener__IInspectable_Delegate_Base = interface(IUnknown)
  ['{0A0EE5ED-041B-5569-B4A4-A1E58F1343A2}']
    procedure Invoke(sender: Input_IPenButtonListener; args: IInspectable); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Object>
  TypedEventHandler_2__Input_IPenButtonListener__IInspectable = interface(TypedEventHandler_2__Input_IPenButtonListener__IInspectable_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonClickedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonClickedEventArgs_Delegate_Base = interface(IUnknown)
  ['{2EDA7109-F1C9-5F26-A054-3D25062CC0DE}']
    procedure Invoke(sender: Input_IPenButtonListener; args: Input_IPenTailButtonClickedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonClickedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonClickedEventArgs = interface(TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonClickedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonDoubleClickedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonDoubleClickedEventArgs_Delegate_Base = interface(IUnknown)
  ['{E6E58D94-6F7B-593F-81F0-033150B4432C}']
    procedure Invoke(sender: Input_IPenButtonListener; args: Input_IPenTailButtonDoubleClickedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonDoubleClickedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonDoubleClickedEventArgs = interface(TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonDoubleClickedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonLongPressedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonLongPressedEventArgs_Delegate_Base = interface(IUnknown)
  ['{CA6DAB1F-20D6-52B0-94CE-6DCC75A1A984}']
    procedure Invoke(sender: Input_IPenButtonListener; args: Input_IPenTailButtonLongPressedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenButtonListener,Windows.Devices.Input.IPenTailButtonLongPressedEventArgs>
  TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonLongPressedEventArgs = interface(TypedEventHandler_2__Input_IPenButtonListener__Input_IPenTailButtonLongPressedEventArgs_Delegate_Base)
  ...
  // UsedAPI Interface
  // Windows.Devices.Input.IPenDevice2
  Input_IPenDevice2 = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Object>
  TypedEventHandler_2__Input_IPenDockListener__IInspectable_Delegate_Base = interface(IUnknown)
  ['{7CEAE82F-499A-5B31-A1D8-3B11C53C7871}']
    procedure Invoke(sender: Input_IPenDockListener; args: IInspectable); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Object>
  TypedEventHandler_2__Input_IPenDockListener__IInspectable = interface(TypedEventHandler_2__Input_IPenDockListener__IInspectable_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Windows.Devices.Input.IPenDockedEventArgs>
  TypedEventHandler_2__Input_IPenDockListener__Input_IPenDockedEventArgs_Delegate_Base = interface(IUnknown)
  ['{19786A6C-8E23-5DE7-A773-E711A5A068C5}']
    procedure Invoke(sender: Input_IPenDockListener; args: Input_IPenDockedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Windows.Devices.Input.IPenDockedEventArgs>
  TypedEventHandler_2__Input_IPenDockListener__Input_IPenDockedEventArgs = interface(TypedEventHandler_2__Input_IPenDockListener__Input_IPenDockedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Windows.Devices.Input.IPenUndockedEventArgs>
  TypedEventHandler_2__Input_IPenDockListener__Input_IPenUndockedEventArgs_Delegate_Base = interface(IUnknown)
  ['{51DBA508-3194-5C91-A2E7-F94637E75A13}']
    procedure Invoke(sender: Input_IPenDockListener; args: Input_IPenUndockedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Devices.Input.IPenDockListener,Windows.Devices.Input.IPenUndockedEventArgs>
  TypedEventHandler_2__Input_IPenDockListener__Input_IPenUndockedEventArgs = interface(TypedEventHandler_2__Input_IPenDockListener__Input_IPenUndockedEventArgs_Delegate_Base)
  ...
  // Windows.Foundation.Collections.IVector`1<Boolean>
  IVector_1__Boolean = interface(IInspectable)
  ['{6180171D-2ED8-5E24-8A55-01ECB1009EB2}']
    function GetAt(index: Cardinal): Boolean; safecall;
    function get_Size: Cardinal; safecall;
    function GetView: IVectorView_1__Boolean; safecall;
    function IndexOf(value: Boolean; out index: Cardinal): Boolean; safecall;
    procedure SetAt(index: Cardinal; value: Boolean); safecall;
    procedure InsertAt(index: Cardinal; value: Boolean); safecall;
    procedure RemoveAt(index: Cardinal); safecall;
    procedure Append(value: Boolean); safecall;
    procedure RemoveAtEnd; safecall;
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PBoolean): Cardinal; safecall;
    procedure ReplaceAll(itemsSize: Cardinal; items: PBoolean); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.SmartCards.SmartCardReaderStatus>
  AsyncOperationCompletedHandler_1__SmartCards_SmartCardReaderStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.SmartCards.SmartCardReaderStatus>
  IAsyncOperation_1__SmartCards_SmartCardReaderStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.SmartCards.SmartCardStatus>
  AsyncOperationCompletedHandler_1__SmartCards_SmartCardStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.SmartCards.SmartCardStatus>
  IAsyncOperation_1__SmartCards_SmartCardStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.SmartCards.SmartCardActivationPolicyChangeResult>
  AsyncOperationCompletedHandler_1__SmartCards_SmartCardActivationPolicyChangeResult = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.SmartCards.SmartCardActivationPolicyChangeResult>
  IAsyncOperation_1__SmartCards_SmartCardActivationPolicyChangeResult = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialType>
  IIterator_1__SmartCards_SmartCardCryptogramMaterialType = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialType>
  IIterable_1__SmartCards_SmartCardCryptogramMaterialType = interface(IInspectable)
  ...
  ['{394BC0CC-C621-5BA3-B4F0-712FCF591392}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.SmartCards.SmartCardCryptogramAlgorithm>
  IIterator_1__SmartCards_SmartCardCryptogramAlgorithm = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramAlgorithm>
  IIterable_1__SmartCards_SmartCardCryptogramAlgorithm = interface(IInspectable)
  ...
  ['{A9DF831C-C22B-5D30-A86C-5A31FE192433}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialPackageFormat>
  IIterator_1__SmartCards_SmartCardCryptogramMaterialPackageFormat = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialPackageFormat>
  IIterable_1__SmartCards_SmartCardCryptogramMaterialPackageFormat = interface(IInspectable)
  ...
  ['{B7CCE3F2-9889-586C-BEB1-68FEDDB7CB15}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialPackageConfirmationResponseFormat>
  IIterator_1__SmartCards_SmartCardCryptogramMaterialPackageConfirmationResponseFormat = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramMaterialPackageConfirmationResponseFormat>
  IIterable_1__SmartCards_SmartCardCryptogramMaterialPackageConfirmationResponseFormat = interface(IInspectable)
  ...
  ['{3A4176A2-D221-5A9F-A4C2-A5B8736DA2D8}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.SmartCards.SmartCardCryptogramStorageKeyCapabilities>
  IIterator_1__SmartCards_SmartCardCryptogramStorageKeyCapabilities = interface(IInspectable)
  ['{9C12738D-E06E-5269-B455-B4D0CD128000}']
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramStorageKeyCapabilities>
  IIterable_1__SmartCards_SmartCardCryptogramStorageKeyCapabilities = interface(IInspectable)
  ['{E457FBB7-CEF9-5C43-B951-328DA58D0B62}']
  ...
  ['{8F4607F4-FF4B-584B-B2CF-4952A4D68AFD}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.SmartCards.SmartCardCryptogramGeneratorOperationStatus>
  AsyncOperationCompletedHandler_1__SmartCards_SmartCardCryptogramGeneratorOperationStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.SmartCards.SmartCardCryptogramGeneratorOperationStatus>
  IAsyncOperation_1__SmartCards_SmartCardCryptogramGeneratorOperationStatus = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.Spi.Provider.ISpiControllerProvider>
  IIterator_1__Spi_Provider_ISpiControllerProvider = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Spi.Provider.ISpiControllerProvider>
  IIterable_1__Spi_Provider_ISpiControllerProvider = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Devices.Spi.Provider.ISpiControllerProvider>>
  AsyncOperationCompletedHandler_1__IVectorView_1__Spi_Provider_ISpiControllerProvider = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Devices.Spi.Provider.ISpiControllerProvider>>
  IAsyncOperation_1__IVectorView_1__Spi_Provider_ISpiControllerProvider = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.WiFi.WiFiWpsKind>
  IIterator_1__WiFi_WiFiWpsKind = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.WiFi.WiFiWpsKind>
  IIterable_1__WiFi_WiFiWpsKind = interface(IInspectable)
  ...
  ['{AAE7E5E5-27F0-5B28-8C58-9039356D3DC7}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.WiFi.WiFiAccessStatus>
  AsyncOperationCompletedHandler_1__WiFi_WiFiAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.WiFi.WiFiAccessStatus>
  IAsyncOperation_1__WiFi_WiFiAccessStatus = interface(IInspectable)
  ...
  // Windows.Foundation.IReference`1<Windows.Devices.WiFi.WiFiOnDemandHotspotCellularBars>
  IReference_1__WiFi_WiFiOnDemandHotspotCellularBars = interface(IInspectable)
  ['{D5CC7E52-2520-5460-84E6-8258C83D0C68}']
    function get_Value: WiFi_WiFiOnDemandHotspotCellularBars; safecall;
    property Value: WiFi_WiFiOnDemandHotspotCellularBars read get_Value;
  end;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod>
  IIterator_1__WiFiDirect_WiFiDirectConfigurationMethod = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod>
  IIterable_1__WiFiDirect_WiFiDirectConfigurationMethod = interface(IInspectable)
  ...
  ['{61A32670-04D3-551D-AD66-BD04E9EF5C78}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IVector`1<Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod>
  IVector_1__WiFiDirect_WiFiDirectConfigurationMethod = interface(IInspectable)
  ...
  ['{DC710FE1-7F04-515B-8AC1-1C5D3C0D2B28}']
  ...
  // Statics: "Windows.Devices.Haptics.IKnownSimpleHapticsControllerWaveformsStatics2"
  THaptics_KnownSimpleHapticsControllerWaveforms = class(TWinRTGenericImportS2<Haptics_IKnownSimpleHapticsControllerWaveformsStatics, Haptics_IKnownSimpleHapticsControllerWaveformsStatics2>)
  public
    ...
    // -> Haptics_IKnownSimpleHapticsControllerWaveformsStatics2
    class function get_BrushContinuous: Word; static; inline;
    class function get_ChiselMarkerContinuous: Word; static; inline;
    class function get_EraserContinuous: Word; static; inline;
    class function get_Error: Word; static; inline;
    class function get_GalaxyPenContinuous: Word; static; inline;
    class function get_Hover: Word; static; inline;
    class function get_InkContinuous: Word; static; inline;
    class function get_MarkerContinuous: Word; static; inline;
    class function get_PencilContinuous: Word; static; inline;
    class function get_Success: Word; static; inline;
    class property BrushContinuous: Word read get_BrushContinuous;
    class property ChiselMarkerContinuous: Word read get_ChiselMarkerContinuous;
    class property EraserContinuous: Word read get_EraserContinuous;
    class property Error: Word read get_Error;
    class property GalaxyPenContinuous: Word read get_GalaxyPenContinuous;
    class property Hover: Word read get_Hover;
    class property InkContinuous: Word read get_InkContinuous;
    class property MarkerContinuous: Word read get_MarkerContinuous;
    class property PencilContinuous: Word read get_PencilContinuous;
    class property Success: Word read get_Success;
  end;
  ...
  // Implements: Windows.Devices.Input.IPenDevice2
...
class function THaptics_KnownSimpleHapticsControllerWaveforms.get_BrushContinuous: Word;
begin
  Result := Statics2.get_BrushContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_ChiselMarkerContinuous: Word;
begin
  Result := Statics2.get_ChiselMarkerContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_EraserContinuous: Word;
begin
  Result := Statics2.get_EraserContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_Error: Word;
begin
  Result := Statics2.get_Error;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_GalaxyPenContinuous: Word;
begin
  Result := Statics2.get_GalaxyPenContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_Hover: Word;
begin
  Result := Statics2.get_Hover;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_InkContinuous: Word;
begin
  Result := Statics2.get_InkContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_MarkerContinuous: Word;
begin
  Result := Statics2.get_MarkerContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_PencilContinuous: Word;
begin
  Result := Statics2.get_PencilContinuous;
end;

class function THaptics_KnownSimpleHapticsControllerWaveforms.get_Success: Word;
begin
  Result := Statics2.get_Success;
end;
