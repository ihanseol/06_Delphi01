...
type
  ...
  Provider_IStorageProviderUICommand = interface;
  PProvider_IStorageProviderUICommand = ^Provider_IStorageProviderUICommand;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IIterator_1__Provider_IStorageProviderUICommand = interface;
  PIIterator_1__Provider_IStorageProviderUICommand = ^IIterator_1__Provider_IStorageProviderUICommand;

  // Windows.Foundation.Collections.IIterable`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IIterable_1__Provider_IStorageProviderUICommand = interface;
  PIIterable_1__Provider_IStorageProviderUICommand = ^IIterable_1__Provider_IStorageProviderUICommand;

  // Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IVectorView_1__Provider_IStorageProviderUICommand = interface;
  PIVectorView_1__Provider_IStorageProviderUICommand = ^IVectorView_1__Provider_IStorageProviderUICommand;

  // Windows.Foundation.Collections.IVector`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IVector_1__Provider_IStorageProviderUICommand = interface;
  PIVector_1__Provider_IStorageProviderUICommand = ^IVector_1__Provider_IStorageProviderUICommand;
  ...
  PProvider_StorageProviderState = ^Provider_StorageProviderState;

  // Windows.Storage.Provider.StorageProviderUICommandState
  Provider_StorageProviderUICommandState = (
    Enabled = 0,
    Disabled = 1,
    Hidden = 2
  );
  PProvider_StorageProviderUICommandState = ^Provider_StorageProviderUICommandState;
  ...
  ['{43E29F53-0298-55AA-A6C8-4EDD323D9598}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Storage.Provider.FileUpdateStatus>
  AsyncOperationCompletedHandler_1__Provider_FileUpdateStatus = interface(IUnknown)
  ...
  ['{A2F87FC6-4EA5-58CF-9490-181604FBD6A2}']
  ...
  ['{D7F094B5-0EA2-5654-85B9-38EE5DE90FFA}']
  ...
  // Windows.Storage.Provider.IStorageProviderUICommand
  Provider_IStorageProviderUICommand = interface(IInspectable)
  ['{0C3E0760-D846-568F-9484-105CC57B502B}']
    ...
    function get_State: Provider_StorageProviderUICommandState; safecall;
    procedure Invoke; safecall;
    property Description: HSTRING read get_Description;
    property Icon: IUriRuntimeClass read get_Icon;
    property &Label: HSTRING read get_Label;
    property State: Provider_StorageProviderUICommandState read get_State;
  end;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IIterator_1__Provider_IStorageProviderUICommand = interface(IInspectable)
  ['{9623990B-1B26-5F45-9F95-43D43B1CFD4C}']
    function get_Current: Provider_IStorageProviderUICommand; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PProvider_IStorageProviderUICommand): Cardinal; safecall;
    property Current: Provider_IStorageProviderUICommand read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IIterable_1__Provider_IStorageProviderUICommand = interface(IInspectable)
  ['{2042AA99-0A84-5D22-B6AE-F7FD19B4E236}']
    function First: IIterator_1__Provider_IStorageProviderUICommand; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IVectorView_1__Provider_IStorageProviderUICommand = interface(IInspectable)
  ['{42E170A8-D66A-55B1-BAB5-9E4C650D7FFB}']
    function GetAt(index: Cardinal): Provider_IStorageProviderUICommand; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: Provider_IStorageProviderUICommand; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PProvider_IStorageProviderUICommand): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;

  // Windows.Foundation.Collections.IVector`1<Windows.Storage.Provider.IStorageProviderUICommand>
  IVector_1__Provider_IStorageProviderUICommand = interface(IInspectable)
  ['{12974CA5-6AB5-5F80-A379-6638F9734F3A}']
    function GetAt(index: Cardinal): Provider_IStorageProviderUICommand; safecall;
    function get_Size: Cardinal; safecall;
    function GetView: IVectorView_1__Provider_IStorageProviderUICommand; safecall;
    function IndexOf(value: Provider_IStorageProviderUICommand; out index: Cardinal): Boolean; safecall;
    procedure SetAt(index: Cardinal; value: Provider_IStorageProviderUICommand); safecall;
    procedure InsertAt(index: Cardinal; value: Provider_IStorageProviderUICommand); safecall;
    procedure RemoveAt(index: Cardinal); safecall;
    procedure Append(value: Provider_IStorageProviderUICommand); safecall;
    procedure RemoveAtEnd; safecall;
    procedure Clear; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PProvider_IStorageProviderUICommand): Cardinal; safecall;
    procedure ReplaceAll(itemsSize: Cardinal; items: PProvider_IStorageProviderUICommand); safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IIterator_1__Provider_IStorageProviderFileTypeInfo_Base = interface(IInspectable)
  ['{7D5B1532-3CA2-5930-A3C8-7C488F6AC2FB}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IIterator_1__Provider_IStorageProviderFileTypeInfo = interface(IIterator_1__Provider_IStorageProviderFileTypeInfo_Base)
  ['{D0BD2F7E-B8BE-5AE2-B490-440D80493E42}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IIterable_1__Provider_IStorageProviderFileTypeInfo_Base = interface(IInspectable)
  ['{B21025BC-4365-5728-B52E-51475166F141}']
    function First: IIterator_1__Provider_IStorageProviderFileTypeInfo; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IIterable_1__Provider_IStorageProviderFileTypeInfo = interface(IIterable_1__Provider_IStorageProviderFileTypeInfo_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IVector`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IVector_1__Provider_IStorageProviderFileTypeInfo_Base = interface(IInspectable)
  ['{9172E4AB-A9CA-5CC4-9311-363F9F097DA5}']
    function GetAt(index: Cardinal): Provider_IStorageProviderFileTypeInfo; safecall;
    function get_Size: Cardinal; safecall;
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IVector`1<Windows.Storage.Provider.IStorageProviderFileTypeInfo>
  IVector_1__Provider_IStorageProviderFileTypeInfo = interface(IVector_1__Provider_IStorageProviderFileTypeInfo_Base)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Storage.Search.IndexedState>
  AsyncOperationCompletedHandler_1__Search_IndexedState = interface(IUnknown)
