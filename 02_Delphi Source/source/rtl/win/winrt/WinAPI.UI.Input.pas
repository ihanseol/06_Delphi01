...
type
  ...
  ['{27A0F2C4-461F-50AB-AF8F-D9D99F30B67D}']
  ...
  ['{5764EB43-DB4F-5FEA-9BC5-AF0158F26929}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.Input.RadialControllerSystemMenuItemKind>
  IIterator_1__RadialControllerSystemMenuItemKind = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.Input.RadialControllerSystemMenuItemKind>
  IIterable_1__RadialControllerSystemMenuItemKind = interface(IInspectable)
