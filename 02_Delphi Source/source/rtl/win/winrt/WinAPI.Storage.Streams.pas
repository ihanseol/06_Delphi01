...
type
  ...
  PIPropertySetSerializer = ^IPropertySetSerializer;
  ...
  ['{FCD5C86F-07E0-5913-A023-B8A898D869F9}']
  ...
  ['{3E3C7C86-0B46-5FF2-A85F-CDF917CF56FD}']
  ...
  ['{928144C1-3E5A-54F0-8AA6-CEF352290E33}']
  ...
  ['{E92DC1B4-2577-59B7-8B4C-4DF35FF0AE61}']
  ...
  ['{4DB31225-E4BF-5170-AE9C-BBA582659316}']
    function GetAt(index: Cardinal): IRandomAccessStream; safecall;
    function get_Size: Cardinal; safecall;
  ...
  ['{C61F4F87-0899-532E-BB03-5548626176BD}']
  ...
  ['{C28C7EEE-2B20-5F75-B92E-48CFFC3EFA2A}']
  ...
  ['{2C48DDFC-8F3F-5D8A-BFC1-7D35E22C319F}']
  ...
  ['{EF884D45-7C4B-5CEF-98C1-349AFC1DC3D5}']
  ...
  ['{22D9080A-F5FF-550F-BCD4-0E11E25AE1B2}']
  ...
  ['{DC8B9D9C-EE3B-5292-BFB0-5D77BEC05076}']
  ...
  ['{39FD3369-806B-57A2-B93D-18A6068E99B1}']
  ...
  ['{73BD03D8-EEDA-5D67-A031-A98DB498EFB2}']
  ...
  ['{19B92A28-30D8-5FCA-B5E8-2A41D0BF21F8}']
  ...
  ['{023C7E1C-C8F7-5CCD-A7D9-E8683EDAB905}']
  ...
  ['{63DC3F5F-E345-5583-9456-919D40E69AAE}']
  ...
  ['{5516400B-05D3-5C9B-816B-1317421A6022}']
  ...
  ['{28572633-830C-56B6-B9B2-E5B596D01C98}']
  ...
  ['{C8F27D3F-91C8-53A2-B3AC-0DA61BA70717}']
  ...
  ['{5CDB391C-D466-56DB-B800-03875667E7A1}']
  ...
  ['{CD2C6C03-5F04-52AA-A38D-744C6CC68CB2}']
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Streams.IRandomAccessStreamWithContentType>>
  AsyncOperationCompletedHandler_1__IVectorView_1__IRandomAccessStreamWithContentType_Delegate_Base = interface(IUnknown)
  ['{5523C9AB-FD61-5863-B264-88A3A098DE4C}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Streams.IRandomAccessStreamWithContentType>>
  AsyncOperationCompletedHandler_1__IVectorView_1__IRandomAccessStreamWithContentType = interface(AsyncOperationCompletedHandler_1__IVectorView_1__IRandomAccessStreamWithContentType_Delegate_Base)
  ['{4572C48A-AAC4-5B60-AB1E-8561D15763BE}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Streams.IRandomAccessStreamWithContentType>>
  IAsyncOperation_1__IVectorView_1__IRandomAccessStreamWithContentType_Base = interface(IInspectable)
  ['{A519B496-149C-575C-B3E1-A2121C83A242}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Streams.IRandomAccessStreamWithContentType>>
  IAsyncOperation_1__IVectorView_1__IRandomAccessStreamWithContentType = interface(IAsyncOperation_1__IVectorView_1__IRandomAccessStreamWithContentType_Base)
  ...
  // Windows.Storage.Streams.IPropertySetSerializer
  IPropertySetSerializer = interface(IInspectable)
  ['{6E8EBF1C-EF3D-4376-B20E-5BE638AEAC77}']
    function Serialize(propertySet: IPropertySet): IBuffer; safecall;
    procedure Deserialize(propertySet: IPropertySet; buffer: IBuffer); safecall;
  end;
