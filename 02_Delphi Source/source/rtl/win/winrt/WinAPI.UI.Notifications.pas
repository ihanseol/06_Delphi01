...
type
  ...
  PToastNotificationMode = ^ToastNotificationMode;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.Notifications.IToastNotificationHistory2>
  AsyncOperationCompletedHandler_1__IToastNotificationHistory2_Delegate_Base = interface(IUnknown)
  ['{FEA0A49E-DEE8-5F9A-9B02-1F32101449FE}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IToastNotificationHistory2; asyncStatus: AsyncStatus); safecall;
  end;
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.Notifications.IToastNotificationHistory2>
  AsyncOperationCompletedHandler_1__IToastNotificationHistory2 = interface(AsyncOperationCompletedHandler_1__IToastNotificationHistory2_Delegate_Base)
  ['{788D1165-6B5A-5874-87BC-EC72DC7F4FD0}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.Notifications.IToastNotificationHistory2>
  IAsyncOperation_1__IToastNotificationHistory2_Base = interface(IInspectable)
  ['{92D2DAFF-3C94-5B26-877F-D3D76322210B}']
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.Notifications.IToastNotificationHistory2>
  IAsyncOperation_1__IToastNotificationHistory2 = interface(IAsyncOperation_1__IToastNotificationHistory2_Base)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus>
  AsyncOperationCompletedHandler_1__Management_UserNotificationListenerAccessStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus>
  IAsyncOperation_1__Management_UserNotificationListenerAccessStatus = interface(IInspectable)
