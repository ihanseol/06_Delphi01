...
type
  ...
  IMobileBroadbandDeviceServiceTriggerDetails2 = interface;
  PIMobileBroadbandDeviceServiceTriggerDetails2 = ^IMobileBroadbandDeviceServiceTriggerDetails2;
  ...
  IMobileBroadbandModem4 = interface;
  PIMobileBroadbandModem4 = ^IMobileBroadbandModem4;
  ...
  PMobileBroadbandSlotState = ^MobileBroadbandSlotState;
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Networking.NetworkOperators.MobileBroadbandPinType>
  IIterable_1__MobileBroadbandPinType = interface(IInspectable)
  ...
  ['{33394C13-028C-553E-867B-3C7C21B6F22D}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Networking.NetworkOperators.MobileBroadbandModemStatus>
  AsyncOperationCompletedHandler_1__MobileBroadbandModemStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Networking.NetworkOperators.MobileBroadbandModemStatus>
  IAsyncOperation_1__MobileBroadbandModemStatus = interface(IInspectable)
  ...
  // Windows.Networking.NetworkOperators.IMobileBroadbandDeviceServiceTriggerDetails2
  IMobileBroadbandDeviceServiceTriggerDetails2 = interface(IInspectable)
  ['{D83D5F16-336A-553F-94BB-0CD1A2FF0C81}']
    function get_EventId: Cardinal; safecall;
    property EventId: Cardinal read get_EventId;
  end;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Networking.NetworkOperators.IMobileBroadbandPco>
  AsyncOperationCompletedHandler_1__IMobileBroadbandPco_Delegate_Base = interface(IUnknown)
  ['{C7D3FC9E-C381-545C-A8AE-6A464EDB16A2}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IMobileBroadbandPco; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Networking.NetworkOperators.IMobileBroadbandPco>
  AsyncOperationCompletedHandler_1__IMobileBroadbandPco = interface(AsyncOperationCompletedHandler_1__IMobileBroadbandPco_Delegate_Base)
  ['{A77FCB2E-97AF-5C65-AA80-2B4E749FF659}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Networking.NetworkOperators.IMobileBroadbandPco>
  IAsyncOperation_1__IMobileBroadbandPco_Base = interface(IInspectable)
  ['{AE622260-0D4B-5B39-976B-A7AB610AC185}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Networking.NetworkOperators.IMobileBroadbandPco>
  IAsyncOperation_1__IMobileBroadbandPco = interface(IAsyncOperation_1__IMobileBroadbandPco_Base)
  ...
  // UsedAPI Interface
  // Windows.Networking.NetworkOperators.IMobileBroadbandModem4
  IMobileBroadbandModem4 = interface(IInspectable)
  ['{4A0398C2-91BE-412B-B569-586E9F0030D1}']
    function SetIsPassthroughEnabledAsync(value: Boolean; slotindex: Integer): IAsyncOperation_1__MobileBroadbandModemStatus; safecall;
    function GetIsPassthroughEnabledAsync(slotindex: Integer): IAsyncOperation_1__Boolean; safecall;
    function SetIsPassthroughEnabled(value: Boolean; slotindex: Integer): MobileBroadbandModemStatus; safecall;
    function GetIsPassthroughEnabled(slotindex: Integer): Boolean; safecall;
  end;
  ...
  // Implements: Windows.Networking.NetworkOperators.IMobileBroadbandModem4
