...
type
  ...
  ['{4E7C8847-584C-5556-8740-EFC9F67A6964}']
  ...
  ['{3BB6472F-0606-434B-A76E-74159F0684D3}']
    ...
    function get_PeripheralConnectionIntervalRange: Byte; safecall;
    ...
    property PeripheralConnectionIntervalRange: Byte read get_PeripheralConnectionIntervalRange;
  ...
  public
    ...
    class function get_PeripheralConnectionIntervalRange: Byte; static; inline;
    ...
    class property PeripheralConnectionIntervalRange: Byte read get_PeripheralConnectionIntervalRange;
...
class function TBluetoothLEAdvertisementDataTypes.get_PeripheralConnectionIntervalRange: Byte;
begin
  Result := Statics.get_PeripheralConnectionIntervalRange;
end;
