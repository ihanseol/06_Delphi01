...
type
  ...
  IVectorView_1__TimeSpan = interface;
  PIVectorView_1__TimeSpan = ^IVectorView_1__TimeSpan;
  ...
  ['{C4378382-3475-5AFA-9243-86B8395773E1}']
  ...
  ['{E8E08338-7257-51CE-BBDE-DA8949BCB54D}']
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.DateTime>
  IIterable_1__DateTime = interface(IInspectable)
  ...
  ['{135A5F72-A818-54A8-B955-DFF2593A3BF5}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.IReference`1<Windows.Foundation.DateTime>>
  AsyncOperationCompletedHandler_1__IReference_1__DateTime = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.IReference`1<Windows.Foundation.TimeSpan>>
  AsyncOperationCompletedHandler_1__IReference_1__TimeSpan = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Point>>
  IIterable_1__IIterable_1__Point = interface(IInspectable)
  ...
  ['{0B7B4C9D-182F-582A-BDDB-42B1AAC30CAD}']
  ...
  ['{48F6A69E-8465-57AE-9400-9764087F65AD}']
  ...
  ['{1EE770FF-C954-59CA-A754-6199A9BE282C}']
  ...
  ['{A18146A2-ABDA-5958-86A7-48D13EFFA294}']
  ...
  ['{61723086-8E53-5276-9F36-2A4BB93E2B75}']
    function get_Value: TSizeF; safecall;
    property Value: TSizeF read get_Value;
  end;

  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.Size>
  IIterator_1__Size = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Size>
  IIterable_1__Size = interface(IInspectable)
  ...
  ['{CB5037FD-660B-51F5-9D28-87F40878268D}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.TimeSpan>
  IIterable_1__TimeSpan = interface(IInspectable)
  ['{E9F78726-829A-5F67-8D19-95EF154B7742}']
    function First: IIterator_1__TimeSpan; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.Foundation.TimeSpan>
  IVectorView_1__TimeSpan = interface(IInspectable)
  ['{6B5828D7-6B8D-58C4-BA3A-9F796710F53C}']
    function GetAt(index: Cardinal): TimeSpan; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: TimeSpan; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PTimeSpan): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.IClosable>
  IIterator_1__IClosable_Base = interface(IInspectable)
  ['{F57B3F9E-CF38-562C-86A8-397C67E9813B}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.IClosable>
  IIterator_1__IClosable = interface(IIterator_1__IClosable_Base)
  ['{C9463957-E47D-5649-9874-4B13AE23061B}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.IClosable>
  IIterable_1__IClosable_Base = interface(IInspectable)
  ['{1A701151-AD86-5AA8-B3ED-A9461871346D}']
    function First: IIterator_1__IClosable; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.IClosable>
  IIterable_1__IClosable = interface(IIterable_1__IClosable_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IVector`1<Windows.Foundation.IClosable>
  IVector_1__IClosable_Base = interface(IInspectable)
  ['{659154C2-5480-5D09-A4B1-6B4B5D873C20}']
    function GetAt(index: Cardinal): IClosable; safecall;
    function get_Size: Cardinal; safecall;
  ...
  // Windows.Foundation.Collections.IVector`1<Windows.Foundation.IClosable>
  IVector_1__IClosable = interface(IVector_1__IClosable_Base)
  ['{1BFCA4F6-2C4E-5174-9869-B39D35848FCC}']
  end;

  // Windows.Foundation.IReference`1<Windows.Foundation.Numerics.Quaternion>
  IReference_1__Numerics_Quaternion = interface(IInspectable)
  ['{B27004BB-C014-5DCE-9A21-799C5A3C1461}']
