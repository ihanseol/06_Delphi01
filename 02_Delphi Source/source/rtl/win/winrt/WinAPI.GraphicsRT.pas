...
type
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.RectInt32>
  IIterator_1__RectInt32 = interface;
  PIIterator_1__RectInt32 = ^IIterator_1__RectInt32;

  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.RectInt32>
  IIterable_1__RectInt32 = interface;
  PIIterable_1__RectInt32 = ^IIterable_1__RectInt32;
  ...
  Capture_IGraphicsCaptureItemStatics2 = interface;
  PCapture_IGraphicsCaptureItemStatics2 = ^Capture_IGraphicsCaptureItemStatics2;
  ...
  Capture_IGraphicsCaptureSession3 = interface;
  PCapture_IGraphicsCaptureSession3 = ^Capture_IGraphicsCaptureSession3;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IIterator_1__Holographic_HolographicDepthReprojectionMethod = interface;
  PIIterator_1__Holographic_HolographicDepthReprojectionMethod = ^IIterator_1__Holographic_HolographicDepthReprojectionMethod;

  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IIterable_1__Holographic_HolographicDepthReprojectionMethod = interface;
  PIIterable_1__Holographic_HolographicDepthReprojectionMethod = ^IIterable_1__Holographic_HolographicDepthReprojectionMethod;

  // Windows.Foundation.Collections.IVectorView`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IVectorView_1__Holographic_HolographicDepthReprojectionMethod = interface;
  PIVectorView_1__Holographic_HolographicDepthReprojectionMethod = ^IVectorView_1__Holographic_HolographicDepthReprojectionMethod;
  ...
  AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus = interface;
  PAsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus = ^AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus;

  // Windows.Foundation.IAsyncOperation`1<Windows.Graphics.Printing.Workflow.PrintWorkflowUICompletionStatus>
  IAsyncOperation_1__Printing_Workflow_PrintWorkflowUICompletionStatus = interface;
  PIAsyncOperation_1__Printing_Workflow_PrintWorkflowUICompletionStatus = ^IAsyncOperation_1__Printing_Workflow_PrintWorkflowUICompletionStatus;
  ...
  Capture_GraphicsCaptureAccessKind = (
    Borderless = 0,
    Programmatic = 1
  );
  PCapture_GraphicsCaptureAccessKind = ^Capture_GraphicsCaptureAccessKind;
  ...
  Holographic_HolographicDepthReprojectionMethod = (
    DepthReprojection = 0,
    AutoPlanar = 1
  );
  PHolographic_HolographicDepthReprojectionMethod = ^Holographic_HolographicDepthReprojectionMethod;
  ...
  Printing_PrintSupport_SettingsLaunchKind = (
    JobPrintTicket = 0,
    UserDefaultPrintTicket = 1
  );
  PPrinting_PrintSupport_SettingsLaunchKind = ^Printing_PrintSupport_SettingsLaunchKind;

  // Windows.Graphics.Printing.PrintSupport.WorkflowPrintTicketValidationStatus
  Printing_PrintSupport_WorkflowPrintTicketValidationStatus = (
    Resolved = 0,
    Conflicting = 1,
    Invalid = 2
  );
  PPrinting_PrintSupport_WorkflowPrintTicketValidationStatus = ^Printing_PrintSupport_WorkflowPrintTicketValidationStatus;
  ...
  Printing_Workflow_PdlConversionHostBasedProcessingOperations = (
    None = 0,
    PageRotation = 1,
    PageOrdering = 2,
    Copies = 4,
  ...
  PPrinting_Workflow_PdlConversionHostBasedProcessingOperations = ^Printing_Workflow_PdlConversionHostBasedProcessingOperations;

  // Windows.Graphics.Printing.Workflow.PrintWorkflowAttributesMergePolicy
  Printing_Workflow_PrintWorkflowAttributesMergePolicy = (
    MergePreferPrintTicketOnConflict = 0,
    MergePreferPsaOnConflict = 1,
    DoNotMergeWithPrintTicket = 2
  );
  PPrinting_Workflow_PrintWorkflowAttributesMergePolicy = ^Printing_Workflow_PrintWorkflowAttributesMergePolicy;

  // Windows.Graphics.Printing.Workflow.PrintWorkflowJobAbortReason
  Printing_Workflow_PrintWorkflowJobAbortReason = (
    JobFailed = 0,
    UserCanceled = 1
  );
  PPrinting_Workflow_PrintWorkflowJobAbortReason = ^Printing_Workflow_PrintWorkflowJobAbortReason;

  // Windows.Graphics.Printing.Workflow.PrintWorkflowPdlConversionType
  Printing_Workflow_PrintWorkflowPdlConversionType = (
    XpsToPdf = 0,
    XpsToPwgr = 1,
    XpsToPclm = 2
  );
  PPrinting_Workflow_PrintWorkflowPdlConversionType = ^Printing_Workflow_PrintWorkflowPdlConversionType;

  // Windows.Graphics.Printing.Workflow.PrintWorkflowPrinterJobStatus
  Printing_Workflow_PrintWorkflowPrinterJobStatus = (
    Error = 0,
    Aborted = 1,
    InProgress = 2,
    Completed = 3
  );
  PPrinting_Workflow_PrintWorkflowPrinterJobStatus = ^Printing_Workflow_PrintWorkflowPrinterJobStatus;
  ...
  Printing_Workflow_PrintWorkflowUICompletionStatus = (
    Completed = 0,
    LaunchFailed = 1,
    JobFailed = 2,
    UserCanceled = 3
  );
  PPrinting_Workflow_PrintWorkflowUICompletionStatus = ^Printing_Workflow_PrintWorkflowUICompletionStatus;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.RectInt32>
  IIterator_1__RectInt32 = interface(IInspectable)
  ['{1ABDF3F6-23F1-55AD-BABD-F4CD908406E7}']
    function get_Current: RectInt32; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PRectInt32): Cardinal; safecall;
    property Current: RectInt32 read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.RectInt32>
  IIterable_1__RectInt32 = interface(IInspectable)
  ['{D6222360-B82E-5EED-9EAB-2E275B36E47E}']
    function First: IIterator_1__RectInt32; safecall;
  end;

  // Windows.Foundation.IReference`1<Windows.Graphics.SizeInt32>
  IReference_1__SizeInt32 = interface(IInspectable)
  ['{B77AA86D-2D6E-55F1-8F99-64AC5C05328B}']
  ...
  // Windows.Foundation.TypedEventHandler`2<Windows.Graphics.Capture.IDirect3D11CaptureFramePool,Object>
  TypedEventHandler_2__Capture_IDirect3D11CaptureFramePool__IInspectable_Delegate_Base = interface(IUnknown)
  ['{51A947F7-79CF-5A3E-A3A5-1289CFA6DFE8}']
    procedure Invoke(sender: Capture_IDirect3D11CaptureFramePool; args: IInspectable); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Graphics.Capture.IDirect3D11CaptureFramePool,Object>
  TypedEventHandler_2__Capture_IDirect3D11CaptureFramePool__IInspectable = interface(TypedEventHandler_2__Capture_IDirect3D11CaptureFramePool__IInspectable_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.Graphics.Capture.IGraphicsCaptureItem,Object>
  TypedEventHandler_2__Capture_IGraphicsCaptureItem__IInspectable_Delegate_Base = interface(IUnknown)
  ['{E9C610C0-A68C-5BD9-8021-8589346EEEE2}']
    procedure Invoke(sender: Capture_IGraphicsCaptureItem; args: IInspectable); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.Graphics.Capture.IGraphicsCaptureItem,Object>
  TypedEventHandler_2__Capture_IGraphicsCaptureItem__IInspectable = interface(TypedEventHandler_2__Capture_IGraphicsCaptureItem__IInspectable_Delegate_Base)
  ...
  // Windows.Graphics.Capture.IGraphicsCaptureItemStatics2
  [WinRTClassNameAttribute(SWindows_Graphics_Capture_GraphicsCaptureItem)]
  Capture_IGraphicsCaptureItemStatics2 = interface(IInspectable)
  ['{3B92ACC9-E584-5862-BF5C-9C316C6D2DBB}']
    function TryCreateFromWindowId(windowId: WindowId): Capture_IGraphicsCaptureItem; safecall;
    function TryCreateFromDisplayId(displayId: DisplayId): Capture_IGraphicsCaptureItem; safecall;
  end;

  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Graphics.Capture.IGraphicsCaptureItem>
  AsyncOperationCompletedHandler_1__Capture_IGraphicsCaptureItem_Delegate_Base = interface(IUnknown)
  ['{43004A3C-FFE7-5352-85A6-7BC41B782FCA}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__Capture_IGraphicsCaptureItem; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Graphics.Capture.IGraphicsCaptureItem>
  AsyncOperationCompletedHandler_1__Capture_IGraphicsCaptureItem = interface(AsyncOperationCompletedHandler_1__Capture_IGraphicsCaptureItem_Delegate_Base)
  ['{09B88462-7AB0-513F-83BF-4D327D69FE8D}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Graphics.Capture.IGraphicsCaptureItem>
  IAsyncOperation_1__Capture_IGraphicsCaptureItem_Base = interface(IInspectable)
  ['{01CCF2AE-1059-5D57-A805-0A1DFC54CAB9}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Graphics.Capture.IGraphicsCaptureItem>
  IAsyncOperation_1__Capture_IGraphicsCaptureItem = interface(IAsyncOperation_1__Capture_IGraphicsCaptureItem_Base)
  ...
  // UsedAPI Interface
  // Windows.Graphics.Capture.IGraphicsCaptureSession3
  Capture_IGraphicsCaptureSession3 = interface(IInspectable)
  ['{F2CDD966-22AE-5EA1-9596-3A289344C3BE}']
    function get_IsBorderRequired: Boolean; safecall;
    procedure put_IsBorderRequired(value: Boolean); safecall;
    property IsBorderRequired: Boolean read get_IsBorderRequired write put_IsBorderRequired;
  end;
  ...
  ['{6BE92993-D069-5A99-B9E8-200CF5C8A060}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.DirectX.DirectXPixelFormat>
  IIterator_1__DirectX_DirectXPixelFormat = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.DirectX.DirectXPixelFormat>
  IIterable_1__DirectX_DirectXPixelFormat = interface(IInspectable)
  ...
  ['{1EDDA1C2-0F6E-516C-80B8-7687DCD1280E}']
  ...
  ['{468FBF64-7BE8-558A-AFE5-615634F7719C}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IIterator_1__Holographic_HolographicDepthReprojectionMethod = interface(IInspectable)
  ['{E2486838-8E17-52A2-B3B2-8DB3DE6412B7}']
    function get_Current: Holographic_HolographicDepthReprojectionMethod; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PHolographic_HolographicDepthReprojectionMethod): Cardinal; safecall;
    property Current: Holographic_HolographicDepthReprojectionMethod read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IIterable_1__Holographic_HolographicDepthReprojectionMethod = interface(IInspectable)
  ['{2803C19F-8082-52C0-AAD1-68AB51ED287F}']
    function First: IIterator_1__Holographic_HolographicDepthReprojectionMethod; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.Graphics.Holographic.HolographicDepthReprojectionMethod>
  IVectorView_1__Holographic_HolographicDepthReprojectionMethod = interface(IInspectable)
  ['{7AC6DC9E-EA0B-594A-B0ED-2D1764EC58E9}']
    function GetAt(index: Cardinal): Holographic_HolographicDepthReprojectionMethod; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: Holographic_HolographicDepthReprojectionMethod; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PHolographic_HolographicDepthReprojectionMethod): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.Printing.IPrintPageRange>
  IIterator_1__Printing_IPrintPageRange_Base = interface(IInspectable)
  ['{38F75665-FB40-53E2-A916-15BA754A6A9E}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Graphics.Printing.IPrintPageRange>
  IIterator_1__Printing_IPrintPageRange = interface(IIterator_1__Printing_IPrintPageRange_Base)
  ['{06F58712-ACBE-5187-9D07-ECBC5EE7BAB7}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.Printing.IPrintPageRange>
  IIterable_1__Printing_IPrintPageRange_Base = interface(IInspectable)
  ['{ED6DDF38-34CF-5A2F-B9AC-413DFFCE7F81}']
    function First: IIterator_1__Printing_IPrintPageRange; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.Printing.IPrintPageRange>
  IIterable_1__Printing_IPrintPageRange = interface(IIterable_1__Printing_IPrintPageRange_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IVector`1<Windows.Graphics.Printing.IPrintPageRange>
  IVector_1__Printing_IPrintPageRange_Base = interface(IInspectable)
  ['{1D314A18-2A16-542F-A986-1B7841B878AA}']
    function GetAt(index: Cardinal): Printing_IPrintPageRange; safecall;
    function get_Size: Cardinal; safecall;
  ...
  // Windows.Foundation.Collections.IVector`1<Windows.Graphics.Printing.IPrintPageRange>
  IVector_1__Printing_IPrintPageRange = interface(IVector_1__Printing_IPrintPageRange_Base)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Graphics.Printing.Workflow.PrintWorkflowUICompletionStatus>
  AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus = interface(IUnknown)
  ['{2CF68098-E07D-5362-A2AD-356551327DF2}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__Printing_Workflow_PrintWorkflowUICompletionStatus; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.Graphics.Printing.Workflow.PrintWorkflowUICompletionStatus>
  IAsyncOperation_1__Printing_Workflow_PrintWorkflowUICompletionStatus = interface(IInspectable)
  ['{E4312E4B-C35D-5CCB-B290-72D0C4A808A6}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus; safecall;
    function GetResults: Printing_Workflow_PrintWorkflowUICompletionStatus; safecall;
    property Completed: AsyncOperationCompletedHandler_1__Printing_Workflow_PrintWorkflowUICompletionStatus read get_Completed write put_Completed;
  end;
  ...
  // Windows.Foundation.AsyncOperationProgressHandler`2<Boolean,Double>
  AsyncOperationProgressHandler_2__Boolean__Double = interface(IUnknown)
  ...
  // Windows.Foundation.AsyncOperationWithProgressCompletedHandler`2<Boolean,Double>
  AsyncOperationWithProgressCompletedHandler_2__Boolean__Double = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperationWithProgress`2<Boolean,Double>
  IAsyncOperationWithProgress_2__Boolean__Double = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Graphics.Imaging.BitmapPixelFormat>
  IIterable_1__Imaging_BitmapPixelFormat = interface(IInspectable)
  ...
  ['{76AC4BC2-C19C-559C-B287-1694C0DC3A0D}']
  ...
  ['{AA19DA70-DEE6-5B42-B562-2FCD218C34CA}']
  ...
  // Statics: "Windows.Graphics.Capture.IGraphicsCaptureItemStatics2"
  TCapture_GraphicsCaptureItem = class(TWinRTGenericImportS2<Capture_IGraphicsCaptureItemStatics, Capture_IGraphicsCaptureItemStatics2>)
  public
    ...
    // -> Capture_IGraphicsCaptureItemStatics2
    class function TryCreateFromWindowId(windowId: WindowId): Capture_IGraphicsCaptureItem; static; inline;
    class function TryCreateFromDisplayId(displayId: DisplayId): Capture_IGraphicsCaptureItem; static; inline;
  end;
  ...
  // Implements: Windows.Graphics.Capture.IGraphicsCaptureSession3
  // Implements: Windows.Foundation.IClosable
...
class function TCapture_GraphicsCaptureItem.TryCreateFromWindowId(windowId: WindowId): Capture_IGraphicsCaptureItem;
begin
  Result := Statics2.TryCreateFromWindowId(windowId);
end;

class function TCapture_GraphicsCaptureItem.TryCreateFromDisplayId(displayId: DisplayId): Capture_IGraphicsCaptureItem;
begin
  Result := Statics2.TryCreateFromDisplayId(displayId);
end;
