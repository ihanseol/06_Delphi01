...
type
  ...
  PIGeocoordinateSatelliteData2 = ^IGeocoordinateSatelliteData2;
  ...
  IGeocoordinateWithRemoteSource = interface;
  PIGeocoordinateWithRemoteSource = ^IGeocoordinateWithRemoteSource;
  ...
  Provider_LocationOverrideStatus = (
    Success = 0,
    AccessDenied = 1,
    AlreadyStarted = 2,
    Other = 3
  );
  PProvider_LocationOverrideStatus = ^Provider_LocationOverrideStatus;
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.BasicGeoposition>
  IIterable_1__BasicGeoposition = interface(IInspectable)
  ...
  // Windows.Devices.Geolocation.IGeocoordinateSatelliteData2
  IGeocoordinateSatelliteData2 = interface(IInspectable)
  ['{761C8CFD-A19D-5A51-80F5-71676115483E}']
    function get_GeometricDilutionOfPrecision: IReference_1__Double; safecall;
    function get_TimeDilutionOfPrecision: IReference_1__Double; safecall;
    property GeometricDilutionOfPrecision: IReference_1__Double read get_GeometricDilutionOfPrecision;
    property TimeDilutionOfPrecision: IReference_1__Double read get_TimeDilutionOfPrecision;
  end;
  ...
  // Windows.Devices.Geolocation.IGeocoordinateWithRemoteSource
  IGeocoordinateWithRemoteSource = interface(IInspectable)
  ['{397CEBD7-EE38-5F3B-8900-C4A7BC9CF953}']
    function get_IsRemoteSource: Boolean; safecall;
    property IsRemoteSource: Boolean read get_IsRemoteSource;
  end;
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Geolocation.GeolocationAccessStatus>
  AsyncOperationCompletedHandler_1__GeolocationAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Geolocation.GeolocationAccessStatus>
  IAsyncOperation_1__GeolocationAccessStatus = interface(IInspectable)
