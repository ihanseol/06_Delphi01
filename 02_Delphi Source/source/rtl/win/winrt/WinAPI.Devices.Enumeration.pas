...
type
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Enumeration.DeviceAccessStatus>
  AsyncOperationCompletedHandler_1__DeviceAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceAccessStatus>
  IAsyncOperation_1__DeviceAccessStatus = interface(IInspectable)
  ...
  ['{703344C1-78B6-5DC8-BF48-DBF667102E2A}']
  ...
  ['{F02F08F2-F30F-5B83-ACC5-57E1F9DAA0DD}']
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Enumeration.DeviceClass>
  IIterable_1__DeviceClass = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Devices.Enumeration.DeviceWatcherEventKind>
  IIterable_1__DeviceWatcherEventKind = interface(IInspectable)
  ...
  ['{475B6D9E-7ABD-57D7-AA40-F180CF911EE8}']
  ...
  ['{0659EAB6-97A1-54FC-9356-FF15E3B0A8A8}']
