...
type
  ...
  IConnectionProfile6 = interface;
  PIConnectionProfile6 = ^IConnectionProfile6;
  ...
  PDomainAuthenticationKind = ^DomainAuthenticationKind;
  ...
  ['{3A0FB210-36C4-5DF2-9707-5F325369A9B0}']
  ...
  ['{2FFEBC9E-4BED-5F3D-8E55-5ABC2598E144}']
  ...
  // Windows.Networking.Connectivity.IConnectionProfile6
  IConnectionProfile6 = interface(IInspectable)
  ['{DC27DFE2-7A6F-5D0E-9589-2FE2E5B6F9AA}']
    function IsDomainAuthenticatedBy(kind: DomainAuthenticationKind): Boolean; safecall;
  end;
