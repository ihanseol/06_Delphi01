...
type
  ...
  MachineLearning_IImageFeatureDescriptor2 = interface;
  PMachineLearning_IImageFeatureDescriptor2 = ^MachineLearning_IImageFeatureDescriptor2;
  ...
  MachineLearning_ILearningModelSessionOptions3 = interface;
  PMachineLearning_ILearningModelSessionOptions3 = ^MachineLearning_ILearningModelSessionOptions3;
  ...
  MachineLearning_LearningModelPixelRange = (
    ZeroTo255 = 0,
    ZeroToOne = 1,
    MinusOneToOne = 2
  );
  PMachineLearning_LearningModelPixelRange = ^MachineLearning_LearningModelPixelRange;
  ...
  // Windows.AI.MachineLearning.IImageFeatureDescriptor2
  MachineLearning_IImageFeatureDescriptor2 = interface(IInspectable)
  ['{2B27CCA7-D533-5862-BB98-1611B155B0E1}']
    function get_PixelRange: MachineLearning_LearningModelPixelRange; safecall;
    property PixelRange: MachineLearning_LearningModelPixelRange read get_PixelRange;
  end;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.AI.MachineLearning.ILearningModelEvaluationResult>
  AsyncOperationCompletedHandler_1__MachineLearning_ILearningModelEvaluationResult_Delegate_Base = interface(IUnknown)
  ['{B8776114-9ADF-50E8-B67F-22E0F1372F45}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.AI.MachineLearning.ILearningModelEvaluationResult>
  AsyncOperationCompletedHandler_1__MachineLearning_ILearningModelEvaluationResult = interface(AsyncOperationCompletedHandler_1__MachineLearning_ILearningModelEvaluationResult_Delegate_Base)
  ['{24706802-4FF0-5E0F-8B75-1C58935E4D57}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.AI.MachineLearning.ILearningModelEvaluationResult>
  IAsyncOperation_1__MachineLearning_ILearningModelEvaluationResult_Base = interface(IInspectable)
  ['{28050590-1422-5A18-8C8B-847F2D2CF69A}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.AI.MachineLearning.ILearningModelEvaluationResult>
  IAsyncOperation_1__MachineLearning_ILearningModelEvaluationResult = interface(IAsyncOperation_1__MachineLearning_ILearningModelEvaluationResult_Base)
  ...
  // UsedAPI Interface
  // Windows.AI.MachineLearning.ILearningModelSessionOptions3
  MachineLearning_ILearningModelSessionOptions3 = interface(IInspectable)
  ['{58E15CEE-D8C2-56FC-92E8-76D751081086}']
    procedure OverrideNamedDimension(name: HSTRING; dimension: Cardinal); safecall;
  end;

  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.AI.MachineLearning.ILearningModel>
  AsyncOperationCompletedHandler_1__MachineLearning_ILearningModel_Delegate_Base = interface(IUnknown)
  ['{755DA6DF-ED55-5AAA-B542-C665F010F50C}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__MachineLearning_ILearningModel; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.AI.MachineLearning.ILearningModel>
  AsyncOperationCompletedHandler_1__MachineLearning_ILearningModel = interface(AsyncOperationCompletedHandler_1__MachineLearning_ILearningModel_Delegate_Base)
  ['{0AF09637-D1B5-5CDE-863C-933F647DF151}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.AI.MachineLearning.ILearningModel>
  IAsyncOperation_1__MachineLearning_ILearningModel_Base = interface(IInspectable)
  ['{634AB3CB-406C-5EDE-8A89-A7F9CA370326}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.AI.MachineLearning.ILearningModel>
  IAsyncOperation_1__MachineLearning_ILearningModel = interface(IAsyncOperation_1__MachineLearning_ILearningModel_Base)
  ...
  // Implements: Windows.AI.MachineLearning.ILearningModelSessionOptions3
