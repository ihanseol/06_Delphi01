...
type
  ...
  // Windows.Foundation.AsyncOperationProgressHandler`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface;
  PAsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = ^AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress;

  // Windows.Foundation.AsyncOperationWithProgressCompletedHandler`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface;
  PAsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = ^AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress;

  // Windows.Foundation.IAsyncOperationWithProgress`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  IAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface;
  PIAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = ^IAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress;
  ...
  Isolation_IsolatedWindowsEnvironmentCreationPriority = (
    Low = 0,
    Normal = 1
  );
  PIsolation_IsolatedWindowsEnvironmentCreationPriority = ^Isolation_IsolatedWindowsEnvironmentCreationPriority;
  ...
  Isolation_IsolatedWindowsEnvironmentShareFileStatus = (
    Success = 0,
    UnknownFailure = 1,
    EnvironmentUnavailable = 2,
  ...
  PIsolation_IsolatedWindowsEnvironmentShareFileStatus = ^Isolation_IsolatedWindowsEnvironmentShareFileStatus;
  ...
  Isolation_IsolatedWindowsEnvironmentSignInProgress = (
    Connecting = 0,
    Connected = 1,
    Authenticating = 2,
    SettingUpAccount = 3,
  ...
  PIsolation_IsolatedWindowsEnvironmentSignInProgress = ^Isolation_IsolatedWindowsEnvironmentSignInProgress;
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult>
  AsyncOperationCompletedHandler_1__EnterpriseData_ProtectionPolicyEvaluationResult = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult>
  IAsyncOperation_1__EnterpriseData_ProtectionPolicyEvaluationResult = interface(IInspectable)
  ...
  ['{6EA0F2E9-BC97-58E8-A3A6-C829B9E5F2AA}']
  ...
  ['{827CAF42-5FE6-5B5B-84CE-C44834134D3D}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.Authentication.Identity.Core.MicrosoftAccountMultiFactorServiceResponse>
  AsyncOperationCompletedHandler_1__Authentication_Identity_Core_MicrosoftAccountMultiFactorServiceResponse = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.Authentication.Identity.Core.MicrosoftAccountMultiFactorServiceResponse>
  IAsyncOperation_1__Authentication_Identity_Core_MicrosoftAccountMultiFactorServiceResponse = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorFinishAuthenticationStatus>
  AsyncOperationCompletedHandler_1__Authentication_Identity_Provider_SecondaryAuthenticationFactorFinishAuthenticationStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorFinishAuthenticationStatus>
  IAsyncOperation_1__Authentication_Identity_Provider_SecondaryAuthenticationFactorFinishAuthenticationStatus = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus>
  AsyncOperationCompletedHandler_1__Authentication_Identity_Provider_SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus>
  IAsyncOperation_1__Authentication_Identity_Provider_SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.Authentication.Web.Core.IFindAllAccountsResult>
  AsyncOperationCompletedHandler_1__Authentication_Web_Core_IFindAllAccountsResult_Delegate_Base = interface(IUnknown)
  ['{5DE9BA5E-0ADE-5344-9FE4-987F1D387EF7}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.Authentication.Web.Core.IFindAllAccountsResult>
  AsyncOperationCompletedHandler_1__Authentication_Web_Core_IFindAllAccountsResult = interface(AsyncOperationCompletedHandler_1__Authentication_Web_Core_IFindAllAccountsResult_Delegate_Base)
  ['{1F4E8443-1CEB-5DCF-833F-4C681C26E7E6}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.Authentication.Web.Core.IFindAllAccountsResult>
  IAsyncOperation_1__Authentication_Web_Core_IFindAllAccountsResult_Base = interface(IInspectable)
  ['{9AFFB572-58C3-5C6C-9397-2B7704AA35C3}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.Authentication.Web.Core.IFindAllAccountsResult>
  IAsyncOperation_1__Authentication_Web_Core_IFindAllAccountsResult = interface(IAsyncOperation_1__Authentication_Web_Core_IFindAllAccountsResult_Base)
  ...
  ['{C0538D02-01F7-51A1-99BD-3D148D055FA1}']
    function get_Key: HSTRING; safecall;
  ...
  ['{4E97286E-7954-5B79-BEA1-83AF142E4FB2}']
  ...
  ['{20366438-9FAB-5C12-87EB-DA867E383FE7}']
  ...
  ['{BDF03EAD-A75B-510C-87D2-5B5753BDF1BD}']
  ...
  ['{A66001F3-E332-531A-BF49-4EDD3AF88DE7}']
  ...
  ['{38402D5C-C584-52DF-9AEA-796867A66835}']
  ...
  ['{E5C62DBD-E029-52E1-AFD5-73F7A4223DE6}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Security.EnterpriseData.FileProtectionStatus>
  AsyncOperationCompletedHandler_1__EnterpriseData_FileProtectionStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Security.EnterpriseData.FileProtectionStatus>
  IAsyncOperation_1__EnterpriseData_FileProtectionStatus = interface(IInspectable)
  ...
  ['{63675C12-3214-5510-82D9-CB807FF89BC8}']
  ...
  ['{A830F621-A4AE-5F5C-A003-985FE3E01E51}']
  ...
  // Windows.Foundation.AsyncOperationProgressHandler`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface(IUnknown)
  ['{75620FB8-3A60-5676-8DD6-D8F700A2FCDC}']
    procedure Invoke(asyncInfo: IAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress; progressInfo: Isolation_IsolatedWindowsEnvironmentSignInProgress); safecall;
  end;

  // Windows.Foundation.AsyncOperationWithProgressCompletedHandler`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface(IUnknown)
  ['{E55295A4-D669-5922-BF42-BBE7EAEB4596}']
    procedure Invoke(asyncInfo: IAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperationWithProgress`2<Boolean,Windows.Security.Isolation.IsolatedWindowsEnvironmentSignInProgress>
  IAsyncOperationWithProgress_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress = interface(IInspectable)
  ['{3342214C-85A9-5729-B0F1-FC667640078A}']
    procedure put_Progress(handler: AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress); safecall;
    function get_Progress: AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress; safecall;
    procedure put_Completed(handler: AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress); safecall;
    function get_Completed: AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress; safecall;
    function GetResults: Boolean; safecall;
    property Progress: AsyncOperationProgressHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress read get_Progress write put_Progress;
    property Completed: AsyncOperationWithProgressCompletedHandler_2__Boolean__Isolation_IsolatedWindowsEnvironmentSignInProgress read get_Completed write put_Completed;
  end;
