...
type
  ...
  TypedEventHandler_2__IStoreQueueItem__IStoreQueueItemCompletedEventArgs_Delegate_Base = Winapi.CommonTypes.TypedEventHandler_2__IStoreQueueItem__IStoreQueueItemCompletedEventArgs_Delegate_Base;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Services.Store.StorePackageUpdateStatus>
  IIterator_1__StorePackageUpdateStatus = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Services.Store.StorePackageUpdateStatus>
  IIterable_1__StorePackageUpdateStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreCanAcquireLicenseResult>
  AsyncOperationCompletedHandler_1__IStoreCanAcquireLicenseResult_Delegate_Base = interface(IUnknown)
  ['{572A21D0-7150-50BA-A558-D91DFFEC1A24}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IStoreCanAcquireLicenseResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreCanAcquireLicenseResult>
  AsyncOperationCompletedHandler_1__IStoreCanAcquireLicenseResult = interface(AsyncOperationCompletedHandler_1__IStoreCanAcquireLicenseResult_Delegate_Base)
  ['{F1D1367C-D253-574E-839F-88CBDD6139E7}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreCanAcquireLicenseResult>
  IAsyncOperation_1__IStoreCanAcquireLicenseResult_Base = interface(IInspectable)
  ['{71AE9F6E-0D10-5BDB-B441-9312E3D2EFC2}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreCanAcquireLicenseResult>
  IAsyncOperation_1__IStoreCanAcquireLicenseResult = interface(IAsyncOperation_1__IStoreCanAcquireLicenseResult_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Services.Store.IStoreQueueItem>
  IIterator_1__IStoreQueueItem_Base = interface(IInspectable)
  ['{907DD469-85B9-52E7-B52F-7310A44745EF}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.Services.Store.IStoreQueueItem>
  IIterator_1__IStoreQueueItem = interface(IIterator_1__IStoreQueueItem_Base)
  ['{615A5179-EEF6-5B2A-AD8E-AD4E717F039F}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.Services.Store.IStoreQueueItem>
  IIterable_1__IStoreQueueItem_Base = interface(IInspectable)
  ['{68EB92E6-3CC6-5259-9A05-BD7F8D9FB8DA}']
    function First: IIterator_1__IStoreQueueItem; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.Services.Store.IStoreQueueItem>
  IIterable_1__IStoreQueueItem = interface(IIterable_1__IStoreQueueItem_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Services.Store.IStoreQueueItem>>
  AsyncOperationCompletedHandler_1__IVectorView_1__IStoreQueueItem_Delegate_Base = interface(IUnknown)
  ['{776B0864-B93D-5669-A75D-70A29325E919}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IVectorView_1__IStoreQueueItem; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Services.Store.IStoreQueueItem>>
  AsyncOperationCompletedHandler_1__IVectorView_1__IStoreQueueItem = interface(AsyncOperationCompletedHandler_1__IVectorView_1__IStoreQueueItem_Delegate_Base)
  ['{4AF9988F-3D25-5C3B-9B5E-562DB60C3D18}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Services.Store.IStoreQueueItem>>
  IAsyncOperation_1__IVectorView_1__IStoreQueueItem_Base = interface(IInspectable)
  ['{1346377D-4D6F-5999-9A6E-9C8FBF6F38A2}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Services.Store.IStoreQueueItem>>
  IAsyncOperation_1__IVectorView_1__IStoreQueueItem = interface(IAsyncOperation_1__IVectorView_1__IStoreQueueItem_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreUninstallStorePackageResult>
  AsyncOperationCompletedHandler_1__IStoreUninstallStorePackageResult_Delegate_Base = interface(IUnknown)
  ['{C4DE9FB6-1FD9-5229-8818-BA65751DB046}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IStoreUninstallStorePackageResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreUninstallStorePackageResult>
  AsyncOperationCompletedHandler_1__IStoreUninstallStorePackageResult = interface(AsyncOperationCompletedHandler_1__IStoreUninstallStorePackageResult_Delegate_Base)
  ['{D8F71ABF-74CB-5A01-A9F5-D3F0157191DA}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreUninstallStorePackageResult>
  IAsyncOperation_1__IStoreUninstallStorePackageResult_Base = interface(IInspectable)
  ['{55AA82FD-CE55-550A-95EC-0554B1915208}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreUninstallStorePackageResult>
  IAsyncOperation_1__IStoreUninstallStorePackageResult = interface(IAsyncOperation_1__IStoreUninstallStorePackageResult_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreRateAndReviewResult>
  AsyncOperationCompletedHandler_1__IStoreRateAndReviewResult_Delegate_Base = interface(IUnknown)
  ['{EE12D599-9DBD-5E46-A46F-0223B8492761}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IStoreRateAndReviewResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Services.Store.IStoreRateAndReviewResult>
  AsyncOperationCompletedHandler_1__IStoreRateAndReviewResult = interface(AsyncOperationCompletedHandler_1__IStoreRateAndReviewResult_Delegate_Base)
  ['{CEE3E1DC-378D-52F3-964E-1168D2D5A581}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreRateAndReviewResult>
  IAsyncOperation_1__IStoreRateAndReviewResult_Base = interface(IInspectable)
  ['{844673EC-3402-5A20-BECF-E92C3F9681EA}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Services.Store.IStoreRateAndReviewResult>
  IAsyncOperation_1__IStoreRateAndReviewResult = interface(IAsyncOperation_1__IStoreRateAndReviewResult_Base)
