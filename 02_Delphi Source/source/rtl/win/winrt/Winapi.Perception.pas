...
type
  ...
  ['{44DD686B-C7D8-582C-91C2-D98E604DCFD4}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Perception.Spatial.SpatialPerceptionAccessStatus>
  AsyncOperationCompletedHandler_1__Spatial_SpatialPerceptionAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Perception.Spatial.SpatialPerceptionAccessStatus>
  IAsyncOperation_1__Spatial_SpatialPerceptionAccessStatus = interface(IInspectable)
