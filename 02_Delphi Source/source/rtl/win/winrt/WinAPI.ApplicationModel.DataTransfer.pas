...
type
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItem>
  IIterator_1__IClipboardHistoryItem_Base = interface(IInspectable)
  ['{63FAC521-1395-5C95-AAFF-9736378A4F2F}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItem>
  IIterator_1__IClipboardHistoryItem = interface(IIterator_1__IClipboardHistoryItem_Base)
  ['{B58D4FCF-1C73-5399-BCB9-AD7290638B73}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItem>
  IIterable_1__IClipboardHistoryItem_Base = interface(IInspectable)
  ['{5C3705F4-8E46-5AE5-97BF-88220CCCFFD9}']
    function First: IIterator_1__IClipboardHistoryItem; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItem>
  IIterable_1__IClipboardHistoryItem = interface(IIterable_1__IClipboardHistoryItem_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItemsResult>
  AsyncOperationCompletedHandler_1__IClipboardHistoryItemsResult_Delegate_Base = interface(IUnknown)
  ['{841DA82D-A32C-5997-8450-F54AF1D5477E}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IClipboardHistoryItemsResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItemsResult>
  AsyncOperationCompletedHandler_1__IClipboardHistoryItemsResult = interface(AsyncOperationCompletedHandler_1__IClipboardHistoryItemsResult_Delegate_Base)
  ['{83194ABC-2E91-57AF-90F1-FAB58A0591CB}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItemsResult>
  IAsyncOperation_1__IClipboardHistoryItemsResult_Base = interface(IInspectable)
  ['{677B06B8-0134-5692-B487-4C8E2408CA01}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryItemsResult>
  IAsyncOperation_1__IClipboardHistoryItemsResult = interface(IAsyncOperation_1__IClipboardHistoryItemsResult_Base)
  ['{3F40CA0A-E46F-54CC-9BA3-10DD5878FCA2}']
  end;

  // Generic Delegate for:
  // Windows.Foundation.EventHandler`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryChangedEventArgs>
  EventHandler_1__IClipboardHistoryChangedEventArgs_Delegate_Base = interface(IUnknown)
  ['{DF4AAC23-4002-5D4C-A237-2526E344978D}']
    procedure Invoke(sender: IInspectable; args: IClipboardHistoryChangedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.EventHandler`1<Windows.ApplicationModel.DataTransfer.IClipboardHistoryChangedEventArgs>
  EventHandler_1__IClipboardHistoryChangedEventArgs = interface(EventHandler_1__IClipboardHistoryChangedEventArgs_Delegate_Base)
  ...
  ['{A5CAEE9B-8708-49D1-8D36-67D25A8DA00C}']
    function add_DataRequested(handler: TypedEventHandler_2__IDataTransferManager__IDataRequestedEventArgs): EventRegistrationToken; safecall;
    procedure remove_DataRequested(token: EventRegistrationToken); safecall;
    function add_TargetApplicationChosen(handler: TypedEventHandler_2__IDataTransferManager__ITargetApplicationChosenEventArgs): EventRegistrationToken; safecall;
    procedure remove_TargetApplicationChosen(token: EventRegistrationToken); safecall;
  end;
