...
type
  ...
  PIAnimationPropertyInfo2 = ^IAnimationPropertyInfo2;

  // Windows.UI.Composition.IBackEasingFunction
  IBackEasingFunction = interface;
  PIBackEasingFunction = ^IBackEasingFunction;
  ...
  IBounceEasingFunction = interface;
  PIBounceEasingFunction = ^IBounceEasingFunction;
  ...
  ICircleEasingFunction = interface;
  PICircleEasingFunction = ^ICircleEasingFunction;
  ...
  IElasticEasingFunction = interface;
  PIElasticEasingFunction = ^IElasticEasingFunction;

  // Windows.UI.Composition.IExponentialEasingFunction
  IExponentialEasingFunction = interface;
  PIExponentialEasingFunction = ^IExponentialEasingFunction;

  // Windows.UI.Composition.IPowerEasingFunction
  IPowerEasingFunction = interface;
  PIPowerEasingFunction = ^IPowerEasingFunction;

  // Windows.UI.Composition.ISineEasingFunction
  ISineEasingFunction = interface;
  PISineEasingFunction = ^ISineEasingFunction;

  // Windows.UI.Composition.ICompositionEasingFunctionStatics
  ICompositionEasingFunctionStatics = interface;
  PICompositionEasingFunctionStatics = ^ICompositionEasingFunctionStatics;
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.Composition.ICompositionSurface>
  ...
  PICompositionGraphicsDevice4 = ^ICompositionGraphicsDevice4;
  ...
  ICompositionObject5 = interface;
  PICompositionObject5 = ^ICompositionObject5;
  ...
  IRectangleClip = interface;
  PIRectangleClip = ^IRectangleClip;

  // Windows.UI.Composition.ICompositor7
  ICompositor7 = interface;
  PICompositor7 = ^ICompositor7;

  // Windows.UI.Composition.ICompositor8
  ICompositor8 = interface;
  PICompositor8 = ^ICompositor8;
  ...
  PICompositorWithBlurredWallpaperBackdropBrush = ^ICompositorWithBlurredWallpaperBackdropBrush;
  ...
  // Windows.UI.Composition Records

  // Windows.UI.Composition.InkTrailPoint
  InkTrailPoint = record
    Point: TPointF;
    Radius: Single;
  end;
  PInkTrailPoint = ^InkTrailPoint;
  ...
  // Windows.UI.Composition.IAnimationPropertyInfo2
  IAnimationPropertyInfo2 = interface(IInspectable)
  ['{591720B4-7472-5218-8B39-DFFE615AE6DA}']
    function GetResolvedCompositionObject: ICompositionObject; safecall;
    function GetResolvedCompositionObjectProperty: HSTRING; safecall;
  end;

  // UsedAPI Interface
  // Windows.UI.Composition.IBackEasingFunction
  IBackEasingFunction = interface(IInspectable)
  ['{B8560DA4-5E3C-545D-B263-7987A2BD27CB}']
    function get_Mode: CompositionEasingFunctionMode; safecall;
    function get_Amplitude: Single; safecall;
    property Amplitude: Single read get_Amplitude;
    property Mode: CompositionEasingFunctionMode read get_Mode;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.IBounceEasingFunction
  IBounceEasingFunction = interface(IInspectable)
  ['{E7FDB44B-AAD5-5174-9421-EEF8B75A6A43}']
    function get_Mode: CompositionEasingFunctionMode; safecall;
    function get_Bounces: Integer; safecall;
    function get_Bounciness: Single; safecall;
    property Bounces: Integer read get_Bounces;
    property Bounciness: Single read get_Bounciness;
    property Mode: CompositionEasingFunctionMode read get_Mode;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.ICircleEasingFunction
  ICircleEasingFunction = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.Composition.ICompositionShape>
  IIterator_1__ICompositionShape_Base = interface(IInspectable)
  ['{FF8D5B3B-AB18-5307-9FFE-E3B5D63452A4}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.Composition.ICompositionShape>
  IIterator_1__ICompositionShape = interface(IIterator_1__ICompositionShape_Base)
  ['{2BAC9158-8A06-5720-B631-4E249A387B79}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.Composition.ICompositionShape>
  IIterable_1__ICompositionShape_Base = interface(IInspectable)
  ['{1135ADF5-DB12-55E8-AE0F-BD8D914BD399}']
    function First: IIterator_1__ICompositionShape; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.Composition.ICompositionShape>
  IIterable_1__ICompositionShape = interface(IIterable_1__ICompositionShape_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IVector`1<Windows.UI.Composition.ICompositionShape>
  IVector_1__ICompositionShape_Base = interface(IInspectable)
  ['{42D4219A-BE1B-5091-8F1E-90270840FC2D}']
    function GetAt(index: Cardinal): ICompositionShape; safecall;
    function get_Size: Cardinal; safecall;
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IVector`1<Windows.UI.Composition.ICompositionShape>
  IVector_1__ICompositionShape = interface(IVector_1__ICompositionShape_Base)
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.IElasticEasingFunction
  IElasticEasingFunction = interface(IInspectable)
  ['{66DE6285-054E-5594-8475-C22CB51F1BD5}']
    function get_Mode: CompositionEasingFunctionMode; safecall;
    function get_Oscillations: Integer; safecall;
    function get_Springiness: Single; safecall;
    property Mode: CompositionEasingFunctionMode read get_Mode;
    property Oscillations: Integer read get_Oscillations;
    property Springiness: Single read get_Springiness;
  end;

  // UsedAPI Interface
  // Windows.UI.Composition.IExponentialEasingFunction
  IExponentialEasingFunction = interface(IInspectable)
  ['{6F7D1A51-98D2-5638-A34A-00486554C750}']
    function get_Mode: CompositionEasingFunctionMode; safecall;
    function get_Exponent: Single; safecall;
    property Exponent: Single read get_Exponent;
    property Mode: CompositionEasingFunctionMode read get_Mode;
  end;

  // UsedAPI Interface
  // Windows.UI.Composition.IPowerEasingFunction
  IPowerEasingFunction = interface(IInspectable)
  ['{C3FF53D6-138B-5815-891A-B7F615CCC563}']
    function get_Mode: CompositionEasingFunctionMode; safecall;
    function get_Power: Single; safecall;
    property Mode: CompositionEasingFunctionMode read get_Mode;
    property Power: Single read get_Power;
  end;

  // UsedAPI Interface
  // Windows.UI.Composition.ISineEasingFunction
  ISineEasingFunction = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.ICompositionEasingFunctionStatics
  [WinRTClassNameAttribute(SWindows_UI_Composition_CompositionEasingFunction)]
  ICompositionEasingFunctionStatics = interface(IInspectable)
  ['{17A766B6-2936-53EA-B5AF-C642F4A61083}']
    function CreateCubicBezierEasingFunction(owner: ICompositor; controlPoint1: Numerics_Vector2; controlPoint2: Numerics_Vector2): ICubicBezierEasingFunction; safecall;
    function CreateLinearEasingFunction(owner: ICompositor): ILinearEasingFunction; safecall;
    function CreateStepEasingFunction(owner: ICompositor): IStepEasingFunction; overload; safecall;
    function CreateStepEasingFunction(owner: ICompositor; stepCount: Integer): IStepEasingFunction; overload; safecall;
    function CreateBackEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; amplitude: Single): IBackEasingFunction; safecall;
    function CreateBounceEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; bounces: Integer; bounciness: Single): IBounceEasingFunction; safecall;
    function CreateCircleEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ICircleEasingFunction; safecall;
    function CreateElasticEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; oscillations: Integer; springiness: Single): IElasticEasingFunction; safecall;
    function CreateExponentialEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; exponent: Single): IExponentialEasingFunction; safecall;
    function CreatePowerEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; power: Single): IPowerEasingFunction; safecall;
    function CreateSineEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ISineEasingFunction; safecall;
  end;
  ...
  ['{DAF572EE-035A-594C-B013-84BD618853CC}']
  ...
  ['{66613CDD-5076-50D6-AB32-BA76DF49C410}']
  ...
  // Windows.UI.Composition.ICompositionGraphicsDevice4
  ICompositionGraphicsDevice4 = interface(IInspectable)
  ['{5A73BFF9-A97F-4CF5-BA46-98EF358E71B1}']
    function CaptureAsync(captureVisual: IVisual; size: SizeInt32; pixelFormat: DirectX_DirectXPixelFormat; alphaMode: DirectX_DirectXAlphaMode; sdrBoost: Single): IAsyncOperation_1__ICompositionSurface; safecall;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.ICompositionObject5
  ICompositionObject5 = interface(IInspectable)
  ['{1D7F391B-A130-5265-A62B-60B8E668965A}']
    procedure StartAnimation(propertyName: HSTRING; animation: ICompositionAnimation; animationController: IAnimationController); safecall;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.IRectangleClip
  IRectangleClip = interface(IInspectable)
  ['{B3E7549E-00B4-5B53-8BE8-353F6C433101}']
    function get_Bottom: Single; safecall;
    procedure put_Bottom(value: Single); safecall;
    function get_BottomLeftRadius: Numerics_Vector2; safecall;
    procedure put_BottomLeftRadius(value: Numerics_Vector2); safecall;
    function get_BottomRightRadius: Numerics_Vector2; safecall;
    procedure put_BottomRightRadius(value: Numerics_Vector2); safecall;
    function get_Left: Single; safecall;
    procedure put_Left(value: Single); safecall;
    function get_Right: Single; safecall;
    procedure put_Right(value: Single); safecall;
    function get_Top: Single; safecall;
    procedure put_Top(value: Single); safecall;
    function get_TopLeftRadius: Numerics_Vector2; safecall;
    procedure put_TopLeftRadius(value: Numerics_Vector2); safecall;
    function get_TopRightRadius: Numerics_Vector2; safecall;
    procedure put_TopRightRadius(value: Numerics_Vector2); safecall;
    property Bottom: Single read get_Bottom write put_Bottom;
    property BottomLeftRadius: Numerics_Vector2 read get_BottomLeftRadius write put_BottomLeftRadius;
    property BottomRightRadius: Numerics_Vector2 read get_BottomRightRadius write put_BottomRightRadius;
    property Left: Single read get_Left write put_Left;
    property Right: Single read get_Right write put_Right;
    property Top: Single read get_Top write put_Top;
    property TopLeftRadius: Numerics_Vector2 read get_TopLeftRadius write put_TopLeftRadius;
    property TopRightRadius: Numerics_Vector2 read get_TopRightRadius write put_TopRightRadius;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.UI.Composition.ICompositor7
  ICompositor7 = interface(IInspectable)
  ['{D3483FAD-9A12-53BA-BFC8-88B7FF7977C6}']
    function get_DispatcherQueue: IDispatcherQueue; safecall;
    function CreateAnimationPropertyInfo: IAnimationPropertyInfo; safecall;
    function CreateRectangleClip: IRectangleClip; overload; safecall;
    function CreateRectangleClip(left: Single; top: Single; right: Single; bottom: Single): IRectangleClip; overload; safecall;
    function CreateRectangleClip(left: Single; top: Single; right: Single; bottom: Single; topLeftRadius: Numerics_Vector2; topRightRadius: Numerics_Vector2; bottomRightRadius: Numerics_Vector2; bottomLeftRadius: Numerics_Vector2): IRectangleClip; overload; safecall;
    property DispatcherQueue: IDispatcherQueue read get_DispatcherQueue;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.ICompositor8
  ICompositor8 = interface(IInspectable)
  ['{9A0BDEE2-FE7B-5F62-A366-9CF8EFFE2112}']
    function CreateAnimationController: IAnimationController; safecall;
  end;
  ...
  // UsedAPI Interface
  // Windows.UI.Composition.ICompositorWithBlurredWallpaperBackdropBrush
  ICompositorWithBlurredWallpaperBackdropBrush = interface(IInspectable)
  ['{0D8FB190-F122-5B8D-9FDD-543B0D8EB7F3}']
    function TryCreateBlurredWallpaperBackdropBrush: ICompositionBackdropBrush; safecall;
  end;
  ...
  // Windows.UI.Composition.IVisual4
  IVisual4 = interface(IInspectable)
  ['{9476BF11-E24B-5BF9-9EBE-6274109B2711}']
    function get_IsPixelSnappingEnabled: Boolean; safecall;
    procedure put_IsPixelSnappingEnabled(value: Boolean); safecall;
    property IsPixelSnappingEnabled: Boolean read get_IsPixelSnappingEnabled write put_IsPixelSnappingEnabled;
  end;
  ...
  // Implements: Windows.UI.Composition.ICompositionObject5
  ...
  // Statics: "Windows.UI.Composition.ICompositionEasingFunctionStatics"
  TCompositionEasingFunction = class(TWinRTGenericImportS<ICompositionEasingFunctionStatics>)
  public
    // -> ICompositionEasingFunctionStatics
    class function CreateCubicBezierEasingFunction(owner: ICompositor; controlPoint1: Numerics_Vector2; controlPoint2: Numerics_Vector2): ICubicBezierEasingFunction; static; inline;
    class function CreateLinearEasingFunction(owner: ICompositor): ILinearEasingFunction; static; inline;
    class function CreateStepEasingFunction(owner: ICompositor): IStepEasingFunction; overload; static; inline;
    class function CreateStepEasingFunction(owner: ICompositor; stepCount: Integer): IStepEasingFunction; overload; static; inline;
    class function CreateBackEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; amplitude: Single): IBackEasingFunction; static; inline;
    class function CreateBounceEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; bounces: Integer; bounciness: Single): IBounceEasingFunction; static; inline;
    class function CreateCircleEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ICircleEasingFunction; static; inline;
    class function CreateElasticEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; oscillations: Integer; springiness: Single): IElasticEasingFunction; static; inline;
    class function CreateExponentialEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; exponent: Single): IExponentialEasingFunction; static; inline;
    class function CreatePowerEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; power: Single): IPowerEasingFunction; static; inline;
    class function CreateSineEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ISineEasingFunction; static; inline;
  end;
  ...
  // Implements: Windows.UI.Composition.ICompositor7
  // Implements: Windows.UI.Composition.ICompositorWithBlurredWallpaperBackdropBrush
  // Implements: Windows.UI.Composition.ICompositor8
  // Implements: Windows.Foundation.IClosable
...
{ TCompositionEasingFunction }

class function TCompositionEasingFunction.CreateCubicBezierEasingFunction(owner: ICompositor; controlPoint1: Numerics_Vector2; controlPoint2: Numerics_Vector2): ICubicBezierEasingFunction;
begin
  Result := Statics.CreateCubicBezierEasingFunction(owner, controlPoint1, controlPoint2);
end;

class function TCompositionEasingFunction.CreateLinearEasingFunction(owner: ICompositor): ILinearEasingFunction;
begin
  Result := Statics.CreateLinearEasingFunction(owner);
end;

class function TCompositionEasingFunction.CreateStepEasingFunction(owner: ICompositor): IStepEasingFunction;
begin
  Result := Statics.CreateStepEasingFunction(owner);
end;

class function TCompositionEasingFunction.CreateStepEasingFunction(owner: ICompositor; stepCount: Integer): IStepEasingFunction;
begin
  Result := Statics.CreateStepEasingFunction(owner, stepCount);
end;

class function TCompositionEasingFunction.CreateBackEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; amplitude: Single): IBackEasingFunction;
begin
  Result := Statics.CreateBackEasingFunction(owner, mode, amplitude);
end;

class function TCompositionEasingFunction.CreateBounceEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; bounces: Integer; bounciness: Single): IBounceEasingFunction;
begin
  Result := Statics.CreateBounceEasingFunction(owner, mode, bounces, bounciness);
end;

class function TCompositionEasingFunction.CreateCircleEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ICircleEasingFunction;
begin
  Result := Statics.CreateCircleEasingFunction(owner, mode);
end;

class function TCompositionEasingFunction.CreateElasticEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; oscillations: Integer; springiness: Single): IElasticEasingFunction;
begin
  Result := Statics.CreateElasticEasingFunction(owner, mode, oscillations, springiness);
end;

class function TCompositionEasingFunction.CreateExponentialEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; exponent: Single): IExponentialEasingFunction;
begin
  Result := Statics.CreateExponentialEasingFunction(owner, mode, exponent);
end;

class function TCompositionEasingFunction.CreatePowerEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode; power: Single): IPowerEasingFunction;
begin
  Result := Statics.CreatePowerEasingFunction(owner, mode, power);
end;

class function TCompositionEasingFunction.CreateSineEasingFunction(owner: ICompositor; mode: CompositionEasingFunctionMode): ISineEasingFunction;
begin
  Result := Statics.CreateSineEasingFunction(owner, mode);
end;
