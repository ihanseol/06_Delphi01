...
type
  ...
  Diagnostics_ISystemDiagnosticInfoStatics2 = interface;
  PDiagnostics_ISystemDiagnosticInfoStatics2 = ^Diagnostics_ISystemDiagnosticInfoStatics2;
  ...
  IAppUriHandlerHost2 = interface;
  PIAppUriHandlerHost2 = ^IAppUriHandlerHost2;
  ...
  PIAppUriHandlerRegistration2 = ^IAppUriHandlerRegistration2;
  ...
  IAppUriHandlerRegistrationManager2 = interface;
  PIAppUriHandlerRegistrationManager2 = ^IAppUriHandlerRegistrationManager2;
  ...
  PIKnownUserPropertiesStatics2 = ^IKnownUserPropertiesStatics2;
  ...
  AsyncOperationCompletedHandler_1__UserAgeConsentResult = interface;
  PAsyncOperationCompletedHandler_1__UserAgeConsentResult = ^AsyncOperationCompletedHandler_1__UserAgeConsentResult;

  // Windows.Foundation.IAsyncOperation`1<Windows.System.UserAgeConsentResult>
  IAsyncOperation_1__UserAgeConsentResult = interface;
  PIAsyncOperation_1__UserAgeConsentResult = ^IAsyncOperation_1__UserAgeConsentResult;
  ...
  IUserStatics2 = interface;
  PIUserStatics2 = ^IUserStatics2;

  // Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgs
  Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = interface;
  PImplementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = ^Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs;

  // Windows.Foundation.TypedEventHandler`2<Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource,Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgs>
  TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = interface;
  PTypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = ^TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs;

  // Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource
  Implementation_FileExplorer_ISysStorageProviderEventSource = interface;
  PImplementation_FileExplorer_ISysStorageProviderEventSource = ^Implementation_FileExplorer_ISysStorageProviderEventSource;

  // Windows.System.Implementation.FileExplorer.ISysStorageProviderHttpRequestProvider
  Implementation_FileExplorer_ISysStorageProviderHttpRequestProvider = interface;
  PImplementation_FileExplorer_ISysStorageProviderHttpRequestProvider = ^Implementation_FileExplorer_ISysStorageProviderHttpRequestProvider;

  // Windows.System.Implementation.FileExplorer.ISysStorageProviderHandlerFactory
  Implementation_FileExplorer_ISysStorageProviderHandlerFactory = interface;
  PImplementation_FileExplorer_ISysStorageProviderHandlerFactory = ^Implementation_FileExplorer_ISysStorageProviderHandlerFactory;
  ...
  Profile_IAnalyticsVersionInfo2 = interface;
  PProfile_IAnalyticsVersionInfo2 = ^Profile_IAnalyticsVersionInfo2;
  ...
  Profile_ISystemIdentificationStatics = interface;
  PProfile_ISystemIdentificationStatics = ^Profile_ISystemIdentificationStatics;
  ...
  RemoteDesktop_Input_IRemoteTextConnection = interface;
  PRemoteDesktop_Input_IRemoteTextConnection = ^RemoteDesktop_Input_IRemoteTextConnection;

  // Windows.System.RemoteDesktop.Input.RemoteTextConnectionDataHandler
  RemoteDesktop_Input_RemoteTextConnectionDataHandler = interface;
  PRemoteDesktop_Input_RemoteTextConnectionDataHandler = ^RemoteDesktop_Input_RemoteTextConnectionDataHandler;

  // Windows.System.RemoteDesktop.Provider.IRemoteDesktopConnectionInfo
  RemoteDesktop_Provider_IRemoteDesktopConnectionInfo = interface;
  PRemoteDesktop_Provider_IRemoteDesktopConnectionInfo = ^RemoteDesktop_Provider_IRemoteDesktopConnectionInfo;
  ...
  RemoteDesktop_Provider_RemoteDesktopConnectionStatus = (
    Connecting = 0,
    Connected = 1,
    UserInputNeeded = 2,
    Disconnected = 3
  );
  PRemoteDesktop_Provider_RemoteDesktopConnectionStatus = ^RemoteDesktop_Provider_RemoteDesktopConnectionStatus;
  ...
  PUserAgeConsentGroup = ^UserAgeConsentGroup;
  ...
  PUserAgeConsentResult = ^UserAgeConsentResult;
  ...
  ['{4D2C87A1-8AD0-5226-BF82-F80164043240}']
  end;
  ...
  ['{9C7749D2-AC22-5079-B092-019AB065989F}']
  end;
  ...
  ['{B690114C-7F7A-5894-8E0E-1474F2916368}']
  end;
  ...
  // Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2
  [WinRTClassNameAttribute(SWindows_System_Diagnostics_SystemDiagnosticInfo)]
  Diagnostics_ISystemDiagnosticInfoStatics2 = interface(IInspectable)
  ['{79DED189-6AF9-4DA9-A422-15F73255B3EB}']
    function IsArchitectureSupported(&type: ProcessorArchitecture): Boolean; safecall;
    function get_PreferredArchitecture: ProcessorArchitecture; safecall;
    property PreferredArchitecture: ProcessorArchitecture read get_PreferredArchitecture;
  end;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.IAppActivationResult>
  AsyncOperationCompletedHandler_1__IAppActivationResult_Delegate_Base = interface(IUnknown)
  ['{966E2307-D529-50EA-9872-8DFB35CFEFFD}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IAppActivationResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.IAppActivationResult>
  AsyncOperationCompletedHandler_1__IAppActivationResult = interface(AsyncOperationCompletedHandler_1__IAppActivationResult_Delegate_Base)
  ['{EBA1FBF3-1E05-5244-8C1E-0028555DBCC3}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.System.IAppActivationResult>
  IAsyncOperation_1__IAppActivationResult_Base = interface(IInspectable)
  ['{B6F373B8-BD4D-50BF-82B4-5B1D452A5F83}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.IAppActivationResult>
  IAsyncOperation_1__IAppActivationResult = interface(IAsyncOperation_1__IAppActivationResult_Base)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.DiagnosticAccessStatus>
  AsyncOperationCompletedHandler_1__DiagnosticAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.DiagnosticAccessStatus>
  IAsyncOperation_1__DiagnosticAccessStatus = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.IAppExecutionStateChangeResult>
  AsyncOperationCompletedHandler_1__IAppExecutionStateChangeResult_Delegate_Base = interface(IUnknown)
  ['{C162B59A-BDD2-5E4D-A309-B476EB97B823}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IAppExecutionStateChangeResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.IAppExecutionStateChangeResult>
  AsyncOperationCompletedHandler_1__IAppExecutionStateChangeResult = interface(AsyncOperationCompletedHandler_1__IAppExecutionStateChangeResult_Delegate_Base)
  ['{90C0B271-7CB2-5B65-9EDA-AA9F7FA1321E}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.System.IAppExecutionStateChangeResult>
  IAsyncOperation_1__IAppExecutionStateChangeResult_Base = interface(IInspectable)
  ['{C251CC22-ABA9-59B8-BF87-20677FC4924E}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.IAppExecutionStateChangeResult>
  IAsyncOperation_1__IAppExecutionStateChangeResult = interface(IAsyncOperation_1__IAppExecutionStateChangeResult_Base)
  ...
  // UsedAPI Interface
  // Windows.System.IAppUriHandlerHost2
  IAppUriHandlerHost2 = interface(IInspectable)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.System.IAppUriHandlerHost>
  IIterator_1__IAppUriHandlerHost_Base = interface(IInspectable)
  ['{66078237-A994-50DE-B1EA-338D7CF89A2C}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.IAppUriHandlerHost>
  IIterator_1__IAppUriHandlerHost = interface(IIterator_1__IAppUriHandlerHost_Base)
  ['{9431179C-CE04-57CE-9F9D-7C206310D816}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.System.IAppUriHandlerHost>
  IIterable_1__IAppUriHandlerHost_Base = interface(IInspectable)
  ['{F6E575BD-EAB7-5981-BA01-49FF976CA186}']
    function First: IIterator_1__IAppUriHandlerHost; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.IAppUriHandlerHost>
  IIterable_1__IAppUriHandlerHost = interface(IIterable_1__IAppUriHandlerHost_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>
  IVector_1__IAppUriHandlerHost_Base = interface(IInspectable)
  ['{4A226614-2197-526A-A9FF-03025D18E322}']
    function GetAt(index: Cardinal): IAppUriHandlerHost; safecall;
    function get_Size: Cardinal; safecall;
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>
  IVector_1__IAppUriHandlerHost = interface(IVector_1__IAppUriHandlerHost_Base)
  ['{A0CBB390-22DA-5A6C-89DE-12C36DB4AA4A}']
  end;

  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>>
  AsyncOperationCompletedHandler_1__IVector_1__IAppUriHandlerHost_Delegate_Base = interface(IUnknown)
  ['{D725228C-1DCD-5748-A84A-E5B03C41E397}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IVector_1__IAppUriHandlerHost; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>>
  AsyncOperationCompletedHandler_1__IVector_1__IAppUriHandlerHost = interface(AsyncOperationCompletedHandler_1__IVector_1__IAppUriHandlerHost_Delegate_Base)
  ['{BAB97844-D5F5-556B-83F9-FA3491624B0A}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>>
  IAsyncOperation_1__IVector_1__IAppUriHandlerHost_Base = interface(IInspectable)
  ['{A87E4877-F690-5883-B2BD-9E3C2AB66413}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVector`1<Windows.System.IAppUriHandlerHost>>
  IAsyncOperation_1__IVector_1__IAppUriHandlerHost = interface(IAsyncOperation_1__IVector_1__IAppUriHandlerHost_Base)
  ...
  // UsedAPI Interface
  // Windows.System.IAppUriHandlerRegistration2
  IAppUriHandlerRegistration2 = interface(IInspectable)
  ['{D54DAC97-CB39-5F1F-883E-01853730BD6D}']
    function GetAllHosts: IVector_1__IAppUriHandlerHost; safecall;
    procedure UpdateHosts(hosts: IIterable_1__IAppUriHandlerHost); safecall;
  ...
  // UsedAPI Interface
  // Windows.System.IAppUriHandlerRegistrationManager2
  IAppUriHandlerRegistrationManager2 = interface(IInspectable)
  ...
  // Windows.System.IKnownUserPropertiesStatics2
  [WinRTClassNameAttribute(SWindows_System_KnownUserProperties)]
  IKnownUserPropertiesStatics2 = interface(IInspectable)
  ['{5B450782-F620-577E-B1B3-DD56644D79B1}']
    function get_AgeEnforcementRegion: HSTRING; safecall;
    property AgeEnforcementRegion: HSTRING read get_AgeEnforcementRegion;
  end;
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.LaunchQuerySupportStatus>
  AsyncOperationCompletedHandler_1__LaunchQuerySupportStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.LaunchQuerySupportStatus>
  IAsyncOperation_1__LaunchQuerySupportStatus = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.LaunchUriStatus>
  AsyncOperationCompletedHandler_1__LaunchUriStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.LaunchUriStatus>
  IAsyncOperation_1__LaunchUriStatus = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.RemoteLaunchUriStatus>
  AsyncOperationCompletedHandler_1__RemoteLaunchUriStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.RemoteLaunchUriStatus>
  IAsyncOperation_1__RemoteLaunchUriStatus = interface(IInspectable)
  ...
  ['{C2B7624C-9F35-5074-8021-0633184899A7}']
  ...
  ['{B69475AC-A5D4-53D7-A53A-BB01B69620FA}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.UserAgeConsentResult>
  AsyncOperationCompletedHandler_1__UserAgeConsentResult = interface(IUnknown)
  ['{5FF26075-034F-5186-8FD3-9EDA8DA3E739}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__UserAgeConsentResult; asyncStatus: AsyncStatus); safecall;
  end;

  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.UserAgeConsentResult>
  IAsyncOperation_1__UserAgeConsentResult = interface(IInspectable)
  ['{D4DF0010-0172-5EFA-BD5C-6444DE94AF74}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__UserAgeConsentResult); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__UserAgeConsentResult; safecall;
    function GetResults: UserAgeConsentResult; safecall;
    property Completed: AsyncOperationCompletedHandler_1__UserAgeConsentResult read get_Completed write put_Completed;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.System.IUser2
  IUser2 = interface(IInspectable)
  ['{98BA5628-A6E3-518E-89D9-D3B2B1991A10}']
    function CheckUserAgeConsentGroupAsync(consentGroup: UserAgeConsentGroup): IAsyncOperation_1__UserAgeConsentResult; safecall;
  end;
  ...
  ['{99011E6C-3047-5BCA-B932-E1D1EB8A937F}']
  ...
  ['{92B358CD-C1CA-5552-9E2E-67E2D6EAD4D1}']
  ...
  // Windows.System.IUserStatics2
  [WinRTClassNameAttribute(SWindows_System_User)]
  IUserStatics2 = interface(IInspectable)
  ['{74A37E11-2EB5-4487-B0D5-2C6790E013E9}']
    function GetDefault: IUser; safecall;
  end;

  // UsedAPI Interface
  // Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgs
  Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = interface(IInspectable)
  ['{E132D1B9-7B9D-5820-9728-4262B5289142}']
    function get_Json: HSTRING; safecall;
    property Json: HSTRING read get_Json;
  end;

  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource,Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgs>
  TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs_Delegate_Base = interface(IUnknown)
  ['{DA34B79F-979C-5E94-82FB-D6C964E97EF6}']
    procedure Invoke(sender: Implementation_FileExplorer_ISysStorageProviderEventSource; args: Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource,Windows.System.Implementation.FileExplorer.ISysStorageProviderEventReceivedEventArgs>
  TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs = interface(TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs_Delegate_Base)
  ['{D9DBBE68-3E3F-54E5-AF48-6A1775347797}']
  end;

  // UsedAPI Interface
  // Windows.System.Implementation.FileExplorer.ISysStorageProviderEventSource
  Implementation_FileExplorer_ISysStorageProviderEventSource = interface(IInspectable)
  ['{1F36C476-9546-536A-8381-2F9A2C08CEDD}']
    function add_EventReceived(handler: TypedEventHandler_2__Implementation_FileExplorer_ISysStorageProviderEventSource__Implementation_FileExplorer_ISysStorageProviderEventReceivedEventArgs): EventRegistrationToken; safecall;
    procedure remove_EventReceived(token: EventRegistrationToken); safecall;
  end;

  // UsedAPI Interface
  // Windows.System.Implementation.FileExplorer.ISysStorageProviderHttpRequestProvider
  Implementation_FileExplorer_ISysStorageProviderHttpRequestProvider = interface(IInspectable)
  ['{CB6FEFB6-E76A-5C25-A33E-3E78A6E0E0CE}']
    function SendRequestAsync(request: Http_IHttpRequestMessage): IAsyncOperation_1__Http_IHttpResponseMessage; safecall;
  end;

  // UsedAPI Interface
  // Windows.System.Implementation.FileExplorer.ISysStorageProviderHandlerFactory
  Implementation_FileExplorer_ISysStorageProviderHandlerFactory = interface(IInspectable)
  ['{EE798431-8213-5E89-A623-14D8C72B8A61}']
    function GetHttpRequestProvider(syncRootId: HSTRING): Implementation_FileExplorer_ISysStorageProviderHttpRequestProvider; safecall;
    function GetEventSource(syncRootId: HSTRING; eventName: HSTRING): Implementation_FileExplorer_ISysStorageProviderEventSource; safecall;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Inventory.IInstalledDesktopApp>
  IIterator_1__Inventory_IInstalledDesktopApp_Base = interface(IInspectable)
  ['{AF3DA06D-0A82-5213-9CB5-F8D2DA12FBE9}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Inventory.IInstalledDesktopApp>
  IIterator_1__Inventory_IInstalledDesktopApp = interface(IIterator_1__Inventory_IInstalledDesktopApp_Base)
  ['{52D9CA44-67C9-5789-8AD4-4B811DBFDF13}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Inventory.IInstalledDesktopApp>
  IIterable_1__Inventory_IInstalledDesktopApp_Base = interface(IInspectable)
  ['{B64037F2-DC1A-57DE-8B03-18A16F9DDBDF}']
    function First: IIterator_1__Inventory_IInstalledDesktopApp; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Inventory.IInstalledDesktopApp>
  IIterable_1__Inventory_IInstalledDesktopApp = interface(IIterable_1__Inventory_IInstalledDesktopApp_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.System.Inventory.IInstalledDesktopApp>>
  AsyncOperationCompletedHandler_1__IVectorView_1__Inventory_IInstalledDesktopApp_Delegate_Base = interface(IUnknown)
  ['{EB945C7C-7EDD-565A-8BCC-82BAF4EA17B6}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.System.Inventory.IInstalledDesktopApp>>
  AsyncOperationCompletedHandler_1__IVectorView_1__Inventory_IInstalledDesktopApp = interface(AsyncOperationCompletedHandler_1__IVectorView_1__Inventory_IInstalledDesktopApp_Delegate_Base)
  ['{06990C85-9D06-52B0-958B-322F2B7B18BF}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.System.Inventory.IInstalledDesktopApp>>
  IAsyncOperation_1__IVectorView_1__Inventory_IInstalledDesktopApp_Base = interface(IInspectable)
  ['{9FFDAF80-6D25-5E34-9886-2B5D541D8324}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.System.Inventory.IInstalledDesktopApp>>
  IAsyncOperation_1__IVectorView_1__Inventory_IInstalledDesktopApp = interface(IAsyncOperation_1__IVectorView_1__Inventory_IInstalledDesktopApp_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading>
  AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreviewReading_Delegate_Base = interface(IUnknown)
  ['{4B1218AD-D399-5762-8202-C5D0D4B6EB54}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading>
  AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreviewReading = interface(AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreviewReading_Delegate_Base)
  ['{7A75D5C4-76F6-533E-9BFB-139D1A0494E0}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading>
  IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreviewReading_Base = interface(IInspectable)
  ['{2286A430-A059-5998-810C-25BA16017C9E}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReading>
  IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreviewReading = interface(IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreviewReading_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview,Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs>
  TypedEventHandler_2__Preview_ITwoPanelHingedDevicePosturePreview__Preview_ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs_Delegate_Base = interface(IUnknown)
  ['{3FC92C27-176D-58AA-A748-BE82C378DF41}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview,Windows.System.Preview.ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs>
  TypedEventHandler_2__Preview_ITwoPanelHingedDevicePosturePreview__Preview_ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs = interface(TypedEventHandler_2__Preview_ITwoPanelHingedDevicePosturePreview__Preview_ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview>
  AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreview_Delegate_Base = interface(IUnknown)
  ['{F2F2C54E-DF52-5A7F-8610-E579FD8593D8}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview>
  AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreview = interface(AsyncOperationCompletedHandler_1__Preview_ITwoPanelHingedDevicePosturePreview_Delegate_Base)
  ['{49E6AB5E-D07C-5EC1-A38F-A51287F100F5}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview>
  IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreview_Base = interface(IInspectable)
  ['{B9620919-E111-520F-8097-8E9B275391B5}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.Preview.ITwoPanelHingedDevicePosturePreview>
  IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreview = interface(IAsyncOperation_1__Preview_ITwoPanelHingedDevicePosturePreview_Base)
  ...
  // UsedAPI Interface
  // Windows.System.Profile.IAnalyticsVersionInfo2
  Profile_IAnalyticsVersionInfo2 = interface(IInspectable)
  ['{76E915B1-FF36-407C-9F57-160D3E540747}']
    function get_ProductName: HSTRING; safecall;
    property ProductName: HSTRING read get_ProductName;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Profile.IUnsupportedAppRequirement>
  IIterator_1__Profile_IUnsupportedAppRequirement_Base = interface(IInspectable)
  ['{10956160-6437-5430-9322-DF0D6AB2EBE6}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Profile.IUnsupportedAppRequirement>
  IIterator_1__Profile_IUnsupportedAppRequirement = interface(IIterator_1__Profile_IUnsupportedAppRequirement_Base)
  ['{BB976B54-C41E-5F1C-B2F6-9130D4842DF4}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Profile.IUnsupportedAppRequirement>
  IIterable_1__Profile_IUnsupportedAppRequirement_Base = interface(IInspectable)
  ['{BD9DED1D-0379-5143-A490-168B6B8413A3}']
    function First: IIterator_1__Profile_IUnsupportedAppRequirement; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Profile.IUnsupportedAppRequirement>
  IIterable_1__Profile_IUnsupportedAppRequirement = interface(IIterable_1__Profile_IUnsupportedAppRequirement_Base)
  ...
  // UsedAPI Interface
  // Windows.System.Profile.ISystemIdentificationStatics
  [WinRTClassNameAttribute(SWindows_System_Profile_SystemIdentification)]
  Profile_ISystemIdentificationStatics = interface(IInspectable)
  ['{5581F42A-D3DF-4D93-A37D-C41A616C6D01}']
    function GetSystemIdForPublisher: Profile_ISystemIdentificationInfo; safecall;
    function GetSystemIdForUser(user: IUser): Profile_ISystemIdentificationInfo; safecall;
  end;
  ...
  // UsedAPI Interface
  // Windows.System.RemoteDesktop.Input.IRemoteTextConnection
  RemoteDesktop_Input_IRemoteTextConnection = interface(IInspectable)
  ['{4E7BB02A-183E-5E66-B5E4-3E6E5C570CF1}']
    function get_IsEnabled: Boolean; safecall;
    procedure put_IsEnabled(value: Boolean); safecall;
    procedure RegisterThread(threadId: Cardinal); safecall;
    procedure UnregisterThread(threadId: Cardinal); safecall;
    procedure ReportDataReceived(pduDataSize: Cardinal; pduData: PByte); safecall;
    property IsEnabled: Boolean read get_IsEnabled write put_IsEnabled;
  end;

  // UsedAPI Interface
  // Windows.System.RemoteDesktop.Input.RemoteTextConnectionDataHandler
  RemoteDesktop_Input_RemoteTextConnectionDataHandler = interface(IUnknown)
  ['{099FFBC8-8BCB-41B5-B056-57E77021BF1B}']
    function Invoke(pduDataSize: Cardinal; pduData: PByte): Boolean; safecall;
  end;

  // UsedAPI Interface
  // Windows.System.RemoteDesktop.Provider.IRemoteDesktopConnectionInfo
  RemoteDesktop_Provider_IRemoteDesktopConnectionInfo = interface(IInspectable)
  ['{886BDE2A-46AD-5A25-9348-03E801C78575}']
    procedure SetConnectionStatus(value: RemoteDesktop_Provider_RemoteDesktopConnectionStatus); safecall;
  end;
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.System.RemoteSystems.IRemoteSystemApp>
  IIterator_1__RemoteSystems_IRemoteSystemApp_Base = interface(IInspectable)
  ['{8AA2049C-EAA5-534E-A144-5217499C739C}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.RemoteSystems.IRemoteSystemApp>
  IIterator_1__RemoteSystems_IRemoteSystemApp = interface(IIterator_1__RemoteSystems_IRemoteSystemApp_Base)
  ['{A5BE1264-7421-53B5-827A-CB1C73A758A6}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.System.RemoteSystems.IRemoteSystemApp>
  IIterable_1__RemoteSystems_IRemoteSystemApp_Base = interface(IInspectable)
  ['{4CFC1093-6DE6-5D4D-8073-30E64B4DFA15}']
    function First: IIterator_1__RemoteSystems_IRemoteSystemApp; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.RemoteSystems.IRemoteSystemApp>
  IIterable_1__RemoteSystems_IRemoteSystemApp = interface(IIterable_1__RemoteSystems_IRemoteSystemApp_Base)
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.RemoteSystems.IRemoteSystemFilter>
  IIterator_1__RemoteSystems_IRemoteSystemFilter = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.RemoteSystems.IRemoteSystemFilter>
  IIterable_1__RemoteSystems_IRemoteSystemFilter = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.RemoteSystems.RemoteSystemAccessStatus>
  AsyncOperationCompletedHandler_1__RemoteSystems_RemoteSystemAccessStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.RemoteSystems.RemoteSystemAccessStatus>
  IAsyncOperation_1__RemoteSystems_RemoteSystemAccessStatus = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.System.RemoteSystems.IRemoteSystemWatcher,Windows.System.RemoteSystems.IRemoteSystemEnumerationCompletedEventArgs>
  TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemEnumerationCompletedEventArgs_Delegate_Base = interface(IUnknown)
  ['{42AE9D52-FD0D-5411-8C8C-D676A09767E9}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.System.RemoteSystems.IRemoteSystemWatcher,Windows.System.RemoteSystems.IRemoteSystemEnumerationCompletedEventArgs>
  TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemEnumerationCompletedEventArgs = interface(TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemEnumerationCompletedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.System.RemoteSystems.IRemoteSystemWatcher,Windows.System.RemoteSystems.IRemoteSystemWatcherErrorOccurredEventArgs>
  TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemWatcherErrorOccurredEventArgs_Delegate_Base = interface(IUnknown)
  ['{A4A023B4-567B-5D4B-A4C8-5CA4F886D3A3}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.System.RemoteSystems.IRemoteSystemWatcher,Windows.System.RemoteSystems.IRemoteSystemWatcherErrorOccurredEventArgs>
  TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemWatcherErrorOccurredEventArgs = interface(TypedEventHandler_2__RemoteSystems_IRemoteSystemWatcher__RemoteSystems_IRemoteSystemWatcherErrorOccurredEventArgs_Delegate_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Update.ISystemUpdateItem>
  IIterator_1__Update_ISystemUpdateItem_Base = interface(IInspectable)
  ['{F4AE5176-C068-542F-81B4-8900F72BD742}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.System.Update.ISystemUpdateItem>
  IIterator_1__Update_ISystemUpdateItem = interface(IIterator_1__Update_ISystemUpdateItem_Base)
  ['{B9D20D2D-9C3A-582F-BA35-51887753CFAF}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Update.ISystemUpdateItem>
  IIterable_1__Update_ISystemUpdateItem_Base = interface(IInspectable)
  ['{318A3078-918C-5521-B460-0B4210360AA1}']
    function First: IIterator_1__Update_ISystemUpdateItem; safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.System.Update.ISystemUpdateItem>
  IIterable_1__Update_ISystemUpdateItem = interface(IIterable_1__Update_ISystemUpdateItem_Base)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.UserProfile.SetImageFeedResult>
  AsyncOperationCompletedHandler_1__UserProfile_SetImageFeedResult = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.UserProfile.SetImageFeedResult>
  IAsyncOperation_1__UserProfile_SetImageFeedResult = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.System.UserProfile.SetAccountPictureResult>
  AsyncOperationCompletedHandler_1__UserProfile_SetAccountPictureResult = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.System.UserProfile.SetAccountPictureResult>
  IAsyncOperation_1__UserProfile_SetAccountPictureResult = interface(IInspectable)
  ...
  // Statics: "Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2"
  TDiagnostics_SystemDiagnosticInfo = class(TWinRTGenericImportS2<Diagnostics_ISystemDiagnosticInfoStatics, Diagnostics_ISystemDiagnosticInfoStatics2>)
  public
    ...
    // -> Diagnostics_ISystemDiagnosticInfoStatics2
    class function IsArchitectureSupported(&type: ProcessorArchitecture): Boolean; static; inline;
    class function get_PreferredArchitecture: ProcessorArchitecture; static; inline;
    class property PreferredArchitecture: ProcessorArchitecture read get_PreferredArchitecture;
  end;
  ...
  // Statics: "Windows.System.IKnownUserPropertiesStatics2"
  TKnownUserProperties = class(TWinRTGenericImportS2<IKnownUserPropertiesStatics, IKnownUserPropertiesStatics2>)
  public
    ...
    class function get_AgeEnforcementRegion: HSTRING; static; inline;
    class property AgeEnforcementRegion: HSTRING read get_AgeEnforcementRegion;
  end;
  ...
  // DualAPI
  // Statics: "Windows.System.Profile.ISystemIdentificationStatics"
  TProfile_SystemIdentification = class(TWinRTGenericImportS<Profile_ISystemIdentificationStatics>)
  public
    // -> Profile_ISystemIdentificationStatics
    class function GetSystemIdForPublisher: Profile_ISystemIdentificationInfo; static; inline;
    class function GetSystemIdForUser(user: IUser): Profile_ISystemIdentificationInfo; static; inline;
  end;
  ...
  // Implements: Windows.System.IUser2
  // Statics: "Windows.System.IUserStatics"
  // Statics: "Windows.System.IUserStatics2"
  TUser = class(TWinRTGenericImportS2<IUserStatics, IUserStatics2>)
  public
    // -> IUserStatics
    ...
    // -> IUserStatics2
    class function GetDefault: IUser; static; inline;
  end;
...
class function TDiagnostics_SystemDiagnosticInfo.IsArchitectureSupported(&type: ProcessorArchitecture): Boolean;
begin
  Result := Statics2.IsArchitectureSupported(&type);
end;

class function TDiagnostics_SystemDiagnosticInfo.get_PreferredArchitecture: ProcessorArchitecture;
begin
  Result := Statics2.get_PreferredArchitecture;
end;
...
class function TKnownUserProperties.get_AgeEnforcementRegion: HSTRING;
begin
  Result := Statics2.get_AgeEnforcementRegion;
end;
...
{ TProfile_SystemIdentification }

class function TProfile_SystemIdentification.GetSystemIdForPublisher: Profile_ISystemIdentificationInfo;
begin
  Result := Statics.GetSystemIdForPublisher;
end;

class function TProfile_SystemIdentification.GetSystemIdForUser(user: IUser): Profile_ISystemIdentificationInfo;
begin
  Result := Statics.GetSystemIdForUser(user);
end;
...
class function TUser.GetDefault: IUser;
begin
  Result := Statics2.GetDefault;
end;
