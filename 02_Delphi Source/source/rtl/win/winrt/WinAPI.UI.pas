...
type
  ...
  TypedEventHandler_2__Core_ICompositorController__IInspectable_Delegate_Base = Winapi.CommonTypes.TypedEventHandler_2__Core_ICompositorController__IInspectable_Delegate_Base;
  ...
  TypedEventHandler_2__Core_ICoreInputView__IInspectable_Delegate_Base = Winapi.CommonTypes.TypedEventHandler_2__Core_ICoreInputView__IInspectable_Delegate_Base;
  ...
  TypedEventHandler_2__WindowManagement_IWindowingEnvironment__WindowManagement_IWindowingEnvironmentChangedEventArgs_Delegate_Base = Winapi.CommonTypes.TypedEventHandler_2__WindowManagement_IWindowingEnvironment__WindowManagement_IWindowingEnvironmentChangedEventArgs_Delegate_Base;
  ...
  WindowId = Winapi.CommonTypes.WindowId;
  PWindowId = Winapi.CommonTypes.PWindowId;
  ...
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.Notifications.IToastNotificationManagerForUser,Object>
  TypedEventHandler_2__IToastNotificationManagerForUser__IInspectable = interface;
  PTypedEventHandler_2__IToastNotificationManagerForUser__IInspectable = ^TypedEventHandler_2__IToastNotificationManagerForUser__IInspectable;

  // Windows.UI.UIAutomation.Core.ICoreAutomationConnectionBoundObjectProvider
  UIAutomation_Core_ICoreAutomationConnectionBoundObjectProvider = interface;
  PUIAutomation_Core_ICoreAutomationConnectionBoundObjectProvider = ^UIAutomation_Core_ICoreAutomationConnectionBoundObjectProvider;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowId>
  IIterator_1__WindowId = interface;
  PIIterator_1__WindowId = ^IIterator_1__WindowId;

  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowId>
  IIterable_1__WindowId = interface;
  PIIterable_1__WindowId = ^IIterable_1__WindowId;

  // Windows.Foundation.Collections.IVectorView`1<Windows.UI.WindowId>
  IVectorView_1__WindowId = interface;
  PIVectorView_1__WindowId = ^IVectorView_1__WindowId;
  ...
  Shell_ShareWindowCommand = (
    None = 0,
    StartSharing = 1,
    StopSharing = 2
  );
  PShell_ShareWindowCommand = ^Shell_ShareWindowCommand;
  ...
  UIAutomation_Core_AutomationRemoteOperationStatus = (
    Success = 0,
    MalformedBytecode = 1,
  ...
  PUIAutomation_Core_AutomationRemoteOperationStatus = ^UIAutomation_Core_AutomationRemoteOperationStatus;
  ...
  Shell_WindowTabManagerContract = record
  end;
  PShell_WindowTabManagerContract = ^Shell_WindowTabManagerContract;

  // Windows.UI.UIAutomation.Core.AutomationAnnotationTypeRegistration
  UIAutomation_Core_AutomationAnnotationTypeRegistration = record
    LocalId: Integer;
  end;
  PUIAutomation_Core_AutomationAnnotationTypeRegistration = ^UIAutomation_Core_AutomationAnnotationTypeRegistration;

  // Windows.UI.UIAutomation.Core.AutomationRemoteOperationOperandId
  UIAutomation_Core_AutomationRemoteOperationOperandId = record
    Value: Integer;
  end;
  PUIAutomation_Core_AutomationRemoteOperationOperandId = ^UIAutomation_Core_AutomationRemoteOperationOperandId;

  // Windows.UI.UIAutomation.UIAutomationContract
  UIAutomation_UIAutomationContract = record
  end;
  PUIAutomation_UIAutomationContract = ^UIAutomation_UIAutomationContract;
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.Color>
  IIterable_1__Color = interface(IInspectable)
  ...
  ['{AB8E5D11-B0C1-5A21-95AE-F16BF3A37624}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowManagement.IDisplayRegion>
  IIterator_1__WindowManagement_IDisplayRegion_Base = interface(IInspectable)
  ['{110D4D7E-2F29-51B8-9691-8B206AD1D73B}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowManagement.IDisplayRegion>
  IIterator_1__WindowManagement_IDisplayRegion = interface(IIterator_1__WindowManagement_IDisplayRegion_Base)
  ['{F4670424-1F7D-5265-BE8A-4877DEC91C8A}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowManagement.IDisplayRegion>
  IIterable_1__WindowManagement_IDisplayRegion_Base = interface(IInspectable)
  ['{026730AB-250D-503C-A876-43BBB754AD44}']
    function First: IIterator_1__WindowManagement_IDisplayRegion; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowManagement.IDisplayRegion>
  IIterable_1__WindowManagement_IDisplayRegion = interface(IIterable_1__WindowManagement_IDisplayRegion_Base)
  ...
  ['{BCC32D2A-7534-5C0E-ACFA-59914B25E18A}']
  ...
  ['{9164232A-8CFF-5C68-857C-F267619645F0}']
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowChangedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowChangedEventArgs_Delegate_Base = interface(IUnknown)
  ['{C6A30887-6F60-597F-B918-757CAB5F3A76}']
    procedure Invoke(sender: WindowManagement_IAppWindow; args: WindowManagement_IAppWindowChangedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowChangedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowChangedEventArgs = interface(TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowChangedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowClosedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowClosedEventArgs_Delegate_Base = interface(IUnknown)
  ['{7F62C430-89B3-5873-93CA-BB4D71A390E4}']
    procedure Invoke(sender: WindowManagement_IAppWindow; args: WindowManagement_IAppWindowClosedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowClosedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowClosedEventArgs = interface(TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowClosedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowCloseRequestedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowCloseRequestedEventArgs_Delegate_Base = interface(IUnknown)
  ['{C0359718-173D-5F19-B76A-91929B2B0451}']
    procedure Invoke(sender: WindowManagement_IAppWindow; args: WindowManagement_IAppWindowCloseRequestedEventArgs); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.WindowManagement.IAppWindow,Windows.UI.WindowManagement.IAppWindowCloseRequestedEventArgs>
  TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowCloseRequestedEventArgs = interface(TypedEventHandler_2__WindowManagement_IAppWindow__WindowManagement_IAppWindowCloseRequestedEventArgs_Delegate_Base)
  ...
  // Generic Delegate for:
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.Notifications.IToastNotificationManagerForUser,Object>
  TypedEventHandler_2__IToastNotificationManagerForUser__IInspectable_Delegate_Base = interface(IUnknown)
  ['{821BDF6B-029A-5299-93F3-3077B2EE5E33}']
    procedure Invoke(sender: IToastNotificationManagerForUser; args: IInspectable); safecall;
  end;
  // Windows.Foundation.TypedEventHandler`2<Windows.UI.Notifications.IToastNotificationManagerForUser,Object>
  TypedEventHandler_2__IToastNotificationManagerForUser__IInspectable = interface(TypedEventHandler_2__IToastNotificationManagerForUser__IInspectable_Delegate_Base)
  ['{0A55B395-91B1-5A40-BD2D-3DA9BC0D86A0}']
  end;

  // Windows.UI.UIAutomation.Core.ICoreAutomationConnectionBoundObjectProvider
  UIAutomation_Core_ICoreAutomationConnectionBoundObjectProvider = interface(IInspectable)
  ['{0620BB64-9616-5593-BE3A-EB8E6DAEB3FA}']
    function get_IsComThreadingRequired: Boolean; safecall;
    property IsComThreadingRequired: Boolean read get_IsComThreadingRequired;
  end;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.WindowManagement.IAppWindow>
  AsyncOperationCompletedHandler_1__WindowManagement_IAppWindow_Delegate_Base = interface(IUnknown)
  ['{3BBEA3E6-34B8-5EF0-A093-9CC71FA40B6E}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__WindowManagement_IAppWindow; asyncStatus: AsyncStatus); safecall;
  end;
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.WindowManagement.IAppWindow>
  AsyncOperationCompletedHandler_1__WindowManagement_IAppWindow = interface(AsyncOperationCompletedHandler_1__WindowManagement_IAppWindow_Delegate_Base)
  ['{B9804EF8-64CB-5FAA-B83B-018AAE52A63E}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.WindowManagement.IAppWindow>
  IAsyncOperation_1__WindowManagement_IAppWindow_Base = interface(IInspectable)
  ['{4167727A-5DF0-5ED3-B624-167C81BEFF6B}']
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.UI.WindowManagement.IAppWindow>
  IAsyncOperation_1__WindowManagement_IAppWindow = interface(IAsyncOperation_1__WindowManagement_IAppWindow_Base)
  ['{0794B92B-B957-5CAC-B79A-8F293E6E9D11}']
  end;

  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowId>
  IIterator_1__WindowId = interface(IInspectable)
  ['{BA0A30A1-C082-5671-AC07-7AAA4F269670}']
    function get_Current: WindowId; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PWindowId): Cardinal; safecall;
    property Current: WindowId read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowId>
  IIterable_1__WindowId = interface(IInspectable)
  ['{745698BF-22AD-5C0D-B0E0-07D35A1C9719}']
    function First: IIterator_1__WindowId; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.UI.WindowId>
  IVectorView_1__WindowId = interface(IInspectable)
  ['{F49E7371-B31A-5620-A42E-7E969003F0FF}']
    function GetAt(index: Cardinal): WindowId; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: WindowId; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PWindowId): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowManagement.IWindowingEnvironment>
  IIterator_1__WindowManagement_IWindowingEnvironment_Base = interface(IInspectable)
  ['{A35C192A-9459-5BCC-9DB3-23243716197F}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.UI.WindowManagement.IWindowingEnvironment>
  IIterator_1__WindowManagement_IWindowingEnvironment = interface(IIterator_1__WindowManagement_IWindowingEnvironment_Base)
  ['{83484D4A-D906-5DBD-AF5A-026F987E8F90}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowManagement.IWindowingEnvironment>
  IIterable_1__WindowManagement_IWindowingEnvironment_Base = interface(IInspectable)
  ['{626A6481-0174-5A56-84C9-E8D4C48CFB1B}']
    function First: IIterator_1__WindowManagement_IWindowingEnvironment; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.UI.WindowManagement.IWindowingEnvironment>
  IIterable_1__WindowManagement_IWindowingEnvironment = interface(IIterable_1__WindowManagement_IWindowingEnvironment_Base)
