...
type
  ...
  Activation_IBackgroundActivatedEventArgs = Winapi.CommonTypes.Activation_IBackgroundActivatedEventArgs;
  PActivation_IBackgroundActivatedEventArgs = Winapi.CommonTypes.PActivation_IBackgroundActivatedEventArgs;
  ...
  AsyncOperationCompletedHandler_1__IVectorView_1__HSTRING = Winapi.CommonTypes.AsyncOperationCompletedHandler_1__IVectorView_1__HSTRING;
  PAsyncOperationCompletedHandler_1__IVectorView_1__HSTRING = Winapi.CommonTypes.PAsyncOperationCompletedHandler_1__IVectorView_1__HSTRING;
  IAppDisplayInfo = Winapi.CommonTypes.IAppDisplayInfo;
  PIAppDisplayInfo = Winapi.CommonTypes.PIAppDisplayInfo;
  IAppInfo = Winapi.CommonTypes.IAppInfo;
  PIAppInfo = Winapi.CommonTypes.PIAppInfo;
  IAsyncOperation_1__IVectorView_1__HSTRING = Winapi.CommonTypes.IAsyncOperation_1__IVectorView_1__HSTRING;
  PIAsyncOperation_1__IVectorView_1__HSTRING = Winapi.CommonTypes.PIAsyncOperation_1__IVectorView_1__HSTRING;
  ...
  TypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs_Delegate_Base = Winapi.CommonTypes.TypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs_Delegate_Base;
  TypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs = Winapi.CommonTypes.TypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs;
  PTypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs = Winapi.CommonTypes.PTypedEventHandler_2__IBackgroundTaskRegistrationGroup__Activation_IBackgroundActivatedEventArgs;
  ...
  AppExtensions_IAppExtension2 = interface;
  PAppExtensions_IAppExtension2 = ^AppExtensions_IAppExtension2;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Calls.PhoneCallOperationStatus>
  AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus = interface;
  PAsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus = ^AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Calls.PhoneCallOperationStatus>
  IAsyncOperation_1__Calls_PhoneCallOperationStatus = interface;
  PIAsyncOperation_1__Calls_PhoneCallOperationStatus = ^IAsyncOperation_1__Calls_PhoneCallOperationStatus;
  ...
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = interface;
  PAsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = ^AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult;
  ...
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = interface;
  PIAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = ^IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult;
  ...
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = interface;
  PAsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = ^AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult;
  ...
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = interface;
  PIAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = ^IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult;
  ...
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = interface;
  PAsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = ^AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult;
  ...
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = interface;
  PIAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = ^IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult;
  ...
  AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult = interface;
  PAsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult = ^AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentActivationResult>
  IAsyncOperation_1__ConversationalAgent_ConversationalAgentActivationResult = interface;
  PIAsyncOperation_1__ConversationalAgent_ConversationalAgentActivationResult = ^IAsyncOperation_1__ConversationalAgent_ConversationalAgentActivationResult;

  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IIterator_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface;
  PIIterator_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^IIterator_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;

  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IIterable_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface;
  PIIterable_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^IIterable_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;

  // Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface;
  PIVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;
  ...
  AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface;
  PAsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;

  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>>
  IAsyncOperation_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface;
  PIAsyncOperation_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^IAsyncOperation_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;

  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IIterator_1__ConversationalAgent_SignalDetectorResourceKind = interface;
  PIIterator_1__ConversationalAgent_SignalDetectorResourceKind = ^IIterator_1__ConversationalAgent_SignalDetectorResourceKind;

  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IIterable_1__ConversationalAgent_SignalDetectorResourceKind = interface;
  PIIterable_1__ConversationalAgent_SignalDetectorResourceKind = ^IIterable_1__ConversationalAgent_SignalDetectorResourceKind;

  // Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IVectorView_1__ConversationalAgent_SignalDetectorResourceKind = interface;
  PIVectorView_1__ConversationalAgent_SignalDetectorResourceKind = ^IVectorView_1__ConversationalAgent_SignalDetectorResourceKind;
  ...
  IAppInfo3 = interface;
  PIAppInfo3 = ^IAppInfo3;

  // Windows.ApplicationModel.IAppInfo4
  IAppInfo4 = interface;
  PIAppInfo4 = ^IAppInfo4;
  ...
  IAppInstallerInfo2 = interface;
  PIAppInstallerInfo2 = ^IAppInstallerInfo2;

  // Windows.ApplicationModel.IFindRelatedPackagesOptions
  IFindRelatedPackagesOptions = interface;
  PIFindRelatedPackagesOptions = ^IFindRelatedPackagesOptions;
  ...
  PAppExecutionContext = ^AppExecutionContext;
  ...
  PAppInstallerPolicySource = ^AppInstallerPolicySource;
  ...
  PCalls_DtmfKey = ^Calls_DtmfKey;

  // Windows.ApplicationModel.Calls.DtmfToneAudioPlayback
  Calls_DtmfToneAudioPlayback = (
    Play = 0,
    DoNotPlay = 1
  );
  PCalls_DtmfToneAudioPlayback = ^Calls_DtmfToneAudioPlayback;
  ...
  // Windows.ApplicationModel.Calls.PhoneCallAudioDevice
  Calls_PhoneCallAudioDevice = (
    Unknown = 0,
    LocalDevice = 1,
    RemoteDevice = 2
  );
  PCalls_PhoneCallAudioDevice = ^Calls_PhoneCallAudioDevice;

  // Windows.ApplicationModel.Calls.PhoneCallDirection
  Calls_PhoneCallDirection = (
    Unknown = 0,
    Incoming = 1,
    Outgoing = 2
  );
  PCalls_PhoneCallDirection = ^Calls_PhoneCallDirection;
  ...
  Calls_PhoneCallOperationStatus = (
    Succeeded = 0,
    OtherFailure = 1,
    TimedOut = 2,
    ConnectionLost = 3,
  ...
  PCalls_PhoneCallOperationStatus = ^Calls_PhoneCallOperationStatus;

  // Windows.ApplicationModel.Calls.PhoneCallStatus
  Calls_PhoneCallStatus = (
    Lost = 0,
    Incoming = 1,
    Dialing = 2,
    Talking = 3,
  ...
  PCalls_PhoneCallStatus = ^Calls_PhoneCallStatus;
  ...
  Calls_PhoneLineOperationStatus = (
    Succeeded = 0,
    OtherFailure = 1,
    TimedOut = 2,
    ConnectionLost = 3,
  ...
  PCalls_PhoneLineOperationStatus = ^Calls_PhoneLineOperationStatus;
  ...
  Calls_TransportDeviceAudioRoutingStatus = (
    Unknown = 0,
    CanRouteToLocalDevice = 1,
    CannotRouteToLocalDevice = 2
  );
  PCalls_TransportDeviceAudioRoutingStatus = ^Calls_TransportDeviceAudioRoutingStatus;
  ...
  ConversationalAgent_ActivationSignalDetectionConfigurationCreationStatus = (
    Success = 0,
  ...
  PConversationalAgent_ActivationSignalDetectionConfigurationCreationStatus = ^ConversationalAgent_ActivationSignalDetectionConfigurationCreationStatus;

  // Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationRemovalResult
  ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = (
    Success = 0,
    NotFound = 1,
    CurrentlyEnabled = 2,
    RemovalNotSupported = 3
  );
  PConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = ^ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult;

  // Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationSetModelDataResult
  ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = (
    Success = 0,
    EmptyModelData = 1,
    UnsupportedFormat = 2,
  ...
  PConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = ^ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult;

  // Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationStateChangeResult
  ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = (
    Success = 0,
    NoModelData = 1,
    ConfigurationNotFound = 2
  );
  PConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = ^ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult;
  ...
  ConversationalAgent_ConversationalAgentActivationKind = (
    VoiceActivationPreview = 0,
    Foreground = 1
  );
  PConversationalAgent_ConversationalAgentActivationKind = ^ConversationalAgent_ConversationalAgentActivationKind;

  // Windows.ApplicationModel.ConversationalAgent.ConversationalAgentActivationResult
  ConversationalAgent_ConversationalAgentActivationResult = (
    Success = 0,
    AgentInactive = 1,
    ScreenNotAvailable = 2,
    AgentInterrupted = 3
  );
  PConversationalAgent_ConversationalAgentActivationResult = ^ConversationalAgent_ConversationalAgentActivationResult;
  ...
  ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = (
  ...
  PConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = ^ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind;
  ...
  ConversationalAgent_SignalDetectorResourceKind = (
  ...
  PConversationalAgent_SignalDetectorResourceKind = ^ConversationalAgent_SignalDetectorResourceKind;
  ...
  PFullTrustLaunchResult = ^FullTrustLaunchResult;
  ...
  PPackageRelationship = ^PackageRelationship;
  ...
  // Windows.ApplicationModel.AppExtensions.IAppExtension2
  AppExtensions_IAppExtension2 = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.AppService.AppServiceConnectionStatus>
  AsyncOperationCompletedHandler_1__AppService_AppServiceConnectionStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.AppService.AppServiceConnectionStatus>
  IAsyncOperation_1__AppService_AppServiceConnectionStatus = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.AppService.AppServiceResponseStatus>
  AsyncOperationCompletedHandler_1__AppService_AppServiceResponseStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.AppService.AppServiceResponseStatus>
  IAsyncOperation_1__AppService_AppServiceResponseStatus = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.AppService.IStatelessAppServiceResponse>
  AsyncOperationCompletedHandler_1__AppService_IStatelessAppServiceResponse_Delegate_Base = interface(IUnknown)
  ['{4D1EE4ED-4D79-53FA-A9D7-C9C9354E4F55}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__AppService_IStatelessAppServiceResponse; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.AppService.IStatelessAppServiceResponse>
  AsyncOperationCompletedHandler_1__AppService_IStatelessAppServiceResponse = interface(AsyncOperationCompletedHandler_1__AppService_IStatelessAppServiceResponse_Delegate_Base)
  ['{A7ADC0D9-78CD-5109-8E9E-87873A303FF3}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.AppService.IStatelessAppServiceResponse>
  IAsyncOperation_1__AppService_IStatelessAppServiceResponse_Base = interface(IInspectable)
  ['{B2A1524E-BEAB-5BEB-AAE9-B43501C3A488}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.AppService.IStatelessAppServiceResponse>
  IAsyncOperation_1__AppService_IStatelessAppServiceResponse = interface(IAsyncOperation_1__AppService_IStatelessAppServiceResponse_Base)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Calls.PhoneCallOperationStatus>
  AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus = interface(IUnknown)
  ['{6E80AE96-2731-51F9-8375-53E6C5E2AD8A}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__Calls_PhoneCallOperationStatus; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Calls.PhoneCallOperationStatus>
  IAsyncOperation_1__Calls_PhoneCallOperationStatus = interface(IInspectable)
  ['{286DF3A1-2F43-5B7A-984F-66B8A43B9876}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus; safecall;
    function GetResults: Calls_PhoneCallOperationStatus; safecall;
    property Completed: AsyncOperationCompletedHandler_1__Calls_PhoneCallOperationStatus read get_Completed write put_Completed;
  end;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Calls.VoipPhoneCallResourceReservationStatus>
  AsyncOperationCompletedHandler_1__Calls_VoipPhoneCallResourceReservationStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Calls.VoipPhoneCallResourceReservationStatus>
  IAsyncOperation_1__Calls_VoipPhoneCallResourceReservationStatus = interface(IInspectable)
  ...
  ['{4F426A27-6D23-58B6-9F29-4F88ED274BCD}']
    function get_Key: HSTRING; safecall;
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<String,Windows.ApplicationModel.Chat.ChatMessageStatus>>
  IIterable_1__IKeyValuePair_2__HSTRING__Chat_ChatMessageStatus = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IMapView`2<String,Windows.ApplicationModel.Chat.ChatMessageStatus>
  IMapView_2__HSTRING__Chat_ChatMessageStatus = interface(IInspectable)
  ...
  ['{6C131B87-097F-5965-84D5-964C52B1787E}']
  ...
  ['{7631A007-93A6-554E-BCDD-3BAEE7C8C2C6}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationSetModelDataResult>
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = interface(IUnknown)
  ['{C3982503-9AE9-582E-9874-33EA36649A3C}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationSetModelDataResult>
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult = interface(IInspectable)
  ['{3738E73C-E4CD-55AD-B760-07AF8B4A29D3}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult; safecall;
    function GetResults: ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult; safecall;
    property Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationSetModelDataResult read get_Completed write put_Completed;
  end;

  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationStateChangeResult>
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = interface(IUnknown)
  ['{4AA91BFB-908E-52BA-A23D-06F464B5B54A}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationStateChangeResult>
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult = interface(IInspectable)
  ['{BE03CC1F-0A8A-5878-A84E-AF4646DF3CC5}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult; safecall;
    function GetResults: ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult; safecall;
    property Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationStateChangeResult read get_Completed write put_Completed;
  end;

  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionTrainingDataFormat>
  IIterator_1__ConversationalAgent_ActivationSignalDetectionTrainingDataFormat = interface(IInspectable)
  ['{1F6EF295-4D31-5874-A22D-29875EE8165C}']
  ...
  ['{679189C6-73C4-5295-8B04-6CE05CAB4D17}']
  ...
  ['{F5DAAC9C-92CF-5945-9C5B-1C0B8EAC8143}']
  ...
  ['{C303FD7F-D073-54C3-8411-C118226323AC}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationRemovalResult>
  AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = interface(IUnknown)
  ['{DF53D38D-347F-587D-B115-BE893A8D7C49}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ConversationalAgent.ActivationSignalDetectionConfigurationRemovalResult>
  IAsyncOperation_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult = interface(IInspectable)
  ['{312794CB-0E43-5CBF-A148-58A9D7A65C14}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult; safecall;
    function GetResults: ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult; safecall;
    property Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ActivationSignalDetectionConfigurationRemovalResult read get_Completed write put_Completed;
  end;

  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentSessionUpdateResponse>
  AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentSessionUpdateResponse = interface(IUnknown)
  ['{6F43477A-01C5-59E2-96E2-1D9A00409159}']
  ...
  ['{4B85887B-8070-5EF9-AAC8-92515257061E}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentActivationResult>
  AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult = interface(IUnknown)
  ['{41948CE0-5D83-5E12-A8BA-114C4A3A62E3}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__ConversationalAgent_ConversationalAgentActivationResult; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentActivationResult>
  IAsyncOperation_1__ConversationalAgent_ConversationalAgentActivationResult = interface(IInspectable)
  ['{D177B8F3-D984-5C78-A57F-F096E291B374}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult; safecall;
    function GetResults: ConversationalAgent_ConversationalAgentActivationResult; safecall;
    property Completed: AsyncOperationCompletedHandler_1__ConversationalAgent_ConversationalAgentActivationResult read get_Completed write put_Completed;
  end;

  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IIterator_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface(IInspectable)
  ['{89B54546-B694-5277-866B-7F2FC740C640}']
    function get_Current: ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind): Cardinal; safecall;
    property Current: ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IIterable_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface(IInspectable)
  ['{4E9BB4C0-65AB-5049-9336-918B6D359071}']
    function First: IIterator_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>
  IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface(IInspectable)
  ['{82216C11-1E7A-592C-9A3D-15D63E6FDD19}']
    function GetAt(index: Cardinal): ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;

  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>>
  AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface(IUnknown)
  ['{80BBBE11-F1C5-5A42-B20B-005A57F88011}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; asyncStatus: AsyncStatus); safecall;
  end;

  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.ConversationalAgentVoiceActivationPrerequisiteKind>>
  IAsyncOperation_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind = interface(IInspectable)
  ['{C192099D-C28A-550A-8C2B-E31C8FABCB4B}']
    procedure put_Completed(handler: AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind); safecall;
    function get_Completed: AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; safecall;
    function GetResults: IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind; safecall;
    property Completed: AsyncOperationCompletedHandler_1__IVectorView_1__ConversationalAgent_ConversationalAgentVoiceActivationPrerequisiteKind read get_Completed write put_Completed;
  end;

  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IIterator_1__ConversationalAgent_SignalDetectorResourceKind = interface(IInspectable)
  ['{A27176EC-AB9A-5A55-8E50-AD4DAB5B5D68}']
    function get_Current: ConversationalAgent_SignalDetectorResourceKind; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PConversationalAgent_SignalDetectorResourceKind): Cardinal; safecall;
    property Current: ConversationalAgent_SignalDetectorResourceKind read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;

  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IIterable_1__ConversationalAgent_SignalDetectorResourceKind = interface(IInspectable)
  ['{263E7B6E-5338-5871-9FDB-A27D9BC02E92}']
    function First: IIterator_1__ConversationalAgent_SignalDetectorResourceKind; safecall;
  end;

  // Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.ConversationalAgent.SignalDetectorResourceKind>
  IVectorView_1__ConversationalAgent_SignalDetectorResourceKind = interface(IInspectable)
  ['{A847AC9B-A9AE-55C5-811D-920122E361D6}']
    function GetAt(index: Cardinal): ConversationalAgent_SignalDetectorResourceKind; safecall;
    function get_Size: Cardinal; safecall;
    function IndexOf(value: ConversationalAgent_SignalDetectorResourceKind; out index: Cardinal): Boolean; safecall;
    function GetMany(startIndex: Cardinal; itemsSize: Cardinal; items: PConversationalAgent_SignalDetectorResourceKind): Cardinal; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.ApplicationModel.Email.EmailCertificateValidationStatus>
  IIterator_1__Email_EmailCertificateValidationStatus = interface(IInspectable)
  ...
  // Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.Email.EmailCertificateValidationStatus>
  IIterable_1__Email_EmailCertificateValidationStatus = interface(IInspectable)
  ...
  ['{A5665FF7-B44E-57E3-BD7A-EF191AA5519C}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Email.EmailCertificateValidationStatus>>
  AsyncOperationCompletedHandler_1__IVectorView_1__Email_EmailCertificateValidationStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Email.EmailCertificateValidationStatus>>
  IAsyncOperation_1__IVectorView_1__Email_EmailCertificateValidationStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Email.EmailMailboxEmptyFolderStatus>
  AsyncOperationCompletedHandler_1__Email_EmailMailboxEmptyFolderStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Email.EmailMailboxEmptyFolderStatus>
  IAsyncOperation_1__Email_EmailMailboxEmptyFolderStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Email.EmailMailboxDeleteFolderStatus>
  AsyncOperationCompletedHandler_1__Email_EmailMailboxDeleteFolderStatus = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Email.EmailMailboxDeleteFolderStatus>
  IAsyncOperation_1__Email_EmailMailboxDeleteFolderStatus = interface(IInspectable)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.ExtendedExecution.ExtendedExecutionResult>
  AsyncOperationCompletedHandler_1__ExtendedExecution_ExtendedExecutionResult = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.ExtendedExecution.ExtendedExecutionResult>
  IAsyncOperation_1__ExtendedExecution_ExtendedExecutionResult = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.ApplicationModel.IAppInfo3
  IAppInfo3 = interface(IInspectable)
  ['{09A78E46-93A4-46DE-9397-0843B57115EA}']
    function get_ExecutionContext: AppExecutionContext; safecall;
    property ExecutionContext: AppExecutionContext read get_ExecutionContext;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.ApplicationModel.IAppInfo4
  IAppInfo4 = interface(IInspectable)
  ['{2F34BDEB-1609-4554-9F33-12E1E803E0D4}']
    function get_SupportedFileExtensions(resultSize: Cardinal; resultValue: PHSTRING): HRESULT; stdcall;
    // property SupportedFileExtensions: PHSTRING read get_SupportedFileExtensions;
  end;
  ...
  // Windows.ApplicationModel.IAppInstallerInfo2
  IAppInstallerInfo2 = interface(IInspectable)
  ['{D20F1388-8256-597C-8511-C84EC50D5E2B}']
    function get_OnLaunch: Boolean; safecall;
    function get_HoursBetweenUpdateChecks: Cardinal; safecall;
    function get_ShowPrompt: Boolean; safecall;
    function get_UpdateBlocksActivation: Boolean; safecall;
    function get_AutomaticBackgroundTask: Boolean; safecall;
    function get_ForceUpdateFromAnyVersion: Boolean; safecall;
    function get_IsAutoRepairEnabled: Boolean; safecall;
    function get_Version: PackageVersion; safecall;
    function get_LastChecked: DateTime; safecall;
    function get_PausedUntil: IReference_1__DateTime; safecall;
    function get_UpdateUris: IVectorView_1__IUriRuntimeClass; safecall;
    function get_RepairUris: IVectorView_1__IUriRuntimeClass; safecall;
    function get_DependencyPackageUris: IVectorView_1__IUriRuntimeClass; safecall;
    function get_OptionalPackageUris: IVectorView_1__IUriRuntimeClass; safecall;
    function get_PolicySource: AppInstallerPolicySource; safecall;
    property AutomaticBackgroundTask: Boolean read get_AutomaticBackgroundTask;
    property DependencyPackageUris: IVectorView_1__IUriRuntimeClass read get_DependencyPackageUris;
    property ForceUpdateFromAnyVersion: Boolean read get_ForceUpdateFromAnyVersion;
    property HoursBetweenUpdateChecks: Cardinal read get_HoursBetweenUpdateChecks;
    property IsAutoRepairEnabled: Boolean read get_IsAutoRepairEnabled;
    property LastChecked: DateTime read get_LastChecked;
    property OnLaunch: Boolean read get_OnLaunch;
    property OptionalPackageUris: IVectorView_1__IUriRuntimeClass read get_OptionalPackageUris;
    property PausedUntil: IReference_1__DateTime read get_PausedUntil;
    property PolicySource: AppInstallerPolicySource read get_PolicySource;
    property RepairUris: IVectorView_1__IUriRuntimeClass read get_RepairUris;
    property ShowPrompt: Boolean read get_ShowPrompt;
    property UpdateBlocksActivation: Boolean read get_UpdateBlocksActivation;
    property UpdateUris: IVectorView_1__IUriRuntimeClass read get_UpdateUris;
    property Version: PackageVersion read get_Version;
  end;

  // UsedAPI Interface
  // Windows.ApplicationModel.IFindRelatedPackagesOptions
  IFindRelatedPackagesOptions = interface(IInspectable)
  ['{41DD7EEA-B335-521F-B96C-5EA07F5B7329}']
    function get_Relationship: PackageRelationship; safecall;
    procedure put_Relationship(value: PackageRelationship); safecall;
    function get_IncludeFrameworks: Boolean; safecall;
    procedure put_IncludeFrameworks(value: Boolean); safecall;
    function get_IncludeHostRuntimes: Boolean; safecall;
    procedure put_IncludeHostRuntimes(value: Boolean); safecall;
    function get_IncludeOptionals: Boolean; safecall;
    procedure put_IncludeOptionals(value: Boolean); safecall;
    function get_IncludeResources: Boolean; safecall;
    procedure put_IncludeResources(value: Boolean); safecall;
    property IncludeFrameworks: Boolean read get_IncludeFrameworks write put_IncludeFrameworks;
    property IncludeHostRuntimes: Boolean read get_IncludeHostRuntimes write put_IncludeHostRuntimes;
    property IncludeOptionals: Boolean read get_IncludeOptionals write put_IncludeOptionals;
    property IncludeResources: Boolean read get_IncludeResources write put_IncludeResources;
    property Relationship: PackageRelationship read get_Relationship write put_Relationship;
  end;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.IPackageUpdateAvailabilityResult>
  AsyncOperationCompletedHandler_1__IPackageUpdateAvailabilityResult_Delegate_Base = interface(IUnknown)
  ['{4020C034-C762-5152-BEEF-F03471E885B9}']
    procedure Invoke(asyncInfo: IAsyncOperation_1__IPackageUpdateAvailabilityResult; asyncStatus: AsyncStatus); safecall;
  end;
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.IPackageUpdateAvailabilityResult>
  AsyncOperationCompletedHandler_1__IPackageUpdateAvailabilityResult = interface(AsyncOperationCompletedHandler_1__IPackageUpdateAvailabilityResult_Delegate_Base)
  ['{4AE0D402-6563-5F18-9A87-D9703D9712D3}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.IPackageUpdateAvailabilityResult>
  IAsyncOperation_1__IPackageUpdateAvailabilityResult_Base = interface(IInspectable)
  ['{010BD015-43EF-576C-BE1E-BC38C5B6B66B}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.IPackageUpdateAvailabilityResult>
  IAsyncOperation_1__IPackageUpdateAvailabilityResult = interface(IAsyncOperation_1__IPackageUpdateAvailabilityResult_Base)
  ...
  // UsedAPI Interface
  // Windows.ApplicationModel.IPackage9
  IPackage9 = interface(IInspectable)
  ['{D5AB224F-D7E1-49EC-90CE-720CDBD02E9C}']
    function FindRelatedPackages(options: IFindRelatedPackagesOptions): IVector_1__IPackage; safecall;
    function get_SourceUriSchemeName: HSTRING; safecall;
    property SourceUriSchemeName: HSTRING read get_SourceUriSchemeName;
  end;
  ...
  // Generic Delegate for:
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.IPackageCatalogRemoveResourcePackagesResult>
  AsyncOperationCompletedHandler_1__IPackageCatalogRemoveResourcePackagesResult_Delegate_Base = interface(IUnknown)
  ['{142B78D7-5CC3-5B40-A58D-43A582CA83EA}']
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.IPackageCatalogRemoveResourcePackagesResult>
  AsyncOperationCompletedHandler_1__IPackageCatalogRemoveResourcePackagesResult = interface(AsyncOperationCompletedHandler_1__IPackageCatalogRemoveResourcePackagesResult_Delegate_Base)
  ['{B3EFAED5-9EBA-5C3E-8E32-FC85B2E6812C}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.IPackageCatalogRemoveResourcePackagesResult>
  IAsyncOperation_1__IPackageCatalogRemoveResourcePackagesResult_Base = interface(IInspectable)
  ['{342EE07C-8D6E-53A4-B746-C5B74BB61F6D}']
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.IPackageCatalogRemoveResourcePackagesResult>
  IAsyncOperation_1__IPackageCatalogRemoveResourcePackagesResult = interface(IAsyncOperation_1__IPackageCatalogRemoveResourcePackagesResult_Base)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.StartupTaskState>
  AsyncOperationCompletedHandler_1__StartupTaskState = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.StartupTaskState>
  IAsyncOperation_1__StartupTaskState = interface(IInspectable)
  ...
  // Generic Delegate for:
  // Windows.Foundation.Collections.VectorChangedEventHandler`1<Windows.ApplicationModel.Search.Core.ISearchSuggestion>
  VectorChangedEventHandler_1__Search_Core_ISearchSuggestion_Delegate_Base = interface(IUnknown)
  ['{CB7B988B-468A-5EAE-AFE4-DF8B005F80AF}']
    procedure Invoke(sender: IObservableVector_1__Search_Core_ISearchSuggestion; event: IVectorChangedEventArgs); safecall;
  end;
  // Windows.Foundation.Collections.VectorChangedEventHandler`1<Windows.ApplicationModel.Search.Core.ISearchSuggestion>
  VectorChangedEventHandler_1__Search_Core_ISearchSuggestion = interface(VectorChangedEventHandler_1__Search_Core_ISearchSuggestion_Delegate_Base)
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Store.FulfillmentResult>
  AsyncOperationCompletedHandler_1__Store_FulfillmentResult = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Store.FulfillmentResult>
  IAsyncOperation_1__Store_FulfillmentResult = interface(IInspectable)
  ...
  ['{C8F90757-EBCF-5F2C-B918-6487105B0CA1}']
  ...
  ['{27017BBF-3EDD-503D-97A6-FC75060EA804}']
  ...
  // Implements: Windows.ApplicationModel.IAppInfo3
  // Implements: Windows.ApplicationModel.IAppInfo4
  ...
  // Implements: Windows.ApplicationModel.IPackage9
