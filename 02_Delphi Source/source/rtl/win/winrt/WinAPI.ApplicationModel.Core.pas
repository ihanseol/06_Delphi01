...
type
  ...
  IAppListEntry4 = interface;
  PIAppListEntry4 = ^IAppListEntry4;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Core.AppRestartFailureReason>
  AsyncOperationCompletedHandler_1__AppRestartFailureReason = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Core.AppRestartFailureReason>
  IAsyncOperation_1__AppRestartFailureReason = interface(IInspectable)
