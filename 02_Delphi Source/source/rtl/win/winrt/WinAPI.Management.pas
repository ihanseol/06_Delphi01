...
type
  ...
  // Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>
  IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface;
  PIKeyValuePair_2__IUriRuntimeClass__HSTRING = ^IKeyValuePair_2__IUriRuntimeClass__HSTRING;

  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface;
  PIIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = ^IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING;

  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface;
  PIIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = ^IIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING;

  // Windows.Foundation.Collections.IMapView`2<Windows.Foundation.IUriRuntimeClass,String>
  IMapView_2__IUriRuntimeClass__HSTRING = interface;
  PIMapView_2__IUriRuntimeClass__HSTRING = ^IMapView_2__IUriRuntimeClass__HSTRING;

  // Windows.Foundation.Collections.IMap`2<Windows.Foundation.IUriRuntimeClass,String>
  IMap_2__IUriRuntimeClass__HSTRING = interface;
  PIMap_2__IUriRuntimeClass__HSTRING = ^IMap_2__IUriRuntimeClass__HSTRING;

  // Windows.Management.Deployment.IAddPackageOptions2
  Deployment_IAddPackageOptions2 = interface;
  PDeployment_IAddPackageOptions2 = ^Deployment_IAddPackageOptions2;
  ...
  Deployment_IPackageAllUserProvisioningOptions = interface;
  PDeployment_IPackageAllUserProvisioningOptions = ^Deployment_IPackageAllUserProvisioningOptions;
  ...
  Deployment_IPackageManager10 = interface;
  PDeployment_IPackageManager10 = ^Deployment_IPackageManager10;
  ...
  Deployment_IRegisterPackageOptions2 = interface;
  PDeployment_IRegisterPackageOptions2 = ^Deployment_IRegisterPackageOptions2;

  // Windows.Management.Deployment.IStagePackageOptions2
  Deployment_IStagePackageOptions2 = interface;
  PDeployment_IStagePackageOptions2 = ^Deployment_IStagePackageOptions2;
  ...
  Deployment_SharedPackageContainerCreationCollisionOptions = (
    FailIfExists = 0,
    MergeWithExisting = 1,
    ReplaceExisting = 2
  );
  PDeployment_SharedPackageContainerCreationCollisionOptions = ^Deployment_SharedPackageContainerCreationCollisionOptions;

  // Windows.Management.Deployment.SharedPackageContainerOperationStatus
  Deployment_SharedPackageContainerOperationStatus = (
    Success = 0,
    BlockedByPolicy = 1,
    AlreadyExists = 2,
  ...
  PDeployment_SharedPackageContainerOperationStatus = ^Deployment_SharedPackageContainerOperationStatus;
  ...
  PUpdate_WindowsUpdateAttentionRequiredReason = ^Update_WindowsUpdateAttentionRequiredReason;
  ...
  Deployment_SharedPackageContainerContract = record
  end;
  PDeployment_SharedPackageContainerContract = ^Deployment_SharedPackageContainerContract;

  // Windows.Management.Update.WindowsUpdateContract
  Update_WindowsUpdateContract = record
  end;
  PUpdate_WindowsUpdateContract = ^Update_WindowsUpdateContract;
  ...
  // Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>
  IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface(IInspectable)
  ['{0890DBDF-7DDE-5E36-AC91-DA629DE2443C}']
    function get_Key: IUriRuntimeClass; safecall;
    function get_Value: HSTRING; safecall;
    property Key: IUriRuntimeClass read get_Key;
    property Value: HSTRING read get_Value;
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING_Base = interface(IInspectable)
  ['{0C11A982-9F05-557F-B3E8-3737B26830D1}']
    function get_Current: IKeyValuePair_2__IUriRuntimeClass__HSTRING; safecall;
    function get_HasCurrent: Boolean; safecall;
    function MoveNext: Boolean; safecall;
    function GetMany(itemsSize: Cardinal; items: PIKeyValuePair_2__IUriRuntimeClass__HSTRING): Cardinal; safecall;
    property Current: IKeyValuePair_2__IUriRuntimeClass__HSTRING read get_Current;
    property HasCurrent: Boolean read get_HasCurrent;
  end;
  // Windows.Foundation.Collections.IIterator`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface(IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING_Base)
  ['{2B4B93AF-FE80-54F4-8D93-C5E0BEF797C3}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING_Base = interface(IInspectable)
  ['{52129C53-B03D-59B3-A27E-B0385643E9FE}']
    function First: IIterator_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING; safecall;
  end;
  // Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<Windows.Foundation.IUriRuntimeClass,String>>
  IIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING = interface(IIterable_1__IKeyValuePair_2__IUriRuntimeClass__HSTRING_Base)
  ['{A9755EA6-DFBC-57F4-B649-A0A88276CEFD}']
  end;

  // Generic Ancestor for:
  // Windows.Foundation.Collections.IMapView`2<Windows.Foundation.IUriRuntimeClass,String>
  IMapView_2__IUriRuntimeClass__HSTRING_Base = interface(IInspectable)
  ['{87530605-8BD4-5F0A-85F1-751E8BD20446}']
    function Lookup(key: IUriRuntimeClass): HSTRING; safecall;
    function get_Size: Cardinal; safecall;
    function HasKey(key: IUriRuntimeClass): Boolean; safecall;
    procedure Split(out first: IMapView_2__IUriRuntimeClass__HSTRING; out second: IMapView_2__IUriRuntimeClass__HSTRING); safecall;
    property Size: Cardinal read get_Size;
  end;
  // Windows.Foundation.Collections.IMapView`2<Windows.Foundation.IUriRuntimeClass,String>
  IMapView_2__IUriRuntimeClass__HSTRING = interface(IMapView_2__IUriRuntimeClass__HSTRING_Base)
  ['{F057EA2C-06B2-5EE0-8BF6-C77F3F098D23}']
  end;

  // Windows.Foundation.Collections.IMap`2<Windows.Foundation.IUriRuntimeClass,String>
  IMap_2__IUriRuntimeClass__HSTRING = interface(IInspectable)
  ['{C158E559-50FF-5A5C-BFCB-81B84DEF38FD}']
    function Lookup(key: IUriRuntimeClass): HSTRING; safecall;
    function get_Size: Cardinal; safecall;
    function HasKey(key: IUriRuntimeClass): Boolean; safecall;
    function GetView: IMapView_2__IUriRuntimeClass__HSTRING; safecall;
    function Insert(key: IUriRuntimeClass; value: HSTRING): Boolean; safecall;
    procedure Remove(key: IUriRuntimeClass); safecall;
    procedure Clear; safecall;
    property Size: Cardinal read get_Size;
  end;
  ...
  // UsedAPI Interface
  // Windows.Management.Deployment.IAddPackageOptions2
  Deployment_IAddPackageOptions2 = interface(IInspectable)
  ['{EE515828-BF33-40F7-84AF-1B6FAD2919D7}']
    function get_ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING; safecall;
    function get_LimitToExistingPackages: Boolean; safecall;
    procedure put_LimitToExistingPackages(value: Boolean); safecall;
    property ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING read get_ExpectedDigests;
    property LimitToExistingPackages: Boolean read get_LimitToExistingPackages write put_LimitToExistingPackages;
  end;
  ...
  // UsedAPI Interface
  // Windows.Management.Deployment.IPackageAllUserProvisioningOptions
  [WinRTClassNameAttribute(SWindows_Management_Deployment_PackageAllUserProvisioningOptions)]
  Deployment_IPackageAllUserProvisioningOptions = interface(IInspectable)
  ['{DA35AA22-1DE0-5D3E-99FF-D24F3118BF5E}']
    function get_OptionalPackageFamilyNames: IVector_1__HSTRING; safecall;
    function get_ProjectionOrderPackageFamilyNames: IVector_1__HSTRING; safecall;
    property OptionalPackageFamilyNames: IVector_1__HSTRING read get_OptionalPackageFamilyNames;
    property ProjectionOrderPackageFamilyNames: IVector_1__HSTRING read get_ProjectionOrderPackageFamilyNames;
  end;
  ...
  ['{A866DF61-F412-5731-87CF-3EA8ADA9B261}']
  end;
  ...
  ['{F98AD0A1-7F83-53FF-9547-DFE003691287}']
  end;
  ...
  ['{ACF70219-39B4-5836-833E-93269EFEE8CE}']
  end;
  ...
  // UsedAPI Interface
  // Windows.Management.Deployment.IPackageManager10
  Deployment_IPackageManager10 = interface(IInspectable)
  ['{A7D7D07E-2E66-4093-AED5-E093ED87B3BB}']
    function ProvisionPackageForAllUsersAsync(mainPackageFamilyName: HSTRING; options: Deployment_IPackageAllUserProvisioningOptions): IAsyncOperationWithProgress_2__Deployment_IDeploymentResult__Deployment_DeploymentProgress; safecall;
  end;
  ...
  // Windows.Foundation.AsyncOperationCompletedHandler`1<UInt64>
  AsyncOperationCompletedHandler_1__UInt64 = interface(IUnknown)
  ...
  // Windows.Foundation.IAsyncOperation`1<UInt64>
  IAsyncOperation_1__UInt64 = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Management.Deployment.IRegisterPackageOptions2
  Deployment_IRegisterPackageOptions2 = interface(IInspectable)
  ['{3DFA9743-86FF-4A11-BC93-434EB6BE3A0B}']
    function get_ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING; safecall;
    property ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING read get_ExpectedDigests;
  end;
  ...
  // UsedAPI Interface
  // Windows.Management.Deployment.IStagePackageOptions2
  Deployment_IStagePackageOptions2 = interface(IInspectable)
  ['{990C4CCC-6226-4192-BA92-79875FCE0D9C}']
    function get_ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING; safecall;
    property ExpectedDigests: IMap_2__IUriRuntimeClass__HSTRING read get_ExpectedDigests;
  end;
  ...
  // Implements: Windows.Management.Deployment.IAddPackageOptions2
  ...
  // DualAPI
  // Implements: Windows.Management.Deployment.IPackageAllUserProvisioningOptions
  // Instantiable: "Deployment_IPackageAllUserProvisioningOptions"
  TDeployment_PackageAllUserProvisioningOptions = class(TWinRTGenericImportI<Deployment_IPackageAllUserProvisioningOptions>) end;
  ...
  // Implements: Windows.Management.Deployment.IPackageManager10
  ...
  // Implements: Windows.Management.Deployment.IRegisterPackageOptions2
  ...
  // Implements: Windows.Management.Deployment.IStagePackageOptions2
...
{ TDeployment_PackageAllUserProvisioningOptions }
