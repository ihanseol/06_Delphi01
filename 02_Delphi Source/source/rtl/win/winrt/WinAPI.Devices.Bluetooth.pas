...
type
  ...
  IBluetoothLEPreferredConnectionParametersRequest = interface;
  PIBluetoothLEPreferredConnectionParametersRequest = ^IBluetoothLEPreferredConnectionParametersRequest;

  // Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParameters
  IBluetoothLEPreferredConnectionParameters = interface;
  PIBluetoothLEPreferredConnectionParameters = ^IBluetoothLEPreferredConnectionParameters;

  // Windows.Devices.Bluetooth.IBluetoothLEDevice6
  IBluetoothLEDevice6 = interface;
  PIBluetoothLEDevice6 = ^IBluetoothLEDevice6;
  ...
  IBluetoothLEPreferredConnectionParametersStatics = interface;
  PIBluetoothLEPreferredConnectionParametersStatics = ^IBluetoothLEPreferredConnectionParametersStatics;
  ...
  PBluetoothLEPreferredConnectionParametersRequestStatus = ^BluetoothLEPreferredConnectionParametersRequestStatus;
  ...
  // UsedAPI Interface
  // Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Devices.Bluetooth.GenericAttributeProfile.GattOpenStatus>
  AsyncOperationCompletedHandler_1__GenericAttributeProfile_GattOpenStatus = interface(IUnknown)
  ...
  // UsedAPI Interface
  // Windows.Foundation.IAsyncOperation`1<Windows.Devices.Bluetooth.GenericAttributeProfile.GattOpenStatus>
  IAsyncOperation_1__GenericAttributeProfile_GattOpenStatus = interface(IInspectable)
  ...
  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEConnectionParameters
  IBluetoothLEConnectionParameters = interface(IInspectable)
  ['{33CB0771-8DA9-508F-A366-1CA388C929AB}']
    function get_LinkTimeout: Word; safecall;
    function get_ConnectionLatency: Word; safecall;
    function get_ConnectionInterval: Word; safecall;
    property ConnectionInterval: Word read get_ConnectionInterval;
    property ConnectionLatency: Word read get_ConnectionLatency;
    property LinkTimeout: Word read get_LinkTimeout;
  end;

  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEConnectionPhyInfo
  IBluetoothLEConnectionPhyInfo = interface(IInspectable)
  ['{9A100BDD-602E-5C27-A1AE-B230015A6394}']
    function get_IsUncoded1MPhy: Boolean; safecall;
    function get_IsUncoded2MPhy: Boolean; safecall;
    function get_IsCodedPhy: Boolean; safecall;
    property IsCodedPhy: Boolean read get_IsCodedPhy;
    property IsUncoded1MPhy: Boolean read get_IsUncoded1MPhy;
    property IsUncoded2MPhy: Boolean read get_IsUncoded2MPhy;
  end;

  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEConnectionPhy
  IBluetoothLEConnectionPhy = interface(IInspectable)
  ['{781E5E48-621E-5A7E-8BE6-1B9561FF63C9}']
    function get_TransmitInfo: IBluetoothLEConnectionPhyInfo; safecall;
    function get_ReceiveInfo: IBluetoothLEConnectionPhyInfo; safecall;
    property ReceiveInfo: IBluetoothLEConnectionPhyInfo read get_ReceiveInfo;
    property TransmitInfo: IBluetoothLEConnectionPhyInfo read get_TransmitInfo;
  end;
  ...
  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersRequest
  IBluetoothLEPreferredConnectionParametersRequest = interface(IInspectable)
  ['{8A375276-A528-5266-B661-CCE6A5FF9739}']
    function get_Status: BluetoothLEPreferredConnectionParametersRequestStatus; safecall;
    property Status: BluetoothLEPreferredConnectionParametersRequestStatus read get_Status;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParameters
  [WinRTClassNameAttribute(SWindows_Devices_Bluetooth_BluetoothLEPreferredConnectionParameters)]
  IBluetoothLEPreferredConnectionParameters = interface(IInspectable)
  ['{F2F44344-7372-5F7B-9B34-29C944F5A715}']
    function get_LinkTimeout: Word; safecall;
    function get_ConnectionLatency: Word; safecall;
    function get_MinConnectionInterval: Word; safecall;
    function get_MaxConnectionInterval: Word; safecall;
    property ConnectionLatency: Word read get_ConnectionLatency;
    property LinkTimeout: Word read get_LinkTimeout;
    property MaxConnectionInterval: Word read get_MaxConnectionInterval;
    property MinConnectionInterval: Word read get_MinConnectionInterval;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Devices.Bluetooth.IBluetoothLEDevice6
  IBluetoothLEDevice6 = interface(IInspectable)
  ['{CA7190EF-0CAE-573C-A1CA-E1FC5BFC39E2}']
    function GetConnectionParameters: IBluetoothLEConnectionParameters; safecall;
    function GetConnectionPhy: IBluetoothLEConnectionPhy; safecall;
    function RequestPreferredConnectionParameters(preferredConnectionParameters: IBluetoothLEPreferredConnectionParameters): IBluetoothLEPreferredConnectionParametersRequest; safecall;
    function add_ConnectionParametersChanged(handler: TypedEventHandler_2__IBluetoothLEDevice__IInspectable): EventRegistrationToken; safecall;
    procedure remove_ConnectionParametersChanged(token: EventRegistrationToken); safecall;
    function add_ConnectionPhyChanged(handler: TypedEventHandler_2__IBluetoothLEDevice__IInspectable): EventRegistrationToken; safecall;
    procedure remove_ConnectionPhyChanged(token: EventRegistrationToken); safecall;
  end;
  ...
  // Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersStatics
  [WinRTClassNameAttribute(SWindows_Devices_Bluetooth_BluetoothLEPreferredConnectionParameters)]
  IBluetoothLEPreferredConnectionParametersStatics = interface(IInspectable)
  ['{0E3E8EDC-2751-55AA-A838-8FAEEE818D72}']
    function get_Balanced: IBluetoothLEPreferredConnectionParameters; safecall;
    function get_ThroughputOptimized: IBluetoothLEPreferredConnectionParameters; safecall;
    function get_PowerOptimized: IBluetoothLEPreferredConnectionParameters; safecall;
    property Balanced: IBluetoothLEPreferredConnectionParameters read get_Balanced;
    property PowerOptimized: IBluetoothLEPreferredConnectionParameters read get_PowerOptimized;
    property ThroughputOptimized: IBluetoothLEPreferredConnectionParameters read get_ThroughputOptimized;
  end;
  ...
  // Implements: Windows.Devices.Bluetooth.IBluetoothLEDevice6
  // Implements: Windows.Foundation.IClosable
  ...
  // DualAPI
  // Implements: Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParameters
  // Statics: "Windows.Devices.Bluetooth.IBluetoothLEPreferredConnectionParametersStatics"
  TBluetoothLEPreferredConnectionParameters = class(TWinRTGenericImportS<IBluetoothLEPreferredConnectionParametersStatics>)
  public
    // -> IBluetoothLEPreferredConnectionParametersStatics
    class function get_Balanced: IBluetoothLEPreferredConnectionParameters; static; inline;
    class function get_ThroughputOptimized: IBluetoothLEPreferredConnectionParameters; static; inline;
    class function get_PowerOptimized: IBluetoothLEPreferredConnectionParameters; static; inline;
    class property Balanced: IBluetoothLEPreferredConnectionParameters read get_Balanced;
    class property PowerOptimized: IBluetoothLEPreferredConnectionParameters read get_PowerOptimized;
    class property ThroughputOptimized: IBluetoothLEPreferredConnectionParameters read get_ThroughputOptimized;
  end;
...
{ TBluetoothLEPreferredConnectionParameters }

class function TBluetoothLEPreferredConnectionParameters.get_Balanced: IBluetoothLEPreferredConnectionParameters;
begin
  Result := Statics.get_Balanced;
end;

class function TBluetoothLEPreferredConnectionParameters.get_ThroughputOptimized: IBluetoothLEPreferredConnectionParameters;
begin
  Result := Statics.get_ThroughputOptimized;
end;

class function TBluetoothLEPreferredConnectionParameters.get_PowerOptimized: IBluetoothLEPreferredConnectionParameters;
begin
  Result := Statics.get_PowerOptimized;
end;
