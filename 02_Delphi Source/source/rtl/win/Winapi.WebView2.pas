...
// $Rev: 98336 $
// File generated on 25/09/2023 21:44:35 from Type Library described below.
...
// SYS_KIND: SYS_WIN64
// Errors:
//   Hint: Symbol 'GUID' renamed to '_GUID'
...
// Cmdline:
//   tlibimp  -P -Fe- -XR+ -FtWinapi.WebView2.pas WebView2.tlb
// ************************************************************************ //
...
const
  ...
  COREWEBVIEW2_MOUSE_EVENT_KIND_NON_CLIENT_RIGHT_BUTTON_DOWN = $000000A4;
  COREWEBVIEW2_MOUSE_EVENT_KIND_NON_CLIENT_RIGHT_BUTTON_UP = $000000A5;
...
// *********************************************************************//
  ...
  _GUID = __MIDL___MIDL_itf_webview2_0005_0001_0001;
...
// *********************************************************************//
  ICoreWebView2Controller = interface(IUnknown)
    ...
    function Get_ParentWindow(out ParentWindow: wireHWND): HResult; stdcall;
...
// *********************************************************************//
  ICoreWebView2SharedBuffer = interface(IUnknown)
    ...
    function Get_Buffer(out value: PByte1): HResult; stdcall;
    function OpenStream(out value: IStream): HResult; stdcall;
    function Get_FileMappingHandle(out value: Pointer): HResult; stdcall;
    function Close: HResult; stdcall;
  end;
...
// *********************************************************************//
  ICoreWebView2CompositionController = interface(IUnknown)
    ...
    function Get_Cursor(out Cursor: wireHICON): HResult; stdcall;
...
// *********************************************************************//
  ICoreWebView2CustomSchemeRegistration = interface(IUnknown)
    ...
    function GetAllowedOrigins(out allowedOriginsCount: SYSUINT; out allowedOrigins: PPWideChar1): HResult; stdcall;
    function SetAllowedOrigins(allowedOriginsCount: SYSUINT; var allowedOrigins: PWideChar): HResult; stdcall;
...
// *********************************************************************//
  ICoreWebView2Environment4 = interface(ICoreWebView2Environment3)
    ...
    function GetAutomationProviderForWindow(hwnd: HWND; out provider: IUnknown): HResult; stdcall;
  end;
...
// *********************************************************************//
  ICoreWebView2EnvironmentOptions4 = interface(IUnknown)
    ...
    function GetCustomSchemeRegistrations(out Count: SYSUINT; out schemeRegistrations: PPUserType3): HResult; stdcall;
    function SetCustomSchemeRegistrations(Count: SYSUINT;
                                          var schemeRegistrations: ICoreWebView2CustomSchemeRegistration): HResult; stdcall;
  end;
