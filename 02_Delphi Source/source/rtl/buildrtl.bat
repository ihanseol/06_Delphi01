...
set PLATFORM=iOSDevice64
set PROJECT=BuildiOSRTL.dproj
call :DoBuild||exit /b 1

set PLATFORM=iOSSimARM64
set PROJECT=BuildIOSSIMARM64RTL.dproj
call :DoBuild||exit /b 1

set PLATFORM=Android
set PROJECT=BuildAndroidRTL.dproj
call :DoBuild||exit /b 1
...
set PROJECT=BuildLinuxRTL.dproj
call :DoBuild||exit /b 1
