...
const
  ...
  NSModalResponseOK = 1;
  NSWindowTabbingModeAutomatic = 0; // 10.12+
  NSWindowTabbingModePreferred = 1; // 10.12+
  NSWindowTabbingModeDisallowed = 2; // 10.12+
...
// ===== Framework typedefs =====
  ...
  NSWindowTabbingMode = NSUInteger; // 10.12+
...
//    procedure setManagedObjectContext(managedObjectContext: NSManagedObjectContext); cdecl;
  ...
  NSWindow = interface(NSResponder)
    ...
    procedure setTabbingMode(tabbingMode: NSWindowTabbingMode); cdecl; // 10.12+
    procedure setTitle(aString: NSString); cdecl;
    ...
    function tabbingMode: NSWindowTabbingMode; cdecl; // 10.12+
    function title: NSString; cdecl;
