...
type
  ...
  TPointF = record
    ...
    class function PointInCircle(const Point, Center: TPointF; const Radius: Single): Boolean; overload; static;
    function IsInCircle(const Center: TPointF; const Radius: Single): Boolean; overload;
...
function TPointF.IsInCircle(const Center: TPointF; const Radius: Single): Boolean;
var
  D: Single;
begin
  D := Distance(Center);
...
class function TPointF.PointInCircle(const Point, Center: TPointF; const Radius: Single): Boolean;
begin
