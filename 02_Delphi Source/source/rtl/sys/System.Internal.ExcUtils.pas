...
{$IFDEF ANDROID}
 ...
 {$IFDEF CPUARM64}
  ...
  begin
    UserContext.uc_mcontext.regs[0] := UserContext.uc_mcontext.arm_pc;
    UserContext.uc_mcontext.regs[1] := UserContext.uc_mcontext.fault_address;
    UserContext.uc_mcontext.regs[2] := MapSignal(SigNum, IntPtr(UContext));

    UserContext.uc_mcontext.regs[30] := UserContext.uc_mcontext.arm_pc;
    NextInst := UIntPtr(@SignalConverter);
  end;
  UserContext.uc_mcontext.arm_pc := NextInst;
