...
class function TInterlocked.Add(var Target: Cardinal; Increment: Cardinal): Cardinal;
begin
  Result := AtomicIncrement(Target, Increment);
end;
...
class function TInterlocked.Add(var Target: UInt64; Increment: UInt64): UInt64;
begin
  Result := AtomicIncrement(Target, Increment);
end;
...
class function TInterlocked.BitTestAndSet(var Target: Cardinal; BitOffset: TBitOffset): Boolean;
begin
  Result := BitTestAndSet(Integer((@Target)^), BitOffset);
end;

class function TInterlocked.BitTestAndSet(var Target: Int64; BitOffset: TBitOffset64): Boolean;
var
  OldValue: Int64;
  BitMask: Int64;
begin
  BitMask := Int64(1) shl (BitOffset and 63);
  repeat
    OldValue := Target;
    until AtomicCmpExchange(Target, OldValue or BitMask, OldValue) = OldValue;
  Result := (OldValue and BitMask) = BitMask;
...
class function TInterlocked.BitTestAndSet(var Target: UInt64; BitOffset: TBitOffset64): Boolean;
begin
  Result := BitTestAndSet(Int64((@Target)^), BitOffset);
end;
...
class function TInterlocked.BitTestAndClear(var Target: Cardinal; BitOffset: TBitOffset): Boolean;
begin
  Result := BitTestAndClear(Integer((@Target)^), BitOffset);
end;

class function TInterlocked.BitTestAndClear(var Target: Int64; BitOffset: TBitOffset64): Boolean;
var
  OldValue: Int64;
  BitMask: Int64;
begin
  BitMask := not(Int64(1) shl (BitOffset and 63));
  repeat
    OldValue := Target;
    until AtomicCmpExchange(Target, OldValue and BitMask, OldValue) = OldValue;
  BitMask := not BitMask;
...
class function TInterlocked.BitTestAndClear(var Target: UInt64; BitOffset: TBitOffset64): Boolean;
begin
  Result := BitTestAndClear(Int64((@Target)^), BitOffset);
end;
...
class function TInterlocked.CompareExchange(var Target: Pointer; Value: Pointer; Comparand: Pointer; out Succeeded: Boolean): Pointer;
begin
...
class function TInterlocked.CompareExchange(var Target: TObject; Value, Comparand: TObject; out Succeeded: Boolean): TObject;
begin
  Result := TObject(CompareExchange(Pointer(Target), Pointer(Value), Pointer(Comparand), Succeeded));
{$IFDEF AUTOREFCOUNT}
  if Pointer(Result) = Pointer(Comparand) then
  begin
    if Value <> nil then
...
class function TInterlocked.CompareExchange(var Target: Int64; Value, Comparand: Int64; out Succeeded: Boolean): Int64;
begin
  Result := AtomicCmpExchange(Target, Value, Comparand, Succeeded);
end;

class function TInterlocked.CompareExchange(var Target: UInt64; Value, Comparand: UInt64): UInt64;
begin
  Result := AtomicCmpExchange(Target, Value, Comparand);
end;

class function TInterlocked.CompareExchange(var Target: UInt64; Value, Comparand: UInt64; out Succeeded: Boolean): UInt64;
begin
  Result := AtomicCmpExchange(Target, Value, Comparand, Succeeded);
end;
...
class function TInterlocked.CompareExchange(var Target: Cardinal; Value, Comparand: Cardinal): Cardinal;
begin
  Result := AtomicCmpExchange(Target, Value, Comparand);
end;

class function TInterlocked.CompareExchange(var Target: Cardinal; Value, Comparand: Cardinal; out Succeeded: Boolean): Cardinal;
begin
  Result := AtomicCmpExchange(Target, Value, Comparand, Succeeded);
end;
...
class function TInterlocked.CompareExchange(var Target: Double; Value, Comparand: Double; out Succeeded: Boolean): Double;
begin
  Int64((@Result)^) := AtomicCmpExchange(Int64((@Target)^), Int64((@Value)^), Int64((@Comparand)^), Succeeded);
end;
...
class function TInterlocked.CompareExchange(var Target: Single; Value, Comparand: Single; out Succeeded: Boolean): Single;
begin
  Integer((@Result)^) := AtomicCmpExchange(Integer((@Target)^), Integer((@Value)^), Integer((@Comparand)^), Succeeded);
end;

class function TInterlocked.CompareExchange(var Target: Boolean; Value, Comparand: Boolean): Boolean;
begin
  Result := Boolean(AtomicCmpExchange(Byte((@Target)^), Byte(Value), Byte(Comparand)));
end;

class function TInterlocked.CompareExchange(var Target: Boolean; Value, Comparand: Boolean; out Succeeded: Boolean): Boolean;
begin
  Result := Boolean(AtomicCmpExchange(Byte((@Target)^), Byte(Value), Byte(Comparand), Succeeded));
end;
...
class function TInterlocked.Decrement(var Target: UInt64): UInt64;
begin
  Result := UInt64(AtomicDecrement(Int64(Target), 1));
end;
...
class function TInterlocked.Decrement(var Target: Cardinal): Cardinal;
begin
  Result := Cardinal(AtomicDecrement(Int32(Target), 1));
end;

class function TInterlocked.CompareExchange<T>(var Target: T; Value, Comparand: T; out Succeeded: Boolean): T;
begin
  TObject((@Result)^) := CompareExchange(TObject((@Target)^), TObject((@Value)^), TObject((@Comparand)^), Succeeded);
end;
...
class function TInterlocked.Exchange(var Target: UInt64; Value: UInt64): UInt64;
begin
  Result := AtomicExchange(Target, Value);
end;
...
class function TInterlocked.Exchange(var Target: Cardinal; Value: Cardinal): Cardinal;
begin
  Result := AtomicExchange(Target, Value);
end;
...
begin
  Result := Boolean(AtomicExchange(Byte((@Target)^), Byte(Value)));
end;
...
class function TInterlocked.Increment(var Target: Cardinal): Cardinal;
begin
  Result := Add(Target, 1);
end;
...
class function TInterlocked.Increment(var Target: UInt64): UInt64;
begin
  Result := Add(Target, 1);
end;
