...
{$IFDEF INCLUDE_CURL_H}
(*$HPPEMIT '#include <curl/curl.h>'*)
{$ENDIF}

const
  CURL_SOCKET_BAD = -1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_SOCKET_BAD} {$ENDIF}
{$IFDEF MSWINDOWS}
  LibCurl = 'libcurl.dll';
{$ENDIF}
{$IFDEF POSIX}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_socket_t} {$ENDIF}
  curl_off_t = Longint;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_off_t} {$ENDIF}
  PCURL = Pointer;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM PCURL} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_slist} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_httppost} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_progress_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_xferinfo_callback} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_MAX_WRITE_SIZE} {$ENDIF}

  { The only reason to have a max limit for this is to avoid the risk of a bad
   server feeding libcurl with a never-ending header that will cause reallocs
   infinitely }
  CURL_MAX_HTTP_HEADER = (100 * 1024);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_MAX_HTTP_HEADER} {$ENDIF}

  { This is a magic return code for the write callback that, when returned,
   will signal libcurl to pause receiving on the current transfer. }
  CURL_WRITEFUNC_PAUSE = $10000001;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_WRITEFUNC_PAUSE} {$ENDIF}

type
  curl_write_callback = function(buffer: Pointer; size: size_t; nitems: size_t; outstream: Pointer): size_t; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_write_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curlfiletype} {$ENDIF}
  TCurlFileType = curlfiletype;

const
  CURLFINFOFLAG_KNOWN_FILENAME = 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_FILENAME} {$ENDIF}
  CURLFINFOFLAG_KNOWN_FILETYPE = 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_FILETYPE} {$ENDIF}
  CURLFINFOFLAG_KNOWN_TIME = 4;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_TIME} {$ENDIF}
  CURLFINFOFLAG_KNOWN_PERM = 8;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_PERM} {$ENDIF}
  CURLFINFOFLAG_KNOWN_UID = 16;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_UID} {$ENDIF}
  CURLFINFOFLAG_KNOWN_GID = 32;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_GID} {$ENDIF}
  CURLFINFOFLAG_KNOWN_SIZE = 64;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_SIZE} {$ENDIF}
  CURLFINFOFLAG_KNOWN_HLINKCOUNT = 128;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFINFOFLAG_KNOWN_HLINKCOUNT} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_fileinfo_strings} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_fileinfo} {$ENDIF}

const
  { return codes for CURLOPT_CHUNK_BGN_FUNCTION }
  CURL_CHUNK_BGN_FUNC_OK = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CHUNK_BGN_FUNC_OK} {$ENDIF}
  CURL_CHUNK_BGN_FUNC_FAIL = 1; { tell the lib to end the task }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CHUNK_BGN_FUNC_FAIL = 1} {$ENDIF}
  CURL_CHUNK_BGN_FUNC_SKIP = 2; { skip this chunk over }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CHUNK_BGN_FUNC_SKIP} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_chunk_bgn_callback} {$ENDIF}

const
  { return codes for CURLOPT_CHUNK_END_FUNCTION }
  CURL_CHUNK_END_FUNC_OK = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CHUNK_END_FUNC_OK} {$ENDIF}
  CURL_CHUNK_END_FUNC_FAIL = 1; { tell the lib to end the task }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CHUNK_END_FUNC_FAIL} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_chunk_end_callback} {$ENDIF}

const
  { return codes for FNMATCHFUNCTION }
  CURL_FNMATCHFUNC_MATCH = 0; { string corresponds to the pattern }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_FNMATCHFUNC_MATCH} {$ENDIF}
  CURL_FNMATCHFUNC_NOMATCH = 1; { pattern doesn't match the string }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_FNMATCHFUNC_NOMATCH} {$ENDIF}
  CURL_FNMATCHFUNC_FAIL = 2; { an error occurred }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_FNMATCHFUNC_FAIL} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_fnmatch_callback} {$ENDIF}

const
 { These are the return codes for the seek callbacks }
  CURL_SEEKFUNC_OK = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_SEEKFUNC_OK} {$ENDIF}
  CURL_SEEKFUNC_FAIL = 1;     { fail the entire transfer }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_SEEKFUNC_FAIL} {$ENDIF}
  CURL_SEEKFUNC_CANTSEEK = 2; { tell libcurl seeking can't be done, so
                                libcurl might try other means instead }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_SEEKFUNC_CANTSEEK} {$ENDIF}

type
  curl_seek_callback = function (instream: Pointer; offset: curl_off_t; origin: Integer): Integer; cdecl; { 'whence' }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_seek_callback} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_sockaddr} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_opensocket_callback} {$ENDIF}

  curl_closesocket_callback = function (clientp: Pointer; item: curl_socket_t): Integer; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_closesocket_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curlioerr} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curliocmd} {$ENDIF}
  TCurlIOCmd = curliocmd;

  curl_ioctl_callback = function (handle: PCURL; cmd: Integer; clientp: Pointer): curlioerr; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ioctl_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_malloc_callback} {$ENDIF}
  curl_free_callback = procedure (ptr: Pointer); cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_free_callback} {$ENDIF}
  curl_realloc_callback = function (ptr: Pointer; size: size_t): Pointer; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_realloc_callback} {$ENDIF}
  curl_strdup_callback = function (str: MarshaledAString): MarshaledAString; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_strdup_callback} {$ENDIF}
  curl_calloc_callback = function (nmemb: size_t; size: size_t): Pointer; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_calloc_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_infotype} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_debug_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLcode} {$ENDIF}
  TCURLCode = CURLcode;

const
  ///<summary>Previously obsolete error code re-used in 7.38.0</summary>
   CURLE_OBSOLETE16 = CURLE_HTTP2;
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_OBSOLETE16} {$ENDIF}

  ///<summary>Previously obsolete error codes re-used in 7.24.0</summary>
  CURLE_OBSOLETE10 = CURLE_FTP_ACCEPT_FAILED;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_OBSOLETE10} {$ENDIF}
  CURLE_OBSOLETE12 = CURLE_FTP_ACCEPT_TIMEOUT;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_OBSOLETE12} {$ENDIF}

  ///<summary>The following were added in 7.21.5, April 2011</summary>
  CURLE_UNKNOWN_TELNET_OPTION = CURLE_UNKNOWN_OPTION;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_UNKNOWN_TELNET_OPTION} {$ENDIF}

  { The following were added in 7.17.1 }
  { These are scheduled to disappear by 2009 }
  CURLE_SSL_PEER_CERTIFICATE = CURLE_PEER_FAILED_VERIFICATION;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_SSL_PEER_CERTIFICATE} {$ENDIF}

  { The following were added in 7.17.0 }
  { These are scheduled to disappear by 2009 }
  CURLE_OBSOLETE = CURLE_OBSOLETE50; { no one should be using this! }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_OBSOLETE} {$ENDIF}
  CURLE_BAD_PASSWORD_ENTERED = CURLE_OBSOLETE46;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_BAD_PASSWORD_ENTERED} {$ENDIF}
  CURLE_BAD_CALLING_ORDER = CURLE_OBSOLETE44;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_BAD_CALLING_ORDER} {$ENDIF}
  CURLE_FTP_USER_PASSWORD_INCORRECT = CURLE_OBSOLETE10;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_USER_PASSWORD_INCORRECT} {$ENDIF}
  CURLE_FTP_CANT_RECONNECT = CURLE_OBSOLETE16;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_CANT_RECONNECT} {$ENDIF}
  CURLE_FTP_COULDNT_GET_SIZE = CURLE_OBSOLETE32;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_COULDNT_GET_SIZE} {$ENDIF}
  CURLE_FTP_COULDNT_SET_ASCII = CURLE_OBSOLETE29;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_COULDNT_SET_ASCII} {$ENDIF}
  CURLE_FTP_WEIRD_USER_REPLY = CURLE_OBSOLETE12;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_WEIRD_USER_REPLY} {$ENDIF}
  CURLE_FTP_WRITE_ERROR = CURLE_OBSOLETE20;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_WRITE_ERROR} {$ENDIF}
  CURLE_LIBRARY_NOT_FOUND = CURLE_OBSOLETE40;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_LIBRARY_NOT_FOUND} {$ENDIF}
  CURLE_MALFORMAT_USER = CURLE_OBSOLETE24;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_MALFORMAT_USER} {$ENDIF}
  CURLE_SHARE_IN_USE = CURLE_OBSOLETE57;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_SHARE_IN_USE} {$ENDIF}
  CURLE_URL_MALFORMAT_USER = CURLE_NOT_BUILT_IN;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_URL_MALFORMAT_USER} {$ENDIF}

  CURLE_FTP_ACCESS_DENIED = CURLE_REMOTE_ACCESS_DENIED;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_ACCESS_DENIED} {$ENDIF}
  CURLE_FTP_COULDNT_SET_BINARY = CURLE_FTP_COULDNT_SET_TYPE;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_COULDNT_SET_BINARY} {$ENDIF}
  CURLE_FTP_QUOTE_ERROR = CURLE_QUOTE_ERROR;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_QUOTE_ERROR} {$ENDIF}
  CURLE_TFTP_DISKFULL = CURLE_REMOTE_DISK_FULL;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_TFTP_DISKFULL} {$ENDIF}
  CURLE_TFTP_EXISTS = CURLE_REMOTE_FILE_EXISTS;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_TFTP_EXISTS} {$ENDIF}
  CURLE_HTTP_RANGE_ERROR = CURLE_RANGE_ERROR;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_HTTP_RANGE_ERROR} {$ENDIF}
  CURLE_FTP_SSL_FAILED = CURLE_USE_SSL_FAILED;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_SSL_FAILED} {$ENDIF}

  { The following were added earlier }

  CURLE_OPERATION_TIMEOUTED = CURLE_OPERATION_TIMEDOUT;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_OPERATION_TIMEOUTED} {$ENDIF}

  CURLE_HTTP_NOT_FOUND = CURLE_HTTP_RETURNED_ERROR;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_HTTP_NOT_FOUND} {$ENDIF}
  CURLE_HTTP_PORT_FAILED = CURLE_INTERFACE_FAILED;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_HTTP_PORT_FAILED} {$ENDIF}
  CURLE_FTP_COULDNT_STOR_FILE = CURLE_UPLOAD_FAILED;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_COULDNT_STOR_FILE} {$ENDIF}

  CURLE_FTP_PARTIAL_FILE = CURLE_PARTIAL_FILE;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_PARTIAL_FILE} {$ENDIF}
  CURLE_FTP_BAD_DOWNLOAD_RESUME = CURLE_BAD_DOWNLOAD_RESUME;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_FTP_BAD_DOWNLOAD_RESUME} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLE_ALREADY_COMPLETE} {$ENDIF}

type
  { This prototype applies to all conversion callbacks }
  curl_conv_callback = function (buffer: MarshaledAString; length: size_t): CURLcode; cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_conv_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ssl_ctx_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_proxytype} {$ENDIF}
...
const
   ...
   * CURLAUTH_ANYSAFE      - All fine types except Basic
   ...
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_NONE} {$ENDIF}
   CURLAUTH_BASIC = Cardinal(1);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_BASIC} {$ENDIF}
   CURLAUTH_DIGEST = Cardinal(2);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_DIGEST} {$ENDIF}
   CURLAUTH_NEGOTIATE = Cardinal(4);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_NEGOTIATE} {$ENDIF}
   { Deprecated since the advent of CURLAUTH_NEGOTIATE }
   CURLAUTH_GSSNEGOTIATE = CURLAUTH_NEGOTIATE;
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_GSSNEGOTIATE} {$ENDIF}
   CURLAUTH_NTLM = Cardinal(8);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_NTLM} {$ENDIF}
   CURLAUTH_DIGEST_IE = Cardinal(16);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_DIGEST_IE} {$ENDIF}
   CURLAUTH_NTLM_WB  = Cardinal(32);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_NTLM_WB} {$ENDIF}
   CURLAUTH_ONLY = Cardinal(2147483648);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_ONLY} {$ENDIF}
   CURLAUTH_ANY = not CURLAUTH_DIGEST_IE;
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_ANY} {$ENDIF}
   CURLAUTH_ANYSAFE = not (CURLAUTH_BASIC or CURLAUTH_DIGEST_IE);
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLAUTH_ANYSAFE} {$ENDIF}

   CURLSSH_AUTH_ANY = not 0;               { all types supported by the server }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_ANY} {$ENDIF}
   CURLSSH_AUTH_NONE = 0;                  { none allowed, silly but complete }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_NONE} {$ENDIF}
   CURLSSH_AUTH_PUBLICKEY = 1;             { public/private key files }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_PUBLICKEY} {$ENDIF}
   CURLSSH_AUTH_PASSWORD = 2;              { password }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_PASSWORD} {$ENDIF}
   CURLSSH_AUTH_HOST = 4;                  { host key files }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_HOST} {$ENDIF}
   CURLSSH_AUTH_KEYBOARD = 8;              { keyboard interactive }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_KEYBOARD} {$ENDIF}
   CURLSSH_AUTH_AGENT = 16;                { agent (ssh-agent, pageant...) }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_AGENT} {$ENDIF}
   CURLSSH_AUTH_DEFAULT = CURLSSH_AUTH_ANY;
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSH_AUTH_DEFAULT} {$ENDIF}

   CURLGSSAPI_DELEGATION_NONE = 0;         { no delegation (default) }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLGSSAPI_DELEGATION_NONE} {$ENDIF}
   CURLGSSAPI_DELEGATION_POLICY_FLAG = 1;  { if permitted by policy }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLGSSAPI_DELEGATION_POLICY_FLAG} {$ENDIF}
   CURLGSSAPI_DELEGATION_FLAG = 2;         { delegate always }
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLGSSAPI_DELEGATION_FLAG} {$ENDIF}

   CURL_ERROR_SIZE = 256;
   {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_ERROR_SIZE} {$ENDIF}

type
  curl_khtype = (CURLKHTYPE_UNKNOWN, CURLKHTYPE_RSA1, CURLKHTYPE_RSA, CURLKHTYPE_DSS);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_khtype} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_khkey} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_khstat} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_khmatch} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_sshkeycallback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_usessl} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSLOPT_ALLOW_BEAST} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSSLOPT_NO_REVOKE} {$ENDIF}

  { Backwards compatibility with older names }
  { These are scheduled to disappear by 2009 }

  CURLFTPSSL_NONE = CURLUSESSL_NONE;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFTPSSL_NONE} {$ENDIF}
  CURLFTPSSL_TRY = CURLUSESSL_TRY;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFTPSSL_TRY} {$ENDIF}
  CURLFTPSSL_CONTROL = CURLUSESSL_CONTROL;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFTPSSL_CONTROL} {$ENDIF}
  CURLFTPSSL_ALL = CURLUSESSL_ALL;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFTPSSL_ALL} {$ENDIF}
  CURLFTPSSL_LAST = CURLUSESSL_LAST;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFTPSSL_LAST} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ftpccc} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ftpauth} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ftpcreatedir} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_ftpmethod} {$ENDIF}
  TCurlFTPMethod = curl_ftpmethod;

const
  { bitmask defines for CURLOPT_HEADEROPT }
  CURLHEADER_UNIFIED = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLHEADER_UNIFIED} {$ENDIF}
  CURLHEADER_SEPARATE = 1 shl 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLHEADER_SEPARATE} {$ENDIF}

  { CURLPROTO_ defines are for the CURLOPT_*PROTOCOLS options }
  CURLPROTO_HTTP = 1 shl 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_HTTP} {$ENDIF}
  CURLPROTO_HTTPS = 1 shl 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_HTTPS} {$ENDIF}
  CURLPROTO_FTP = 1 shl 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_FTP} {$ENDIF}
  CURLPROTO_FTPS = 1 shl 3;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_FTPS} {$ENDIF}
  CURLPROTO_SCP = 1 shl 4;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SCP} {$ENDIF}
  CURLPROTO_SFTP = 1 shl 5;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SFTP} {$ENDIF}
  CURLPROTO_TELNET = 1 shl 6;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_TELNET} {$ENDIF}
  CURLPROTO_LDAP = 1 shl 7;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_LDAP} {$ENDIF}
  CURLPROTO_LDAPS = 1 shl 8;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_LDAPS} {$ENDIF}
  CURLPROTO_DICT = 1 shl 9;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_DICT} {$ENDIF}
  CURLPROTO_FILE = 1 shl 10;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_FILE} {$ENDIF}
  CURLPROTO_TFTP = 1 shl 11;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_TFTP} {$ENDIF}
  CURLPROTO_IMAP = 1 shl 12;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_IMAP} {$ENDIF}
  CURLPROTO_IMAPS = 1 shl 13;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_IMAPS} {$ENDIF}
  CURLPROTO_POP3 = 1 shl 14;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_POP3} {$ENDIF}
  CURLPROTO_POP3S = 1 shl 15;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_POP3S} {$ENDIF}
  CURLPROTO_SMTP = 1 shl 16;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SMTP} {$ENDIF}
  CURLPROTO_SMTPS = 1 shl 17;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SMTPS} {$ENDIF}
  CURLPROTO_RTSP = 1 shl 18;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTSP} {$ENDIF}
  CURLPROTO_RTMP = 1 shl 19;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMP} {$ENDIF}
  CURLPROTO_RTMPT = 1 shl 20;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMPT} {$ENDIF}
  CURLPROTO_RTMPE = 1 shl 21;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMPE} {$ENDIF}
  CURLPROTO_RTMPTE = 1 shl 22;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMPTE} {$ENDIF}
  CURLPROTO_RTMPS = 1 shl 23;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMPS} {$ENDIF}
  CURLPROTO_RTMPTS = 1 shl 24;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_RTMPTS} {$ENDIF}
  CURLPROTO_GOPHER = 1 shl 25;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_GOPHER} {$ENDIF}
  CURLPROTO_SMB = 1 shl 26;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SMB} {$ENDIF}
  CURLPROTO_SMBS = 1 shl 27;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_SMBS} {$ENDIF}
  CURLPROTO_ALL = not 0; { enable everything }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPROTO_ALL} {$ENDIF}

  { long may be 32 or 64 bits, but we should never depend on anything else but 32 }
  CURLOPTTYPE_LONG          =     0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLOPTTYPE_LONG} {$ENDIF}
  CURLOPTTYPE_OBJECTPOINT   = 10000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLOPTTYPE_OBJECTPOINT} {$ENDIF}
  CURLOPTTYPE_FUNCTIONPOINT = 20000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLOPTTYPE_FUNCTIONPOINT} {$ENDIF}
  CURLOPTTYPE_OFF_T         = 30000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLOPTTYPE_OFF_T} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLoption} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_IPRESOLVE_WHATEVER} {$ENDIF}
  CURL_IPRESOLVE_V4       = 1; { resolve to IPv4 addresses }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_IPRESOLVE_V4} {$ENDIF}
  CURL_IPRESOLVE_V6       = 2; { resolve to IPv6 addresses }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_IPRESOLVE_V6} {$ENDIF}

  ///<summary>three convenient "aliases" that follow the name scheme better</summary>
  CURLOPT_RTSPHEADER = CURLOPT_HTTPHEADER;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLOPT_RTSPHEADER} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_HTTP_VERSION_2} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_NETRC_OPTION} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_TLSAUTH} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_REDIR_GET_ALL} {$ENDIF}
  CURL_REDIR_POST_301 = 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_REDIR_POST_301} {$ENDIF}
  CURL_REDIR_POST_302 = 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_REDIR_POST_302} {$ENDIF}
  CURL_REDIR_POST_303 = 4;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_REDIR_POST_303} {$ENDIF}
  CURL_REDIR_POST_ALL = (CURL_REDIR_POST_301 or CURL_REDIR_POST_302 or CURL_REDIR_POST_303);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_REDIR_POST_ALL} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_TimeCond} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLformoption} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_forms} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLFORMcode} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_formget_callback} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_certinfo} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_sslbackend} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_tlssessioninfo} {$ENDIF}
  TCURLTLSSessionInfo = curl_tlssessioninfo;

const
  CURLINFO_STRING   = $100000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_STRING} {$ENDIF}
  CURLINFO_LONG     = $200000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_LONG} {$ENDIF}
  CURLINFO_DOUBLE   = $300000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_DOUBLE} {$ENDIF}
  CURLINFO_SLIST    = $400000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_SLIST} {$ENDIF}
  CURLINFO_SOCKET   = $500000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_SOCKET} {$ENDIF}
  CURLINFO_MASK     = $0fffff;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_MASK} {$ENDIF}
  CURLINFO_TYPEMASK = $f00000;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_TYPEMASK} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO} {$ENDIF}
  TCurlInfo = CURLINFO;
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLINFO_HTTP_CODE} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_closepolicy} {$ENDIF}
  TCurlClosePolicy = curl_closepolicy;

const
  CURL_GLOBAL_SSL = 1 shl 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_SSL} {$ENDIF}
  CURL_GLOBAL_WIN32 = 1 shl 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_WIN32} {$ENDIF}
  CURL_GLOBAL_ALL = CURL_GLOBAL_SSL or CURL_GLOBAL_WIN32;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_ALL} {$ENDIF}
  CURL_GLOBAL_NOTHING = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_NOTHING} {$ENDIF}
  CURL_GLOBAL_DEFAULT = CURL_GLOBAL_ALL;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_DEFAULT} {$ENDIF}
  CURL_GLOBAL_ACK_EINTR = 1 shl 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_GLOBAL_ACK_EINTR} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_lock_data} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_lock_access} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_lock_function} {$ENDIF}
  curl_unlock_function = procedure (handle: PCURL; data: curl_lock_data; userptr: Pointer); cdecl;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_unlock_function} {$ENDIF}

  PCURLSH = Pointer;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM PCURLSH} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSHcode} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLSHoption} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLversion} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLVERSION_NOW} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_version_info_data} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_IPV6} {$ENDIF}
  CURL_VERSION_KERBEROS4    = 1 shl 1;  { Kerberos V4 auth is supported (deprecated) }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_KERBEROS4} {$ENDIF}
  CURL_VERSION_SSL          = 1 shl 2;  { SSL options are present }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_SSL} {$ENDIF}
  CURL_VERSION_LIBZ         = 1 shl 3;  { libz features are present }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_LIBZ} {$ENDIF}
  CURL_VERSION_NTLM         = 1 shl 4;  { NTLM auth is supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_NTLM} {$ENDIF}
  CURL_VERSION_GSSNEGOTIATE = 1 shl 5;  { Negotiate auth is supported (deprecated) }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_GSSNEGOTIATE} {$ENDIF}
  CURL_VERSION_DEBUG        = 1 shl 6;  { Built with debug capabilities }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_DEBUG} {$ENDIF}
  CURL_VERSION_ASYNCHDNS    = 1 shl 7;  { Asynchronous DNS resolves }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_ASYNCHDNS} {$ENDIF}
  CURL_VERSION_SPNEGO       = 1 shl 8;  { SPNEGO auth is supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_SPNEGO} {$ENDIF}
  CURL_VERSION_LARGEFILE    = 1 shl 9;  { Supports files larger than 2GB }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_LARGEFILE} {$ENDIF}
  CURL_VERSION_IDN          = 1 shl 10; { Internationized Domain Names are supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_IDN} {$ENDIF}
  CURL_VERSION_SSPI         = 1 shl 11; { Built against Windows SSPI }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_SSPI} {$ENDIF}
  CURL_VERSION_CONV         = 1 shl 12; { Character conversions supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_CONV} {$ENDIF}
  CURL_VERSION_CURLDEBUG    = 1 shl 13; { Debug memory tracking supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_CURLDEBUG} {$ENDIF}
  CURL_VERSION_TLSAUTH_SRP  = 1 shl 14; { TLS-SRP auth is supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_TLSAUTH_SRP} {$ENDIF}
  CURL_VERSION_NTLM_WB      = 1 shl 15; { NTLM delegation to winbind helper is suported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_NTLM_WB} {$ENDIF}
  CURL_VERSION_HTTP2        = 1 shl 16; { HTTP2 support built-in }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_HTTP2} {$ENDIF}
  CURL_VERSION_GSSAPI       = 1 shl 17; { Built against a GSS-API library }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_GSSAPI} {$ENDIF}
  CURL_VERSION_KERBEROS5    = 1 shl 18; { Kerberos V5 auth is supported }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_KERBEROS5} {$ENDIF}
  CURL_VERSION_UNIX_SOCKETS = 1 shl 19; { Unix domain sockets support }
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_VERSION_UNIX_SOCKETS} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_RECV} {$ENDIF}
  CURLPAUSE_RECV_CONT = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_RECV_CONT} {$ENDIF}

  CURLPAUSE_SEND = 1 shl 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_SEND} {$ENDIF}
  CURLPAUSE_SEND_CONT = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_SEND_CONT} {$ENDIF}

  CURLPAUSE_ALL = CURLPAUSE_RECV or CURLPAUSE_SEND;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_ALL} {$ENDIF}
  CURLPAUSE_CONT = CURLPAUSE_RECV_CONT or CURLPAUSE_SEND_CONT;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPAUSE_CONT} {$ENDIF}
...
type
  PCURLM = Pointer;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM PCURLM} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLMcode} {$ENDIF}
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLM_CALL_MULTI_SOCKET} {$ENDIF}

  { bitmask bits for CURLMOPT_PIPELINING }
  CURLPIPE_NOTHING   = Longint(0);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPIPE_NOTHING} {$ENDIF}
  CURLPIPE_HTTP1      = Longint(1);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPIPE_HTTP1} {$ENDIF}
  CURLPIPE_MULTIPLEX = Longint(2);
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLPIPE_MULTIPLEX} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLMSG_VAL} {$ENDIF}
  TCURLMsgVal = CURLMSG_VAL;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM TCURLMsgVal} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLMsg} {$ENDIF}
  TCurlMsg = CURLMsg;
  PCurlMsg = ^CurlMsg;
...
const
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_WAIT_POLLIN} {$ENDIF}
  CURL_WAIT_POLLPRI  = $0002;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_WAIT_POLLPRI} {$ENDIF}
  CURL_WAIT_POLLOUT  = $0004;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_WAIT_POLLOUT} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_waitfd} {$ENDIF}
...
const
  CURL_POLL_NONE   = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_POLL_NONE} {$ENDIF}
  CURL_POLL_IN     = 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_POLL_IN} {$ENDIF}
  CURL_POLL_OUT    = 2;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_POLL_OUT} {$ENDIF}
  CURL_POLL_INOUT  = 3;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_POLL_INOUT} {$ENDIF}
  CURL_POLL_REMOVE = 4;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_POLL_REMOVE} {$ENDIF}

  CURL_SOCKET_TIMEOUT = CURL_SOCKET_BAD;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_SOCKET_TIMEOUT} {$ENDIF}

  CURL_CSELECT_IN   = $01;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CSELECT_IN} {$ENDIF}
  CURL_CSELECT_OUT  = $02;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CSELECT_OUT} {$ENDIF}
  CURL_CSELECT_ERR  = $04;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_CSELECT_ERR} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_socket_callback} {$ENDIF}
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_multi_timer_callback} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURLMoption} {$ENDIF}
...
const
  CURL_PUSH_OK   = 0;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_PUSH_OK} {$ENDIF}
  CURL_PUSH_DENY = 1;
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM CURL_PUSH_DENY} {$ENDIF}
...
type
  ...
  {$IFDEF INCLUDE_CURL_H} {$EXTERNALSYM curl_push_callback} {$ENDIF}
