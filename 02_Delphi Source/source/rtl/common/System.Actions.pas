...
{$ENDIF}
  protected
    ...
    procedure SetActionList(AActionList: TContainedActionList); virtual;
  public
...
function RegisteredShortCut(Index: integer): TShortCut;
begin
  if (Index < 0) or (Index >= RegisteredShortCutCount) then
    RangeIndexError(Index, RegisteredShortCutCount - 1, vShortCuts);
