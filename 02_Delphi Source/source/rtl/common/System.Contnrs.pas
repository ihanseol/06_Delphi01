...
{ TObjectList class }
  ...
  protected
    ...
    function GetItem(Index: NativeInt): TObject; inline;
    procedure SetItem(Index: NativeInt; AObject: TObject); inline;
  public
    constructor Create; overload;
    constructor Create(AOwnsObjects: Boolean); overload;

    function Add(AObject: TObject): NativeInt; inline;
    function Extract(Item: TObject): TObject; inline;
    function ExtractItem(Item: TObject; Direction: TList.TDirection): TObject; inline;
    function Remove(AObject: TObject): NativeInt; overload; inline;
    function RemoveItem(AObject: TObject; ADirection: TList.TDirection): NativeInt; inline;
    function IndexOf(AObject: TObject): NativeInt; inline;
    function IndexOfItem(AObject: TObject; ADirection: TList.TDirection): NativeInt; inline;
    function FindInstanceOf(AClass: TClass; AExact: Boolean = True; AStartAt: NativeInt = 0): NativeInt;
    procedure Insert(Index: NativeInt; AObject: TObject); inline;
    function First: TObject; inline;
    function Last: TObject; inline;
    property OwnsObjects: Boolean read FOwnsObjects write FOwnsObjects;
    property Items[Index: NativeInt]: TObject read GetItem write SetItem; default;
  end;
...
{ TComponentList class }
  ...
  protected
    ...
    procedure SetItems(Index: NativeInt; AComponent: TComponent); inline;
  ...
  public
    ...
    function IndexOf(AComponent: TComponent): NativeInt; inline;
    function IndexOfItem(AComponent: TComponent; ADirection: TList.TDirection): NativeInt; inline;
    function First: TComponent; inline;
    function Last: TComponent; inline;
    procedure Insert(Index: NativeInt; AComponent: TComponent); inline;
    property Items[Index: NativeInt]: TComponent read GetItems write SetItems; default;
  end;
...
{ TClassList class }
  ...
  protected
    function GetItems(Index: NativeInt): TClass; inline;
    procedure SetItems(Index: NativeInt; AClass: TClass); inline;
  public
    function Add(AClass: TClass): NativeInt; inline;
    ...
    function IndexOf(AClass: TClass): NativeInt; inline;
    function IndexOfItem(AClass: TClass; ADirection: TList.TDirection): NativeInt; inline;
    function First: TClass; inline;
    function Last: TClass; inline;
    procedure Insert(Index: NativeInt; AClass: TClass); inline;
    property Items[Index: NativeInt]: TClass read GetItems write SetItems; default;
  end;
...
function TObjectList.Add(AObject: TObject): NativeInt;
begin
...
function TObjectList.GetItem(Index: NativeInt): TObject;
begin
  Result := inherited Items[Index];
end;

function TObjectList.IndexOf(AObject: TObject): NativeInt;
begin
  Result := inherited IndexOf(AObject);
end;

function TObjectList.IndexOfItem(AObject: TObject; ADirection: TList.TDirection): NativeInt;
begin
  Result := inherited IndexOfItem(AObject, ADirection);
end;

procedure TObjectList.Insert(Index: NativeInt; AObject: TObject);
begin
...
function TObjectList.Remove(AObject: TObject): NativeInt;
begin
...
function TObjectList.RemoveItem(AObject: TObject; ADirection: TList.TDirection): NativeInt;
begin
...
procedure TObjectList.SetItem(Index: NativeInt; AObject: TObject);
begin
...
function TComponentList.Add(AComponent: TComponent): NativeInt;
begin
...
function TComponentList.GetItems(Index: NativeInt): TComponent;
begin
...
function TComponentList.IndexOf(AComponent: TComponent): NativeInt;
begin
  Result := inherited IndexOf(AComponent);
end;

function TComponentList.IndexOfItem(AComponent: TComponent; ADirection: TList.TDirection): NativeInt;
begin
  Result := inherited IndexOfItem(AComponent, ADirection);
end;

procedure TComponentList.Insert(Index: NativeInt; AComponent: TComponent);
begin
...
function TComponentList.Remove(AComponent: TComponent): NativeInt;
begin
  Result := inherited Remove(AComponent);
end;

function TComponentList.RemoveItem(AComponent: TComponent; ADirection: TList.TDirection): NativeInt;
begin
  Result := inherited RemoveItem(AComponent, ADirection);
end;

procedure TComponentList.SetItems(Index: NativeInt; AComponent: TComponent);
begin
...
function TClassList.Add(AClass: TClass): NativeInt;
begin
...
function TClassList.GetItems(Index: NativeInt): TClass;
begin
  Result := TClass(inherited Items[Index]);
end;

function TClassList.IndexOf(AClass: TClass): NativeInt;
begin
  Result := inherited IndexOf(AClass);
end;

function TClassList.IndexOfItem(AClass: TClass; ADirection: TList.TDirection): NativeInt;
begin
  Result := inherited IndexOfItem(AClass, ADirection);
end;

procedure TClassList.Insert(Index: NativeInt; AClass: TClass);
begin
...
function TClassList.Remove(AClass: TClass): NativeInt;
begin
  Result := inherited Remove(AClass);
end;

function TClassList.RemoveItem(AClass: TClass; ADirection: TList.TDirection): NativeInt;
begin
  Result := inherited RemoveItem(AClass, ADirection);
end;

procedure TClassList.SetItems(Index: NativeInt; AClass: TClass);
begin
...
function TOrderedList.AtLeast(ACount: NativeInt): boolean;
begin
...
function TOrderedList.Count: NativeInt;
begin
  Result := List.Count;
end;
