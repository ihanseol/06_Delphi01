...
type
  ...
  private
    ...
    function GetAsDecimal: TJsonDecimal128;
  ...
  public
    ...
    /// <summary> Returns current item TJsonDecimal128 value. </summary>
...
function TJSONCollectionBuilder.TBaseCollection.Add(const AKey: string;
  const AValue: TJsonDecimal128): TPairs;
begin
  AddingPair;
  Writer.WritePropertyName(AKey);
  Writer.WriteValue(AValue);
...
begin
  ...
  repeat
    ...
    if FReader.Read then
      ...
      else if (FStack.Count > 0) and (FStack.List[FStack.Count - 1].FToken = TJsonToken.StartArray) then
      begin
...
begin
  Result := FReader.Value.AsType<TJsonDecimal128>;
end;
