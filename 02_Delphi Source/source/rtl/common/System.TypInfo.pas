...
var
  ...
  GetRecCompareAddrs: procedure (Info: PTypeInfo; out PEQOper, PGetHashCode: Pointer) = nil;
...
var
  len: NativeInt;
begin
  len := Byte(TypeInfo.Name{$IFNDEF NEXTGEN}[0]{$ENDIF});
  Result := Pointer(PByte(TypeInfo) + len + 2);
end;
