...
type
  ...
  /// <summary>
  /// TCustomBase64Encoding is a base class for the family of base64
  /// (https://en.wikipedia.org/wiki/Base64) based encoding classes.
  /// Provides methods to encode and decode data in base64 format.
  /// The derived classes can use different number of output characters
  /// per line, padding mode of the output end.
  /// </summary>
  ...
  /// <summary>
  /// TBase64Encoding is inherited from TCustomBase64Encoding and provides standard
  /// base64 endoding/decoding (https://en.wikipedia.org/wiki/Base64). The default
  /// number of output characters per line is 76, and the output end is padded by '='.
  /// To use TBase64Encoding you usually do not need to create your own instance.
  /// You can use TNetEncoding.Base64 instead.
  /// </summary>
  ...
  /// <summary>
  /// TBase64StringEncoding is inherited from TCustomBase64Encoding and provides
  /// base64 endoding/decoding (https://en.wikipedia.org/wiki/Base64). The output
  /// is not splitted into separate lines and is provided as a single string.
  /// Also the output end is padded by '='.
  /// To use TBase64StringEncoding you usually do not need to create your own instance.
  /// You can use TNetEncoding.Base64String instead.
  /// </summary>
  ...
  /// <summary>
  /// TBase64URLEncoding is inherited from TCustomBase64Encoding and provides
  /// base64url endoding/decoding (https://en.wikipedia.org/wiki/Base64#URL_applications).
  /// The output is provided as a single string and the output end is not padded.
  /// Additionally '+' and '/' characters in the output string are respectively
  /// replaced by '-' and '_' characters.
  /// To use TBase64URLEncoding you usually do not need to create your own instance.
  /// You can use TNetEncoding.Base64URL instead.
  /// </summary>
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              Inc(J, 2);
              if ((Sp + 2)^ <> '%') or ((Sp + 3)^ = '%') or (J >= High(Buff)) then
                Break;
              Inc(Sp, 3);
            end;
            J := J div 2;
...
begin
  Result := Encode(Auth, AuthUnsafeChars + AExtraUnsafeChars, [TEncodeOption.EncodePercent]);
end;
...
begin
  Result := Encode(AQuery, QueryUnsafeChars + AExtraUnsafeChars, [TEncodeOption.EncodePercent]);
end;
