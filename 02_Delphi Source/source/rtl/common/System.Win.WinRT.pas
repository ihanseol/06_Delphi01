...
/// <summary>Classes and Helper utilities for dealing with WinRT interfaces and strings</summary>
...
{$M+}
  ...
  TWinRTGenericImportS9<S1, S2, S3, S4, S5, S6, S7, S8, S9: IInspectable> = class(TWinRTGenericImportS8<S1, S2, S3, S4, S5, S6, S7, S8>)
  private
...
{ TWinRTGenericImportS9<S1, S2, S3, S4, S5, S6, S7, S8, S9> }

class function TWinRTGenericImportS9<S1, S2, S3, S4, S5, S6, S7, S8, S9>.GetStatics9: S9;
begin
  if FStatics9 = nil then
    FStatics9 := S9(GetFactoryOrStatics(TypeInfo(S9), FRTClassName));
  Result := FStatics9;
