...
// ===== Forward declarations =====
  ...
  JSafeBrowsingResponse = interface;//android.webkit.SafeBrowsingResponse
  ...
  JTracingConfig = interface;//android.webkit.TracingConfig
  JTracingConfig_Builder = interface;//android.webkit.TracingConfig$Builder
  JTracingController = interface;//android.webkit.TracingController
  ...
  JWebViewRenderProcess = interface;//android.webkit.WebViewRenderProcess
  JWebViewRenderProcessClient = interface;//android.webkit.WebViewRenderProcessClient
...
// ===== Interface declarations =====
  ...
  JCookieManagerClass = interface(JObjectClass)
    ...
    {class} function init: JCookieManager; cdecl;//Deprecated
    {class} function allowFileSchemeCookies: Boolean; cdecl;
    {class} function getInstance: JCookieManager; cdecl;
    {class} procedure setAcceptFileSchemeCookies(accept: Boolean); cdecl;//Deprecated
  end;
  ...
  JRenderProcessGoneDetailClass = interface(JObjectClass)
    ...
    {class} function init: JRenderProcessGoneDetail; cdecl;//Deprecated
  end;
  ...
  JSafeBrowsingResponseClass = interface(JObjectClass)
    ['{7A14ED66-97DB-4CA2-ABFA-4ACE5F0E150A}']
    {class} function init: JSafeBrowsingResponse; cdecl;//Deprecated
  end;

  [JavaSignature('android/webkit/SafeBrowsingResponse')]
  JSafeBrowsingResponse = interface(JObject)
    ['{4B42BABC-B2DF-46BF-9686-53DB7B5E3D5D}']
    procedure backToSafety(report: Boolean); cdecl;
    procedure proceed(report: Boolean); cdecl;
    procedure showInterstitial(allowReporting: Boolean); cdecl;
  end;
  TJSafeBrowsingResponse = class(TJavaGenericImport<JSafeBrowsingResponseClass, JSafeBrowsingResponse>) end;
  ...
  JServiceWorkerControllerClass = interface(JObjectClass)
    ...
    {class} function init: JServiceWorkerController; cdecl;//Deprecated
  ...
  JTracingConfigClass = interface(JObjectClass)
    ['{6CB9AE7F-0720-4DF7-A0E8-3F59934273B2}']
  ...
  [JavaSignature('android/webkit/TracingConfig')]
  JTracingConfig = interface(JObject)
    ['{648A950C-C2E8-49FE-AB50-8ABB48257135}']
  ...
  TJTracingConfig = class(TJavaGenericImport<JTracingConfigClass, JTracingConfig>) end;

  JTracingConfig_BuilderClass = interface(JObjectClass)
    ['{1208336D-DE83-486A-AF4D-53FBC14C0A73}']
    {class} function init: JTracingConfig_Builder; cdecl;
  end;

  [JavaSignature('android/webkit/TracingConfig$Builder')]
  JTracingConfig_Builder = interface(JObject)
    ['{7E96FED9-B65C-4E88-B9BD-F3603AB3FC29}']
    function addCategories(categories: JCollection): JTracingConfig_Builder; cdecl; overload;
    function build: JTracingConfig; cdecl;
    function setTracingMode(tracingMode: Integer): JTracingConfig_Builder; cdecl;
  end;
  TJTracingConfig_Builder = class(TJavaGenericImport<JTracingConfig_BuilderClass, JTracingConfig_Builder>) end;

  JTracingControllerClass = interface(JObjectClass)
    ['{C180802B-3863-4B3B-8C61-3129DF2FF90D}']
    {class} function init: JTracingController; cdecl;//Deprecated
    {class} function getInstance: JTracingController; cdecl;
  end;

  [JavaSignature('android/webkit/TracingController')]
  JTracingController = interface(JObject)
    ['{FB7A6F7A-C606-4674-BEAE-D46EB70024CF}']
    function isTracing: Boolean; cdecl;
    procedure start(tracingConfig: JTracingConfig); cdecl;
    function stop(outputStream: JOutputStream; executor: JExecutor): Boolean; cdecl;
  end;
  TJTracingController = class(TJavaGenericImport<JTracingControllerClass, JTracingController>) end;
  ...
  JWebChromeClient = interface(JObject)
    ...
    procedure getVisitedHistory(callback: JValueCallback); cdecl;
  ...
  JWebSettings = interface(JObject)
    ...
    function getForceDark: Integer; cdecl;//Deprecated
    ...
    procedure setAlgorithmicDarkeningAllowed(allow: Boolean); cdecl;
    procedure setAllowContentAccess(allow: Boolean); cdecl;
    procedure setAllowFileAccess(allow: Boolean); cdecl;
    procedure setAllowFileAccessFromFileURLs(flag: Boolean); cdecl;//Deprecated
    procedure setAllowUniversalAccessFromFileURLs(flag: Boolean); cdecl;//Deprecated
    procedure setAppCacheEnabled(flag: Boolean); cdecl;//Deprecated
    procedure setAppCacheMaxSize(appCacheMaxSize: Int64); cdecl;//Deprecated
    procedure setAppCachePath(appCachePath: JString); cdecl;//Deprecated
    ...
    procedure setForceDark(forceDark: Integer); cdecl;//Deprecated
  ...
  JWebViewClass = interface(JAbsoluteLayoutClass)
    ...
    {class} procedure disableWebView; cdecl;
    {class} procedure enableSlowWholeDocumentDraw; cdecl;
    {class} function findAddress(addr: JString): JString; cdecl;//Deprecated
    ...
    {class} procedure setDataDirectorySuffix(suffix: JString); cdecl;
    {class} procedure setSafeBrowsingWhitelist(hosts: JList; callback: JValueCallback); cdecl;
    {class} procedure setWebContentsDebuggingEnabled(enabled: Boolean); cdecl;
    {class} procedure startSafeBrowsing(context: JContext; callback: JValueCallback); cdecl;
  ...
  JWebView = interface(JAbsoluteLayout)
    ...
    procedure dispatchCreateViewTranslationRequest(viewIds: JMap; supportedFormats: TJavaArray<Integer>; capability: JTranslationCapability; requests: JList); cdecl;
    ...
    function getWebViewLooper: JLooper; cdecl;
    function getWebViewRenderProcess: JWebViewRenderProcess; cdecl;
    function getWebViewRenderProcessClient: JWebViewRenderProcessClient; cdecl;
    ...
    function isVisibleToUserForAutofill(virtualId: Integer): Boolean; cdecl;
    ...
    procedure onCreateVirtualViewTranslationRequests(virtualIds: TJavaArray<Int64>; supportedFormats: TJavaArray<Integer>; requestsCollector: JConsumer); cdecl;
    ...
    procedure onVirtualViewTranslationResponses(response: JLongSparseArray); cdecl;
    ...
    procedure setWebViewRenderProcessClient(executor: JExecutor; webViewRenderProcessClient: JWebViewRenderProcessClient); cdecl; overload;
    procedure setWebViewRenderProcessClient(webViewRenderProcessClient: JWebViewRenderProcessClient); cdecl; overload;
  ...
  JWebViewClientClass = interface(JObjectClass)
    ...
    {class} function _GetSAFE_BROWSING_THREAT_BILLING: Integer; cdecl;
    {class} function _GetSAFE_BROWSING_THREAT_MALWARE: Integer; cdecl;
    {class} function _GetSAFE_BROWSING_THREAT_PHISHING: Integer; cdecl;
    {class} function _GetSAFE_BROWSING_THREAT_UNKNOWN: Integer; cdecl;
    {class} function _GetSAFE_BROWSING_THREAT_UNWANTED_SOFTWARE: Integer; cdecl;
    ...
    {class} property SAFE_BROWSING_THREAT_BILLING: Integer read _GetSAFE_BROWSING_THREAT_BILLING;
    {class} property SAFE_BROWSING_THREAT_MALWARE: Integer read _GetSAFE_BROWSING_THREAT_MALWARE;
    {class} property SAFE_BROWSING_THREAT_PHISHING: Integer read _GetSAFE_BROWSING_THREAT_PHISHING;
    {class} property SAFE_BROWSING_THREAT_UNKNOWN: Integer read _GetSAFE_BROWSING_THREAT_UNKNOWN;
    {class} property SAFE_BROWSING_THREAT_UNWANTED_SOFTWARE: Integer read _GetSAFE_BROWSING_THREAT_UNWANTED_SOFTWARE;
  end;
  ...
  JWebViewClient = interface(JObject)
    ...
    procedure onSafeBrowsingHit(view: JWebView; request: JWebResourceRequest; threatType: Integer; callback: JSafeBrowsingResponse); cdecl;
  ...
  JWebViewDatabaseClass = interface(JObjectClass)
    ...
    {class} function init: JWebViewDatabase; cdecl;//Deprecated
  ...
  JWebViewRenderProcessClass = interface(JObjectClass)
    ['{7FC8947C-4D7C-497D-8E7E-43BED6A18258}']
    {class} function init: JWebViewRenderProcess; cdecl;
  end;

  [JavaSignature('android/webkit/WebViewRenderProcess')]
  JWebViewRenderProcess = interface(JObject)
    ['{679A431A-6F9A-40C7-90CB-EEB3F5A3DB00}']
    function terminate: Boolean; cdecl;
  end;
  TJWebViewRenderProcess = class(TJavaGenericImport<JWebViewRenderProcessClass, JWebViewRenderProcess>) end;

  JWebViewRenderProcessClientClass = interface(JObjectClass)
    ['{5206704C-DBD7-4CC9-ACA1-9B92C65309FC}']
    {class} function init: JWebViewRenderProcessClient; cdecl;
  end;

  [JavaSignature('android/webkit/WebViewRenderProcessClient')]
  JWebViewRenderProcessClient = interface(JObject)
    ['{F3519894-E9DE-4C6E-A6BC-5E46E82C6585}']
    procedure onRenderProcessResponsive(view: JWebView; renderer: JWebViewRenderProcess); cdecl;
    procedure onRenderProcessUnresponsive(view: JWebView; renderer: JWebViewRenderProcess); cdecl;
  end;
  TJWebViewRenderProcessClient = class(TJavaGenericImport<JWebViewRenderProcessClientClass, JWebViewRenderProcessClient>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JSafeBrowsingResponse', TypeInfo(Androidapi.JNI.Webkit.JSafeBrowsingResponse));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JTracingConfig', TypeInfo(Androidapi.JNI.Webkit.JTracingConfig));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JTracingConfig_Builder', TypeInfo(Androidapi.JNI.Webkit.JTracingConfig_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JTracingController', TypeInfo(Androidapi.JNI.Webkit.JTracingController));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JWebViewRenderProcess', TypeInfo(Androidapi.JNI.Webkit.JWebViewRenderProcess));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JWebViewRenderProcessClient', TypeInfo(Androidapi.JNI.Webkit.JWebViewRenderProcessClient));
end;
