...
// ===== Forward declarations =====
  ...
  //JNativeOnCompleteListener = interface;//com.google.android.gms.tasks.NativeOnCompleteListener
  ...
  //Jtasks_zzab = interface;//com.google.android.gms.tasks.zzab
  //Jtasks_zzac = interface;//com.google.android.gms.tasks.zzac
  //Jtasks_zzae = interface;//com.google.android.gms.tasks.zzae
  //Jtasks_zzad = interface;//com.google.android.gms.tasks.zzad
  //Jtasks_zzaf = interface;//com.google.android.gms.tasks.zzaf
...
// ===== Interface declarations =====
  ...
  JContinuation = interface(IJavaInstance)
    ...
    function &then(task: JTask): JObject; cdecl;
  end;
  ...
  JTasksClass = interface(JObjectClass)
    ...
    {class} function await(task: JTask; l: Int64; timeUnit: JTimeUnit): JObject; cdecl; overload;
    ...
    {class} function withTimeout(task: JTask; l: Int64; timeUnit: JTimeUnit): JTask; cdecl;
  end;
...
begin
  ...
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.JNativeOnCompleteListener', TypeInfo(Androidapi.JNI.PlayServices.Tasks.JNativeOnCompleteListener));
  ...
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.Jtasks_zzab', TypeInfo(Androidapi.JNI.PlayServices.Tasks.Jtasks_zzab));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.Jtasks_zzac', TypeInfo(Androidapi.JNI.PlayServices.Tasks.Jtasks_zzac));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.Jtasks_zzae', TypeInfo(Androidapi.JNI.PlayServices.Tasks.Jtasks_zzae));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.Jtasks_zzad', TypeInfo(Androidapi.JNI.PlayServices.Tasks.Jtasks_zzad));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Tasks.Jtasks_zzaf', TypeInfo(Androidapi.JNI.PlayServices.Tasks.Jtasks_zzaf));
