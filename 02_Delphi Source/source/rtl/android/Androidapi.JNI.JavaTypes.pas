...
// ===== Forward declarations =====
  ...
  JThreadLocal = interface;//java.lang.ThreadLocal
  ...
  JStandardCharsets = interface;//java.nio.charset.StandardCharsets
  ...
  JChronoUnit = interface;//java.time.temporal.ChronoUnit
  ...
  JCollections = interface;//java.util.Collections
  ...
  JNavigableMap = interface;//java.util.NavigableMap
  ...
  JAtomicReference = interface;//java.util.concurrent.atomic.AtomicReference
  ...
  JCipher = interface;//javax.crypto.Cipher
  JExemptionMechanism = interface;//javax.crypto.ExemptionMechanism
  JMac = interface;//javax.crypto.Mac
...
// ===== Interface declarations =====
  ...
  JObject = interface(IJavaInstance)
    ...
    procedure wait(timeout: Int64); cdecl; overload;
    procedure wait(timeout: Int64; nanos: Integer); cdecl; overload;
  ...
  JInputStreamClass = interface(JObjectClass)
    ...
    {class} function nullInputStream: JInputStream; cdecl;
  end;
  ...
  JInputStream = interface(JObject)
    ...
    function readAllBytes: TJavaArray<Byte>; cdecl;
    function readNBytes(len: Integer): TJavaArray<Byte>; cdecl; overload;
    function readNBytes(b: TJavaArray<Byte>; off: Integer; len: Integer): Integer; cdecl; overload;
    procedure reset; cdecl;
    function skip(n: Int64): Int64; cdecl;
    function transferTo(out_: JOutputStream): Int64; cdecl;
  end;
  ...
  JByteArrayInputStream = interface(JInputStream)
    ...
    function read(b: TJavaArray<Byte>; off: Integer; len: Integer): Integer; cdecl; overload;
    function readAllBytes: TJavaArray<Byte>; cdecl;
    function readNBytes(b: TJavaArray<Byte>; off: Integer; len: Integer): Integer; cdecl;
    procedure reset; cdecl;
    function skip(n: Int64): Int64; cdecl;
    function transferTo(out_: JOutputStream): Int64; cdecl;
  end;
  ...
  JOutputStreamClass = interface(JObjectClass)
    ...
    {class} function nullOutputStream: JOutputStream; cdecl;
  end;
  ...
  JByteArrayOutputStream = interface(JOutputStream)
    ...
    function toString(charset: JCharset): JString; cdecl; overload;
    function toString(hibyte: Integer): JString; cdecl; overload;//Deprecated
    procedure write(b: Integer); cdecl; overload;
    procedure write(b: TJavaArray<Byte>; off: Integer; len: Integer); cdecl; overload;
    procedure writeBytes(b: TJavaArray<Byte>); cdecl;
  ...
  JPrintStreamClass = interface(JFilterOutputStreamClass)
    ...
    {class} function init(out_: JOutputStream; autoFlush: Boolean; charset: JCharset): JPrintStream; cdecl; overload;
    ...
    {class} function init(fileName: JString; charset: JCharset): JPrintStream; cdecl; overload;
    ...
    {class} function init(file_: JFile; charset: JCharset): JPrintStream; cdecl; overload;
  end;
  ...
  JWriterClass = interface(JObjectClass)
    ...
    {class} function nullWriter: JWriter; cdecl;
  end;
  ...
  JPrintWriterClass = interface(JWriterClass)
    ...
    {class} function init(out_: JOutputStream; autoFlush: Boolean; charset: JCharset): JPrintWriter; cdecl; overload;
    ...
    {class} function init(fileName: JString; charset: JCharset): JPrintWriter; cdecl; overload;
    ...
    {class} function init(file_: JFile; charset: JCharset): JPrintWriter; cdecl; overload;
  end;
  ...
  JRandomAccessFile = interface(JObject)
    ...
    procedure seek(pos: Int64); cdecl;
  ...
  JReaderClass = interface(JObjectClass)
    ...
    {class} function nullReader: JReader; cdecl;
  end;
  ...
  JReader = interface(JObject)
    ...
    procedure reset; cdecl;
    function skip(n: Int64): Int64; cdecl;
    function transferTo(out_: JWriter): Int64; cdecl;
  end;
  ...
  JAbstractStringBuilder = interface(JObject)
    ...
    function append(obj: JObject): JAbstractStringBuilder; cdecl; overload;
    function append(str: JString): JAbstractStringBuilder; cdecl; overload;
    function append(sb: JStringBuffer): JAbstractStringBuilder; cdecl; overload;
    function append(s: JCharSequence): JAbstractStringBuilder; cdecl; overload;
    function append(s: JCharSequence; start: Integer; end_: Integer): JAbstractStringBuilder; cdecl; overload;
    function append(str: TJavaArray<Char>): JAbstractStringBuilder; cdecl; overload;
    function append(str: TJavaArray<Char>; offset: Integer; len: Integer): JAbstractStringBuilder; cdecl; overload;
    function append(b: Boolean): JAbstractStringBuilder; cdecl; overload;
    function append(c: Char): JAbstractStringBuilder; cdecl; overload;
    function append(i: Integer): JAbstractStringBuilder; cdecl; overload;
    function append(l: Int64): JAbstractStringBuilder; cdecl; overload;
    function append(f: Single): JAbstractStringBuilder; cdecl; overload;
    function append(d: Double): JAbstractStringBuilder; cdecl; overload;
    function appendCodePoint(codePoint: Integer): JAbstractStringBuilder; cdecl;
    ...
    function delete(start: Integer; end_: Integer): JAbstractStringBuilder; cdecl;
    function deleteCharAt(index: Integer): JAbstractStringBuilder; cdecl;
    ...
    function insert(index: Integer; str: TJavaArray<Char>; offset: Integer; len: Integer): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; obj: JObject): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; str: JString): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; str: TJavaArray<Char>): JAbstractStringBuilder; cdecl; overload;
    function insert(dstOffset: Integer; s: JCharSequence): JAbstractStringBuilder; cdecl; overload;
    function insert(dstOffset: Integer; s: JCharSequence; start: Integer; end_: Integer): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; b: Boolean): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; c: Char): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; i: Integer): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; l: Int64): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; f: Single): JAbstractStringBuilder; cdecl; overload;
    function insert(offset: Integer; d: Double): JAbstractStringBuilder; cdecl; overload;
    ...
    function replace(start: Integer; end_: Integer; str: JString): JAbstractStringBuilder; cdecl;
    function reverse: JAbstractStringBuilder; cdecl;
  ...
  JBooleanClass = interface(JObjectClass)
    ...
    {class} function init(value: Boolean): JBoolean; cdecl; overload;//Deprecated
    {class} function init(s: JString): JBoolean; cdecl; overload;//Deprecated
  ...
  JByteClass = interface(JNumberClass)
    ...
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: Byte): JByte; cdecl; overload;//Deprecated
    {class} function init(s: JString): JByte; cdecl; overload;//Deprecated
    {class} function compare(x: Byte; y: Byte): Integer; cdecl;
    {class} function compareUnsigned(x: Byte; y: Byte): Integer; cdecl;
  ...
  JDoubleClass = interface(JNumberClass)
    ...
    {class} function _GetSIZE: Integer; cdecl;
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: Double): JDouble; cdecl; overload;//Deprecated
    {class} function init(s: JString): JDouble; cdecl; overload;//Deprecated
  ...
  JFloatClass = interface(JNumberClass)
    ...
    {class} function _GetSIZE: Integer; cdecl;
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: Single): JFloat; cdecl; overload;//Deprecated
    {class} function init(value: Double): JFloat; cdecl; overload;//Deprecated
    {class} function init(s: JString): JFloat; cdecl; overload;//Deprecated
  ...
  JIllegalArgumentExceptionClass = interface(JRuntimeExceptionClass)
    ...
    {class} function init(s: JString): JIllegalArgumentException; cdecl; overload;
  ...
  JIntegerClass = interface(JNumberClass)
    ...
    {class} function _GetSIZE: Integer; cdecl;
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: Integer): JInteger; cdecl; overload;//Deprecated
    {class} function init(s: JString): JInteger; cdecl; overload;//Deprecated
    ...
    {class} function parseInt(s: JCharSequence; beginIndex: Integer; endIndex: Integer; radix: Integer): Integer; cdecl; overload;
    ...
    {class} function parseUnsignedInt(s: JCharSequence; beginIndex: Integer; endIndex: Integer; radix: Integer): Integer; cdecl; overload;
  ...
  JLongClass = interface(JNumberClass)
    ...
    {class} function _GetSIZE: Integer; cdecl;
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: Int64): JLong; cdecl; overload;//Deprecated
    {class} function init(s: JString): JLong; cdecl; overload;//Deprecated
    ...
    {class} function parseLong(s: JCharSequence; beginIndex: Integer; endIndex: Integer; radix: Integer): Int64; cdecl; overload;
    ...
    {class} function parseUnsignedLong(s: JCharSequence; beginIndex: Integer; endIndex: Integer; radix: Integer): Int64; cdecl; overload;
  ...
  JShortClass = interface(JNumberClass)
    ...
    {class} function _GetSIZE: Integer; cdecl;
    {class} function _GetTYPE: Jlang_Class; cdecl;
    {class} function init(value: SmallInt): JShort; cdecl; overload;//Deprecated
    {class} function init(s: JString): JShort; cdecl; overload;//Deprecated
    {class} function compare(x: SmallInt; y: SmallInt): Integer; cdecl;
    {class} function compareUnsigned(x: SmallInt; y: SmallInt): Integer; cdecl;
  ...
  JString = interface(JObject)
    ...
    function isBlank: Boolean; cdecl;
    ...
    function &repeat(count: Integer): JString; cdecl;
    ...
    function strip: JString; cdecl;
    function stripLeading: JString; cdecl;
    function stripTrailing: JString; cdecl;
  ...
  JThreadClass = interface(JObjectClass)
    ...
    {class} function init(group: JThreadGroup; target: JRunnable; name: JString; stackSize: Int64; inheritThreadLocals: Boolean): JThread; cdecl; overload;
    ...
    {class} function getAllStackTraces: JMap; cdecl;
    ...
    {class} procedure onSpinWait; cdecl;
  ...
  JThreadLocalClass = interface(JObjectClass)
    ['{B4342500-D0F3-4E67-8FB4-830A31A39A1E}']
    {class} function init: JThreadLocal; cdecl;
    {class} function withInitial(supplier: JSupplier): JThreadLocal; cdecl;
  end;

  [JavaSignature('java/lang/ThreadLocal')]
  JThreadLocal = interface(JObject)
    ['{4A418D00-B163-4B20-AB00-1FEE2C5E30F4}']
    function &get: JObject; cdecl;
    procedure remove; cdecl;
    procedure &set(value: JObject); cdecl;
  end;
  TJThreadLocal = class(TJavaGenericImport<JThreadLocalClass, JThreadLocal>) end;
  ...
  JReferenceClass = interface(JObjectClass)
    ...
    {class} procedure reachabilityFence(ref: JObject); cdecl;
  end;
  ...
  JReference = interface(JObject)
    ...
    function &get: JObject; cdecl;
    function isEnqueued: Boolean; cdecl;//Deprecated
    function refersTo(obj: JObject): Boolean; cdecl;
  end;
  ...
  JReferenceQueue = interface(JObject)
    ...
    function remove(timeout: Int64): JReference; cdecl; overload;
  ...
  JWeakReferenceClass = interface(JReferenceClass)
    ...
    {class} function init(referent: JObject): JWeakReference; cdecl; overload;
    {class} function init(referent: JObject; q: JReferenceQueue): JWeakReference; cdecl; overload;
  end;
  ...
  JBigIntegerClass = interface(JNumberClass)
    ...
    {class} function _GetTWO: JBigInteger; cdecl;
    {class} function _GetZERO: JBigInteger; cdecl;
    {class} function init(val: TJavaArray<Byte>; off: Integer; len: Integer): JBigInteger; cdecl; overload;
    {class} function init(val: TJavaArray<Byte>): JBigInteger; cdecl; overload;
    {class} function init(signum: Integer; magnitude: TJavaArray<Byte>; off: Integer; len: Integer): JBigInteger; cdecl; overload;
    {class} function init(signum: Integer; magnitude: TJavaArray<Byte>): JBigInteger; cdecl; overload;
    {class} function init(val: JString; radix: Integer): JBigInteger; cdecl; overload;
    {class} function init(val: JString): JBigInteger; cdecl; overload;
    {class} function init(numBits: Integer; rnd: JRandom): JBigInteger; cdecl; overload;
    {class} function init(bitLength: Integer; certainty: Integer; rnd: JRandom): JBigInteger; cdecl; overload;
    {class} function probablePrime(bitLength: Integer; rnd: JRandom): JBigInteger; cdecl;
    {class} function valueOf(val: Int64): JBigInteger; cdecl;
    {class} property ONE: JBigInteger read _GetONE;
    {class} property TEN: JBigInteger read _GetTEN;
    {class} property TWO: JBigInteger read _GetTWO;
  ...
  JBigInteger = interface(JNumber)
    ...
    function add(val: JBigInteger): JBigInteger; cdecl;
    function &and(val: JBigInteger): JBigInteger; cdecl;
    function andNot(val: JBigInteger): JBigInteger; cdecl;
    ...
    function compareTo(val: JBigInteger): Integer; cdecl;
    function divide(val: JBigInteger): JBigInteger; cdecl;
    function divideAndRemainder(val: JBigInteger): TJavaObjectArray<JBigInteger>; cdecl;
    function doubleValue: Double; cdecl;
    function equals(x: JObject): Boolean; cdecl;
    function flipBit(n: Integer): JBigInteger; cdecl;
    function floatValue: Single; cdecl;
    function gcd(val: JBigInteger): JBigInteger; cdecl;
    ...
    function max(val: JBigInteger): JBigInteger; cdecl;
    function min(val: JBigInteger): JBigInteger; cdecl;
    function &mod(m: JBigInteger): JBigInteger; cdecl;
    function modInverse(m: JBigInteger): JBigInteger; cdecl;
    function modPow(exponent: JBigInteger; m: JBigInteger): JBigInteger; cdecl;
    function multiply(val: JBigInteger): JBigInteger; cdecl;
    function negate: JBigInteger; cdecl;
    function nextProbablePrime: JBigInteger; cdecl;
    function &not: JBigInteger; cdecl;
    function &or(val: JBigInteger): JBigInteger; cdecl;
    function pow(exponent: Integer): JBigInteger; cdecl;
    function remainder(val: JBigInteger): JBigInteger; cdecl;
    ...
    function sqrt: JBigInteger; cdecl;
    function sqrtAndRemainder: TJavaObjectArray<JBigInteger>; cdecl;
    function subtract(val: JBigInteger): JBigInteger; cdecl;
    function testBit(n: Integer): Boolean; cdecl;
    function toByteArray: TJavaArray<Byte>; cdecl;
    function toString(radix: Integer): JString; cdecl; overload;
    function toString: JString; cdecl; overload;
    function &xor(val: JBigInteger): JBigInteger; cdecl;
  end;
  ...
  JByteBuffer = interface(JBuffer)
    ...
    function alignedSlice(unitSize: Integer): JByteBuffer; cdecl;
    function alignmentOffset(index: Integer; unitSize: Integer): Integer; cdecl;
    ...
    function hashCode: Integer; cdecl;
    function isDirect: Boolean; cdecl;
    function limit(newLimit: Integer): JBuffer; cdecl;
    function mark: JBuffer; cdecl;
    function order: JByteOrder; cdecl; overload;
    function order(bo: JByteOrder): JByteBuffer; cdecl; overload;
    function position(newPosition: Integer): JBuffer; cdecl;
  ...
  JSelectionKey = interface(JObject)
    ...
    function interestOpsAnd(ops: Integer): Integer; cdecl;
    function interestOpsOr(ops: Integer): Integer; cdecl;
  ...
  JSelector = interface(JObject)
    ...
    function select(action: JConsumer; timeout: Int64): Integer; cdecl; overload;
    function select(action: JConsumer): Integer; cdecl; overload;
    function selectNow: Integer; cdecl; overload;
    function selectNow(action: JConsumer): Integer; cdecl; overload;
  ...
  JStandardCharsetsClass = interface(JObjectClass)
    ['{FB75DD5B-CE10-488E-9C3D-5C1849659629}']
    {class} function _GetISO_8859_1: JCharset; cdecl;
    {class} function _GetUS_ASCII: JCharset; cdecl;
    {class} function _GetUTF_16: JCharset; cdecl;
    {class} function _GetUTF_16BE: JCharset; cdecl;
    {class} function _GetUTF_16LE: JCharset; cdecl;
    {class} function _GetUTF_8: JCharset; cdecl;
    {class} property ISO_8859_1: JCharset read _GetISO_8859_1;
    {class} property US_ASCII: JCharset read _GetUS_ASCII;
    {class} property UTF_16: JCharset read _GetUTF_16;
    {class} property UTF_16BE: JCharset read _GetUTF_16BE;
    {class} property UTF_16LE: JCharset read _GetUTF_16LE;
    {class} property UTF_8: JCharset read _GetUTF_8;
  end;

  [JavaSignature('java/nio/charset/StandardCharsets')]
  JStandardCharsets = interface(JObject)
    ['{D0524DAF-1F0A-4A8F-9F59-5D9567FBED9E}']
  end;
  TJStandardCharsets = class(TJavaGenericImport<JStandardCharsetsClass, JStandardCharsets>) end;
  ...
  JFileStore = interface(JObject)
    ...
    function getBlockSize: Int64; cdecl;
  ...
  JClockClass = interface(JObjectClass)
    ...
    {class} function tickMillis(zone: JZoneId): JClock; cdecl;
  ...
  Jtime_Duration = interface(JObject)
    ...
    function dividedBy(divisor: Int64): Jtime_Duration; cdecl; overload;
    function dividedBy(divisor: Jtime_Duration): Int64; cdecl; overload;
    ...
    function toDaysPart: Int64; cdecl;
    function toHours: Int64; cdecl;
    function toHoursPart: Integer; cdecl;
    function toMillis: Int64; cdecl;
    function toMillisPart: Integer; cdecl;
    function toMinutes: Int64; cdecl;
    function toMinutesPart: Integer; cdecl;
    function toNanos: Int64; cdecl;
    function toNanosPart: Integer; cdecl;
    function toSeconds: Int64; cdecl;
    function toSecondsPart: Integer; cdecl;
    function toString: JString; cdecl;
    function truncatedTo(unit_: JTemporalUnit): Jtime_Duration; cdecl;
  ...
  JLocalDateClass = interface(JObjectClass)
    ...
    {class} function _GetEPOCH: JLocalDate; cdecl;
    ...
    {class} function ofInstant(instant: JInstant; zone: JZoneId): JLocalDate; cdecl;
    ...
    {class} property EPOCH: JLocalDate read _GetEPOCH;
  ...
  JLocalDate = interface(JObject)
    ...
    function datesUntil(endExclusive: JLocalDate): JStream; cdecl; overload;
    function datesUntil(endExclusive: JLocalDate; step: JPeriod): JStream; cdecl; overload;
    function equals(obj: JObject): Boolean; cdecl;
    ...
    function toEpochSecond(time: JLocalTime; offset: JZoneOffset): Int64; cdecl;
    function toString: JString; cdecl;
  ...
  JLocalTimeClass = interface(JObjectClass)
    ...
    {class} function ofInstant(instant: JInstant; zone: JZoneId): JLocalTime; cdecl;
  ...
  JLocalTime = interface(JObject)
    ...
    function query(query: JTemporalQuery): JObject; cdecl;
    function range(field: JTemporalField): JValueRange; cdecl;
    function toEpochSecond(date: JLocalDate; offset: JZoneOffset): Int64; cdecl;
  ...
  JOffsetTime = interface(JObject)
    ...
    function query(query: JTemporalQuery): JObject; cdecl;
    function range(field: JTemporalField): JValueRange; cdecl;
    function toEpochSecond(date: JLocalDate): Int64; cdecl;
    function toLocalTime: JLocalTime; cdecl;
    function toString: JString; cdecl;
  ...
  JChronology = interface(JComparable)
    ...
    function epochSecond(prolepticYear: Integer; month: Integer; dayOfMonth: Integer; hour: Integer; minute: Integer; second: Integer; zoneOffset: JZoneOffset): Int64; cdecl; overload;
    function epochSecond(era: JEra; yearOfEra: Integer; month: Integer; dayOfMonth: Integer; hour: Integer; minute: Integer; second: Integer; zoneOffset: JZoneOffset): Int64; cdecl; overload;
    function equals(obj: JObject): Boolean; cdecl;
  ...
  JIsoChronology = interface(JAbstractChronology)
    ...
    function epochSecond(prolepticYear: Integer; month: Integer; dayOfMonth: Integer; hour: Integer; minute: Integer; second: Integer; zoneOffset: JZoneOffset): Int64; cdecl;
  ...
  JDateTimeFormatter = interface(JObject)
    ...
    function getZone: JZoneId; cdecl;
    function localizedBy(locale: JLocale): JDateTimeFormatter; cdecl;
  ...
  JChronoUnitClass = interface(JEnumClass)
    ['{E0A8C77F-A7C9-48F2-BD4B-198D83C39A7C}']
    {class} function _GetCENTURIES: JChronoUnit; cdecl;
    {class} function _GetDAYS: JChronoUnit; cdecl;
    {class} function _GetDECADES: JChronoUnit; cdecl;
    {class} function _GetERAS: JChronoUnit; cdecl;
    {class} function _GetFOREVER: JChronoUnit; cdecl;
    {class} function _GetHALF_DAYS: JChronoUnit; cdecl;
    {class} function _GetHOURS: JChronoUnit; cdecl;
    {class} function _GetMICROS: JChronoUnit; cdecl;
    {class} function _GetMILLENNIA: JChronoUnit; cdecl;
    {class} function _GetMILLIS: JChronoUnit; cdecl;
    {class} function _GetMINUTES: JChronoUnit; cdecl;
    {class} function _GetMONTHS: JChronoUnit; cdecl;
    {class} function _GetNANOS: JChronoUnit; cdecl;
    {class} function _GetSECONDS: JChronoUnit; cdecl;
    {class} function _GetWEEKS: JChronoUnit; cdecl;
    {class} function _GetYEARS: JChronoUnit; cdecl;
    {class} function valueOf(name: JString): JChronoUnit; cdecl;
    {class} function values: TJavaObjectArray<JChronoUnit>; cdecl;
    {class} property CENTURIES: JChronoUnit read _GetCENTURIES;
    {class} property DAYS: JChronoUnit read _GetDAYS;
    {class} property DECADES: JChronoUnit read _GetDECADES;
    {class} property ERAS: JChronoUnit read _GetERAS;
    {class} property FOREVER: JChronoUnit read _GetFOREVER;
    {class} property HALF_DAYS: JChronoUnit read _GetHALF_DAYS;
    {class} property HOURS: JChronoUnit read _GetHOURS;
    {class} property MICROS: JChronoUnit read _GetMICROS;
    {class} property MILLENNIA: JChronoUnit read _GetMILLENNIA;
    {class} property MILLIS: JChronoUnit read _GetMILLIS;
    {class} property MINUTES: JChronoUnit read _GetMINUTES;
    {class} property MONTHS: JChronoUnit read _GetMONTHS;
    {class} property NANOS: JChronoUnit read _GetNANOS;
    {class} property SECONDS: JChronoUnit read _GetSECONDS;
    {class} property WEEKS: JChronoUnit read _GetWEEKS;
    {class} property YEARS: JChronoUnit read _GetYEARS;
  end;

  [JavaSignature('java/time/temporal/ChronoUnit')]
  JChronoUnit = interface(JEnum)
    ['{4E43FFBD-6761-4D4C-AE9C-8EC165ED382C}']
  ...
  TJChronoUnit = class(TJavaGenericImport<JChronoUnitClass, JChronoUnit>) end;
  ...
  JCollection = interface(JIterable)
    ...
    function toArray: TJavaObjectArray<JObject>; cdecl; overload;
    function toArray(a: TJavaObjectArray<JObject>): TJavaObjectArray<JObject>; cdecl; overload;
    function toArray(generator: JIntFunction): TJavaObjectArray<JObject>; cdecl; overload;
  end;
  TJCollection = class(TJavaGenericImport<JCollectionClass, JCollection>) end;

  JCollectionsClass = interface(JObjectClass)
    ['{979C3C4E-0DAC-4F70-9B5D-4EF1DEB77443}']
    {class} function _GetEMPTY_LIST: JList; cdecl;
    {class} function _GetEMPTY_MAP: JMap; cdecl;
    {class} function _GetEMPTY_SET: JSet; cdecl;
    {class} function asLifoQueue(deque: JDeque): JQueue; cdecl;
    {class} function binarySearch(list: JList; key: JObject): Integer; cdecl; overload;
    {class} function binarySearch(list: JList; key: JObject; c: JComparator): Integer; cdecl; overload;
    {class} function checkedCollection(c: JCollection; type_: Jlang_Class): JCollection; cdecl;
    {class} function checkedList(list: JList; type_: Jlang_Class): JList; cdecl;
    {class} function checkedMap(m: JMap; keyType: Jlang_Class; valueType: Jlang_Class): JMap; cdecl;
    {class} function checkedNavigableMap(m: JNavigableMap; keyType: Jlang_Class; valueType: Jlang_Class): JNavigableMap; cdecl;
    {class} function checkedNavigableSet(s: JNavigableSet; type_: Jlang_Class): JNavigableSet; cdecl;
    {class} function checkedQueue(queue: JQueue; type_: Jlang_Class): JQueue; cdecl;
    {class} function checkedSet(s: JSet; type_: Jlang_Class): JSet; cdecl;
    {class} function checkedSortedMap(m: JSortedMap; keyType: Jlang_Class; valueType: Jlang_Class): JSortedMap; cdecl;
    {class} function checkedSortedSet(s: JSortedSet; type_: Jlang_Class): JSortedSet; cdecl;
    {class} procedure copy(dest: JList; src: JList); cdecl;
    {class} function disjoint(c1: JCollection; c2: JCollection): Boolean; cdecl;
    {class} function emptyEnumeration: JEnumeration; cdecl;
    {class} function emptyIterator: JIterator; cdecl;
    {class} function emptyList: JList; cdecl;
    {class} function emptyListIterator: JListIterator; cdecl;
    {class} function emptyMap: JMap; cdecl;
    {class} function emptyNavigableMap: JNavigableMap; cdecl;
    {class} function emptyNavigableSet: JNavigableSet; cdecl;
    {class} function emptySet: JSet; cdecl;
    {class} function emptySortedMap: JSortedMap; cdecl;
    {class} function emptySortedSet: JSortedSet; cdecl;
    {class} function enumeration(c: JCollection): JEnumeration; cdecl;
    {class} procedure fill(list: JList; obj: JObject); cdecl;
    {class} function frequency(c: JCollection; o: JObject): Integer; cdecl;
    {class} function indexOfSubList(source: JList; target: JList): Integer; cdecl;
    {class} function lastIndexOfSubList(source: JList; target: JList): Integer; cdecl;
    {class} function list(e: JEnumeration): JArrayList; cdecl;
    {class} function max(coll: JCollection): JObject; cdecl; overload;
    {class} function max(coll: JCollection; comp: JComparator): JObject; cdecl; overload;
    {class} function min(coll: JCollection): JObject; cdecl; overload;
    {class} function min(coll: JCollection; comp: JComparator): JObject; cdecl; overload;
    {class} function nCopies(n: Integer; o: JObject): JList; cdecl;
    {class} function newSetFromMap(map: JMap): JSet; cdecl;
    {class} function replaceAll(list: JList; oldVal: JObject; newVal: JObject): Boolean; cdecl;
    {class} procedure reverse(list: JList); cdecl;
    {class} function reverseOrder: JComparator; cdecl; overload;
    {class} function reverseOrder(cmp: JComparator): JComparator; cdecl; overload;
    {class} procedure rotate(list: JList; distance: Integer); cdecl;
    {class} procedure shuffle(list: JList); cdecl; overload;
    {class} procedure shuffle(list: JList; rnd: JRandom); cdecl; overload;
    {class} function singleton(o: JObject): JSet; cdecl;
    {class} function singletonList(o: JObject): JList; cdecl;
    {class} function singletonMap(key: JObject; value: JObject): JMap; cdecl;
    {class} procedure sort(list: JList); cdecl; overload;
    {class} procedure sort(list: JList; c: JComparator); cdecl; overload;
    {class} procedure swap(list: JList; i: Integer; j: Integer); cdecl;
    {class} function synchronizedCollection(c: JCollection): JCollection; cdecl;
    {class} function synchronizedList(list: JList): JList; cdecl;
    {class} function synchronizedMap(m: JMap): JMap; cdecl;
    {class} function synchronizedNavigableMap(m: JNavigableMap): JNavigableMap; cdecl;
    {class} function synchronizedNavigableSet(s: JNavigableSet): JNavigableSet; cdecl;
    {class} function synchronizedSet(s: JSet): JSet; cdecl;
    {class} function synchronizedSortedMap(m: JSortedMap): JSortedMap; cdecl;
    {class} function synchronizedSortedSet(s: JSortedSet): JSortedSet; cdecl;
    {class} function unmodifiableCollection(c: JCollection): JCollection; cdecl;
    {class} function unmodifiableList(list: JList): JList; cdecl;
    {class} function unmodifiableMap(m: JMap): JMap; cdecl;
    {class} function unmodifiableNavigableMap(m: JNavigableMap): JNavigableMap; cdecl;
    {class} function unmodifiableNavigableSet(s: JNavigableSet): JNavigableSet; cdecl;
    {class} function unmodifiableSet(s: JSet): JSet; cdecl;
    {class} function unmodifiableSortedMap(m: JSortedMap): JSortedMap; cdecl;
    {class} function unmodifiableSortedSet(s: JSortedSet): JSortedSet; cdecl;
    {class} property EMPTY_LIST: JList read _GetEMPTY_LIST;
    {class} property EMPTY_MAP: JMap read _GetEMPTY_MAP;
    {class} property EMPTY_SET: JSet read _GetEMPTY_SET;
  end;

  [JavaSignature('java/util/Collections')]
  JCollections = interface(JObject)
    ['{ED71F349-7C4F-40C7-B37D-A067CA69D71F}']
  end;
  TJCollections = class(TJavaGenericImport<JCollectionsClass, JCollections>) end;
  ...
  JDeque = interface(JQueue)
    ...
    function add(e: JObject): Boolean; cdecl;
    function addAll(c: JCollection): Boolean; cdecl;
    procedure addFirst(e: JObject); cdecl;
    ...
    function peek: JObject; cdecl;
    function peekFirst: JObject; cdecl;
    function peekLast: JObject; cdecl;
    function poll: JObject; cdecl;
    function pollFirst: JObject; cdecl;
    function pollLast: JObject; cdecl;
    function pop: JObject; cdecl;
    procedure push(e: JObject); cdecl;
    function remove: JObject; cdecl; overload;
    function remove(o: JObject): Boolean; cdecl; overload;
    ...
    function removeLastOccurrence(o: JObject): Boolean; cdecl;
    function size: Integer; cdecl;
  end;
  ...
  JEnumeration = interface(IJavaInstance)
    ...
    function asIterator: JIterator; cdecl;
  ...
  JEventObjectClass = interface(JObjectClass)
    ...
    {class} function init(source: JObject): JEventObject; cdecl;
  end;
  ...
  JIntSummaryStatisticsClass = interface(JObjectClass)
    ...
    {class} function init: JIntSummaryStatistics; cdecl; overload;
    {class} function init(count: Int64; min: Integer; max: Integer; sum: Int64): JIntSummaryStatistics; cdecl; overload;
  end;
  ...
  JListClass = interface(JCollectionClass)
    ...
    {class} function copyOf(coll: JCollection): JList; cdecl;
    {class} function &of: JList; cdecl; overload;
    {class} function &of(e1: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject; e9: JObject): JList; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject; e9: JObject; e10: JObject): JList; cdecl; overload;
  end;
  ...
  JLongSummaryStatisticsClass = interface(JObjectClass)
    ...
    {class} function init: JLongSummaryStatistics; cdecl; overload;
    {class} function init(count: Int64; min: Int64; max: Int64; sum: Int64): JLongSummaryStatistics; cdecl; overload;
  end;
  ...
  JMapClass = interface(IJavaClass)
    ...
    {class} function copyOf(map: JMap): JMap; cdecl;
    {class} function entry(k: JObject; v: JObject): JMap_Entry; cdecl;
    {class} function &of: JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject; k6: JObject; v6: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject; k6: JObject; v6: JObject; k7: JObject; v7: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject; k6: JObject; v6: JObject; k7: JObject; v7: JObject; k8: JObject; v8: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject; k6: JObject; v6: JObject; k7: JObject; v7: JObject; k8: JObject; v8: JObject; k9: JObject; v9: JObject): JMap; cdecl; overload;
    {class} function &of(k1: JObject; v1: JObject; k2: JObject; v2: JObject; k3: JObject; v3: JObject; k4: JObject; v4: JObject; k5: JObject; v5: JObject; k6: JObject; v6: JObject; k7: JObject; v7: JObject; k8: JObject; v8: JObject; k9: JObject; v9: JObject; k10: JObject; v10: JObject): JMap; cdecl; overload;
  end;
  ...
  JMap_EntryClass = interface(IJavaClass)
    ...
    {class} function comparingByKey: JComparator; cdecl; overload;
    {class} function comparingByKey(cmp: JComparator): JComparator; cdecl; overload;
    {class} function comparingByValue: JComparator; cdecl; overload;
    {class} function comparingByValue(cmp: JComparator): JComparator; cdecl; overload;
  end;
  ...
  JMap_Entry = interface(IJavaInstance)
    ...
    function hashCode: Integer; cdecl;
    function setValue(value: JObject): JObject; cdecl;
  end;
  ...
  JNavigableMap = interface(JSortedMap)
    ...
    function ceilingEntry(key: JObject): JMap_Entry; cdecl;
    ...
    function floorEntry(key: JObject): JMap_Entry; cdecl;
    function floorKey(key: JObject): JObject; cdecl;
    function headMap(toKey: JObject; inclusive: Boolean): JNavigableMap; cdecl; overload;
    ...
    function lowerEntry(key: JObject): JMap_Entry; cdecl;
    function lowerKey(key: JObject): JObject; cdecl;
    ...
    function subMap(fromKey: JObject; fromInclusive: Boolean; toKey: JObject; toInclusive: Boolean): JNavigableMap; cdecl; overload;
    function subMap(fromKey: JObject; toKey: JObject): JSortedMap; cdecl; overload;
  ...
  JSetClass = interface(JCollectionClass)
    ...
    {class} function copyOf(coll: JCollection): JSet; cdecl;
    {class} function &of: JSet; cdecl; overload;
    {class} function &of(e1: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject; e9: JObject): JSet; cdecl; overload;
    {class} function &of(e1: JObject; e2: JObject; e3: JObject; e4: JObject; e5: JObject; e6: JObject; e7: JObject; e8: JObject; e9: JObject; e10: JObject): JSet; cdecl; overload;
  end;
  ...
  JSortedSet = interface(JSet)
    ...
    function headSet(toElement: JObject): JSortedSet; cdecl;
    function last: JObject; cdecl;
    function spliterator: JSpliterator; cdecl;
    function subSet(fromElement: JObject; toElement: JObject): JSortedSet; cdecl;
    function tailSet(fromElement: JObject): JSortedSet; cdecl;
  end;
  ...
  JNavigableSet = interface(JSortedSet)
    ...
    function headSet(toElement: JObject; inclusive: Boolean): JNavigableSet; cdecl; overload;
  ...
  JOptional = interface(JObject)
    ...
    function &get: JObject; cdecl;
    function hashCode: Integer; cdecl;
    procedure ifPresent(action: JConsumer); cdecl;
    procedure ifPresentOrElse(action: JConsumer; emptyAction: JRunnable); cdecl;
    function isEmpty: Boolean; cdecl;
    function isPresent: Boolean; cdecl;
    function map(mapper: JFunction): JOptional; cdecl;
    function &or(supplier: JSupplier): JOptional; cdecl;
    function orElse(other: JObject): JObject; cdecl;
    function orElseGet(supplier: JSupplier): JObject; cdecl;
    function orElseThrow: JObject; cdecl; overload;
    function orElseThrow(exceptionSupplier: JSupplier): JObject; cdecl; overload;
    function stream: JStream; cdecl;
    function toString: JString; cdecl;
  end;
  ...
  JOptionalDouble = interface(JObject)
    ...
    function hashCode: Integer; cdecl;
    procedure ifPresent(action: JDoubleConsumer); cdecl;
    procedure ifPresentOrElse(action: JDoubleConsumer; emptyAction: JRunnable); cdecl;
    function isEmpty: Boolean; cdecl;
    function isPresent: Boolean; cdecl;
    function orElse(other: Double): Double; cdecl;
    function orElseGet(supplier: JDoubleSupplier): Double; cdecl;
    function orElseThrow: Double; cdecl; overload;
    function orElseThrow(exceptionSupplier: JSupplier): Double; cdecl; overload;
    function stream: JDoubleStream; cdecl;
    function toString: JString; cdecl;
  end;
  ...
  JOptionalInt = interface(JObject)
    ...
    function hashCode: Integer; cdecl;
    procedure ifPresent(action: JIntConsumer); cdecl;
    procedure ifPresentOrElse(action: JIntConsumer; emptyAction: JRunnable); cdecl;
    function isEmpty: Boolean; cdecl;
    function isPresent: Boolean; cdecl;
    function orElse(other: Integer): Integer; cdecl;
    function orElseGet(supplier: JIntSupplier): Integer; cdecl;
    function orElseThrow: Integer; cdecl; overload;
    function orElseThrow(exceptionSupplier: JSupplier): Integer; cdecl; overload;
    function stream: JIntStream; cdecl;
    function toString: JString; cdecl;
  end;
  ...
  JOptionalLong = interface(JObject)
    ...
    function hashCode: Integer; cdecl;
    procedure ifPresent(action: JLongConsumer); cdecl;
    procedure ifPresentOrElse(action: JLongConsumer; emptyAction: JRunnable); cdecl;
    function isEmpty: Boolean; cdecl;
    function isPresent: Boolean; cdecl;
    function orElse(other: Int64): Int64; cdecl;
    function orElseGet(supplier: JLongSupplier): Int64; cdecl;
    function orElseThrow: Int64; cdecl; overload;
    function orElseThrow(exceptionSupplier: JSupplier): Int64; cdecl; overload;
    function stream: JLongStream; cdecl;
    function toString: JString; cdecl;
  end;
  ...
  JTimeUnitClass = interface(JEnumClass)
    ...
    {class} function &of(chronoUnit: JChronoUnit): JTimeUnit; cdecl;
  ...
  JTimeUnit = interface(JEnum)
    ...
    function convert(sourceDuration: Int64; sourceUnit: JTimeUnit): Int64; cdecl; overload;
    function convert(duration: Jtime_Duration): Int64; cdecl; overload;
    ...
    function toChronoUnit: JChronoUnit; cdecl;
  ...
  JAtomicBoolean = interface(JObject)
    ...
    function compareAndExchange(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function compareAndExchangeAcquire(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function compareAndExchangeRelease(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function compareAndSet(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function &get: Boolean; cdecl;
    function getAcquire: Boolean; cdecl;
    function getAndSet(newValue: Boolean): Boolean; cdecl;
    function getOpaque: Boolean; cdecl;
    function getPlain: Boolean; cdecl;
    procedure lazySet(newValue: Boolean); cdecl;
    procedure &set(newValue: Boolean); cdecl;
    procedure setOpaque(newValue: Boolean); cdecl;
    procedure setPlain(newValue: Boolean); cdecl;
    procedure setRelease(newValue: Boolean); cdecl;
    function toString: JString; cdecl;
    function weakCompareAndSet(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;//Deprecated
    function weakCompareAndSetAcquire(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function weakCompareAndSetPlain(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function weakCompareAndSetRelease(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
    function weakCompareAndSetVolatile(expectedValue: Boolean; newValue: Boolean): Boolean; cdecl;
  end;
  ...
  JAtomicReference = interface(JObject)
    ...
    function accumulateAndGet(x: JObject; accumulatorFunction: JBinaryOperator): JObject; cdecl;
    function compareAndExchange(expectedValue: JObject; newValue: JObject): JObject; cdecl;
    function compareAndExchangeAcquire(expectedValue: JObject; newValue: JObject): JObject; cdecl;
    function compareAndExchangeRelease(expectedValue: JObject; newValue: JObject): JObject; cdecl;
    function compareAndSet(expectedValue: JObject; newValue: JObject): Boolean; cdecl;
    function &get: JObject; cdecl;
    function getAcquire: JObject; cdecl;
    function getAndAccumulate(x: JObject; accumulatorFunction: JBinaryOperator): JObject; cdecl;
    function getAndSet(newValue: JObject): JObject; cdecl;
    function getAndUpdate(updateFunction: JUnaryOperator): JObject; cdecl;
    function getOpaque: JObject; cdecl;
    function getPlain: JObject; cdecl;
    procedure lazySet(newValue: JObject); cdecl;
    procedure &set(newValue: JObject); cdecl;
    procedure setOpaque(newValue: JObject); cdecl;
    procedure setPlain(newValue: JObject); cdecl;
    procedure setRelease(newValue: JObject); cdecl;
    function toString: JString; cdecl;
    function updateAndGet(updateFunction: JUnaryOperator): JObject; cdecl;
    function weakCompareAndSet(expectedValue: JObject; newValue: JObject): Boolean; cdecl;//Deprecated
    function weakCompareAndSetAcquire(expectedValue: JObject; newValue: JObject): Boolean; cdecl;
    function weakCompareAndSetPlain(expectedValue: JObject; newValue: JObject): Boolean; cdecl;
    function weakCompareAndSetRelease(expectedValue: JObject; newValue: JObject): Boolean; cdecl;
    function weakCompareAndSetVolatile(expectedValue: JObject; newValue: JObject): Boolean; cdecl;
  end;
  ...
  Jfunction_PredicateClass = interface(IJavaClass)
    ...
    {class} function &not(target: Jfunction_Predicate): Jfunction_Predicate; cdecl;
  end;
  ...
  JCipher = interface(JObject)
    ...
    function doFinal(output: TJavaArray<Byte>; outputOffset: Integer): Integer; cdecl; overload;
    ...
    function doFinal(input: TJavaArray<Byte>; inputOffset: Integer; inputLen: Integer; output: TJavaArray<Byte>; outputOffset: Integer): Integer; cdecl; overload;
    function doFinal(input: JByteBuffer; output: JByteBuffer): Integer; cdecl; overload;
    ...
    function getOutputSize(inputLen: Integer): Integer; cdecl;
    ...
    //procedure init(opmode: Integer; key: JKey; params: JAlgorithmParameterSpec; random: JSecureRandom); cdecl; overload;
    //procedure init(opmode: Integer; key: JKey; params: JAlgorithmParameters); cdecl; overload;
    //procedure init(opmode: Integer; key: JKey; params: JAlgorithmParameters; random: JSecureRandom); cdecl; overload;
    ...
    function update(input: TJavaArray<Byte>): TJavaArray<Byte>; cdecl; overload;
    function update(input: TJavaArray<Byte>; inputOffset: Integer; inputLen: Integer): TJavaArray<Byte>; cdecl; overload;
    function update(input: TJavaArray<Byte>; inputOffset: Integer; inputLen: Integer; output: TJavaArray<Byte>): Integer; cdecl; overload;
    function update(input: TJavaArray<Byte>; inputOffset: Integer; inputLen: Integer; output: TJavaArray<Byte>; outputOffset: Integer): Integer; cdecl; overload;
    function update(input: JByteBuffer; output: JByteBuffer): Integer; cdecl; overload;
    procedure updateAAD(src: TJavaArray<Byte>); cdecl; overload;
    procedure updateAAD(src: TJavaArray<Byte>; offset: Integer; len: Integer); cdecl; overload;
    procedure updateAAD(src: JByteBuffer); cdecl; overload;
    //function wrap(key: JKey): TJavaArray<Byte>; cdecl;
  end;
  ...
  JExemptionMechanism = interface(JObject)
    ...
    function genExemptionBlob(output: TJavaArray<Byte>): Integer; cdecl; overload;
    function genExemptionBlob(output: TJavaArray<Byte>; outputOffset: Integer): Integer; cdecl; overload;
    function getName: JString; cdecl;
    function getOutputSize(inputLen: Integer): Integer; cdecl;
    //function getProvider: JProvider; cdecl;
    //procedure init(key: JKey); cdecl; overload;
    //procedure init(key: JKey; params: JAlgorithmParameterSpec); cdecl; overload;
    //procedure init(key: JKey; params: JAlgorithmParameters); cdecl; overload;
  ...
  JJSONExceptionClass = interface(JExceptionClass)
    ...
    {class} function init(s: JString): JJSONException; cdecl; overload;
    {class} function init(message: JString; cause: JThrowable): JJSONException; cdecl; overload;
    {class} function init(cause: JThrowable): JJSONException; cdecl; overload;
  end;
  ...
  JJSONObject = interface(JObject)
    ...
    function append(name: JString; value: JObject): JJSONObject; cdecl;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JIllegalArgumentException', TypeInfo(Androidapi.JNI.JavaTypes.JIllegalArgumentException));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JThreadLocal', TypeInfo(Androidapi.JNI.JavaTypes.JThreadLocal));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JVoid', TypeInfo(Androidapi.JNI.JavaTypes.JVoid));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JAnnotation', TypeInfo(Androidapi.JNI.JavaTypes.JAnnotation));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JReference', TypeInfo(Androidapi.JNI.JavaTypes.JReference));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JReferenceQueue', TypeInfo(Androidapi.JNI.JavaTypes.JReferenceQueue));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JWeakReference', TypeInfo(Androidapi.JNI.JavaTypes.JWeakReference));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JStandardCharsets', TypeInfo(Androidapi.JNI.JavaTypes.JStandardCharsets));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JChronoUnit', TypeInfo(Androidapi.JNI.JavaTypes.JChronoUnit));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JCollections', TypeInfo(Androidapi.JNI.JavaTypes.JCollections));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JDeque', TypeInfo(Androidapi.JNI.JavaTypes.JDeque));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JEventListener', TypeInfo(Androidapi.JNI.JavaTypes.JEventListener));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JEventObject', TypeInfo(Androidapi.JNI.JavaTypes.JEventObject));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JMap_Entry', TypeInfo(Androidapi.JNI.JavaTypes.JMap_Entry));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JSortedMap', TypeInfo(Androidapi.JNI.JavaTypes.JSortedMap));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JNavigableMap', TypeInfo(Androidapi.JNI.JavaTypes.JNavigableMap));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JSet', TypeInfo(Androidapi.JNI.JavaTypes.JSet));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JSortedSet', TypeInfo(Androidapi.JNI.JavaTypes.JSortedSet));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JNavigableSet', TypeInfo(Androidapi.JNI.JavaTypes.JNavigableSet));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JScheduledExecutorService', TypeInfo(Androidapi.JNI.JavaTypes.JScheduledExecutorService));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JAtomicBoolean', TypeInfo(Androidapi.JNI.JavaTypes.JAtomicBoolean));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JAtomicReference', TypeInfo(Androidapi.JNI.JavaTypes.JAtomicReference));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JCipher', TypeInfo(Androidapi.JNI.JavaTypes.JCipher));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JExemptionMechanism', TypeInfo(Androidapi.JNI.JavaTypes.JExemptionMechanism));
  TRegTypes.RegisterType('Androidapi.JNI.JavaTypes.JMac', TypeInfo(Androidapi.JNI.JavaTypes.JMac));
