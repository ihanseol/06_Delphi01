...
// ===== Forward declarations =====
  ...
  JCallLog_Locations = interface;//android.provider.CallLog$Locations
  JCloudMediaProvider = interface;//android.provider.CloudMediaProvider
  JCloudMediaProvider_CloudMediaSurfaceController = interface;//android.provider.CloudMediaProvider$CloudMediaSurfaceController
  JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback = interface;//android.provider.CloudMediaProvider$CloudMediaSurfaceStateChangedCallback
  JCloudMediaProviderContract = interface;//android.provider.CloudMediaProviderContract
  JCloudMediaProviderContract_AlbumColumns = interface;//android.provider.CloudMediaProviderContract$AlbumColumns
  JCloudMediaProviderContract_MediaCollectionInfo = interface;//android.provider.CloudMediaProviderContract$MediaCollectionInfo
  JCloudMediaProviderContract_MediaColumns = interface;//android.provider.CloudMediaProviderContract$MediaColumns
  ...
  JContactsContract_SimAccount = interface;//android.provider.ContactsContract$SimAccount
  JContactsContract_SimContacts = interface;//android.provider.ContactsContract$SimContacts
  ...
  JMediaStore_DownloadColumns = interface;//android.provider.MediaStore$DownloadColumns
  JMediaStore_Downloads = interface;//android.provider.MediaStore$Downloads
  ...
  JMediaStore_PickerMediaColumns = interface;//android.provider.MediaStore$PickerMediaColumns
  ...
  JSettings_Panel = interface;//android.provider.Settings$Panel
  ...
  JSettingsSlicesContract = interface;//android.provider.SettingsSlicesContract
  JSimPhonebookContract = interface;//android.provider.SimPhonebookContract
  JSimPhonebookContract_ElementaryFiles = interface;//android.provider.SimPhonebookContract$ElementaryFiles
  JSimPhonebookContract_SimRecords = interface;//android.provider.SimPhonebookContract$SimRecords
  ...
  JTelephony_CarrierId = interface;//android.provider.Telephony$CarrierId
...
// ===== Interface declarations =====
  ...
  JAlarmClockClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_DISMISS_TIMER: JString; cdecl;
    ...
    {class} property ACTION_DISMISS_TIMER: JString read _GetACTION_DISMISS_TIMER;
  ...
  JCalendarContractClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_VIEW_MANAGED_PROFILE_CALENDAR_EVENT: JString; cdecl;
    {class} function _GetAUTHORITY: JString; cdecl;
    ...
    {class} function _GetEXTRA_EVENT_ID: JString; cdecl;
    {class} function startViewCalendarEventInManagedProfile(context: JContext; eventId: Int64; startMs: Int64; endMs: Int64; allDay: Boolean; flags: Integer): Boolean; cdecl;
    ...
    {class} property ACTION_VIEW_MANAGED_PROFILE_CALENDAR_EVENT: JString read _GetACTION_VIEW_MANAGED_PROFILE_CALENDAR_EVENT;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    ...
    {class} property EXTRA_EVENT_ID: JString read _GetEXTRA_EVENT_ID;
  end;
  ...
  JCalendarContract_InstancesClass = interface(JObjectClass)
    ...
    {class} function _GetENTERPRISE_CONTENT_BY_DAY_URI: Jnet_Uri; cdecl;
    {class} function _GetENTERPRISE_CONTENT_SEARCH_BY_DAY_URI: Jnet_Uri; cdecl;
    {class} function _GetENTERPRISE_CONTENT_SEARCH_URI: Jnet_Uri; cdecl;
    {class} function _GetENTERPRISE_CONTENT_URI: Jnet_Uri; cdecl;
    ...
    {class} property ENTERPRISE_CONTENT_BY_DAY_URI: Jnet_Uri read _GetENTERPRISE_CONTENT_BY_DAY_URI;
    {class} property ENTERPRISE_CONTENT_SEARCH_BY_DAY_URI: Jnet_Uri read _GetENTERPRISE_CONTENT_SEARCH_BY_DAY_URI;
    {class} property ENTERPRISE_CONTENT_SEARCH_URI: Jnet_Uri read _GetENTERPRISE_CONTENT_SEARCH_URI;
    {class} property ENTERPRISE_CONTENT_URI: Jnet_Uri read _GetENTERPRISE_CONTENT_URI;
  ...
  JCallLog_CallsClass = interface(JObjectClass)
    ...
    {class} function _GetAUTO_MISSED_EMERGENCY_CALL: Int64; cdecl;
    {class} function _GetAUTO_MISSED_MAXIMUM_DIALING: Int64; cdecl;
    {class} function _GetAUTO_MISSED_MAXIMUM_RINGING: Int64; cdecl;
    {class} function _GetBLOCKED_TYPE: Integer; cdecl;
    {class} function _GetBLOCK_REASON: JString; cdecl;
    {class} function _GetBLOCK_REASON_BLOCKED_NUMBER: Integer; cdecl;
    {class} function _GetBLOCK_REASON_CALL_SCREENING_SERVICE: Integer; cdecl;
    {class} function _GetBLOCK_REASON_DIRECT_TO_VOICEMAIL: Integer; cdecl;
    {class} function _GetBLOCK_REASON_NOT_BLOCKED: Integer; cdecl;
    {class} function _GetBLOCK_REASON_NOT_IN_CONTACTS: Integer; cdecl;
    {class} function _GetBLOCK_REASON_PAY_PHONE: Integer; cdecl;
    {class} function _GetBLOCK_REASON_RESTRICTED_NUMBER: Integer; cdecl;
    {class} function _GetBLOCK_REASON_UNKNOWN_NUMBER: Integer; cdecl;
    ...
    {class} function _GetCALL_SCREENING_APP_NAME: JString; cdecl;
    {class} function _GetCALL_SCREENING_COMPONENT_NAME: JString; cdecl;
    {class} function _GetCOMPOSER_PHOTO_URI: JString; cdecl;
    ...
    {class} function _GetFEATURES_ASSISTED_DIALING_USED: Integer; cdecl;
    {class} function _GetFEATURES_HD_CALL: Integer; cdecl;
    {class} function _GetFEATURES_PULLED_EXTERNALLY: Integer; cdecl;
    {class} function _GetFEATURES_RTT: Integer; cdecl;
    {class} function _GetFEATURES_VIDEO: Integer; cdecl;
    {class} function _GetFEATURES_VOLTE: Integer; cdecl;
    ...
    {class} function _GetMISSED_REASON: JString; cdecl;
    {class} function _GetMISSED_REASON_NOT_MISSED: Int64; cdecl;
    ...
    {class} function _GetPRESENTATION_UNAVAILABLE: Integer; cdecl;
    ...
    {class} function _GetPRIORITY_URGENT: Integer; cdecl;
    ...
    {class} function _GetUSER_MISSED_CALL_FILTERS_TIMEOUT: Int64; cdecl;
    {class} function _GetUSER_MISSED_CALL_SCREENING_SERVICE_SILENCED: Int64; cdecl;
    {class} function _GetUSER_MISSED_DND_MODE: Int64; cdecl;
    {class} function _GetUSER_MISSED_LOW_RING_VOLUME: Int64; cdecl;
    {class} function _GetUSER_MISSED_NO_ANSWER: Int64; cdecl;
    {class} function _GetUSER_MISSED_NO_VIBRATE: Int64; cdecl;
    {class} function _GetUSER_MISSED_SHORT_RING: Int64; cdecl;
    ...
    {class} property AUTO_MISSED_EMERGENCY_CALL: Int64 read _GetAUTO_MISSED_EMERGENCY_CALL;
    {class} property AUTO_MISSED_MAXIMUM_DIALING: Int64 read _GetAUTO_MISSED_MAXIMUM_DIALING;
    {class} property AUTO_MISSED_MAXIMUM_RINGING: Int64 read _GetAUTO_MISSED_MAXIMUM_RINGING;
    {class} property BLOCKED_TYPE: Integer read _GetBLOCKED_TYPE;
    {class} property BLOCK_REASON: JString read _GetBLOCK_REASON;
    {class} property BLOCK_REASON_BLOCKED_NUMBER: Integer read _GetBLOCK_REASON_BLOCKED_NUMBER;
    {class} property BLOCK_REASON_CALL_SCREENING_SERVICE: Integer read _GetBLOCK_REASON_CALL_SCREENING_SERVICE;
    {class} property BLOCK_REASON_DIRECT_TO_VOICEMAIL: Integer read _GetBLOCK_REASON_DIRECT_TO_VOICEMAIL;
    {class} property BLOCK_REASON_NOT_BLOCKED: Integer read _GetBLOCK_REASON_NOT_BLOCKED;
    {class} property BLOCK_REASON_NOT_IN_CONTACTS: Integer read _GetBLOCK_REASON_NOT_IN_CONTACTS;
    {class} property BLOCK_REASON_PAY_PHONE: Integer read _GetBLOCK_REASON_PAY_PHONE;
    {class} property BLOCK_REASON_RESTRICTED_NUMBER: Integer read _GetBLOCK_REASON_RESTRICTED_NUMBER;
    {class} property BLOCK_REASON_UNKNOWN_NUMBER: Integer read _GetBLOCK_REASON_UNKNOWN_NUMBER;
    ...
    {class} property CALL_SCREENING_APP_NAME: JString read _GetCALL_SCREENING_APP_NAME;
    {class} property CALL_SCREENING_COMPONENT_NAME: JString read _GetCALL_SCREENING_COMPONENT_NAME;
    {class} property COMPOSER_PHOTO_URI: JString read _GetCOMPOSER_PHOTO_URI;
    ...
    {class} property FEATURES_ASSISTED_DIALING_USED: Integer read _GetFEATURES_ASSISTED_DIALING_USED;
    ...
    {class} property FEATURES_RTT: Integer read _GetFEATURES_RTT;
    {class} property FEATURES_VIDEO: Integer read _GetFEATURES_VIDEO;
    {class} property FEATURES_VOLTE: Integer read _GetFEATURES_VOLTE;
    ...
    {class} property MISSED_REASON: JString read _GetMISSED_REASON;
    {class} property MISSED_REASON_NOT_MISSED: Int64 read _GetMISSED_REASON_NOT_MISSED;
    ...
    {class} property PRESENTATION_UNAVAILABLE: Integer read _GetPRESENTATION_UNAVAILABLE;
    ...
    {class} property PRIORITY_URGENT: Integer read _GetPRIORITY_URGENT;
    ...
    {class} property USER_MISSED_CALL_FILTERS_TIMEOUT: Int64 read _GetUSER_MISSED_CALL_FILTERS_TIMEOUT;
    {class} property USER_MISSED_CALL_SCREENING_SERVICE_SILENCED: Int64 read _GetUSER_MISSED_CALL_SCREENING_SERVICE_SILENCED;
    {class} property USER_MISSED_DND_MODE: Int64 read _GetUSER_MISSED_DND_MODE;
    {class} property USER_MISSED_LOW_RING_VOLUME: Int64 read _GetUSER_MISSED_LOW_RING_VOLUME;
    {class} property USER_MISSED_NO_ANSWER: Int64 read _GetUSER_MISSED_NO_ANSWER;
    {class} property USER_MISSED_NO_VIBRATE: Int64 read _GetUSER_MISSED_NO_VIBRATE;
    {class} property USER_MISSED_SHORT_RING: Int64 read _GetUSER_MISSED_SHORT_RING;
  ...
  JCallLog_LocationsClass = interface(JObjectClass)
    ['{D5B8BF25-01A8-46A3-A474-05E214F1AE16}']
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
  ...
  [JavaSignature('android/provider/CallLog$Locations')]
  JCallLog_Locations = interface(JObject)
    ['{F8E8AC38-307E-4567-9D77-2322DF7360F8}']
  end;
  TJCallLog_Locations = class(TJavaGenericImport<JCallLog_LocationsClass, JCallLog_Locations>) end;

  JCloudMediaProviderClass = interface(JContentProviderClass)
    ['{83CB575F-F64F-47FB-B78E-3DABDD54B8F2}']
    {class} function init: JCloudMediaProvider; cdecl;
  end;

  [JavaSignature('android/provider/CloudMediaProvider')]
  JCloudMediaProvider = interface(JContentProvider)
    ['{E028020A-24F5-4E23-99B4-9DC9BB92607C}']
    ...
    function onCreateCloudMediaSurfaceController(config: JBundle; callback: JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback): JCloudMediaProvider_CloudMediaSurfaceController; cdecl;
    function onGetMediaCollectionInfo(extras: JBundle): JBundle; cdecl;
    function onOpenMedia(mediaId: JString; extras: JBundle; signal: JCancellationSignal): JParcelFileDescriptor; cdecl;
    function onOpenPreview(mediaId: JString; size: JPoint; extras: JBundle; signal: JCancellationSignal): JAssetFileDescriptor; cdecl;
    function onQueryAlbums(extras: JBundle): JCursor; cdecl;
    function onQueryDeletedMedia(extras: JBundle): JCursor; cdecl;
    function onQueryMedia(extras: JBundle): JCursor; cdecl;
  ...
  TJCloudMediaProvider = class(TJavaGenericImport<JCloudMediaProviderClass, JCloudMediaProvider>) end;

  JCloudMediaProvider_CloudMediaSurfaceControllerClass = interface(JObjectClass)
    ['{590BD664-BFF5-4D5E-AFD0-E6D1E62D2459}']
    {class} function init: JCloudMediaProvider_CloudMediaSurfaceController; cdecl;
  end;

  [JavaSignature('android/provider/CloudMediaProvider$CloudMediaSurfaceController')]
  JCloudMediaProvider_CloudMediaSurfaceController = interface(JObject)
    ['{3D1659FD-8D5C-4B10-BAFF-F91581CB9440}']
    procedure onConfigChange(config: JBundle); cdecl;
    procedure onDestroy; cdecl;
    procedure onMediaPause(surfaceId: Integer); cdecl;
    procedure onMediaPlay(surfaceId: Integer); cdecl;
    procedure onMediaSeekTo(surfaceId: Integer; timestampMillis: Int64); cdecl;
    procedure onPlayerCreate; cdecl;
    procedure onPlayerRelease; cdecl;
    procedure onSurfaceChanged(surfaceId: Integer; format: Integer; width: Integer; height: Integer); cdecl;
    procedure onSurfaceCreated(surfaceId: Integer; surface: JSurface; mediaId: JString); cdecl;
    procedure onSurfaceDestroyed(surfaceId: Integer); cdecl;
  end;
  TJCloudMediaProvider_CloudMediaSurfaceController = class(TJavaGenericImport<JCloudMediaProvider_CloudMediaSurfaceControllerClass, JCloudMediaProvider_CloudMediaSurfaceController>) end;

  JCloudMediaProvider_CloudMediaSurfaceStateChangedCallbackClass = interface(JObjectClass)
    ['{B1D63D2E-0D29-462E-B036-356557010F75}']
    {class} function _GetPLAYBACK_STATE_BUFFERING: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_COMPLETED: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_ERROR_PERMANENT_FAILURE: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_ERROR_RETRIABLE_FAILURE: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_MEDIA_SIZE_CHANGED: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_PAUSED: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_READY: Integer; cdecl;
    {class} function _GetPLAYBACK_STATE_STARTED: Integer; cdecl;
    {class} property PLAYBACK_STATE_BUFFERING: Integer read _GetPLAYBACK_STATE_BUFFERING;
    {class} property PLAYBACK_STATE_COMPLETED: Integer read _GetPLAYBACK_STATE_COMPLETED;
    {class} property PLAYBACK_STATE_ERROR_PERMANENT_FAILURE: Integer read _GetPLAYBACK_STATE_ERROR_PERMANENT_FAILURE;
    {class} property PLAYBACK_STATE_ERROR_RETRIABLE_FAILURE: Integer read _GetPLAYBACK_STATE_ERROR_RETRIABLE_FAILURE;
    {class} property PLAYBACK_STATE_MEDIA_SIZE_CHANGED: Integer read _GetPLAYBACK_STATE_MEDIA_SIZE_CHANGED;
    ...
    {class} property PLAYBACK_STATE_STARTED: Integer read _GetPLAYBACK_STATE_STARTED;
  end;

  [JavaSignature('android/provider/CloudMediaProvider$CloudMediaSurfaceStateChangedCallback')]
  JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback = interface(JObject)
    ['{CF8233CC-1E1A-48D5-8FB6-45EBCA9D69D3}']
    procedure setPlaybackState(surfaceId: Integer; playbackState: Integer; playbackStateInfo: JBundle); cdecl;
  end;
  TJCloudMediaProvider_CloudMediaSurfaceStateChangedCallback = class(TJavaGenericImport<JCloudMediaProvider_CloudMediaSurfaceStateChangedCallbackClass, JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback>) end;

  JCloudMediaProviderContractClass = interface(JObjectClass)
    ['{ABFE2F13-72B7-4E89-ADB5-CA3C892ED00D}']
    {class} function _GetEXTRA_ALBUM_ID: JString; cdecl;
    {class} function _GetEXTRA_LOOPING_PLAYBACK_ENABLED: JString; cdecl;
    {class} function _GetEXTRA_MEDIA_COLLECTION_ID: JString; cdecl;
    {class} function _GetEXTRA_PAGE_TOKEN: JString; cdecl;
    {class} function _GetEXTRA_PREVIEW_THUMBNAIL: JString; cdecl;
    {class} function _GetEXTRA_SURFACE_CONTROLLER_AUDIO_MUTE_ENABLED: JString; cdecl;
    {class} function _GetEXTRA_SYNC_GENERATION: JString; cdecl;
    {class} function _GetMANAGE_CLOUD_MEDIA_PROVIDERS_PERMISSION: JString; cdecl;
    {class} function _GetPROVIDER_INTERFACE: JString; cdecl;
    {class} property EXTRA_ALBUM_ID: JString read _GetEXTRA_ALBUM_ID;
    {class} property EXTRA_LOOPING_PLAYBACK_ENABLED: JString read _GetEXTRA_LOOPING_PLAYBACK_ENABLED;
    {class} property EXTRA_MEDIA_COLLECTION_ID: JString read _GetEXTRA_MEDIA_COLLECTION_ID;
    {class} property EXTRA_PAGE_TOKEN: JString read _GetEXTRA_PAGE_TOKEN;
    {class} property EXTRA_PREVIEW_THUMBNAIL: JString read _GetEXTRA_PREVIEW_THUMBNAIL;
    {class} property EXTRA_SURFACE_CONTROLLER_AUDIO_MUTE_ENABLED: JString read _GetEXTRA_SURFACE_CONTROLLER_AUDIO_MUTE_ENABLED;
    {class} property EXTRA_SYNC_GENERATION: JString read _GetEXTRA_SYNC_GENERATION;
    {class} property MANAGE_CLOUD_MEDIA_PROVIDERS_PERMISSION: JString read _GetMANAGE_CLOUD_MEDIA_PROVIDERS_PERMISSION;
    {class} property PROVIDER_INTERFACE: JString read _GetPROVIDER_INTERFACE;
  end;

  [JavaSignature('android/provider/CloudMediaProviderContract')]
  JCloudMediaProviderContract = interface(JObject)
    ['{31FAEE27-403B-4240-BA92-95C486F848A8}']
  end;
  TJCloudMediaProviderContract = class(TJavaGenericImport<JCloudMediaProviderContractClass, JCloudMediaProviderContract>) end;

  JCloudMediaProviderContract_AlbumColumnsClass = interface(JObjectClass)
    ['{A3BAF329-A708-422E-BBA8-CA3A28123EF1}']
    {class} function _GetDATE_TAKEN_MILLIS: JString; cdecl;
    {class} function _GetDISPLAY_NAME: JString; cdecl;
    {class} function _GetID: JString; cdecl;
    {class} function _GetMEDIA_COUNT: JString; cdecl;
    {class} function _GetMEDIA_COVER_ID: JString; cdecl;
    {class} property DATE_TAKEN_MILLIS: JString read _GetDATE_TAKEN_MILLIS;
    {class} property DISPLAY_NAME: JString read _GetDISPLAY_NAME;
    {class} property ID: JString read _GetID;
    {class} property MEDIA_COUNT: JString read _GetMEDIA_COUNT;
    {class} property MEDIA_COVER_ID: JString read _GetMEDIA_COVER_ID;
  end;

  [JavaSignature('android/provider/CloudMediaProviderContract$AlbumColumns')]
  JCloudMediaProviderContract_AlbumColumns = interface(JObject)
    ['{A059AE57-3D8D-4A09-AE0E-560A4752B762}']
  end;
  TJCloudMediaProviderContract_AlbumColumns = class(TJavaGenericImport<JCloudMediaProviderContract_AlbumColumnsClass, JCloudMediaProviderContract_AlbumColumns>) end;

  JCloudMediaProviderContract_MediaCollectionInfoClass = interface(JObjectClass)
    ['{56733E43-6EE4-4830-B439-E83D98C24C4F}']
    {class} function _GetACCOUNT_CONFIGURATION_INTENT: JString; cdecl;
    {class} function _GetACCOUNT_NAME: JString; cdecl;
    {class} function _GetLAST_MEDIA_SYNC_GENERATION: JString; cdecl;
    {class} function _GetMEDIA_COLLECTION_ID: JString; cdecl;
    {class} property ACCOUNT_CONFIGURATION_INTENT: JString read _GetACCOUNT_CONFIGURATION_INTENT;
    {class} property ACCOUNT_NAME: JString read _GetACCOUNT_NAME;
    {class} property LAST_MEDIA_SYNC_GENERATION: JString read _GetLAST_MEDIA_SYNC_GENERATION;
    {class} property MEDIA_COLLECTION_ID: JString read _GetMEDIA_COLLECTION_ID;
  end;

  [JavaSignature('android/provider/CloudMediaProviderContract$MediaCollectionInfo')]
  JCloudMediaProviderContract_MediaCollectionInfo = interface(JObject)
    ['{E1D0A620-68EB-43F8-942A-0BD77E1968C3}']
  end;
  TJCloudMediaProviderContract_MediaCollectionInfo = class(TJavaGenericImport<JCloudMediaProviderContract_MediaCollectionInfoClass, JCloudMediaProviderContract_MediaCollectionInfo>) end;

  JCloudMediaProviderContract_MediaColumnsClass = interface(JObjectClass)
    ['{1969DB78-E5D7-4393-94E4-8208354F7C27}']
    {class} function _GetDATE_TAKEN_MILLIS: JString; cdecl;
    {class} function _GetDURATION_MILLIS: JString; cdecl;
    {class} function _GetID: JString; cdecl;
    {class} function _GetIS_FAVORITE: JString; cdecl;
    {class} function _GetMEDIA_STORE_URI: JString; cdecl;
    {class} function _GetMIME_TYPE: JString; cdecl;
    {class} function _GetSIZE_BYTES: JString; cdecl;
    {class} function _GetSTANDARD_MIME_TYPE_EXTENSION: JString; cdecl;
    {class} function _GetSTANDARD_MIME_TYPE_EXTENSION_ANIMATED_WEBP: Integer; cdecl;
    {class} function _GetSTANDARD_MIME_TYPE_EXTENSION_GIF: Integer; cdecl;
    {class} function _GetSTANDARD_MIME_TYPE_EXTENSION_MOTION_PHOTO: Integer; cdecl;
    {class} function _GetSTANDARD_MIME_TYPE_EXTENSION_NONE: Integer; cdecl;
    {class} function _GetSYNC_GENERATION: JString; cdecl;
    {class} property DATE_TAKEN_MILLIS: JString read _GetDATE_TAKEN_MILLIS;
    {class} property DURATION_MILLIS: JString read _GetDURATION_MILLIS;
    {class} property ID: JString read _GetID;
    {class} property IS_FAVORITE: JString read _GetIS_FAVORITE;
    {class} property MEDIA_STORE_URI: JString read _GetMEDIA_STORE_URI;
    {class} property MIME_TYPE: JString read _GetMIME_TYPE;
    {class} property SIZE_BYTES: JString read _GetSIZE_BYTES;
    {class} property STANDARD_MIME_TYPE_EXTENSION: JString read _GetSTANDARD_MIME_TYPE_EXTENSION;
    {class} property STANDARD_MIME_TYPE_EXTENSION_ANIMATED_WEBP: Integer read _GetSTANDARD_MIME_TYPE_EXTENSION_ANIMATED_WEBP;
    {class} property STANDARD_MIME_TYPE_EXTENSION_GIF: Integer read _GetSTANDARD_MIME_TYPE_EXTENSION_GIF;
    {class} property STANDARD_MIME_TYPE_EXTENSION_MOTION_PHOTO: Integer read _GetSTANDARD_MIME_TYPE_EXTENSION_MOTION_PHOTO;
    {class} property STANDARD_MIME_TYPE_EXTENSION_NONE: Integer read _GetSTANDARD_MIME_TYPE_EXTENSION_NONE;
    {class} property SYNC_GENERATION: JString read _GetSYNC_GENERATION;
  end;

  [JavaSignature('android/provider/CloudMediaProviderContract$MediaColumns')]
  JCloudMediaProviderContract_MediaColumns = interface(JObject)
    ['{B602C518-BA6C-4FEC-9B52-8F9672FD6215}']
  end;
  TJCloudMediaProviderContract_MediaColumns = class(TJavaGenericImport<JCloudMediaProviderContract_MediaColumnsClass, JCloudMediaProviderContract_MediaColumns>) end;
  ...
  JContactsContract_ProfileSyncStateClass = interface(JObjectClass)
    ...
    {class} function getWithUri(provider: JContentProviderClient; account: JAccount): JPair; cdecl;
  ...
  JContactsContract_RawContactsClass = interface(JObjectClass)
    ...
    {class} function getLocalAccountName(context: JContext): JString; cdecl;
    {class} function getLocalAccountType(context: JContext): JString; cdecl;
    {class} function newEntityIterator(cursor: JCursor): JEntityIterator; cdecl;
  ...
  JContactsContract_SettingsClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_SET_DEFAULT_ACCOUNT: JString; cdecl;
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function getDefaultAccount(resolver: JContentResolver): JAccount; cdecl;
    {class} property ACTION_SET_DEFAULT_ACCOUNT: JString read _GetACTION_SET_DEFAULT_ACCOUNT;
    {class} property CONTENT_ITEM_TYPE: JString read _GetCONTENT_ITEM_TYPE;
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
  end;
  ...
  JContactsContract_SimAccountClass = interface(JObjectClass)
    ['{7C5BC270-4D17-4374-B695-85F85C075504}']
    {class} function _GetADN_EF_TYPE: Integer; cdecl;
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function _GetFDN_EF_TYPE: Integer; cdecl;
    {class} function _GetSDN_EF_TYPE: Integer; cdecl;
    {class} function _GetUNKNOWN_EF_TYPE: Integer; cdecl;
    {class} property ADN_EF_TYPE: Integer read _GetADN_EF_TYPE;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
    {class} property FDN_EF_TYPE: Integer read _GetFDN_EF_TYPE;
    {class} property SDN_EF_TYPE: Integer read _GetSDN_EF_TYPE;
    {class} property UNKNOWN_EF_TYPE: Integer read _GetUNKNOWN_EF_TYPE;
  end;

  [JavaSignature('android/provider/ContactsContract$SimAccount')]
  JContactsContract_SimAccount = interface(JObject)
    ['{A9735180-C1E1-4B69-B7A7-AB72997B38E9}']
    function describeContents: Integer; cdecl;
    function equals(obj: JObject): Boolean; cdecl;
    function getAccountName: JString; cdecl;
    function getAccountType: JString; cdecl;
    function getEfType: Integer; cdecl;
    function getSimSlotIndex: Integer; cdecl;
    function hashCode: Integer; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJContactsContract_SimAccount = class(TJavaGenericImport<JContactsContract_SimAccountClass, JContactsContract_SimAccount>) end;

  JContactsContract_SimContactsClass = interface(JObjectClass)
    ['{28341977-8002-4E3D-8125-BE25589CE18D}']
    {class} function _GetACTION_SIM_ACCOUNTS_CHANGED: JString; cdecl;
    {class} function getSimAccounts(contentResolver: JContentResolver): JList; cdecl;
    {class} property ACTION_SIM_ACCOUNTS_CHANGED: JString read _GetACTION_SIM_ACCOUNTS_CHANGED;
  end;

  [JavaSignature('android/provider/ContactsContract$SimContacts')]
  JContactsContract_SimContacts = interface(JObject)
    ['{1BC00FFD-DDA1-4207-962C-8D20644BE949}']
  end;
  TJContactsContract_SimContacts = class(TJavaGenericImport<JContactsContract_SimContactsClass, JContactsContract_SimContacts>) end;
  ...
  JContactsContract_StreamItemsClass = interface(JObjectClass)
    ...
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_LIMIT_URI: Jnet_Uri; cdecl;
    {class} function _GetCONTENT_PHOTO_URI: Jnet_Uri; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetMAX_ITEMS: JString; cdecl;
    {class} property CONTENT_ITEM_TYPE: JString read _GetCONTENT_ITEM_TYPE;
    {class} property CONTENT_LIMIT_URI: Jnet_Uri read _GetCONTENT_LIMIT_URI;
    {class} property CONTENT_PHOTO_URI: Jnet_Uri read _GetCONTENT_PHOTO_URI;
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property MAX_ITEMS: JString read _GetMAX_ITEMS;
  end;
  ...
  JDocumentsContractClass = interface(JObjectClass)
    ...
    {class} function _GetMETADATA_EXIF: JString; cdecl;
    {class} function _GetMETADATA_TREE_COUNT: JString; cdecl;
    {class} function _GetMETADATA_TREE_SIZE: JString; cdecl;
    {class} function _GetMETADATA_TYPES: JString; cdecl;
    {class} function _GetPROVIDER_INTERFACE: JString; cdecl;
    {class} function _GetQUERY_ARG_DISPLAY_NAME: JString; cdecl;
    {class} function _GetQUERY_ARG_EXCLUDE_MEDIA: JString; cdecl;
    {class} function _GetQUERY_ARG_FILE_SIZE_OVER: JString; cdecl;
    {class} function _GetQUERY_ARG_LAST_MODIFIED_AFTER: JString; cdecl;
    {class} function _GetQUERY_ARG_MIME_TYPES: JString; cdecl;
    ...
    {class} function copyDocument(content: JContentResolver; sourceDocumentUri: Jnet_Uri; targetParentDocumentUri: Jnet_Uri): Jnet_Uri; cdecl;
    {class} function createDocument(content: JContentResolver; parentDocumentUri: Jnet_Uri; mimeType: JString; displayName: JString): Jnet_Uri; cdecl;
    {class} function createWebLinkIntent(content: JContentResolver; uri: Jnet_Uri; options: JBundle): JIntentSender; cdecl;
    {class} function deleteDocument(content: JContentResolver; documentUri: Jnet_Uri): Boolean; cdecl;
    {class} procedure ejectRoot(content: JContentResolver; rootUri: Jnet_Uri); cdecl;
    {class} function findDocumentPath(content: JContentResolver; treeUri: Jnet_Uri): JDocumentsContract_Path; cdecl;
    {class} function getDocumentId(documentUri: Jnet_Uri): JString; cdecl;
    {class} function getDocumentMetadata(content: JContentResolver; documentUri: Jnet_Uri): JBundle; cdecl;
    {class} function getDocumentThumbnail(content: JContentResolver; documentUri: Jnet_Uri; size: JPoint; signal: JCancellationSignal): JBitmap; cdecl;
    ...
    {class} function isChildDocument(content: JContentResolver; parentDocumentUri: Jnet_Uri; childDocumentUri: Jnet_Uri): Boolean; cdecl;
    {class} function isDocumentUri(context: JContext; uri: Jnet_Uri): Boolean; cdecl;
    {class} function isRootUri(context: JContext; uri: Jnet_Uri): Boolean; cdecl;
    {class} function isRootsUri(context: JContext; uri: Jnet_Uri): Boolean; cdecl;
    {class} function isTreeUri(uri: Jnet_Uri): Boolean; cdecl;
    {class} function moveDocument(content: JContentResolver; sourceDocumentUri: Jnet_Uri; sourceParentDocumentUri: Jnet_Uri; targetParentDocumentUri: Jnet_Uri): Jnet_Uri; cdecl;
    {class} function removeDocument(content: JContentResolver; documentUri: Jnet_Uri; parentDocumentUri: Jnet_Uri): Boolean; cdecl;
    {class} function renameDocument(content: JContentResolver; documentUri: Jnet_Uri; displayName: JString): Jnet_Uri; cdecl;
    ...
    {class} property METADATA_EXIF: JString read _GetMETADATA_EXIF;
    {class} property METADATA_TREE_COUNT: JString read _GetMETADATA_TREE_COUNT;
    {class} property METADATA_TREE_SIZE: JString read _GetMETADATA_TREE_SIZE;
    {class} property METADATA_TYPES: JString read _GetMETADATA_TYPES;
    {class} property PROVIDER_INTERFACE: JString read _GetPROVIDER_INTERFACE;
    {class} property QUERY_ARG_DISPLAY_NAME: JString read _GetQUERY_ARG_DISPLAY_NAME;
    {class} property QUERY_ARG_EXCLUDE_MEDIA: JString read _GetQUERY_ARG_EXCLUDE_MEDIA;
    {class} property QUERY_ARG_FILE_SIZE_OVER: JString read _GetQUERY_ARG_FILE_SIZE_OVER;
    {class} property QUERY_ARG_LAST_MODIFIED_AFTER: JString read _GetQUERY_ARG_LAST_MODIFIED_AFTER;
    {class} property QUERY_ARG_MIME_TYPES: JString read _GetQUERY_ARG_MIME_TYPES;
  end;
  ...
  JDocumentsContract_DocumentClass = interface(JObjectClass)
    ...
    {class} function _GetFLAG_DIR_BLOCKS_OPEN_DOCUMENT_TREE: Integer; cdecl;
    ...
    {class} property FLAG_DIR_BLOCKS_OPEN_DOCUMENT_TREE: Integer read _GetFLAG_DIR_BLOCKS_OPEN_DOCUMENT_TREE;
    ...
    {class} property FLAG_PARTIAL: Integer read _GetFLAG_PARTIAL;
    ...
    {class} property FLAG_SUPPORTS_METADATA: Integer read _GetFLAG_SUPPORTS_METADATA;
  ...
  JDocumentsContract_RootClass = interface(JObjectClass)
    ...
    {class} function _GetCOLUMN_QUERY_ARGS: JString; cdecl;
    ...
    {class} property COLUMN_QUERY_ARGS: JString read _GetCOLUMN_QUERY_ARGS;
  ...
  JDocumentsProvider = interface(JContentProvider)
    ...
    function getDocumentMetadata(documentId: JString): JBundle; cdecl;
    ...
    function queryRecentDocuments(rootId: JString; projection: TJavaObjectArray<JString>): JCursor; cdecl; overload;
    function queryRecentDocuments(rootId: JString; projection: TJavaObjectArray<JString>; queryArgs: JBundle; signal: JCancellationSignal): JCursor; cdecl; overload;
    function queryRoots(projection: TJavaObjectArray<JString>): JCursor; cdecl;
    function querySearchDocuments(rootId: JString; query: JString; projection: TJavaObjectArray<JString>): JCursor; cdecl; overload;
    function querySearchDocuments(rootId: JString; projection: TJavaObjectArray<JString>; queryArgs: JBundle): JCursor; cdecl; overload;
  ...
  JMediaStoreClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_PICK_IMAGES: JString; cdecl;
    {class} function _GetACTION_PICK_IMAGES_SETTINGS: JString; cdecl;
    {class} function _GetACTION_REVIEW: JString; cdecl;
    {class} function _GetACTION_REVIEW_SECURE: JString; cdecl;
    {class} function _GetACTION_VIDEO_CAPTURE: JString; cdecl;
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetAUTHORITY_URI: Jnet_Uri; cdecl;
    {class} function _GetEXTRA_ACCEPT_ORIGINAL_MEDIA_FORMAT: JString; cdecl;
    {class} function _GetEXTRA_BRIGHTNESS: JString; cdecl;
    ...
    {class} function _GetEXTRA_MEDIA_CAPABILITIES: JString; cdecl;
    {class} function _GetEXTRA_MEDIA_CAPABILITIES_UID: JString; cdecl;
    ...
    {class} function _GetEXTRA_PICK_IMAGES_MAX: JString; cdecl;
    ...
    {class} function _GetMATCH_DEFAULT: Integer; cdecl;
    {class} function _GetMATCH_EXCLUDE: Integer; cdecl;
    {class} function _GetMATCH_INCLUDE: Integer; cdecl;
    {class} function _GetMATCH_ONLY: Integer; cdecl;
    {class} function _GetMEDIA_IGNORE_FILENAME: JString; cdecl;
    {class} function _GetMEDIA_SCANNER_VOLUME: JString; cdecl;
    {class} function _GetMETA_DATA_REVIEW_GALLERY_PREWARM_SERVICE: JString; cdecl;
    {class} function _GetMETA_DATA_STILL_IMAGE_CAMERA_PREWARM_SERVICE: JString; cdecl;
    {class} function _GetQUERY_ARG_INCLUDE_RECENTLY_UNMOUNTED_VOLUMES: JString; cdecl;
    {class} function _GetQUERY_ARG_MATCH_FAVORITE: JString; cdecl;
    {class} function _GetQUERY_ARG_MATCH_PENDING: JString; cdecl;
    {class} function _GetQUERY_ARG_MATCH_TRASHED: JString; cdecl;
    {class} function _GetQUERY_ARG_RELATED_URI: JString; cdecl;
    {class} function _GetUNKNOWN_STRING: JString; cdecl;
    {class} function _GetVOLUME_EXTERNAL: JString; cdecl;
    {class} function _GetVOLUME_EXTERNAL_PRIMARY: JString; cdecl;
    {class} function _GetVOLUME_INTERNAL: JString; cdecl;
    {class} function init: JMediaStore; cdecl;
    {class} function canManageMedia(context: JContext): Boolean; cdecl;
    {class} function createDeleteRequest(resolver: JContentResolver; uris: JCollection): JPendingIntent; cdecl;
    {class} function createFavoriteRequest(resolver: JContentResolver; uris: JCollection; value: Boolean): JPendingIntent; cdecl;
    {class} function createTrashRequest(resolver: JContentResolver; uris: JCollection; value: Boolean): JPendingIntent; cdecl;
    {class} function createWriteRequest(resolver: JContentResolver; uris: JCollection): JPendingIntent; cdecl;
    {class} function getDocumentUri(context: JContext; mediaUri: Jnet_Uri): Jnet_Uri; cdecl;
    {class} function getExternalVolumeNames(context: JContext): JSet; cdecl;
    {class} function getGeneration(context: JContext; volumeName: JString): Int64; cdecl;
    {class} function getMediaScannerUri: Jnet_Uri; cdecl;
    {class} function getMediaUri(context: JContext; documentUri: Jnet_Uri): Jnet_Uri; cdecl;
    {class} function getOriginalMediaFormatFileDescriptor(context: JContext; fileDescriptor: JParcelFileDescriptor): JParcelFileDescriptor; cdecl;
    {class} function getPickImagesMaxLimit: Integer; cdecl;
    {class} function getRecentExternalVolumeNames(context: JContext): JSet; cdecl;
    {class} function getRedactedUri(resolver: JContentResolver; uri: Jnet_Uri): Jnet_Uri; cdecl; overload;
    {class} function getRedactedUri(resolver: JContentResolver; uris: JList): JList; cdecl; overload;
    {class} function getRequireOriginal(uri: Jnet_Uri): Boolean; cdecl;
    {class} function getVersion(context: JContext): JString; cdecl; overload;
    {class} function getVersion(context: JContext; volumeName: JString): JString; cdecl; overload;
    {class} function getVolumeName(uri: Jnet_Uri): JString; cdecl;
    {class} function isCurrentCloudMediaProviderAuthority(resolver: JContentResolver; authority: JString): Boolean; cdecl;
    {class} function isCurrentSystemGallery(resolver: JContentResolver; uid: Integer; packageName: JString): Boolean; cdecl;
    {class} function isSupportedCloudMediaProviderAuthority(resolver: JContentResolver; authority: JString): Boolean; cdecl;
    {class} procedure notifyCloudMediaChangedEvent(resolver: JContentResolver; authority: JString; currentMediaCollectionId: JString); cdecl;
    {class} function setIncludePending(uri: Jnet_Uri): Jnet_Uri; cdecl;//Deprecated
    {class} function setRequireOriginal(uri: Jnet_Uri): Jnet_Uri; cdecl;
    ...
    {class} property ACTION_PICK_IMAGES: JString read _GetACTION_PICK_IMAGES;
    {class} property ACTION_PICK_IMAGES_SETTINGS: JString read _GetACTION_PICK_IMAGES_SETTINGS;
    {class} property ACTION_REVIEW: JString read _GetACTION_REVIEW;
    {class} property ACTION_REVIEW_SECURE: JString read _GetACTION_REVIEW_SECURE;
    {class} property ACTION_VIDEO_CAPTURE: JString read _GetACTION_VIDEO_CAPTURE;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property AUTHORITY_URI: Jnet_Uri read _GetAUTHORITY_URI;
    {class} property EXTRA_ACCEPT_ORIGINAL_MEDIA_FORMAT: JString read _GetEXTRA_ACCEPT_ORIGINAL_MEDIA_FORMAT;
    {class} property EXTRA_BRIGHTNESS: JString read _GetEXTRA_BRIGHTNESS;
    ...
    {class} property EXTRA_MEDIA_CAPABILITIES: JString read _GetEXTRA_MEDIA_CAPABILITIES;
    {class} property EXTRA_MEDIA_CAPABILITIES_UID: JString read _GetEXTRA_MEDIA_CAPABILITIES_UID;
    ...
    {class} property EXTRA_PICK_IMAGES_MAX: JString read _GetEXTRA_PICK_IMAGES_MAX;
    ...
    {class} property MATCH_DEFAULT: Integer read _GetMATCH_DEFAULT;
    {class} property MATCH_EXCLUDE: Integer read _GetMATCH_EXCLUDE;
    {class} property MATCH_INCLUDE: Integer read _GetMATCH_INCLUDE;
    {class} property MATCH_ONLY: Integer read _GetMATCH_ONLY;
    ...
    {class} property META_DATA_REVIEW_GALLERY_PREWARM_SERVICE: JString read _GetMETA_DATA_REVIEW_GALLERY_PREWARM_SERVICE;
    ...
    {class} property QUERY_ARG_INCLUDE_RECENTLY_UNMOUNTED_VOLUMES: JString read _GetQUERY_ARG_INCLUDE_RECENTLY_UNMOUNTED_VOLUMES;
    {class} property QUERY_ARG_MATCH_FAVORITE: JString read _GetQUERY_ARG_MATCH_FAVORITE;
    {class} property QUERY_ARG_MATCH_PENDING: JString read _GetQUERY_ARG_MATCH_PENDING;
    {class} property QUERY_ARG_MATCH_TRASHED: JString read _GetQUERY_ARG_MATCH_TRASHED;
    {class} property QUERY_ARG_RELATED_URI: JString read _GetQUERY_ARG_RELATED_URI;
    {class} property UNKNOWN_STRING: JString read _GetUNKNOWN_STRING;
    {class} property VOLUME_EXTERNAL: JString read _GetVOLUME_EXTERNAL;
    {class} property VOLUME_EXTERNAL_PRIMARY: JString read _GetVOLUME_EXTERNAL_PRIMARY;
    {class} property VOLUME_INTERNAL: JString read _GetVOLUME_INTERNAL;
  end;
  ...
  JMediaStore_AudioClass = interface(JObjectClass)
    ...
    {class} function keyFor(name: JString): JString; cdecl;//Deprecated
  end;
  ...
  JMediaStore_MediaColumnsClass = interface(JBaseColumnsClass)
    ...
    {class} function _GetALBUM: JString; cdecl;
    {class} function _GetALBUM_ARTIST: JString; cdecl;
    {class} function _GetARTIST: JString; cdecl;
    {class} function _GetAUTHOR: JString; cdecl;
    {class} function _GetBITRATE: JString; cdecl;
    {class} function _GetBUCKET_DISPLAY_NAME: JString; cdecl;
    {class} function _GetBUCKET_ID: JString; cdecl;
    {class} function _GetCAPTURE_FRAMERATE: JString; cdecl;
    {class} function _GetCD_TRACK_NUMBER: JString; cdecl;
    {class} function _GetCOMPILATION: JString; cdecl;
    {class} function _GetCOMPOSER: JString; cdecl;
    {class} function _GetDATA: JString; cdecl;
    {class} function _GetDATE_ADDED: JString; cdecl;
    {class} function _GetDATE_EXPIRES: JString; cdecl;
    {class} function _GetDATE_MODIFIED: JString; cdecl;
    {class} function _GetDATE_TAKEN: JString; cdecl;
    {class} function _GetDISC_NUMBER: JString; cdecl;
    {class} function _GetDISPLAY_NAME: JString; cdecl;
    {class} function _GetDOCUMENT_ID: JString; cdecl;
    {class} function _GetDURATION: JString; cdecl;
    {class} function _GetGENERATION_ADDED: JString; cdecl;
    {class} function _GetGENERATION_MODIFIED: JString; cdecl;
    {class} function _GetGENRE: JString; cdecl;
    {class} function _GetGROUP_ID: JString; cdecl;
    {class} function _GetHEIGHT: JString; cdecl;
    {class} function _GetINSTANCE_ID: JString; cdecl;
    {class} function _GetIS_DOWNLOAD: JString; cdecl;
    {class} function _GetIS_DRM: JString; cdecl;
    {class} function _GetIS_FAVORITE: JString; cdecl;
    {class} function _GetIS_PENDING: JString; cdecl;
    {class} function _GetIS_TRASHED: JString; cdecl;
    {class} function _GetMIME_TYPE: JString; cdecl;
    {class} function _GetNUM_TRACKS: JString; cdecl;
    {class} function _GetORIENTATION: JString; cdecl;
    {class} function _GetORIGINAL_DOCUMENT_ID: JString; cdecl;
    {class} function _GetOWNER_PACKAGE_NAME: JString; cdecl;
    {class} function _GetRELATIVE_PATH: JString; cdecl;
    {class} function _GetRESOLUTION: JString; cdecl;
    {class} function _GetSIZE: JString; cdecl;
    {class} function _GetTITLE: JString; cdecl;
    {class} function _GetVOLUME_NAME: JString; cdecl;
    {class} function _GetWIDTH: JString; cdecl;
    {class} function _GetWRITER: JString; cdecl;
    {class} function _GetXMP: JString; cdecl;
    {class} function _GetYEAR: JString; cdecl;
    {class} property ALBUM: JString read _GetALBUM;
    {class} property ALBUM_ARTIST: JString read _GetALBUM_ARTIST;
    {class} property ARTIST: JString read _GetARTIST;
    {class} property AUTHOR: JString read _GetAUTHOR;
    {class} property BITRATE: JString read _GetBITRATE;
    ...
    {class} property CAPTURE_FRAMERATE: JString read _GetCAPTURE_FRAMERATE;
    {class} property CD_TRACK_NUMBER: JString read _GetCD_TRACK_NUMBER;
    {class} property COMPILATION: JString read _GetCOMPILATION;
    {class} property COMPOSER: JString read _GetCOMPOSER;
    {class} property DATA: JString read _GetDATA;
    {class} property DATE_ADDED: JString read _GetDATE_ADDED;
    {class} property DATE_EXPIRES: JString read _GetDATE_EXPIRES;
    {class} property DATE_MODIFIED: JString read _GetDATE_MODIFIED;
    {class} property DATE_TAKEN: JString read _GetDATE_TAKEN;
    {class} property DISC_NUMBER: JString read _GetDISC_NUMBER;
    {class} property DISPLAY_NAME: JString read _GetDISPLAY_NAME;
    {class} property DOCUMENT_ID: JString read _GetDOCUMENT_ID;
    {class} property DURATION: JString read _GetDURATION;
    {class} property GENERATION_ADDED: JString read _GetGENERATION_ADDED;
    {class} property GENERATION_MODIFIED: JString read _GetGENERATION_MODIFIED;
    {class} property GENRE: JString read _GetGENRE;
    {class} property GROUP_ID: JString read _GetGROUP_ID;
    {class} property HEIGHT: JString read _GetHEIGHT;
    {class} property INSTANCE_ID: JString read _GetINSTANCE_ID;
    {class} property IS_DOWNLOAD: JString read _GetIS_DOWNLOAD;
    {class} property IS_DRM: JString read _GetIS_DRM;
    {class} property IS_FAVORITE: JString read _GetIS_FAVORITE;
    {class} property IS_PENDING: JString read _GetIS_PENDING;
    {class} property IS_TRASHED: JString read _GetIS_TRASHED;
    {class} property MIME_TYPE: JString read _GetMIME_TYPE;
    {class} property NUM_TRACKS: JString read _GetNUM_TRACKS;
    {class} property ORIENTATION: JString read _GetORIENTATION;
    {class} property ORIGINAL_DOCUMENT_ID: JString read _GetORIGINAL_DOCUMENT_ID;
    {class} property OWNER_PACKAGE_NAME: JString read _GetOWNER_PACKAGE_NAME;
    {class} property RELATIVE_PATH: JString read _GetRELATIVE_PATH;
    {class} property RESOLUTION: JString read _GetRESOLUTION;
    {class} property SIZE: JString read _GetSIZE;
    {class} property TITLE: JString read _GetTITLE;
    {class} property VOLUME_NAME: JString read _GetVOLUME_NAME;
    {class} property WIDTH: JString read _GetWIDTH;
    {class} property WRITER: JString read _GetWRITER;
    {class} property XMP: JString read _GetXMP;
  ...
  JAudio_AudioColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ...
    {class} function _GetGENRE_KEY: JString; cdecl;
    {class} function _GetIS_ALARM: JString; cdecl;
    {class} function _GetIS_AUDIOBOOK: JString; cdecl;
    ...
    {class} function _GetIS_RECORDING: JString; cdecl;
    {class} function _GetIS_RINGTONE: JString; cdecl;
    {class} function _GetTITLE_KEY: JString; cdecl;
    {class} function _GetTITLE_RESOURCE_URI: JString; cdecl;
    {class} function _GetTRACK: JString; cdecl;
    {class} function _GetYEAR: JString; cdecl;
    {class} //ALBUM is defined in parent interface
    {class} property ALBUM_ID: JString read _GetALBUM_ID;
    {class} property ALBUM_KEY: JString read _GetALBUM_KEY;
    {class} //ARTIST is defined in parent interface
    {class} property ARTIST_ID: JString read _GetARTIST_ID;
    {class} property ARTIST_KEY: JString read _GetARTIST_KEY;
    {class} property BOOKMARK: JString read _GetBOOKMARK;
    {class} //COMPOSER is defined in parent interface
    {class} //DURATION is defined in parent interface
    {class} //GENRE is defined in parent interface
    {class} property GENRE_ID: JString read _GetGENRE_ID;
    {class} property GENRE_KEY: JString read _GetGENRE_KEY;
    {class} property IS_ALARM: JString read _GetIS_ALARM;
    {class} property IS_AUDIOBOOK: JString read _GetIS_AUDIOBOOK;
    ...
    {class} property IS_RECORDING: JString read _GetIS_RECORDING;
    {class} property IS_RINGTONE: JString read _GetIS_RINGTONE;
    {class} property TITLE_KEY: JString read _GetTITLE_KEY;
    {class} property TITLE_RESOURCE_URI: JString read _GetTITLE_RESOURCE_URI;
    {class} property TRACK: JString read _GetTRACK;
    {class} //YEAR is defined in parent interface
  end;
  ...
  JAudio_MediaClass = interface(JObjectClass)
    ...
    {class} function getContentUri(volumeName: JString; id: Int64): Jnet_Uri; cdecl; overload;
    {class} function getContentUriForPath(path: JString): Jnet_Uri; cdecl;//Deprecated
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property DEFAULT_SORT_ORDER: JString read _GetDEFAULT_SORT_ORDER;
    {class} property ENTRY_CONTENT_TYPE: JString read _GetENTRY_CONTENT_TYPE;
    {class} property EXTERNAL_CONTENT_URI: Jnet_Uri read _GetEXTERNAL_CONTENT_URI;
  ...
  JAudio_PlaylistsColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ['{D6BF287D-2B2D-43DC-B70B-82B3AF310A8A}']
    {class} function _GetDATA: JString; cdecl;
    {class} function _GetDATE_ADDED: JString; cdecl;
    {class} function _GetDATE_MODIFIED: JString; cdecl;
    {class} function _GetNAME: JString; cdecl;
    {class} //DATA is defined in parent interface
    {class} //DATE_ADDED is defined in parent interface
    {class} //DATE_MODIFIED is defined in parent interface
    {class} property NAME: JString read _GetNAME;
  end;

  [JavaSignature('android/provider/MediaStore$Audio$PlaylistsColumns')]
  JAudio_PlaylistsColumns = interface(JMediaStore_MediaColumns)
  ...
  JMediaStore_DownloadColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ['{7EC29D10-D818-4D00-A3B8-51DA4BF8FE2D}']
    {class} function _GetDESCRIPTION: JString; cdecl;
    {class} function _GetDOWNLOAD_URI: JString; cdecl;
    {class} function _GetREFERER_URI: JString; cdecl;
    {class} property DESCRIPTION: JString read _GetDESCRIPTION;
    {class} property DOWNLOAD_URI: JString read _GetDOWNLOAD_URI;
    {class} property REFERER_URI: JString read _GetREFERER_URI;
  end;

  [JavaSignature('android/provider/MediaStore$DownloadColumns')]
  JMediaStore_DownloadColumns = interface(JMediaStore_MediaColumns)
    ['{8E79A5E7-392D-47FE-91A8-6C30D96BAF94}']
  end;
  TJMediaStore_DownloadColumns = class(TJavaGenericImport<JMediaStore_DownloadColumnsClass, JMediaStore_DownloadColumns>) end;

  JMediaStore_DownloadsClass = interface(JObjectClass)
    ['{886F1700-E03D-46D9-BC88-F1969EFD0708}']
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetEXTERNAL_CONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetINTERNAL_CONTENT_URI: Jnet_Uri; cdecl;
    {class} function getContentUri(volumeName: JString): Jnet_Uri; cdecl; overload;
  ...
  [JavaSignature('android/provider/MediaStore$Downloads')]
  JMediaStore_Downloads = interface(JObject)
    ['{0771FFB0-62DD-423E-894E-9122EF32D348}']
  end;
  TJMediaStore_Downloads = class(TJavaGenericImport<JMediaStore_DownloadsClass, JMediaStore_Downloads>) end;
  ...
  JFiles_FileColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ...
    {class} function _GetMEDIA_TYPE_DOCUMENT: Integer; cdecl;
    ...
    {class} function _GetMEDIA_TYPE_SUBTITLE: Integer; cdecl;
    ...
    {class} property MEDIA_TYPE_DOCUMENT: Integer read _GetMEDIA_TYPE_DOCUMENT;
    ...
    {class} property MEDIA_TYPE_SUBTITLE: Integer read _GetMEDIA_TYPE_SUBTITLE;
  ...
  JImages_ImageColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ...
    {class} function _GetDATE_TAKEN: JString; cdecl;
    {class} function _GetDESCRIPTION: JString; cdecl;
    {class} function _GetEXPOSURE_TIME: JString; cdecl;
    {class} function _GetF_NUMBER: JString; cdecl;
    {class} function _GetGROUP_ID: JString; cdecl;
    {class} function _GetISO: JString; cdecl;
    ...
    {class} function _GetSCENE_CAPTURE_TYPE: JString; cdecl;
    {class} //BUCKET_DISPLAY_NAME is defined in parent interface
    {class} //BUCKET_ID is defined in parent interface
    {class} //DATE_TAKEN is defined in parent interface
    {class} property DESCRIPTION: JString read _GetDESCRIPTION;
    {class} property EXPOSURE_TIME: JString read _GetEXPOSURE_TIME;
    {class} property F_NUMBER: JString read _GetF_NUMBER;
    {class} //GROUP_ID is defined in parent interface
    {class} property ISO: JString read _GetISO;
    {class} property IS_PRIVATE: JString read _GetIS_PRIVATE;
    {class} property LATITUDE: JString read _GetLATITUDE;
    {class} property LONGITUDE: JString read _GetLONGITUDE;
    {class} property MINI_THUMB_MAGIC: JString read _GetMINI_THUMB_MAGIC;
    {class} //ORIENTATION is defined in parent interface
    {class} property PICASA_ID: JString read _GetPICASA_ID;
    {class} property SCENE_CAPTURE_TYPE: JString read _GetSCENE_CAPTURE_TYPE;
  end;
  ...
  JImages_MediaClass = interface(JObjectClass)
    ...
    {class} function getBitmap(cr: JContentResolver; url: Jnet_Uri): JBitmap; cdecl;//Deprecated
    {class} function getContentUri(volumeName: JString): Jnet_Uri; cdecl; overload;
    {class} function getContentUri(volumeName: JString; id: Int64): Jnet_Uri; cdecl; overload;
    {class} function insertImage(cr: JContentResolver; imagePath: JString; name: JString; description: JString): JString; cdecl; overload;//Deprecated
    {class} function insertImage(cr: JContentResolver; source: JBitmap; title: JString; description: JString): JString; cdecl; overload;//Deprecated
    {class} function query(cr: JContentResolver; uri: Jnet_Uri; projection: TJavaObjectArray<JString>): JCursor; cdecl; overload;//Deprecated
    {class} function query(cr: JContentResolver; uri: Jnet_Uri; projection: TJavaObjectArray<JString>; where: JString; orderBy: JString): JCursor; cdecl; overload;//Deprecated
    {class} function query(cr: JContentResolver; uri: Jnet_Uri; projection: TJavaObjectArray<JString>; selection: JString; selectionArgs: TJavaObjectArray<JString>; orderBy: JString): JCursor; cdecl; overload;//Deprecated
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property DEFAULT_SORT_ORDER: JString read _GetDEFAULT_SORT_ORDER;
    {class} property EXTERNAL_CONTENT_URI: Jnet_Uri read _GetEXTERNAL_CONTENT_URI;
    {class} property INTERNAL_CONTENT_URI: Jnet_Uri read _GetINTERNAL_CONTENT_URI;
  ...
  JImages_ThumbnailsClass = interface(JObjectClass)
    ...
    {class} procedure cancelThumbnailRequest(cr: JContentResolver; origId: Int64); cdecl; overload;//Deprecated
    {class} procedure cancelThumbnailRequest(cr: JContentResolver; origId: Int64; groupId: Int64); cdecl; overload;//Deprecated
    {class} function getContentUri(volumeName: JString): Jnet_Uri; cdecl;
    {class} function getKindSize(kind: Integer): Jutil_Size; cdecl;//Deprecated
    {class} function getThumbnail(cr: JContentResolver; imageId: Int64; kind: Integer; options: JBitmapFactory_Options): JBitmap; cdecl; overload;//Deprecated
    {class} function getThumbnail(cr: JContentResolver; imageId: Int64; groupId: Int64; kind: Integer; options: JBitmapFactory_Options): JBitmap; cdecl; overload;//Deprecated
    {class} function query(cr: JContentResolver; uri: Jnet_Uri; projection: TJavaObjectArray<JString>): JCursor; cdecl;//Deprecated
    {class} function queryMiniThumbnail(cr: JContentResolver; origId: Int64; kind: Integer; projection: TJavaObjectArray<JString>): JCursor; cdecl;//Deprecated
    {class} function queryMiniThumbnails(cr: JContentResolver; uri: Jnet_Uri; kind: Integer; projection: TJavaObjectArray<JString>): JCursor; cdecl;//Deprecated
    {class} property DATA: JString read _GetDATA;
    {class} property DEFAULT_SORT_ORDER: JString read _GetDEFAULT_SORT_ORDER;
    {class} property EXTERNAL_CONTENT_URI: Jnet_Uri read _GetEXTERNAL_CONTENT_URI;
  ...
  JMediaStore_PickerMediaColumnsClass = interface(JObjectClass)
    ['{E0124E4B-CC0C-41AA-B4CE-6C319E8E054B}']
    {class} function _GetDATA: JString; cdecl;
    {class} function _GetDATE_TAKEN: JString; cdecl;
    {class} function _GetDISPLAY_NAME: JString; cdecl;
    {class} function _GetDURATION_MILLIS: JString; cdecl;
  ...
  [JavaSignature('android/provider/MediaStore$PickerMediaColumns')]
  JMediaStore_PickerMediaColumns = interface(JObject)
    ['{C6522AC8-4EA4-466B-A92B-9898485E313D}']
  end;
  TJMediaStore_PickerMediaColumns = class(TJavaGenericImport<JMediaStore_PickerMediaColumnsClass, JMediaStore_PickerMediaColumns>) end;
  ...
  JVideo_ThumbnailsClass = interface(JObjectClass)
    ...
    {class} procedure cancelThumbnailRequest(cr: JContentResolver; origId: Int64); cdecl; overload;//Deprecated
    {class} procedure cancelThumbnailRequest(cr: JContentResolver; videoId: Int64; groupId: Int64); cdecl; overload;//Deprecated
    {class} function getContentUri(volumeName: JString): Jnet_Uri; cdecl;
    {class} function getKindSize(kind: Integer): Jutil_Size; cdecl;//Deprecated
    {class} function getThumbnail(cr: JContentResolver; videoId: Int64; kind: Integer; options: JBitmapFactory_Options): JBitmap; cdecl; overload;//Deprecated
    {class} function getThumbnail(cr: JContentResolver; videoId: Int64; groupId: Int64; kind: Integer; options: JBitmapFactory_Options): JBitmap; cdecl; overload;//Deprecated
    {class} property DATA: JString read _GetDATA;
    {class} property DEFAULT_SORT_ORDER: JString read _GetDEFAULT_SORT_ORDER;
    {class} property EXTERNAL_CONTENT_URI: Jnet_Uri read _GetEXTERNAL_CONTENT_URI;
    {class} property FULL_SCREEN_KIND: Integer read _GetFULL_SCREEN_KIND;
  ...
  JVideo_VideoColumnsClass = interface(JMediaStore_MediaColumnsClass)
    ...
    {class} function _GetCOLOR_RANGE: JString; cdecl;
    {class} function _GetCOLOR_STANDARD: JString; cdecl;
    {class} function _GetCOLOR_TRANSFER: JString; cdecl;
    {class} function _GetDATE_TAKEN: JString; cdecl;
    {class} function _GetDESCRIPTION: JString; cdecl;
    {class} function _GetDURATION: JString; cdecl;
    {class} function _GetGROUP_ID: JString; cdecl;
    ...
    {class} property COLOR_RANGE: JString read _GetCOLOR_RANGE;
    {class} property COLOR_STANDARD: JString read _GetCOLOR_STANDARD;
    {class} property COLOR_TRANSFER: JString read _GetCOLOR_TRANSFER;
    {class} //DATE_TAKEN is defined in parent interface
    {class} property DESCRIPTION: JString read _GetDESCRIPTION;
    {class} //DURATION is defined in parent interface
    {class} //GROUP_ID is defined in parent interface
    ...
    {class} property LONGITUDE: JString read _GetLONGITUDE;
    {class} property MINI_THUMB_MAGIC: JString read _GetMINI_THUMB_MAGIC;
    {class} //RESOLUTION is defined in parent interface
  ...
  JSettingsClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_ALL_APPS_NOTIFICATION_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_APP_LOCALE_SETTINGS: JString; cdecl;
    {class} function _GetACTION_APP_NOTIFICATION_BUBBLE_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_APP_SEARCH_SETTINGS: JString; cdecl;
    {class} function _GetACTION_APP_USAGE_SETTINGS: JString; cdecl;
    {class} function _GetACTION_AUTO_ROTATE_SETTINGS: JString; cdecl;
    {class} function _GetACTION_BATTERY_SAVER_SETTINGS: JString; cdecl;
    {class} function _GetACTION_BIOMETRIC_ENROLL: JString; cdecl;
    ...
    {class} function _GetACTION_CONDITION_PROVIDER_SETTINGS: JString; cdecl;
    {class} function _GetACTION_DATA_ROAMING_SETTINGS: JString; cdecl;
    {class} function _GetACTION_DATA_USAGE_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_FINGERPRINT_ENROLL: JString; cdecl;
    ...
    {class} function _GetACTION_MANAGE_ALL_FILES_ACCESS_PERMISSION: JString; cdecl;
    {class} function _GetACTION_MANAGE_ALL_SIM_PROFILES_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_MANAGE_SUPERVISOR_RESTRICTED_SETTING: JString; cdecl;
    ...
    {class} function _GetACTION_NOTIFICATION_ASSISTANT_SETTINGS: JString; cdecl;
    {class} function _GetACTION_NOTIFICATION_LISTENER_DETAIL_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_PROCESS_WIFI_EASY_CONNECT_URI: JString; cdecl;
    {class} function _GetACTION_QUICK_ACCESS_WALLET_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_REQUEST_MANAGE_MEDIA: JString; cdecl;
    {class} function _GetACTION_REQUEST_SCHEDULE_EXACT_ALARM: JString; cdecl;
    ...
    {class} function _GetACTION_SETTINGS_EMBED_DEEP_LINK_ACTIVITY: JString; cdecl;
    {class} function _GetACTION_SHOW_REGULATORY_INFO: JString; cdecl;
    {class} function _GetACTION_SHOW_WORK_POLICY_INFO: JString; cdecl;
    {class} function _GetACTION_SOUND_SETTINGS: JString; cdecl;
    {class} function _GetACTION_STORAGE_VOLUME_ACCESS_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_WIFI_ADD_NETWORKS: JString; cdecl;
    ...
    {class} function _GetADD_WIFI_RESULT_ADD_OR_UPDATE_FAILED: Integer; cdecl;
    {class} function _GetADD_WIFI_RESULT_ALREADY_EXISTS: Integer; cdecl;
    {class} function _GetADD_WIFI_RESULT_SUCCESS: Integer; cdecl;
    {class} function _GetAUTHORITY: JString; cdecl;
    ...
    {class} function _GetEXTRA_BIOMETRIC_AUTHENTICATORS_ALLOWED: JString; cdecl;
    {class} function _GetEXTRA_CHANNEL_FILTER_LIST: JString; cdecl;
    {class} function _GetEXTRA_CHANNEL_ID: JString; cdecl;
    {class} function _GetEXTRA_CONVERSATION_ID: JString; cdecl;
    ...
    {class} function _GetEXTRA_EASY_CONNECT_ATTEMPTED_SSID: JString; cdecl;
    {class} function _GetEXTRA_EASY_CONNECT_BAND_LIST: JString; cdecl;
    {class} function _GetEXTRA_EASY_CONNECT_CHANNEL_LIST: JString; cdecl;
    {class} function _GetEXTRA_EASY_CONNECT_ERROR_CODE: JString; cdecl;
    {class} function _GetEXTRA_INPUT_METHOD_ID: JString; cdecl;
    {class} function _GetEXTRA_NOTIFICATION_LISTENER_COMPONENT_NAME: JString; cdecl;
    {class} function _GetEXTRA_SETTINGS_EMBEDDED_DEEP_LINK_HIGHLIGHT_MENU_KEY: JString; cdecl;
    {class} function _GetEXTRA_SETTINGS_EMBEDDED_DEEP_LINK_INTENT_URI: JString; cdecl;
    {class} function _GetEXTRA_SUB_ID: JString; cdecl;
    {class} function _GetEXTRA_SUPERVISOR_RESTRICTED_SETTING_KEY: JString; cdecl;
    {class} function _GetEXTRA_WIFI_NETWORK_LIST: JString; cdecl;
    {class} function _GetEXTRA_WIFI_NETWORK_RESULT_LIST: JString; cdecl;
    ...
    {class} function _GetSUPERVISOR_VERIFICATION_SETTING_BIOMETRICS: Integer; cdecl;
    {class} function _GetSUPERVISOR_VERIFICATION_SETTING_UNKNOWN: Integer; cdecl;
    ...
    {class} property ACTION_ALL_APPS_NOTIFICATION_SETTINGS: JString read _GetACTION_ALL_APPS_NOTIFICATION_SETTINGS;
    ...
    {class} property ACTION_APP_LOCALE_SETTINGS: JString read _GetACTION_APP_LOCALE_SETTINGS;
    {class} property ACTION_APP_NOTIFICATION_BUBBLE_SETTINGS: JString read _GetACTION_APP_NOTIFICATION_BUBBLE_SETTINGS;
    ...
    {class} property ACTION_APP_SEARCH_SETTINGS: JString read _GetACTION_APP_SEARCH_SETTINGS;
    {class} property ACTION_APP_USAGE_SETTINGS: JString read _GetACTION_APP_USAGE_SETTINGS;
    {class} property ACTION_AUTO_ROTATE_SETTINGS: JString read _GetACTION_AUTO_ROTATE_SETTINGS;
    {class} property ACTION_BATTERY_SAVER_SETTINGS: JString read _GetACTION_BATTERY_SAVER_SETTINGS;
    {class} property ACTION_BIOMETRIC_ENROLL: JString read _GetACTION_BIOMETRIC_ENROLL;
    ...
    {class} property ACTION_CONDITION_PROVIDER_SETTINGS: JString read _GetACTION_CONDITION_PROVIDER_SETTINGS;
    {class} property ACTION_DATA_ROAMING_SETTINGS: JString read _GetACTION_DATA_ROAMING_SETTINGS;
    {class} property ACTION_DATA_USAGE_SETTINGS: JString read _GetACTION_DATA_USAGE_SETTINGS;
    ...
    {class} property ACTION_FINGERPRINT_ENROLL: JString read _GetACTION_FINGERPRINT_ENROLL;
    ...
    {class} property ACTION_MANAGE_ALL_FILES_ACCESS_PERMISSION: JString read _GetACTION_MANAGE_ALL_FILES_ACCESS_PERMISSION;
    {class} property ACTION_MANAGE_ALL_SIM_PROFILES_SETTINGS: JString read _GetACTION_MANAGE_ALL_SIM_PROFILES_SETTINGS;
    ...
    {class} property ACTION_MANAGE_SUPERVISOR_RESTRICTED_SETTING: JString read _GetACTION_MANAGE_SUPERVISOR_RESTRICTED_SETTING;
    ...
    {class} property ACTION_NOTIFICATION_ASSISTANT_SETTINGS: JString read _GetACTION_NOTIFICATION_ASSISTANT_SETTINGS;
    {class} property ACTION_NOTIFICATION_LISTENER_DETAIL_SETTINGS: JString read _GetACTION_NOTIFICATION_LISTENER_DETAIL_SETTINGS;
    ...
    {class} property ACTION_PROCESS_WIFI_EASY_CONNECT_URI: JString read _GetACTION_PROCESS_WIFI_EASY_CONNECT_URI;
    {class} property ACTION_QUICK_ACCESS_WALLET_SETTINGS: JString read _GetACTION_QUICK_ACCESS_WALLET_SETTINGS;
    ...
    {class} property ACTION_REQUEST_MANAGE_MEDIA: JString read _GetACTION_REQUEST_MANAGE_MEDIA;
    {class} property ACTION_REQUEST_SCHEDULE_EXACT_ALARM: JString read _GetACTION_REQUEST_SCHEDULE_EXACT_ALARM;
    ...
    {class} property ACTION_SETTINGS_EMBED_DEEP_LINK_ACTIVITY: JString read _GetACTION_SETTINGS_EMBED_DEEP_LINK_ACTIVITY;
    {class} property ACTION_SHOW_REGULATORY_INFO: JString read _GetACTION_SHOW_REGULATORY_INFO;
    {class} property ACTION_SHOW_WORK_POLICY_INFO: JString read _GetACTION_SHOW_WORK_POLICY_INFO;
    {class} property ACTION_SOUND_SETTINGS: JString read _GetACTION_SOUND_SETTINGS;
    {class} property ACTION_STORAGE_VOLUME_ACCESS_SETTINGS: JString read _GetACTION_STORAGE_VOLUME_ACCESS_SETTINGS;
    ...
    {class} property ACTION_WIFI_ADD_NETWORKS: JString read _GetACTION_WIFI_ADD_NETWORKS;
    ...
    {class} property ADD_WIFI_RESULT_ADD_OR_UPDATE_FAILED: Integer read _GetADD_WIFI_RESULT_ADD_OR_UPDATE_FAILED;
    {class} property ADD_WIFI_RESULT_ALREADY_EXISTS: Integer read _GetADD_WIFI_RESULT_ALREADY_EXISTS;
    {class} property ADD_WIFI_RESULT_SUCCESS: Integer read _GetADD_WIFI_RESULT_SUCCESS;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    ...
    {class} property EXTRA_BIOMETRIC_AUTHENTICATORS_ALLOWED: JString read _GetEXTRA_BIOMETRIC_AUTHENTICATORS_ALLOWED;
    {class} property EXTRA_CHANNEL_FILTER_LIST: JString read _GetEXTRA_CHANNEL_FILTER_LIST;
    {class} property EXTRA_CHANNEL_ID: JString read _GetEXTRA_CHANNEL_ID;
    {class} property EXTRA_CONVERSATION_ID: JString read _GetEXTRA_CONVERSATION_ID;
    ...
    {class} property EXTRA_EASY_CONNECT_ATTEMPTED_SSID: JString read _GetEXTRA_EASY_CONNECT_ATTEMPTED_SSID;
    {class} property EXTRA_EASY_CONNECT_BAND_LIST: JString read _GetEXTRA_EASY_CONNECT_BAND_LIST;
    {class} property EXTRA_EASY_CONNECT_CHANNEL_LIST: JString read _GetEXTRA_EASY_CONNECT_CHANNEL_LIST;
    {class} property EXTRA_EASY_CONNECT_ERROR_CODE: JString read _GetEXTRA_EASY_CONNECT_ERROR_CODE;
    {class} property EXTRA_INPUT_METHOD_ID: JString read _GetEXTRA_INPUT_METHOD_ID;
    {class} property EXTRA_NOTIFICATION_LISTENER_COMPONENT_NAME: JString read _GetEXTRA_NOTIFICATION_LISTENER_COMPONENT_NAME;
    {class} property EXTRA_SETTINGS_EMBEDDED_DEEP_LINK_HIGHLIGHT_MENU_KEY: JString read _GetEXTRA_SETTINGS_EMBEDDED_DEEP_LINK_HIGHLIGHT_MENU_KEY;
    {class} property EXTRA_SETTINGS_EMBEDDED_DEEP_LINK_INTENT_URI: JString read _GetEXTRA_SETTINGS_EMBEDDED_DEEP_LINK_INTENT_URI;
    {class} property EXTRA_SUB_ID: JString read _GetEXTRA_SUB_ID;
    {class} property EXTRA_SUPERVISOR_RESTRICTED_SETTING_KEY: JString read _GetEXTRA_SUPERVISOR_RESTRICTED_SETTING_KEY;
    {class} property EXTRA_WIFI_NETWORK_LIST: JString read _GetEXTRA_WIFI_NETWORK_LIST;
    {class} property EXTRA_WIFI_NETWORK_RESULT_LIST: JString read _GetEXTRA_WIFI_NETWORK_RESULT_LIST;
    ...
    {class} property SUPERVISOR_VERIFICATION_SETTING_BIOMETRICS: Integer read _GetSUPERVISOR_VERIFICATION_SETTING_BIOMETRICS;
    {class} property SUPERVISOR_VERIFICATION_SETTING_UNKNOWN: Integer read _GetSUPERVISOR_VERIFICATION_SETTING_UNKNOWN;
  end;
  ...
  JSettings_GlobalClass = interface(JSettings_NameValueTableClass)
    ...
    {class} function _GetAPPLY_RAMPING_RINGER: JString; cdecl;
    ...
    {class} property APPLY_RAMPING_RINGER: JString read _GetAPPLY_RAMPING_RINGER;
  ...
  JSettings_PanelClass = interface(JObjectClass)
    ['{1FFBA416-DFD2-416C-A37D-1D272131D0D3}']
    {class} function _GetACTION_INTERNET_CONNECTIVITY: JString; cdecl;
    {class} function _GetACTION_NFC: JString; cdecl;
    {class} function _GetACTION_VOLUME: JString; cdecl;
    {class} function _GetACTION_WIFI: JString; cdecl;
    {class} property ACTION_INTERNET_CONNECTIVITY: JString read _GetACTION_INTERNET_CONNECTIVITY;
    {class} property ACTION_NFC: JString read _GetACTION_NFC;
    {class} property ACTION_VOLUME: JString read _GetACTION_VOLUME;
    {class} property ACTION_WIFI: JString read _GetACTION_WIFI;
  end;

  [JavaSignature('android/provider/Settings$Panel')]
  JSettings_Panel = interface(JObject)
    ['{FC210B00-8C8D-459E-85AF-47F6CDF8C135}']
  end;
  TJSettings_Panel = class(TJavaGenericImport<JSettings_PanelClass, JSettings_Panel>) end;
  ...
  JSettings_SecureClass = interface(JSettings_NameValueTableClass)
    ...
    {class} function _GetRTT_CALLING_MODE: JString; cdecl;
    {class} function _GetSECURE_FRP_MODE: JString; cdecl;
    ...
    {class} property RTT_CALLING_MODE: JString read _GetRTT_CALLING_MODE;
    {class} property SECURE_FRP_MODE: JString read _GetSECURE_FRP_MODE;
  ...
  JSettingsSlicesContractClass = interface(JObjectClass)
    ['{8C879F1D-5C3E-43A7-93AE-3F9B92970C01}']
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetBASE_URI: Jnet_Uri; cdecl;
    {class} function _GetKEY_AIRPLANE_MODE: JString; cdecl;
    {class} function _GetKEY_BATTERY_SAVER: JString; cdecl;
    {class} function _GetKEY_BLUETOOTH: JString; cdecl;
    {class} function _GetKEY_LOCATION: JString; cdecl;
    {class} function _GetKEY_WIFI: JString; cdecl;
    {class} function _GetPATH_SETTING_ACTION: JString; cdecl;
    {class} function _GetPATH_SETTING_INTENT: JString; cdecl;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property BASE_URI: Jnet_Uri read _GetBASE_URI;
    {class} property KEY_AIRPLANE_MODE: JString read _GetKEY_AIRPLANE_MODE;
    {class} property KEY_BATTERY_SAVER: JString read _GetKEY_BATTERY_SAVER;
    {class} property KEY_BLUETOOTH: JString read _GetKEY_BLUETOOTH;
    {class} property KEY_LOCATION: JString read _GetKEY_LOCATION;
    {class} property KEY_WIFI: JString read _GetKEY_WIFI;
    {class} property PATH_SETTING_ACTION: JString read _GetPATH_SETTING_ACTION;
    {class} property PATH_SETTING_INTENT: JString read _GetPATH_SETTING_INTENT;
  end;

  [JavaSignature('android/provider/SettingsSlicesContract')]
  JSettingsSlicesContract = interface(JObject)
    ['{29FD29AE-5348-43E9-AD6E-D4ECFCD94497}']
  end;
  TJSettingsSlicesContract = class(TJavaGenericImport<JSettingsSlicesContractClass, JSettingsSlicesContract>) end;

  JSimPhonebookContractClass = interface(JObjectClass)
    ['{CF1F9743-4127-4979-9B5D-DDBCD1FA973C}']
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetAUTHORITY_URI: Jnet_Uri; cdecl;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property AUTHORITY_URI: Jnet_Uri read _GetAUTHORITY_URI;
  ...
  [JavaSignature('android/provider/SimPhonebookContract')]
  JSimPhonebookContract = interface(JObject)
    ['{0E838EEF-9BEC-4AB7-99CF-D3253395F16E}']
  end;
  TJSimPhonebookContract = class(TJavaGenericImport<JSimPhonebookContractClass, JSimPhonebookContract>) end;

  JSimPhonebookContract_ElementaryFilesClass = interface(JObjectClass)
    ['{11D37F05-582A-4EEE-BA6A-5BD2E574B349}']
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetEF_ADN: Integer; cdecl;
    {class} function _GetEF_FDN: Integer; cdecl;
    {class} function _GetEF_SDN: Integer; cdecl;
    {class} function _GetEF_TYPE: JString; cdecl;
    {class} function _GetEF_UNKNOWN: Integer; cdecl;
    {class} function _GetMAX_RECORDS: JString; cdecl;
    {class} function _GetNAME_MAX_LENGTH: JString; cdecl;
    {class} function _GetPHONE_NUMBER_MAX_LENGTH: JString; cdecl;
    {class} function _GetRECORD_COUNT: JString; cdecl;
    {class} function _GetSLOT_INDEX: JString; cdecl;
    {class} function _GetSUBSCRIPTION_ID: JString; cdecl;
    {class} function getItemUri(subscriptionId: Integer; efType: Integer): Jnet_Uri; cdecl;
    {class} property CONTENT_ITEM_TYPE: JString read _GetCONTENT_ITEM_TYPE;
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property EF_ADN: Integer read _GetEF_ADN;
    {class} property EF_FDN: Integer read _GetEF_FDN;
    {class} property EF_SDN: Integer read _GetEF_SDN;
    {class} property EF_TYPE: JString read _GetEF_TYPE;
    {class} property EF_UNKNOWN: Integer read _GetEF_UNKNOWN;
    {class} property MAX_RECORDS: JString read _GetMAX_RECORDS;
    {class} property NAME_MAX_LENGTH: JString read _GetNAME_MAX_LENGTH;
    {class} property PHONE_NUMBER_MAX_LENGTH: JString read _GetPHONE_NUMBER_MAX_LENGTH;
    {class} property RECORD_COUNT: JString read _GetRECORD_COUNT;
    {class} property SLOT_INDEX: JString read _GetSLOT_INDEX;
    {class} property SUBSCRIPTION_ID: JString read _GetSUBSCRIPTION_ID;
  end;

  [JavaSignature('android/provider/SimPhonebookContract$ElementaryFiles')]
  JSimPhonebookContract_ElementaryFiles = interface(JObject)
    ['{4507F64B-519F-457E-AB52-1AF48D7638DA}']
  end;
  TJSimPhonebookContract_ElementaryFiles = class(TJavaGenericImport<JSimPhonebookContract_ElementaryFilesClass, JSimPhonebookContract_ElementaryFiles>) end;

  JSimPhonebookContract_SimRecordsClass = interface(JObjectClass)
    ['{D4F8C2CC-4FC9-4C9C-B09A-5C3D328CD50C}']
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetELEMENTARY_FILE_TYPE: JString; cdecl;
    {class} function _GetERROR_NAME_UNSUPPORTED: Integer; cdecl;
    {class} function _GetNAME: JString; cdecl;
    {class} function _GetPHONE_NUMBER: JString; cdecl;
    {class} function _GetRECORD_NUMBER: JString; cdecl;
    {class} function _GetSUBSCRIPTION_ID: JString; cdecl;
    {class} function getContentUri(subscriptionId: Integer; efType: Integer): Jnet_Uri; cdecl;
    {class} function getEncodedNameLength(resolver: JContentResolver; name: JString): Integer; cdecl;
    {class} function getItemUri(subscriptionId: Integer; efType: Integer; recordNumber: Integer): Jnet_Uri; cdecl;
    {class} property CONTENT_ITEM_TYPE: JString read _GetCONTENT_ITEM_TYPE;
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property ELEMENTARY_FILE_TYPE: JString read _GetELEMENTARY_FILE_TYPE;
    {class} property ERROR_NAME_UNSUPPORTED: Integer read _GetERROR_NAME_UNSUPPORTED;
    {class} property NAME: JString read _GetNAME;
    {class} property PHONE_NUMBER: JString read _GetPHONE_NUMBER;
    {class} property RECORD_NUMBER: JString read _GetRECORD_NUMBER;
    {class} property SUBSCRIPTION_ID: JString read _GetSUBSCRIPTION_ID;
  end;

  [JavaSignature('android/provider/SimPhonebookContract$SimRecords')]
  JSimPhonebookContract_SimRecords = interface(JObject)
    ['{458442E5-85FE-41DD-B43D-1C32B39E94CC}']
  end;
  TJSimPhonebookContract_SimRecords = class(TJavaGenericImport<JSimPhonebookContract_SimRecordsClass, JSimPhonebookContract_SimRecords>) end;
  ...
  JSyncStateContract_HelpersClass = interface(JObjectClass)
    ...
    {class} function getWithUri(provider: JContentProviderClient; uri: Jnet_Uri; account: JAccount): JPair; cdecl;
  ...
  JTelephony_CarrierIdClass = interface(JObjectClass)
    ['{6C58940D-C93C-4174-8277-A16467FC4282}']
    {class} function _GetCARRIER_ID: JString; cdecl;
    {class} function _GetCARRIER_NAME: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetSPECIFIC_CARRIER_ID: JString; cdecl;
    {class} function _GetSPECIFIC_CARRIER_ID_NAME: JString; cdecl;
    {class} function getSpecificCarrierIdUriForSubscriptionId(subscriptionId: Integer): Jnet_Uri; cdecl;
    {class} function getUriForSubscriptionId(subscriptionId: Integer): Jnet_Uri; cdecl;
    {class} property CARRIER_ID: JString read _GetCARRIER_ID;
    {class} property CARRIER_NAME: JString read _GetCARRIER_NAME;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property SPECIFIC_CARRIER_ID: JString read _GetSPECIFIC_CARRIER_ID;
    {class} property SPECIFIC_CARRIER_ID_NAME: JString read _GetSPECIFIC_CARRIER_ID_NAME;
  end;

  [JavaSignature('android/provider/Telephony$CarrierId')]
  JTelephony_CarrierId = interface(JObject)
    ['{7B67BD12-75C5-473F-B666-180C577DD85C}']
  end;
  TJTelephony_CarrierId = class(TJavaGenericImport<JTelephony_CarrierIdClass, JTelephony_CarrierId>) end;
  ...
  JTelephony_CarriersClass = interface(JObjectClass)
    ...
    {class} function _GetNAME: JString; cdecl;
    {class} function _GetNETWORK_TYPE_BITMASK: JString; cdecl;
    ...
    {class} function _GetSIM_APN_URI: Jnet_Uri; cdecl;
    {class} function _GetSUBSCRIPTION_ID: JString; cdecl;
    {class} function _GetTYPE: JString; cdecl;
    ...
    {class} property NAME: JString read _GetNAME;
    {class} property NETWORK_TYPE_BITMASK: JString read _GetNETWORK_TYPE_BITMASK;
    ...
    {class} property SIM_APN_URI: Jnet_Uri read _GetSIM_APN_URI;
    {class} property SUBSCRIPTION_ID: JString read _GetSUBSCRIPTION_ID;
    {class} property &TYPE: JString read _GetTYPE;
  ...
  JMms_AddrClass = interface(JObjectClass)
    ...
    {class} function _GetTYPE: JString; cdecl;
    {class} function getAddrUriForMessage(messageId: JString): Jnet_Uri; cdecl;
    {class} property ADDRESS: JString read _GetADDRESS;
  ...
  JMms_PartClass = interface(JObjectClass)
    ...
    {class} function getPartUriForMessage(messageId: JString): Jnet_Uri; cdecl;
    {class} property CHARSET: JString read _GetCHARSET;
  ...
  JTelephony_ServiceStateTableClass = interface(JObjectClass)
    ...
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetDATA_NETWORK_TYPE: JString; cdecl;
    {class} function _GetDATA_REG_STATE: JString; cdecl;
    {class} function _GetDUPLEX_MODE: JString; cdecl;
    ...
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property DATA_NETWORK_TYPE: JString read _GetDATA_NETWORK_TYPE;
    {class} property DATA_REG_STATE: JString read _GetDATA_REG_STATE;
    {class} property DUPLEX_MODE: JString read _GetDUPLEX_MODE;
  ...
  JSms_IntentsClass = interface(JObjectClass)
    ...
    {class} function _GetRESULT_SMS_DATABASE_ERROR: Integer; cdecl;
    {class} function _GetRESULT_SMS_DISPATCH_FAILURE: Integer; cdecl;
    ...
    {class} function _GetRESULT_SMS_INVALID_URI: Integer; cdecl;
    {class} function _GetRESULT_SMS_NULL_MESSAGE: Integer; cdecl;
    {class} function _GetRESULT_SMS_NULL_PDU: Integer; cdecl;
    {class} function _GetRESULT_SMS_OUT_OF_MEMORY: Integer; cdecl;
    {class} function _GetRESULT_SMS_RECEIVED_WHILE_ENCRYPTED: Integer; cdecl;
    {class} function _GetRESULT_SMS_UNSUPPORTED: Integer; cdecl;
    {class} function _GetSECRET_CODE_ACTION: JString; cdecl;
    ...
    {class} property RESULT_SMS_DATABASE_ERROR: Integer read _GetRESULT_SMS_DATABASE_ERROR;
    {class} property RESULT_SMS_DISPATCH_FAILURE: Integer read _GetRESULT_SMS_DISPATCH_FAILURE;
    ...
    {class} property RESULT_SMS_INVALID_URI: Integer read _GetRESULT_SMS_INVALID_URI;
    {class} property RESULT_SMS_NULL_MESSAGE: Integer read _GetRESULT_SMS_NULL_MESSAGE;
    {class} property RESULT_SMS_NULL_PDU: Integer read _GetRESULT_SMS_NULL_PDU;
    {class} property RESULT_SMS_OUT_OF_MEMORY: Integer read _GetRESULT_SMS_OUT_OF_MEMORY;
    {class} property RESULT_SMS_RECEIVED_WHILE_ENCRYPTED: Integer read _GetRESULT_SMS_RECEIVED_WHILE_ENCRYPTED;
    {class} property RESULT_SMS_UNSUPPORTED: Integer read _GetRESULT_SMS_UNSUPPORTED;
    {class} property SECRET_CODE_ACTION: JString read _GetSECRET_CODE_ACTION;
  ...
  JVoicemailContract_VoicemailsClass = interface(JObjectClass)
    ...
    {class} function _GetDIRTY_RETAIN: Integer; cdecl;
    {class} function _GetDIR_TYPE: JString; cdecl;
    {class} function _GetDURATION: JString; cdecl;
    ...
    {class} property DIRTY_RETAIN: Integer read _GetDIRTY_RETAIN;
    {class} property DIR_TYPE: JString read _GetDIR_TYPE;
    {class} property DURATION: JString read _GetDURATION;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCallLog_Locations', TypeInfo(Androidapi.JNI.Provider.JCallLog_Locations));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProvider', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProvider));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProvider_CloudMediaSurfaceController', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProvider_CloudMediaSurfaceController));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProvider_CloudMediaSurfaceStateChangedCallback));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProviderContract', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProviderContract));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProviderContract_AlbumColumns', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProviderContract_AlbumColumns));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProviderContract_MediaCollectionInfo', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProviderContract_MediaCollectionInfo));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JCloudMediaProviderContract_MediaColumns', TypeInfo(Androidapi.JNI.Provider.JCloudMediaProviderContract_MediaColumns));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JContacts_StreamItems', TypeInfo(Androidapi.JNI.Provider.JContacts_StreamItems));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JRawContacts_StreamItems', TypeInfo(Androidapi.JNI.Provider.JRawContacts_StreamItems));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JContactsContract_SimAccount', TypeInfo(Androidapi.JNI.Provider.JContactsContract_SimAccount));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JContactsContract_SimContacts', TypeInfo(Androidapi.JNI.Provider.JContactsContract_SimContacts));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JContactsContract_StreamItemPhotos', TypeInfo(Androidapi.JNI.Provider.JContactsContract_StreamItemPhotos));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JContactsContract_StreamItems', TypeInfo(Androidapi.JNI.Provider.JContactsContract_StreamItems));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JStreamItems_StreamItemPhotos', TypeInfo(Androidapi.JNI.Provider.JStreamItems_StreamItemPhotos));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JMediaStore_DownloadColumns', TypeInfo(Androidapi.JNI.Provider.JMediaStore_DownloadColumns));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JMediaStore_Downloads', TypeInfo(Androidapi.JNI.Provider.JMediaStore_Downloads));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JMediaStore_PickerMediaColumns', TypeInfo(Androidapi.JNI.Provider.JMediaStore_PickerMediaColumns));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JSettings_Panel', TypeInfo(Androidapi.JNI.Provider.JSettings_Panel));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JSettingsSlicesContract', TypeInfo(Androidapi.JNI.Provider.JSettingsSlicesContract));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JSimPhonebookContract', TypeInfo(Androidapi.JNI.Provider.JSimPhonebookContract));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JSimPhonebookContract_ElementaryFiles', TypeInfo(Androidapi.JNI.Provider.JSimPhonebookContract_ElementaryFiles));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JSimPhonebookContract_SimRecords', TypeInfo(Androidapi.JNI.Provider.JSimPhonebookContract_SimRecords));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JTelephony_CarrierId', TypeInfo(Androidapi.JNI.Provider.JTelephony_CarrierId));
