...
// ===== Interface declarations =====
  ...
  JKeyStoreClass = interface(JObjectClass)
    ...
    {class} function getInstance(file_: JFile; password: TJavaArray<Char>): JKeyStore; cdecl; overload;
    {class} function getInstance(file_: JFile; param: JKeyStore_LoadStoreParameter): JKeyStore; cdecl; overload;
  end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JKeyPair', TypeInfo(Androidapi.JNI.Java.Security.JKeyPair));
