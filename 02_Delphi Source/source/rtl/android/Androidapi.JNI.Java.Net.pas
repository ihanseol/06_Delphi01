...
// ===== Forward declarations =====
  ...
  JHandshakeCompletedEvent = interface;//javax.net.ssl.HandshakeCompletedEvent
  JHandshakeCompletedListener = interface;//javax.net.ssl.HandshakeCompletedListener
  ...
  JSSLSocket = interface;//javax.net.ssl.SSLSocket
...
// ===== Interface declarations =====
  ...
  JDatagramSocket = interface(JObject)
    ...
    function getOption(name: JSocketOption): JObject; cdecl;
    function getPort: Integer; cdecl;
    ...
    function setOption(name: JSocketOption; value: JObject): JDatagramSocket; cdecl;
  ...
  JServerSocket = interface(JObject)
    ...
    function isBound: Boolean; cdecl;
    function isClosed: Boolean; cdecl;
    function setOption(name: JSocketOption; value: JObject): JServerSocket; cdecl;
  ...
  JSocket = interface(JObject)
    ...
    function setOption(name: JSocketOption; value: JObject): JSocket; cdecl;
    procedure setPerformancePreferences(connectionTime: Integer; latency: Integer; bandwidth: Integer); cdecl;
    procedure setReceiveBufferSize(size: Integer); cdecl;
    procedure setReuseAddress(on: Boolean); cdecl;
    procedure setSendBufferSize(size: Integer); cdecl;
  ...
  JHandshakeCompletedEventClass = interface(JEventObjectClass)
    ['{CFAA6F28-45B6-4EC3-8286-74180A2B1B55}']
    {class} function init(sock: JSSLSocket; s: JSSLSession): JHandshakeCompletedEvent; cdecl;
  end;

  [JavaSignature('javax/net/ssl/HandshakeCompletedEvent')]
  JHandshakeCompletedEvent = interface(JEventObject)
    ['{2067BCD9-5A93-4D03-B20A-B943607FD99F}']
    ...
    function getSocket: JSSLSocket; cdecl;
  end;
  TJHandshakeCompletedEvent = class(TJavaGenericImport<JHandshakeCompletedEventClass, JHandshakeCompletedEvent>) end;

  JHandshakeCompletedListenerClass = interface(JEventListenerClass)
    ['{5244922D-5007-45E8-A48E-B86438C8D26C}']
  end;

  [JavaSignature('javax/net/ssl/HandshakeCompletedListener')]
  JHandshakeCompletedListener = interface(JEventListener)
    ['{B2C338F1-6D36-4592-BAFD-6DB69CCE1E59}']
    procedure handshakeCompleted(event: JHandshakeCompletedEvent); cdecl;
  end;
  TJHandshakeCompletedListener = class(TJavaGenericImport<JHandshakeCompletedListenerClass, JHandshakeCompletedListener>) end;
  ...
  JSSLEngine = interface(JObject)
    ...
    function getApplicationProtocol: JString; cdecl;
    ...
    function getHandshakeApplicationProtocol: JString; cdecl;
    function getHandshakeApplicationProtocolSelector: JBiFunction; cdecl;
    ...
    procedure setHandshakeApplicationProtocolSelector(selector: JBiFunction); cdecl;
  ...
  JSSLParameters = interface(JObject)
    ...
    function getApplicationProtocols: TJavaObjectArray<JString>; cdecl;
    ...
    procedure setApplicationProtocols(protocols: TJavaObjectArray<JString>); cdecl;
  ...
  JSSLSessionContext = interface(IJavaInstance)
    ...
    function getIds: JEnumeration; cdecl;
  ...
  JSSLSocketClass = interface(JSocketClass)
    ['{1CBD2EB8-69C3-4707-82E7-649A8647CBE5}']
  end;

  [JavaSignature('javax/net/ssl/SSLSocket')]
  JSSLSocket = interface(JSocket)
    ['{F82B5DC3-CA55-44E4-97FE-EF6A7A6AF834}']
    procedure addHandshakeCompletedListener(listener: JHandshakeCompletedListener); cdecl;
    function getApplicationProtocol: JString; cdecl;
    function getEnableSessionCreation: Boolean; cdecl;
    function getEnabledCipherSuites: TJavaObjectArray<JString>; cdecl;
    function getEnabledProtocols: TJavaObjectArray<JString>; cdecl;
    ...
    function getUseClientMode: Boolean; cdecl;
    function getWantClientAuth: Boolean; cdecl;
    procedure removeHandshakeCompletedListener(listener: JHandshakeCompletedListener); cdecl;
    procedure setEnableSessionCreation(flag: Boolean); cdecl;
    procedure setEnabledCipherSuites(suites: TJavaObjectArray<JString>); cdecl;
    procedure setEnabledProtocols(protocols: TJavaObjectArray<JString>); cdecl;
    procedure setHandshakeApplicationProtocolSelector(selector: JBiFunction); cdecl;
    ...
    procedure setUseClientMode(mode: Boolean); cdecl;
    procedure setWantClientAuth(want: Boolean); cdecl;
    procedure startHandshake; cdecl;
    function toString: JString; cdecl;
  end;
  TJSSLSocket = class(TJavaGenericImport<JSSLSocketClass, JSSLSocket>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Net.JHandshakeCompletedEvent', TypeInfo(Androidapi.JNI.Java.Net.JHandshakeCompletedEvent));
  TRegTypes.RegisterType('Androidapi.JNI.Java.Net.JHandshakeCompletedListener', TypeInfo(Androidapi.JNI.Java.Net.JHandshakeCompletedListener));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Net.JSSLSocket', TypeInfo(Androidapi.JNI.Java.Net.JSSLSocket));
