...
// ===== Forward declarations =====
  ...
  JNotification_BubbleMetadata = interface;//android.app.Notification$BubbleMetadata
  JNotification_Builder = interface;//android.app.Notification$Builder
  JNotification_Extender = interface;//android.app.Notification$Extender
  JNotification_Style = interface;//android.app.Notification$Style
  ...
  Jandroid_app_Person = interface;//android.app.Person
  Japp_Person_Builder = interface;//android.app.Person$Builder
  JPictureInPictureParams = interface;//android.app.PictureInPictureParams
  JPictureInPictureUiState = interface;//android.app.PictureInPictureUiState
  JRemoteAction = interface;//android.app.RemoteAction
  ...
  JGenericDocument = interface;//android.app.appsearch.GenericDocument
...
// ===== Interface declarations =====
  ...
  JActivity = interface(JContextThemeWrapper)
    ...
    procedure finishActivityFromChild(child: JActivity; requestCode: Integer); cdecl;//Deprecated
    procedure finishAffinity; cdecl;
    procedure finishAfterTransition; cdecl;
    procedure finishAndRemoveTask; cdecl;
    procedure finishFromChild(child: JActivity); cdecl;//Deprecated
    ...
    function getFragmentManager: JFragmentManager; cdecl;//Deprecated
    ...
    function getLoaderManager: JLoaderManager; cdecl;//Deprecated
    ...
    //function getSplashScreen: JSplashScreen; cdecl;
    ...
    function isLaunchedFromBubble: Boolean; cdecl;
    ...
    function navigateUpToFromChild(child: JActivity; upIntent: JIntent): Boolean; cdecl;//Deprecated
    ...
    procedure onAttachFragment(fragment: JFragment); cdecl;//Deprecated
    ...
    function onCreateThumbnail(outBitmap: JBitmap; canvas: JCanvas): Boolean; cdecl;//Deprecated
    ...
    procedure onGetDirectActions(cancellationSignal: JCancellationSignal; callback: JConsumer); cdecl;
    ...
    function onNavigateUpFromChild(child: JActivity): Boolean; cdecl;//Deprecated
    ...
    procedure onPerformDirectAction(actionId: JString; arguments: JBundle; cancellationSignal: JCancellationSignal; resultListener: JConsumer); cdecl;
    ...
    function onPictureInPictureRequested: Boolean; cdecl;
    procedure onPictureInPictureUiStateChanged(pipState: JPictureInPictureUiState); cdecl;
    ...
    procedure onStateNotSaved; cdecl;//Deprecated
    procedure onTopResumedActivityChanged(isTopResumedActivity: Boolean); cdecl;
    ...
    procedure overridePendingTransition(enterAnim: Integer; exitAnim: Integer); cdecl; overload;
    procedure overridePendingTransition(enterAnim: Integer; exitAnim: Integer; backgroundColor: Integer); cdecl; overload;
    ...
    function requireViewById(id: Integer): JView; cdecl;
    ...
    procedure setInheritShowWhenLocked(inheritShowWhenLocked: Boolean); cdecl;
    procedure setIntent(newIntent: JIntent); cdecl;
    procedure setLocusContext(locusId: JLocusId; bundle: JBundle); cdecl;
    ...
    procedure setRecentsScreenshotEnabled(enabled: Boolean); cdecl;
    ...
    procedure setShouldDockBigOverlays(shouldDockBigOverlays: Boolean); cdecl;
    procedure setShowWhenLocked(showWhenLocked: Boolean); cdecl;
    ...
    function setTranslucent(translucent: Boolean): Boolean; cdecl;
    procedure setTurnScreenOn(turnScreenOn: Boolean); cdecl;
    ...
    function shouldDockBigOverlays: Boolean; cdecl;
    ...
    procedure startActivityFromChild(child: JActivity; intent: JIntent; requestCode: Integer); cdecl; overload;//Deprecated
    procedure startActivityFromChild(child: JActivity; intent: JIntent; requestCode: Integer; options: JBundle); cdecl; overload;//Deprecated
    procedure startActivityFromFragment(fragment: JFragment; intent: JIntent; requestCode: Integer); cdecl; overload;//Deprecated
    procedure startActivityFromFragment(fragment: JFragment; intent: JIntent; requestCode: Integer; options: JBundle); cdecl; overload;//Deprecated
    ...
    procedure startIntentSenderFromChild(child: JActivity; intent: JIntentSender; requestCode: Integer; fillInIntent: JIntent; flagsMask: Integer; flagsValues: Integer; extraFlags: Integer); cdecl; overload;//Deprecated
    procedure startIntentSenderFromChild(child: JActivity; intent: JIntentSender; requestCode: Integer; fillInIntent: JIntent; flagsMask: Integer; flagsValues: Integer; extraFlags: Integer; options: JBundle); cdecl; overload;//Deprecated
  ...
  JActivityManagerClass = interface(JObjectClass)
    ...
    {class} function isLowMemoryKillReportSupported: Boolean; cdecl;
    {class} function isRunningInTestHarness: Boolean; cdecl;//Deprecated
    {class} function isRunningInUserTestHarness: Boolean; cdecl;
  ...
  JActivityManager = interface(JObject)
    ...
    procedure appNotResponding(reason: JString); cdecl;
    ...
    function getHistoricalProcessExitReasons(packageName: JString; pid: Integer; maxNum: Integer): JList; cdecl;
    ...
    function isActivityStartAllowedOnDisplay(context: JContext; displayId: Integer; intent: JIntent): Boolean; cdecl;
    function isBackgroundRestricted: Boolean; cdecl;
    ...
    procedure setProcessStateSummary(state: TJavaArray<Byte>); cdecl;
  ...
  JActivityManager_RunningAppProcessInfoClass = interface(JObjectClass)
    ...
    {class} function _GetIMPORTANCE_CANT_SAVE_STATE: Integer; cdecl;
    ...
    {class} function _GetIMPORTANCE_TOP_SLEEPING_PRE_28: Integer; cdecl;
    ...
    {class} property IMPORTANCE_CANT_SAVE_STATE: Integer read _GetIMPORTANCE_CANT_SAVE_STATE;
    ...
    {class} property IMPORTANCE_TOP_SLEEPING_PRE_28: Integer read _GetIMPORTANCE_TOP_SLEEPING_PRE_28;
  ...
  JActivityManager_TaskDescriptionClass = interface(JObjectClass)
    ...
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function init(label_: JString; iconRes: Integer; colorPrimary: Integer): JActivityManager_TaskDescription; cdecl; overload;//Deprecated
    {class} function init(label_: JString; iconRes: Integer): JActivityManager_TaskDescription; cdecl; overload;//Deprecated
    {class} function init(label_: JString): JActivityManager_TaskDescription; cdecl; overload;//Deprecated
    {class} function init: JActivityManager_TaskDescription; cdecl; overload;//Deprecated
    {class} function init(label_: JString; icon: JBitmap; colorPrimary: Integer): JActivityManager_TaskDescription; cdecl; overload;//Deprecated
    {class} function init(label_: JString; icon: JBitmap): JActivityManager_TaskDescription; cdecl; overload;//Deprecated
  ...
  JActivityManager_TaskDescription = interface(JObject)
    ...
    function getIcon: JBitmap; cdecl;//Deprecated
  ...
  JAlarmManagerClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_SCHEDULE_EXACT_ALARM_PERMISSION_STATE_CHANGED: JString; cdecl;
    ...
    {class} property ACTION_SCHEDULE_EXACT_ALARM_PERMISSION_STATE_CHANGED: JString read _GetACTION_SCHEDULE_EXACT_ALARM_PERMISSION_STATE_CHANGED;
  ...
  JApplicationClass = interface(JContextWrapperClass)
    ...
    {class} function getProcessName: JString; cdecl;
  end;
  ...
  JAutomaticZenRuleClass = interface(JObjectClass)
    ...
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} //function init(name: JString; owner: JComponentName; conditionId: Jnet_Uri; interruptionFilter: Integer; enabled: Boolean): JAutomaticZenRule; cdecl; overload;//Deprecated
    {class} //function init(name: JString; owner: JComponentName; configurationActivity: JComponentName; conditionId: Jnet_Uri; policy: JZenPolicy; interruptionFilter: Integer; enabled: Boolean): JAutomaticZenRule; cdecl; overload;
  ...
  JAutomaticZenRule = interface(JObject)
    ...
    function getConfigurationActivity: JComponentName; cdecl;
  ...
  JServiceClass = interface(JContextWrapperClass)
    ...
    {class} function _GetSTOP_FOREGROUND_LEGACY: Integer; cdecl;
    ...
    {class} property STOP_FOREGROUND_LEGACY: Integer read _GetSTOP_FOREGROUND_LEGACY;
  ...
  JService = interface(JContextWrapper)
    ...
    procedure startForeground(id: Integer; notification: JNotification); cdecl; overload;
    procedure startForeground(id: Integer; notification: JNotification; foregroundServiceType: Integer); cdecl; overload;
    procedure stopForeground(removeNotification: Boolean); cdecl; overload;//Deprecated
    procedure stopForeground(notificationBehavior: Integer); cdecl; overload;
  ...
  JNotificationClass = interface(JObjectClass)
    ...
    {class} function _GetEXTRA_MESSAGING_PERSON: JString; cdecl;
    ...
    {class} function _GetEXTRA_REMOTE_INPUT_DRAFT: JString; cdecl;
    ...
    {class} function getNotificationStyleClass(templateClass: JString): Jlang_Class; cdecl;
    ...
    {class} property EXTRA_MESSAGING_PERSON: JString read _GetEXTRA_MESSAGING_PERSON;
    ...
    {class} property EXTRA_REMOTE_INPUT_DRAFT: JString read _GetEXTRA_REMOTE_INPUT_DRAFT;
  ...
  JNotification = interface(JObject)
    ...
    function describeContents: Integer; cdecl;
    function findRemoteInputActionPair(requiresFreeform: Boolean): JPair; cdecl;
    function getAllowSystemGeneratedContextualActions: Boolean; cdecl;
    function getBadgeIconType: Integer; cdecl;
    function getBubbleMetadata: JNotification_BubbleMetadata; cdecl;
    function getChannel: JString; cdecl;//Deprecated
    function getChannelId: JString; cdecl;
    function getContextualActions: JList; cdecl;
    function getGroup: JString; cdecl;
    function getGroupAlertBehavior: Integer; cdecl;
    function getLargeIcon: JIcon; cdecl;
    function getLocusId: JLocusId; cdecl;
  ...
  JNotification_BubbleMetadataClass = interface(JObjectClass)
    ['{000B54D0-B989-4C16-BF2F-C83EDED55CAE}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/app/Notification$BubbleMetadata')]
  JNotification_BubbleMetadata = interface(JObject)
    ['{A8126D3A-4E8B-4F03-8A80-13C83550CAFD}']
    function describeContents: Integer; cdecl;
    function getAutoExpandBubble: Boolean; cdecl;
    function getBubbleIcon: JIcon; cdecl;//Deprecated
    function getBubbleIntent: JPendingIntent; cdecl;//Deprecated
    ...
    function getShortcutId: JString; cdecl;
    function isBubbleSuppressable: Boolean; cdecl;
    function isBubbleSuppressed: Boolean; cdecl;
    function isNotificationSuppressed: Boolean; cdecl;
    procedure writeToParcel(out_: JParcel; flags: Integer); cdecl;
  end;
  TJNotification_BubbleMetadata = class(TJavaGenericImport<JNotification_BubbleMetadataClass, JNotification_BubbleMetadata>) end;

  JNotification_BuilderClass = interface(JObjectClass)
    ['{9B3ACFA3-6A5F-41B0-A992-DD36502877B2}']
    {class} function init(context: JContext; channelId: JString): JNotification_Builder; cdecl; overload;
    {class} function init(context: JContext): JNotification_Builder; cdecl; overload;//Deprecated
    {class} function recoverBuilder(context: JContext; n: JNotification): JNotification_Builder; cdecl;
  end;

  [JavaSignature('android/app/Notification$Builder')]
  JNotification_Builder = interface(JObject)
    ['{C9C251D8-9142-4035-98B9-0148702A7D7F}']
    function addAction(icon: Integer; title: JCharSequence; intent: JPendingIntent): JNotification_Builder; cdecl; overload;//Deprecated
    ...
    function addPerson(uri: JString): JNotification_Builder; cdecl; overload;//Deprecated
    function addPerson(person: Jandroid_app_Person): JNotification_Builder; cdecl; overload;
    ...
    function setAllowSystemGeneratedContextualActions(allowed: Boolean): JNotification_Builder; cdecl;
    ...
    function setBubbleMetadata(data: JNotification_BubbleMetadata): JNotification_Builder; cdecl;
    function setCategory(category: JString): JNotification_Builder; cdecl;
    function setChannel(channelId: JString): JNotification_Builder; cdecl;//Deprecated
    ...
    function setContent(views: JRemoteViews): JNotification_Builder; cdecl;//Deprecated
    function setContentInfo(info: JCharSequence): JNotification_Builder; cdecl;//Deprecated
    ...
    function setDefaults(defaults: Integer): JNotification_Builder; cdecl;//Deprecated
    ...
    function setFlag(mask: Integer; value: Boolean): JNotification_Builder; cdecl;
    ...
    function setLights(argb: Integer; onMs: Integer; offMs: Integer): JNotification_Builder; cdecl;//Deprecated
    function setLocalOnly(localOnly: Boolean): JNotification_Builder; cdecl;
    function setLocusId(locusId: JLocusId): JNotification_Builder; cdecl;
    ...
    function setPriority(pri: Integer): JNotification_Builder; cdecl;//Deprecated
    ...
    function setRemoteInputHistory(text: TJavaObjectArray<JCharSequence>): JNotification_Builder; cdecl;
    ...
    //function setSound(sound: Jnet_Uri): JNotification_Builder; cdecl; overload;//Deprecated
    //function setSound(sound: Jnet_Uri; streamType: Integer): JNotification_Builder; cdecl; overload;//Deprecated
    //function setSound(sound: Jnet_Uri; audioAttributes: JAudioAttributes): JNotification_Builder; cdecl; overload;//Deprecated
    ...
    function setTicker(tickerText: JCharSequence; views: JRemoteViews): JNotification_Builder; cdecl; overload;//Deprecated
    function setTimeout(durationMs: Int64): JNotification_Builder; cdecl;//Deprecated
    ...
    function setVibrate(pattern: TJavaArray<Int64>): JNotification_Builder; cdecl;//Deprecated
  ...
  TJNotification_Builder = class(TJavaGenericImport<JNotification_BuilderClass, JNotification_Builder>) end;

  JNotification_ExtenderClass = interface(IJavaClass)
    ['{671939D9-DD6A-4D81-A32D-A3E4545C2B8D}']
  end;

  [JavaSignature('android/app/Notification$Extender')]
  JNotification_Extender = interface(IJavaInstance)
    ['{B4C20B2D-8BAC-4A53-998C-8034BAC5FFBE}']
    function extend(builder: JNotification_Builder): JNotification_Builder; cdecl;
  end;
  TJNotification_Extender = class(TJavaGenericImport<JNotification_ExtenderClass, JNotification_Extender>) end;

  JNotification_StyleClass = interface(JObjectClass)
    ['{CDAF37E4-47F6-4730-96A4-2A1903BE2CBF}']
    {class} function init: JNotification_Style; cdecl;
  end;

  [JavaSignature('android/app/Notification$Style')]
  JNotification_Style = interface(JObject)
    ['{DD435E41-DA0C-4FA7-A8DC-A338EC558D3D}']
    function build: JNotification; cdecl;
    procedure setBuilder(builder: JNotification_Builder); cdecl;
  end;
  TJNotification_Style = class(TJavaGenericImport<JNotification_StyleClass, JNotification_Style>) end;
  ...
  JNotificationChannelClass = interface(JObjectClass)
    ...
    {class} function _GetEDIT_CONVERSATION: JString; cdecl;
    {class} function _GetEDIT_IMPORTANCE: JString; cdecl;
    {class} function _GetEDIT_LAUNCHER: JString; cdecl;
    {class} function _GetEDIT_LOCKED_DEVICE: JString; cdecl;
    {class} function _GetEDIT_SOUND: JString; cdecl;
    {class} function _GetEDIT_VIBRATION: JString; cdecl;
    {class} function _GetEDIT_ZEN: JString; cdecl;
    ...
    {class} property EDIT_CONVERSATION: JString read _GetEDIT_CONVERSATION;
    {class} property EDIT_IMPORTANCE: JString read _GetEDIT_IMPORTANCE;
    {class} property EDIT_LAUNCHER: JString read _GetEDIT_LAUNCHER;
    {class} property EDIT_LOCKED_DEVICE: JString read _GetEDIT_LOCKED_DEVICE;
    {class} property EDIT_SOUND: JString read _GetEDIT_SOUND;
    {class} property EDIT_VIBRATION: JString read _GetEDIT_VIBRATION;
    {class} property EDIT_ZEN: JString read _GetEDIT_ZEN;
  end;

  [JavaSignature('android/app/NotificationChannel')]
  JNotificationChannel = interface(JObject)
    ['{717B07CA-7843-4334-97A7-DD51210E263E}']
    function canBubble: Boolean; cdecl;
    ...
    function getConversationId: JString; cdecl;
    ...
    function getParentChannelId: JString; cdecl;
    //function getSound: Jnet_Uri; cdecl;
    function getVibrationPattern: TJavaArray<Int64>; cdecl;
    function hasUserSetImportance: Boolean; cdecl;
    function hasUserSetSound: Boolean; cdecl;
    function hashCode: Integer; cdecl;
    function isBlockable: Boolean; cdecl;
    function isConversation: Boolean; cdecl;
    function isDemoted: Boolean; cdecl;
    function isImportantConversation: Boolean; cdecl;
    procedure setAllowBubbles(allowBubbles: Boolean); cdecl;
    procedure setBlockable(blockable: Boolean); cdecl;
    procedure setBypassDnd(bypassDnd: Boolean); cdecl;
    procedure setConversationId(parentChannelId: JString; conversationId: JString); cdecl;
  ...
  JNotificationManagerClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_APP_BLOCK_STATE_CHANGED: JString; cdecl;
    {class} function _GetACTION_AUTOMATIC_ZEN_RULE: JString; cdecl;
    {class} function _GetACTION_AUTOMATIC_ZEN_RULE_STATUS_CHANGED: JString; cdecl;
    {class} function _GetACTION_INTERRUPTION_FILTER_CHANGED: JString; cdecl;
    {class} function _GetACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED: JString; cdecl;
    {class} function _GetACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED: JString; cdecl;
    ...
    {class} function _GetAUTOMATIC_RULE_STATUS_DISABLED: Integer; cdecl;
    {class} function _GetAUTOMATIC_RULE_STATUS_ENABLED: Integer; cdecl;
    {class} function _GetAUTOMATIC_RULE_STATUS_REMOVED: Integer; cdecl;
    {class} function _GetAUTOMATIC_RULE_STATUS_UNKNOWN: Integer; cdecl;
    {class} function _GetBUBBLE_PREFERENCE_ALL: Integer; cdecl;
    {class} function _GetBUBBLE_PREFERENCE_NONE: Integer; cdecl;
    {class} function _GetBUBBLE_PREFERENCE_SELECTED: Integer; cdecl;
    {class} function _GetEXTRA_AUTOMATIC_RULE_ID: JString; cdecl;
    {class} function _GetEXTRA_AUTOMATIC_ZEN_RULE_ID: JString; cdecl;
    {class} function _GetEXTRA_AUTOMATIC_ZEN_RULE_STATUS: JString; cdecl;
    {class} function _GetEXTRA_BLOCKED_STATE: JString; cdecl;
    {class} function _GetEXTRA_NOTIFICATION_CHANNEL_GROUP_ID: JString; cdecl;
    {class} function _GetEXTRA_NOTIFICATION_CHANNEL_ID: JString; cdecl;
    ...
    {class} function _GetMETA_DATA_AUTOMATIC_RULE_TYPE: JString; cdecl;
    {class} function _GetMETA_DATA_RULE_INSTANCE_LIMIT: JString; cdecl;
    {class} property ACTION_APP_BLOCK_STATE_CHANGED: JString read _GetACTION_APP_BLOCK_STATE_CHANGED;
    {class} property ACTION_AUTOMATIC_ZEN_RULE: JString read _GetACTION_AUTOMATIC_ZEN_RULE;
    {class} property ACTION_AUTOMATIC_ZEN_RULE_STATUS_CHANGED: JString read _GetACTION_AUTOMATIC_ZEN_RULE_STATUS_CHANGED;
    {class} property ACTION_INTERRUPTION_FILTER_CHANGED: JString read _GetACTION_INTERRUPTION_FILTER_CHANGED;
    {class} property ACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED: JString read _GetACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED;
    {class} property ACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED: JString read _GetACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED;
    ...
    {class} property AUTOMATIC_RULE_STATUS_DISABLED: Integer read _GetAUTOMATIC_RULE_STATUS_DISABLED;
    {class} property AUTOMATIC_RULE_STATUS_ENABLED: Integer read _GetAUTOMATIC_RULE_STATUS_ENABLED;
    {class} property AUTOMATIC_RULE_STATUS_REMOVED: Integer read _GetAUTOMATIC_RULE_STATUS_REMOVED;
    {class} property AUTOMATIC_RULE_STATUS_UNKNOWN: Integer read _GetAUTOMATIC_RULE_STATUS_UNKNOWN;
    {class} property BUBBLE_PREFERENCE_ALL: Integer read _GetBUBBLE_PREFERENCE_ALL;
    {class} property BUBBLE_PREFERENCE_NONE: Integer read _GetBUBBLE_PREFERENCE_NONE;
    {class} property BUBBLE_PREFERENCE_SELECTED: Integer read _GetBUBBLE_PREFERENCE_SELECTED;
    {class} property EXTRA_AUTOMATIC_RULE_ID: JString read _GetEXTRA_AUTOMATIC_RULE_ID;
    {class} property EXTRA_AUTOMATIC_ZEN_RULE_ID: JString read _GetEXTRA_AUTOMATIC_ZEN_RULE_ID;
    {class} property EXTRA_AUTOMATIC_ZEN_RULE_STATUS: JString read _GetEXTRA_AUTOMATIC_ZEN_RULE_STATUS;
    {class} property EXTRA_BLOCKED_STATE: JString read _GetEXTRA_BLOCKED_STATE;
    {class} property EXTRA_NOTIFICATION_CHANNEL_GROUP_ID: JString read _GetEXTRA_NOTIFICATION_CHANNEL_GROUP_ID;
    {class} property EXTRA_NOTIFICATION_CHANNEL_ID: JString read _GetEXTRA_NOTIFICATION_CHANNEL_ID;
    ...
    {class} property META_DATA_AUTOMATIC_RULE_TYPE: JString read _GetMETA_DATA_AUTOMATIC_RULE_TYPE;
    {class} property META_DATA_RULE_INSTANCE_LIMIT: JString read _GetMETA_DATA_RULE_INSTANCE_LIMIT;
  end;
  ...
  JNotificationManager = interface(JObject)
    ...
    function areBubblesAllowed: Boolean; cdecl;//Deprecated
    function areBubblesEnabled: Boolean; cdecl;
    function areNotificationsEnabled: Boolean; cdecl;
    function areNotificationsPaused: Boolean; cdecl;
    function canNotifyAsPackage(pkg: JString): Boolean; cdecl;
    ...
    procedure cancelAsPackage(targetPackage: JString; tag: JString; id: Integer); cdecl;
    ...
    function getBubblePreference: Integer; cdecl;
    function getConsolidatedNotificationPolicy: JNotificationManager_Policy; cdecl;
    function getCurrentInterruptionFilter: Integer; cdecl;
    function getImportance: Integer; cdecl;
    function getNotificationChannel(channelId: JString): JNotificationChannel; cdecl; overload;
    function getNotificationChannel(channelId: JString; conversationId: JString): JNotificationChannel; cdecl; overload;
    function getNotificationChannelGroup(channelGroupId: JString): JNotificationChannelGroup; cdecl;
    function getNotificationChannelGroups: JList; cdecl;
    function getNotificationChannels: JList; cdecl;
    function getNotificationDelegate: JString; cdecl;
    function getNotificationPolicy: JNotificationManager_Policy; cdecl;
    function isNotificationListenerAccessGranted(listener: JComponentName): Boolean; cdecl;
    function isNotificationPolicyAccessGranted: Boolean; cdecl;
    //function matchesCallFilter(uri: Jnet_Uri): Boolean; cdecl;
    ...
    procedure notifyAsPackage(targetPackage: JString; tag: JString; id: Integer; notification: JNotification); cdecl;
    function removeAutomaticZenRule(id: JString): Boolean; cdecl;
    //procedure setAutomaticZenRuleState(id: JString; condition: Jnotification_Condition); cdecl;
    procedure setInterruptionFilter(interruptionFilter: Integer); cdecl;
    procedure setNotificationDelegate(delegate: JString); cdecl;
    procedure setNotificationPolicy(policy: JNotificationManager_Policy); cdecl;
    function shouldHideSilentStatusBarIcons: Boolean; cdecl;
  ...
  JNotificationManager_PolicyClass = interface(JObjectClass)
    ...
    {class} function _GetCONVERSATION_SENDERS_ANYONE: Integer; cdecl;
    {class} function _GetCONVERSATION_SENDERS_IMPORTANT: Integer; cdecl;
    {class} function _GetCONVERSATION_SENDERS_NONE: Integer; cdecl;
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function _GetPRIORITY_CATEGORY_ALARMS: Integer; cdecl;
    {class} function _GetPRIORITY_CATEGORY_CALLS: Integer; cdecl;
    {class} function _GetPRIORITY_CATEGORY_CONVERSATIONS: Integer; cdecl;
    {class} function _GetPRIORITY_CATEGORY_EVENTS: Integer; cdecl;
    {class} function _GetPRIORITY_CATEGORY_MEDIA: Integer; cdecl;
    ...
    {class} function _GetPRIORITY_CATEGORY_SYSTEM: Integer; cdecl;
    ...
    {class} function _GetSUPPRESSED_EFFECT_AMBIENT: Integer; cdecl;
    {class} function _GetSUPPRESSED_EFFECT_BADGE: Integer; cdecl;
    {class} function _GetSUPPRESSED_EFFECT_FULL_SCREEN_INTENT: Integer; cdecl;
    {class} function _GetSUPPRESSED_EFFECT_LIGHTS: Integer; cdecl;
    {class} function _GetSUPPRESSED_EFFECT_NOTIFICATION_LIST: Integer; cdecl;
    {class} function _GetSUPPRESSED_EFFECT_PEEK: Integer; cdecl;
    ...
    {class} function _GetSUPPRESSED_EFFECT_STATUS_BAR: Integer; cdecl;
    ...
    {class} function init(priorityCategories: Integer; priorityCallSenders: Integer; priorityMessageSenders: Integer; suppressedVisualEffects: Integer; priorityConversationSenders: Integer): JNotificationManager_Policy; cdecl; overload;
    ...
    {class} property CONVERSATION_SENDERS_ANYONE: Integer read _GetCONVERSATION_SENDERS_ANYONE;
    {class} property CONVERSATION_SENDERS_IMPORTANT: Integer read _GetCONVERSATION_SENDERS_IMPORTANT;
    {class} property CONVERSATION_SENDERS_NONE: Integer read _GetCONVERSATION_SENDERS_NONE;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
    {class} property PRIORITY_CATEGORY_ALARMS: Integer read _GetPRIORITY_CATEGORY_ALARMS;
    {class} property PRIORITY_CATEGORY_CALLS: Integer read _GetPRIORITY_CATEGORY_CALLS;
    {class} property PRIORITY_CATEGORY_CONVERSATIONS: Integer read _GetPRIORITY_CATEGORY_CONVERSATIONS;
    {class} property PRIORITY_CATEGORY_EVENTS: Integer read _GetPRIORITY_CATEGORY_EVENTS;
    {class} property PRIORITY_CATEGORY_MEDIA: Integer read _GetPRIORITY_CATEGORY_MEDIA;
    ...
    {class} property PRIORITY_CATEGORY_SYSTEM: Integer read _GetPRIORITY_CATEGORY_SYSTEM;
    ...
    {class} property SUPPRESSED_EFFECT_AMBIENT: Integer read _GetSUPPRESSED_EFFECT_AMBIENT;
    {class} property SUPPRESSED_EFFECT_BADGE: Integer read _GetSUPPRESSED_EFFECT_BADGE;
    {class} property SUPPRESSED_EFFECT_FULL_SCREEN_INTENT: Integer read _GetSUPPRESSED_EFFECT_FULL_SCREEN_INTENT;
    {class} property SUPPRESSED_EFFECT_LIGHTS: Integer read _GetSUPPRESSED_EFFECT_LIGHTS;
    {class} property SUPPRESSED_EFFECT_NOTIFICATION_LIST: Integer read _GetSUPPRESSED_EFFECT_NOTIFICATION_LIST;
    {class} property SUPPRESSED_EFFECT_PEEK: Integer read _GetSUPPRESSED_EFFECT_PEEK;
    ...
    {class} property SUPPRESSED_EFFECT_STATUS_BAR: Integer read _GetSUPPRESSED_EFFECT_STATUS_BAR;
  end;
  ...
  JNotificationManager_Policy = interface(JObject)
    ...
    function _GetpriorityConversationSenders: Integer; cdecl;
    ...
    property priorityConversationSenders: Integer read _GetpriorityConversationSenders;
  ...
  JPendingIntentClass = interface(JObjectClass)
    ...
    {class} function _GetFLAG_MUTABLE: Integer; cdecl;
    ...
    {class} property FLAG_MUTABLE: Integer read _GetFLAG_MUTABLE;
  ...
  JPendingIntent = interface(JObject)
    ...
    function hashCode: Integer; cdecl;
    function isActivity: Boolean; cdecl;
    function isBroadcast: Boolean; cdecl;
    function isForegroundService: Boolean; cdecl;
    function isImmutable: Boolean; cdecl;
    function isService: Boolean; cdecl;
  ...
  Jandroid_app_PersonClass = interface(JObjectClass)
    ['{E4632219-01B9-4801-B60B-5A37ADFD5BF0}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/app/Person')]
  Jandroid_app_Person = interface(JObject)
    ['{9FE26D24-7F7A-449A-83F6-B3BC4C2D64A3}']
    function describeContents: Integer; cdecl;
    function equals(obj: JObject): Boolean; cdecl;
    function getIcon: JIcon; cdecl;
    ...
    function hashCode: Integer; cdecl;
    function isBot: Boolean; cdecl;
    function isImportant: Boolean; cdecl;
    function toBuilder: Japp_Person_Builder; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJandroid_app_Person = class(TJavaGenericImport<Jandroid_app_PersonClass, Jandroid_app_Person>) end;

  Japp_Person_BuilderClass = interface(JObjectClass)
    ['{E6596197-0BD4-429F-8951-478B2D81FA9F}']
    {class} function init: Japp_Person_Builder; cdecl;
  end;

  [JavaSignature('android/app/Person$Builder')]
  Japp_Person_Builder = interface(JObject)
    ['{9405AD3E-3F4F-47CE-A703-BD2F381AB990}']
    function build: Jandroid_app_Person; cdecl;
    function setBot(isBot: Boolean): Japp_Person_Builder; cdecl;
    function setIcon(icon: JIcon): Japp_Person_Builder; cdecl;
    function setImportant(isImportant: Boolean): Japp_Person_Builder; cdecl;
    function setKey(key: JString): Japp_Person_Builder; cdecl;
    function setName(name: JCharSequence): Japp_Person_Builder; cdecl;
    function setUri(uri: JString): Japp_Person_Builder; cdecl;
  end;
  TJapp_Person_Builder = class(TJavaGenericImport<Japp_Person_BuilderClass, Japp_Person_Builder>) end;
  ...
  JPictureInPictureParams = interface(JObject)
    ...
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function getActions: JList; cdecl;
    function getAspectRatio: JRational; cdecl;
    function getCloseAction: JRemoteAction; cdecl;
    function getExpandedAspectRatio: JRational; cdecl;
    function getSourceRectHint: JRect; cdecl;
    function getSubtitle: JCharSequence; cdecl;
    function getTitle: JCharSequence; cdecl;
    function hashCode: Integer; cdecl;
    function isAutoEnterEnabled: Boolean; cdecl;
    function isSeamlessResizeEnabled: Boolean; cdecl;
    function toString: JString; cdecl;
    procedure writeToParcel(out_: JParcel; flags: Integer); cdecl;
  end;
  TJPictureInPictureParams = class(TJavaGenericImport<JPictureInPictureParamsClass, JPictureInPictureParams>) end;

  JPictureInPictureUiStateClass = interface(JObjectClass)
    ['{2F97BAF1-6EA5-4236-9BEF-DE8C358B5145}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/app/PictureInPictureUiState')]
  JPictureInPictureUiState = interface(JObject)
    ['{B4AC3E98-C042-4F2F-9258-364495259E18}']
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function hashCode: Integer; cdecl;
    function isStashed: Boolean; cdecl;
    procedure writeToParcel(out_: JParcel; flags: Integer); cdecl;
  end;
  TJPictureInPictureUiState = class(TJavaGenericImport<JPictureInPictureUiStateClass, JPictureInPictureUiState>) end;

  JRemoteActionClass = interface(JObjectClass)
    ['{69EC1692-62DB-4383-9491-8BDC419FBCD3}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function init(icon: JIcon; title: JCharSequence; contentDescription: JCharSequence; intent: JPendingIntent): JRemoteAction; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/app/RemoteAction')]
  JRemoteAction = interface(JObject)
    ['{F7E0BBBA-DCBB-440E-ABCE-CF401A8DD5F4}']
    function clone: JRemoteAction; cdecl;
    function describeContents: Integer; cdecl;
    procedure dump(prefix: JString; pw: JPrintWriter); cdecl;
    function equals(o: JObject): Boolean; cdecl;
    ...
    function isEnabled: Boolean; cdecl;
    procedure setEnabled(enabled: Boolean); cdecl;
    procedure setShouldShowIcon(shouldShowIcon: Boolean); cdecl;
    function shouldShowIcon: Boolean; cdecl;
    procedure writeToParcel(out_: JParcel; flags: Integer); cdecl;
  end;
  TJRemoteAction = class(TJavaGenericImport<JRemoteActionClass, JRemoteAction>) end;
  ...
  JRemoteInputClass = interface(JObjectClass)
    ...
    {class} procedure setResultsSource(intent: JIntent; source: Integer); cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  ...
  JVoiceInteractor = interface(JObject)
    ...
    function isDestroyed: Boolean; cdecl;
    procedure notifyDirectActionsChanged; cdecl;
    function registerOnDestroyedCallback(executor: JExecutor; callback: JRunnable): Boolean; cdecl;
    ...
    function unregisterOnDestroyedCallback(callback: JRunnable): Boolean; cdecl;
  end;
  ...
  JGenericDocumentClass = interface(JObjectClass)
    ['{997DEDA6-1CD0-4964-A645-4DC14DD20854}']
    {class} function getMaxIndexedProperties: Integer; cdecl;
  end;

  [JavaSignature('android/app/appsearch/GenericDocument')]
  JGenericDocument = interface(JObject)
    ['{4D079F68-3186-4683-AC56-C9C3A3E14634}']
    function equals(other: JObject): Boolean; cdecl;
    function getCreationTimestampMillis: Int64; cdecl;
    function getId: JString; cdecl;
    function getNamespace: JString; cdecl;
    function getProperty(path: JString): JObject; cdecl;
    function getPropertyBoolean(path: JString): Boolean; cdecl;
    function getPropertyBooleanArray(path: JString): TJavaArray<Boolean>; cdecl;
    function getPropertyBytes(path: JString): TJavaArray<Byte>; cdecl;
    function getPropertyBytesArray(path: JString): TJavaBiArray<Byte>; cdecl;
    function getPropertyDocument(path: JString): JGenericDocument; cdecl;
    function getPropertyDocumentArray(path: JString): TJavaObjectArray<JGenericDocument>; cdecl;
    function getPropertyDouble(path: JString): Double; cdecl;
    function getPropertyDoubleArray(path: JString): TJavaArray<Double>; cdecl;
    function getPropertyLong(path: JString): Int64; cdecl;
    function getPropertyLongArray(path: JString): TJavaArray<Int64>; cdecl;
    function getPropertyNames: JSet; cdecl;
    function getPropertyString(path: JString): JString; cdecl;
    function getPropertyStringArray(path: JString): TJavaObjectArray<JString>; cdecl;
    function getSchemaType: JString; cdecl;
    function getScore: Integer; cdecl;
    function getTtlMillis: Int64; cdecl;
    function hashCode: Integer; cdecl;
    function toString: JString; cdecl;
  end;
  TJGenericDocument = class(TJavaGenericImport<JGenericDocumentClass, JGenericDocument>) end;
  ...
  JAppWidgetProviderInfoClass = interface(JObjectClass)
    ...
    {class} function _GetWIDGET_FEATURE_CONFIGURATION_OPTIONAL: Integer; cdecl;
    {class} function _GetWIDGET_FEATURE_HIDE_FROM_PICKER: Integer; cdecl;
    {class} function _GetWIDGET_FEATURE_RECONFIGURABLE: Integer; cdecl;
    ...
    {class} property WIDGET_FEATURE_CONFIGURATION_OPTIONAL: Integer read _GetWIDGET_FEATURE_CONFIGURATION_OPTIONAL;
    {class} property WIDGET_FEATURE_HIDE_FROM_PICKER: Integer read _GetWIDGET_FEATURE_HIDE_FROM_PICKER;
    {class} property WIDGET_FEATURE_RECONFIGURABLE: Integer read _GetWIDGET_FEATURE_RECONFIGURABLE;
  end;
  ...
  JAppWidgetProviderInfo = interface(JObject)
    ...
    function _GetmaxResizeHeight: Integer; cdecl;
    procedure _SetmaxResizeHeight(Value: Integer); cdecl;
    function _GetmaxResizeWidth: Integer; cdecl;
    procedure _SetmaxResizeWidth(Value: Integer); cdecl;
    ...
    function _GetpreviewLayout: Integer; cdecl;
    procedure _SetpreviewLayout(Value: Integer); cdecl;
    ...
    function _GettargetCellHeight: Integer; cdecl;
    procedure _SettargetCellHeight(Value: Integer); cdecl;
    function _GettargetCellWidth: Integer; cdecl;
    procedure _SettargetCellWidth(Value: Integer); cdecl;
    ...
    function _GetwidgetFeatures: Integer; cdecl;
    procedure _SetwidgetFeatures(Value: Integer); cdecl;
    function clone: JAppWidgetProviderInfo; cdecl;
    function describeContents: Integer; cdecl;
    function getActivityInfo: JActivityInfo; cdecl;
    function getProfile: JUserHandle; cdecl;
    function loadDescription(context: JContext): JCharSequence; cdecl;
    ...
    property maxResizeHeight: Integer read _GetmaxResizeHeight write _SetmaxResizeHeight;
    property maxResizeWidth: Integer read _GetmaxResizeWidth write _SetmaxResizeWidth;
    ...
    property previewLayout: Integer read _GetpreviewLayout write _SetpreviewLayout;
    ...
    property targetCellHeight: Integer read _GettargetCellHeight write _SettargetCellHeight;
    property targetCellWidth: Integer read _GettargetCellWidth write _SettargetCellWidth;
    ...
    property widgetFeatures: Integer read _GetwidgetFeatures write _SetwidgetFeatures;
  end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.App.JNotification_BubbleMetadata', TypeInfo(Androidapi.JNI.App.JNotification_BubbleMetadata));
  TRegTypes.RegisterType('Androidapi.JNI.App.JNotification_Builder', TypeInfo(Androidapi.JNI.App.JNotification_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.App.JNotification_Extender', TypeInfo(Androidapi.JNI.App.JNotification_Extender));
  TRegTypes.RegisterType('Androidapi.JNI.App.JNotification_Style', TypeInfo(Androidapi.JNI.App.JNotification_Style));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.App.Jandroid_app_Person', TypeInfo(Androidapi.JNI.App.Jandroid_app_Person));
  TRegTypes.RegisterType('Androidapi.JNI.App.Japp_Person_Builder', TypeInfo(Androidapi.JNI.App.Japp_Person_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.App.JPictureInPictureParams', TypeInfo(Androidapi.JNI.App.JPictureInPictureParams));
  TRegTypes.RegisterType('Androidapi.JNI.App.JPictureInPictureUiState', TypeInfo(Androidapi.JNI.App.JPictureInPictureUiState));
  TRegTypes.RegisterType('Androidapi.JNI.App.JRemoteAction', TypeInfo(Androidapi.JNI.App.JRemoteAction));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.App.JGenericDocument', TypeInfo(Androidapi.JNI.App.JGenericDocument));
