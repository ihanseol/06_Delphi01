...
// ===== Interface declarations =====
  ...
  JAccountManager = interface(JObject)
    ...
    function getAccountsByTypeAndFeatures(type_: JString; features: TJavaObjectArray<JString>; callback: JAccountManagerCallback; handler: JHandler): JAccountManagerFuture; cdecl;
