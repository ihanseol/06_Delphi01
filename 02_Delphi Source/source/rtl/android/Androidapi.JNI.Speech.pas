...
// ===== Forward declarations =====
  ...
  JRecognitionService_SupportCallback = interface;//android.speech.RecognitionService$SupportCallback
  JRecognitionSupport = interface;//android.speech.RecognitionSupport
  JRecognitionSupport_Builder = interface;//android.speech.RecognitionSupport$Builder
  JRecognitionSupportCallback = interface;//android.speech.RecognitionSupportCallback
...
// ===== Interface declarations =====
  ...
  JRecognitionService = interface(JService)
    ...
    function createContext(contextParams: JContextParams): JContext; cdecl;
    function onBind(intent: JIntent): JIBinder; cdecl;
    procedure onCheckRecognitionSupport(recognizerIntent: JIntent; supportCallback: JRecognitionService_SupportCallback); cdecl;
    procedure onDestroy; cdecl;
    procedure onTriggerModelDownload(recognizerIntent: JIntent); cdecl;
  end;
  ...
  JRecognitionService_Callback = interface(JObject)
    ...
    procedure endOfSegmentedSession; cdecl;
    procedure endOfSpeech; cdecl;
    procedure error(error: Integer); cdecl;
    function getCallingAttributionSource: JAttributionSource; cdecl;
    ...
    procedure segmentResults(results: JBundle); cdecl;
  end;
  ...
  JRecognitionService_SupportCallbackClass = interface(JObjectClass)
    ['{06FA9361-EF56-471E-B749-26F4FAF79EFF}']
  end;

  [JavaSignature('android/speech/RecognitionService$SupportCallback')]
  JRecognitionService_SupportCallback = interface(JObject)
    ['{90ED0DE9-634F-4E1F-A291-8E874B7FA0BE}']
    procedure onError(errorCode: Integer); cdecl;
    procedure onSupportResult(recognitionSupport: JRecognitionSupport); cdecl;
  end;
  TJRecognitionService_SupportCallback = class(TJavaGenericImport<JRecognitionService_SupportCallbackClass, JRecognitionService_SupportCallback>) end;

  JRecognitionSupportClass = interface(JObjectClass)
    ['{F57D43CD-B375-4691-ABFF-AD25E5106653}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/speech/RecognitionSupport')]
  JRecognitionSupport = interface(JObject)
    ['{0416ACE6-6DCE-4D2A-921B-07FF574A3AF6}']
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function getInstalledOnDeviceLanguages: JList; cdecl;
    function getOnlineLanguages: JList; cdecl;
    function getPendingOnDeviceLanguages: JList; cdecl;
    function getSupportedOnDeviceLanguages: JList; cdecl;
    function hashCode: Integer; cdecl;
    function toString: JString; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJRecognitionSupport = class(TJavaGenericImport<JRecognitionSupportClass, JRecognitionSupport>) end;

  JRecognitionSupport_BuilderClass = interface(JObjectClass)
    ['{0FD35A6D-EC0D-4712-95A2-943DA835E326}']
    {class} function init: JRecognitionSupport_Builder; cdecl;
  end;

  [JavaSignature('android/speech/RecognitionSupport$Builder')]
  JRecognitionSupport_Builder = interface(JObject)
    ['{9FE7121F-28CD-450E-B2F3-1200CD070378}']
    function addInstalledOnDeviceLanguage(value: JString): JRecognitionSupport_Builder; cdecl;
    function addOnlineLanguage(value: JString): JRecognitionSupport_Builder; cdecl;
    function addPendingOnDeviceLanguage(value: JString): JRecognitionSupport_Builder; cdecl;
    function addSupportedOnDeviceLanguage(value: JString): JRecognitionSupport_Builder; cdecl;
    function build: JRecognitionSupport; cdecl;
    function setInstalledOnDeviceLanguages(value: JList): JRecognitionSupport_Builder; cdecl;
    function setOnlineLanguages(value: JList): JRecognitionSupport_Builder; cdecl;
    function setPendingOnDeviceLanguages(value: JList): JRecognitionSupport_Builder; cdecl;
    function setSupportedOnDeviceLanguages(value: JList): JRecognitionSupport_Builder; cdecl;
  end;
  TJRecognitionSupport_Builder = class(TJavaGenericImport<JRecognitionSupport_BuilderClass, JRecognitionSupport_Builder>) end;

  JRecognitionSupportCallbackClass = interface(IJavaClass)
    ['{4317A1DC-DB9D-4D66-BFD3-6D06F8E16A12}']
  end;

  [JavaSignature('android/speech/RecognitionSupportCallback')]
  JRecognitionSupportCallback = interface(IJavaInstance)
    ['{7174FBE8-2E43-4E9F-AC26-B501E432AF01}']
    procedure onError(error: Integer); cdecl;
    procedure onSupportResult(recognitionSupport: JRecognitionSupport); cdecl;
  end;
  TJRecognitionSupportCallback = class(TJavaGenericImport<JRecognitionSupportCallbackClass, JRecognitionSupportCallback>) end;
  ...
  JRecognizerIntentClass = interface(JObjectClass)
    ...
    {class} function _GetEXTRA_AUDIO_INJECT_SOURCE: JString; cdecl;
    {class} function _GetEXTRA_AUDIO_SOURCE: JString; cdecl;
    {class} function _GetEXTRA_AUDIO_SOURCE_CHANNEL_COUNT: JString; cdecl;
    {class} function _GetEXTRA_AUDIO_SOURCE_ENCODING: JString; cdecl;
    {class} function _GetEXTRA_AUDIO_SOURCE_SAMPLING_RATE: JString; cdecl;
    {class} function _GetEXTRA_BIASING_STRINGS: JString; cdecl;
    {class} function _GetEXTRA_CALLING_PACKAGE: JString; cdecl;
    {class} function _GetEXTRA_CONFIDENCE_SCORES: JString; cdecl;
    {class} function _GetEXTRA_ENABLE_BIASING_DEVICE_CONTEXT: JString; cdecl;
    {class} function _GetEXTRA_ENABLE_FORMATTING: JString; cdecl;
    {class} function _GetEXTRA_HIDE_PARTIAL_TRAILING_PUNCTUATION: JString; cdecl;
    ...
    {class} function _GetEXTRA_MASK_OFFENSIVE_WORDS: JString; cdecl;
    ...
    {class} function _GetEXTRA_SEGMENTED_SESSION: JString; cdecl;
    ...
    {class} function _GetFORMATTING_OPTIMIZE_LATENCY: JString; cdecl;
    {class} function _GetFORMATTING_OPTIMIZE_QUALITY: JString; cdecl;
    ...
    {class} property EXTRA_AUDIO_INJECT_SOURCE: JString read _GetEXTRA_AUDIO_INJECT_SOURCE;
    {class} property EXTRA_AUDIO_SOURCE: JString read _GetEXTRA_AUDIO_SOURCE;
    {class} property EXTRA_AUDIO_SOURCE_CHANNEL_COUNT: JString read _GetEXTRA_AUDIO_SOURCE_CHANNEL_COUNT;
    {class} property EXTRA_AUDIO_SOURCE_ENCODING: JString read _GetEXTRA_AUDIO_SOURCE_ENCODING;
    {class} property EXTRA_AUDIO_SOURCE_SAMPLING_RATE: JString read _GetEXTRA_AUDIO_SOURCE_SAMPLING_RATE;
    {class} property EXTRA_BIASING_STRINGS: JString read _GetEXTRA_BIASING_STRINGS;
    ...
    {class} property EXTRA_ENABLE_BIASING_DEVICE_CONTEXT: JString read _GetEXTRA_ENABLE_BIASING_DEVICE_CONTEXT;
    {class} property EXTRA_ENABLE_FORMATTING: JString read _GetEXTRA_ENABLE_FORMATTING;
    {class} property EXTRA_HIDE_PARTIAL_TRAILING_PUNCTUATION: JString read _GetEXTRA_HIDE_PARTIAL_TRAILING_PUNCTUATION;
    ...
    {class} property EXTRA_MASK_OFFENSIVE_WORDS: JString read _GetEXTRA_MASK_OFFENSIVE_WORDS;
    ...
    {class} property EXTRA_SEGMENTED_SESSION: JString read _GetEXTRA_SEGMENTED_SESSION;
    ...
    {class} property FORMATTING_OPTIMIZE_LATENCY: JString read _GetFORMATTING_OPTIMIZE_LATENCY;
    {class} property FORMATTING_OPTIMIZE_QUALITY: JString read _GetFORMATTING_OPTIMIZE_QUALITY;
  ...
  JSpeechRecognizerClass = interface(JObjectClass)
    ...
    {class} function _GetERROR_CANNOT_CHECK_SUPPORT: Integer; cdecl;
    {class} function _GetERROR_CLIENT: Integer; cdecl;
    {class} function _GetERROR_INSUFFICIENT_PERMISSIONS: Integer; cdecl;
    {class} function _GetERROR_LANGUAGE_NOT_SUPPORTED: Integer; cdecl;
    {class} function _GetERROR_LANGUAGE_UNAVAILABLE: Integer; cdecl;
    ...
    {class} function _GetERROR_SERVER_DISCONNECTED: Integer; cdecl;
    ...
    {class} function createOnDeviceSpeechRecognizer(context: JContext): JSpeechRecognizer; cdecl;
    ...
    {class} function isOnDeviceRecognitionAvailable(context: JContext): Boolean; cdecl;
    ...
    {class} property ERROR_CANNOT_CHECK_SUPPORT: Integer read _GetERROR_CANNOT_CHECK_SUPPORT;
    ...
    {class} property ERROR_LANGUAGE_NOT_SUPPORTED: Integer read _GetERROR_LANGUAGE_NOT_SUPPORTED;
    {class} property ERROR_LANGUAGE_UNAVAILABLE: Integer read _GetERROR_LANGUAGE_UNAVAILABLE;
    ...
    {class} property ERROR_SERVER_DISCONNECTED: Integer read _GetERROR_SERVER_DISCONNECTED;
  ...
  JSpeechRecognizer = interface(JObject)
    ...
    procedure checkRecognitionSupport(recognizerIntent: JIntent; executor: JExecutor; supportListener: JRecognitionSupportCallback); cdecl;
    ...
    procedure triggerModelDownload(recognizerIntent: JIntent); cdecl;
  end;
  ...
  JTextToSpeech = interface(JObject)
    ...
    function addEarcon(earcon: JString; uri: Jnet_Uri): Integer; cdecl; overload;
    ...
    function addSpeech(text: JCharSequence; uri: Jnet_Uri): Integer; cdecl; overload;
    ...
    function synthesizeToFile(text: JCharSequence; params: JBundle; fileDescriptor: JParcelFileDescriptor; utteranceId: JString): Integer; cdecl; overload;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Speech.JRecognitionService_SupportCallback', TypeInfo(Androidapi.JNI.Speech.JRecognitionService_SupportCallback));
  TRegTypes.RegisterType('Androidapi.JNI.Speech.JRecognitionSupport', TypeInfo(Androidapi.JNI.Speech.JRecognitionSupport));
  TRegTypes.RegisterType('Androidapi.JNI.Speech.JRecognitionSupport_Builder', TypeInfo(Androidapi.JNI.Speech.JRecognitionSupport_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Speech.JRecognitionSupportCallback', TypeInfo(Androidapi.JNI.Speech.JRecognitionSupportCallback));
