...
// ===== Forward declarations =====
  ...
  JBuild_Partition = interface;//android.os.Build$Partition
  ...
  JCombinedVibration = interface;//android.os.CombinedVibration
  JCombinedVibration_ParallelCombination = interface;//android.os.CombinedVibration$ParallelCombination
  ...
  JMemoryFile = interface;//android.os.MemoryFile
  ...
  JOutcomeReceiver = interface;//android.os.OutcomeReceiver
  ...
  JPowerManager_OnThermalStatusChangedListener = interface;//android.os.PowerManager$OnThermalStatusChangedListener
  JPowerManager_WakeLock = interface;//android.os.PowerManager$WakeLock
  JPowerManager_WakeLockStateListener = interface;//android.os.PowerManager$WakeLockStateListener
  ...
  JVibrationAttributes = interface;//android.os.VibrationAttributes
  JVibrationEffect = interface;//android.os.VibrationEffect
  JVibrationEffect_Composition = interface;//android.os.VibrationEffect$Composition
  JVibrator = interface;//android.os.Vibrator
  JVibratorManager = interface;//android.os.VibratorManager
...
// ===== Interface declarations =====
  ...
  JManifest_permissionClass = interface(JObjectClass)
    ...
    {class} function _GetACCEPT_HANDOVER: JString; cdecl;
    {class} function _GetACCESS_BACKGROUND_LOCATION: JString; cdecl;
    {class} function _GetACCESS_BLOBS_ACROSS_USERS: JString; cdecl;
    ...
    {class} function _GetACCESS_MEDIA_LOCATION: JString; cdecl;
    ...
    {class} function _GetACTIVITY_RECOGNITION: JString; cdecl;
    ...
    {class} function _GetBIND_CALL_REDIRECTION_SERVICE: JString; cdecl;
    {class} function _GetBIND_CARRIER_MESSAGING_CLIENT_SERVICE: JString; cdecl;
    ...
    {class} function _GetBIND_COMPANION_DEVICE_SERVICE: JString; cdecl;
    {class} function _GetBIND_CONDITION_PROVIDER_SERVICE: JString; cdecl;
    {class} function _GetBIND_CONTROLS: JString; cdecl;
    ...
    {class} function _GetBIND_QUICK_ACCESS_WALLET_SERVICE: JString; cdecl;
    ...
    {class} function _GetBIND_TV_INTERACTIVE_APP: JString; cdecl;
    ...
    {class} function _GetBLUETOOTH_ADVERTISE: JString; cdecl;
    {class} function _GetBLUETOOTH_CONNECT: JString; cdecl;
    {class} function _GetBLUETOOTH_PRIVILEGED: JString; cdecl;
    {class} function _GetBLUETOOTH_SCAN: JString; cdecl;
    {class} function _GetBODY_SENSORS: JString; cdecl;
    {class} function _GetBODY_SENSORS_BACKGROUND: JString; cdecl;
    ...
    {class} function _GetCALL_COMPANION_APP: JString; cdecl;
    ...
    {class} function _GetDELIVER_COMPANION_MESSAGES: JString; cdecl;
    ...
    {class} function _GetFOREGROUND_SERVICE: JString; cdecl;
    ...
    {class} function _GetHIDE_OVERLAY_WINDOWS: JString; cdecl;
    {class} function _GetHIGH_SAMPLING_RATE_SENSORS: JString; cdecl;
    ...
    {class} function _GetINTERACT_ACROSS_PROFILES: JString; cdecl;
    {class} function _GetINTERNET: JString; cdecl;
    {class} function _GetKILL_BACKGROUND_PROCESSES: JString; cdecl;
    {class} function _GetLAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK: JString; cdecl;
    {class} function _GetLOADER_USAGE_STATS: JString; cdecl;
    {class} function _GetLOCATION_HARDWARE: JString; cdecl;
    {class} function _GetMANAGE_DOCUMENTS: JString; cdecl;
    {class} function _GetMANAGE_EXTERNAL_STORAGE: JString; cdecl;
    {class} function _GetMANAGE_MEDIA: JString; cdecl;
    {class} function _GetMANAGE_ONGOING_CALLS: JString; cdecl;
    {class} function _GetMANAGE_OWN_CALLS: JString; cdecl;
    {class} function _GetMANAGE_WIFI_INTERFACES: JString; cdecl;
    {class} function _GetMANAGE_WIFI_NETWORK_SELECTION: JString; cdecl;
    ...
    {class} function _GetNEARBY_WIFI_DEVICES: JString; cdecl;
    {class} function _GetNFC: JString; cdecl;
    {class} function _GetNFC_PREFERRED_PAYMENT_INFO: JString; cdecl;
    {class} function _GetNFC_TRANSACTION_EVENT: JString; cdecl;
    {class} function _GetOVERRIDE_WIFI_CONFIG: JString; cdecl;
    {class} function _GetPACKAGE_USAGE_STATS: JString; cdecl;
    {class} function _GetPERSISTENT_ACTIVITY: JString; cdecl;
    {class} function _GetPOST_NOTIFICATIONS: JString; cdecl;
    {class} function _GetPROCESS_OUTGOING_CALLS: JString; cdecl;
    {class} function _GetQUERY_ALL_PACKAGES: JString; cdecl;
    {class} function _GetREAD_ASSISTANT_APP_SEARCH_DATA: JString; cdecl;
    {class} function _GetREAD_BASIC_PHONE_STATE: JString; cdecl;
    ...
    {class} function _GetREAD_HOME_APP_SEARCH_DATA: JString; cdecl;
    {class} function _GetREAD_INPUT_STATE: JString; cdecl;
    {class} function _GetREAD_LOGS: JString; cdecl;
    {class} function _GetREAD_MEDIA_AUDIO: JString; cdecl;
    {class} function _GetREAD_MEDIA_IMAGES: JString; cdecl;
    {class} function _GetREAD_MEDIA_VIDEO: JString; cdecl;
    {class} function _GetREAD_NEARBY_STREAMING_POLICY: JString; cdecl;
    {class} function _GetREAD_PHONE_NUMBERS: JString; cdecl;
    {class} function _GetREAD_PHONE_STATE: JString; cdecl;
    {class} function _GetREAD_PRECISE_PHONE_STATE: JString; cdecl;
    ...
    {class} function _GetREQUEST_COMPANION_PROFILE_APP_STREAMING: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_PROFILE_COMPUTER: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_PROFILE_WATCH: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_RUN_IN_BACKGROUND: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_SELF_MANAGED: JString; cdecl;
    {class} function _GetREQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND: JString; cdecl;
    ...
    {class} function _GetREQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE: JString; cdecl;
    {class} function _GetREQUEST_PASSWORD_COMPLEXITY: JString; cdecl;
    {class} function _GetRESTART_PACKAGES: JString; cdecl;
    {class} function _GetSCHEDULE_EXACT_ALARM: JString; cdecl;
    ...
    {class} function _GetSMS_FINANCIAL_TRANSACTIONS: JString; cdecl;
    {class} function _GetSTART_FOREGROUND_SERVICES_FROM_BACKGROUND: JString; cdecl;
    {class} function _GetSTART_VIEW_APP_FEATURES: JString; cdecl;
    {class} function _GetSTART_VIEW_PERMISSION_USAGE: JString; cdecl;
    {class} function _GetSTATUS_BAR: JString; cdecl;
    {class} function _GetSUBSCRIBE_TO_KEYGUARD_LOCKED_STATE: JString; cdecl;
    ...
    {class} function _GetUPDATE_PACKAGES_WITHOUT_USER_ACTION: JString; cdecl;
    {class} function _GetUSE_BIOMETRIC: JString; cdecl;
    {class} function _GetUSE_EXACT_ALARM: JString; cdecl;
    {class} function _GetUSE_FINGERPRINT: JString; cdecl;
    {class} function _GetUSE_FULL_SCREEN_INTENT: JString; cdecl;
    {class} function _GetUSE_ICC_AUTH_WITH_DEVICE_IDENTIFIER: JString; cdecl;
    {class} function _GetUSE_SIP: JString; cdecl;
    {class} function _GetUWB_RANGING: JString; cdecl;
    ...
    {class} property ACCEPT_HANDOVER: JString read _GetACCEPT_HANDOVER;
    {class} property ACCESS_BACKGROUND_LOCATION: JString read _GetACCESS_BACKGROUND_LOCATION;
    {class} property ACCESS_BLOBS_ACROSS_USERS: JString read _GetACCESS_BLOBS_ACROSS_USERS;
    ...
    {class} property ACCESS_MEDIA_LOCATION: JString read _GetACCESS_MEDIA_LOCATION;
    ...
    {class} property ACTIVITY_RECOGNITION: JString read _GetACTIVITY_RECOGNITION;
    ...
    {class} property BIND_CALL_REDIRECTION_SERVICE: JString read _GetBIND_CALL_REDIRECTION_SERVICE;
    {class} property BIND_CARRIER_MESSAGING_CLIENT_SERVICE: JString read _GetBIND_CARRIER_MESSAGING_CLIENT_SERVICE;
    ...
    {class} property BIND_COMPANION_DEVICE_SERVICE: JString read _GetBIND_COMPANION_DEVICE_SERVICE;
    {class} property BIND_CONDITION_PROVIDER_SERVICE: JString read _GetBIND_CONDITION_PROVIDER_SERVICE;
    {class} property BIND_CONTROLS: JString read _GetBIND_CONTROLS;
    ...
    {class} property BIND_QUICK_ACCESS_WALLET_SERVICE: JString read _GetBIND_QUICK_ACCESS_WALLET_SERVICE;
    ...
    {class} property BIND_TV_INTERACTIVE_APP: JString read _GetBIND_TV_INTERACTIVE_APP;
    ...
    {class} property BLUETOOTH_ADVERTISE: JString read _GetBLUETOOTH_ADVERTISE;
    {class} property BLUETOOTH_CONNECT: JString read _GetBLUETOOTH_CONNECT;
    {class} property BLUETOOTH_PRIVILEGED: JString read _GetBLUETOOTH_PRIVILEGED;
    {class} property BLUETOOTH_SCAN: JString read _GetBLUETOOTH_SCAN;
    {class} property BODY_SENSORS: JString read _GetBODY_SENSORS;
    {class} property BODY_SENSORS_BACKGROUND: JString read _GetBODY_SENSORS_BACKGROUND;
    ...
    {class} property CALL_COMPANION_APP: JString read _GetCALL_COMPANION_APP;
    ...
    {class} property DELIVER_COMPANION_MESSAGES: JString read _GetDELIVER_COMPANION_MESSAGES;
    ...
    {class} property FOREGROUND_SERVICE: JString read _GetFOREGROUND_SERVICE;
    ...
    {class} property HIDE_OVERLAY_WINDOWS: JString read _GetHIDE_OVERLAY_WINDOWS;
    {class} property HIGH_SAMPLING_RATE_SENSORS: JString read _GetHIGH_SAMPLING_RATE_SENSORS;
    ...
    {class} property INTERACT_ACROSS_PROFILES: JString read _GetINTERACT_ACROSS_PROFILES;
    ...
    {class} property LAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK: JString read _GetLAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK;
    {class} property LOADER_USAGE_STATS: JString read _GetLOADER_USAGE_STATS;
    ...
    {class} property MANAGE_EXTERNAL_STORAGE: JString read _GetMANAGE_EXTERNAL_STORAGE;
    {class} property MANAGE_MEDIA: JString read _GetMANAGE_MEDIA;
    {class} property MANAGE_ONGOING_CALLS: JString read _GetMANAGE_ONGOING_CALLS;
    {class} property MANAGE_OWN_CALLS: JString read _GetMANAGE_OWN_CALLS;
    {class} property MANAGE_WIFI_INTERFACES: JString read _GetMANAGE_WIFI_INTERFACES;
    {class} property MANAGE_WIFI_NETWORK_SELECTION: JString read _GetMANAGE_WIFI_NETWORK_SELECTION;
    ...
    {class} property NEARBY_WIFI_DEVICES: JString read _GetNEARBY_WIFI_DEVICES;
    {class} property NFC: JString read _GetNFC;
    {class} property NFC_PREFERRED_PAYMENT_INFO: JString read _GetNFC_PREFERRED_PAYMENT_INFO;
    {class} property NFC_TRANSACTION_EVENT: JString read _GetNFC_TRANSACTION_EVENT;
    {class} property OVERRIDE_WIFI_CONFIG: JString read _GetOVERRIDE_WIFI_CONFIG;
    ...
    {class} property POST_NOTIFICATIONS: JString read _GetPOST_NOTIFICATIONS;
    {class} property PROCESS_OUTGOING_CALLS: JString read _GetPROCESS_OUTGOING_CALLS;
    {class} property QUERY_ALL_PACKAGES: JString read _GetQUERY_ALL_PACKAGES;
    {class} property READ_ASSISTANT_APP_SEARCH_DATA: JString read _GetREAD_ASSISTANT_APP_SEARCH_DATA;
    {class} property READ_BASIC_PHONE_STATE: JString read _GetREAD_BASIC_PHONE_STATE;
    ...
    {class} property READ_HOME_APP_SEARCH_DATA: JString read _GetREAD_HOME_APP_SEARCH_DATA;
    {class} property READ_INPUT_STATE: JString read _GetREAD_INPUT_STATE;
    {class} property READ_LOGS: JString read _GetREAD_LOGS;
    {class} property READ_MEDIA_AUDIO: JString read _GetREAD_MEDIA_AUDIO;
    {class} property READ_MEDIA_IMAGES: JString read _GetREAD_MEDIA_IMAGES;
    {class} property READ_MEDIA_VIDEO: JString read _GetREAD_MEDIA_VIDEO;
    {class} property READ_NEARBY_STREAMING_POLICY: JString read _GetREAD_NEARBY_STREAMING_POLICY;
    ...
    {class} property READ_PRECISE_PHONE_STATE: JString read _GetREAD_PRECISE_PHONE_STATE;
    ...
    {class} property REQUEST_COMPANION_PROFILE_APP_STREAMING: JString read _GetREQUEST_COMPANION_PROFILE_APP_STREAMING;
    {class} property REQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION: JString read _GetREQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION;
    {class} property REQUEST_COMPANION_PROFILE_COMPUTER: JString read _GetREQUEST_COMPANION_PROFILE_COMPUTER;
    {class} property REQUEST_COMPANION_PROFILE_WATCH: JString read _GetREQUEST_COMPANION_PROFILE_WATCH;
    {class} property REQUEST_COMPANION_RUN_IN_BACKGROUND: JString read _GetREQUEST_COMPANION_RUN_IN_BACKGROUND;
    {class} property REQUEST_COMPANION_SELF_MANAGED: JString read _GetREQUEST_COMPANION_SELF_MANAGED;
    {class} property REQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND: JString read _GetREQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND;
    ...
    {class} property REQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE: JString read _GetREQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE;
    {class} property REQUEST_PASSWORD_COMPLEXITY: JString read _GetREQUEST_PASSWORD_COMPLEXITY;
    {class} property RESTART_PACKAGES: JString read _GetRESTART_PACKAGES;
    {class} property SCHEDULE_EXACT_ALARM: JString read _GetSCHEDULE_EXACT_ALARM;
    ...
    {class} property SMS_FINANCIAL_TRANSACTIONS: JString read _GetSMS_FINANCIAL_TRANSACTIONS;
    {class} property START_FOREGROUND_SERVICES_FROM_BACKGROUND: JString read _GetSTART_FOREGROUND_SERVICES_FROM_BACKGROUND;
    {class} property START_VIEW_APP_FEATURES: JString read _GetSTART_VIEW_APP_FEATURES;
    {class} property START_VIEW_PERMISSION_USAGE: JString read _GetSTART_VIEW_PERMISSION_USAGE;
    {class} property STATUS_BAR: JString read _GetSTATUS_BAR;
    {class} property SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE: JString read _GetSUBSCRIBE_TO_KEYGUARD_LOCKED_STATE;
    ...
    {class} property UPDATE_PACKAGES_WITHOUT_USER_ACTION: JString read _GetUPDATE_PACKAGES_WITHOUT_USER_ACTION;
    {class} property USE_BIOMETRIC: JString read _GetUSE_BIOMETRIC;
    {class} property USE_EXACT_ALARM: JString read _GetUSE_EXACT_ALARM;
    {class} property USE_FINGERPRINT: JString read _GetUSE_FINGERPRINT;
    {class} property USE_FULL_SCREEN_INTENT: JString read _GetUSE_FULL_SCREEN_INTENT;
    {class} property USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER: JString read _GetUSE_ICC_AUTH_WITH_DEVICE_IDENTIFIER;
    {class} property USE_SIP: JString read _GetUSE_SIP;
    {class} property UWB_RANGING: JString read _GetUWB_RANGING;
  ...
  JManifest_permission_groupClass = interface(JObjectClass)
    ...
    {class} function _GetCALL_LOG: JString; cdecl;
    {class} function _GetCAMERA: JString; cdecl;
    ...
    {class} function _GetNEARBY_DEVICES: JString; cdecl;
    {class} function _GetNOTIFICATIONS: JString; cdecl;
    {class} function _GetPHONE: JString; cdecl;
    {class} function _GetREAD_MEDIA_AURAL: JString; cdecl;
    {class} function _GetREAD_MEDIA_VISUAL: JString; cdecl;
    ...
    {class} property CALL_LOG: JString read _GetCALL_LOG;
    {class} property CAMERA: JString read _GetCAMERA;
    ...
    {class} property NEARBY_DEVICES: JString read _GetNEARBY_DEVICES;
    {class} property NOTIFICATIONS: JString read _GetNOTIFICATIONS;
    {class} property PHONE: JString read _GetPHONE;
    {class} property READ_MEDIA_AURAL: JString read _GetREAD_MEDIA_AURAL;
    {class} property READ_MEDIA_VISUAL: JString read _GetREAD_MEDIA_VISUAL;
  ...
  JBaseBundle = interface(JObject)
    ...
    function &get(key: JString): JObject; cdecl;//Deprecated
  ...
  JBinderClass = interface(JObjectClass)
    ...
    {class} function init: JBinder; cdecl; overload;
    {class} function init(descriptor: JString): JBinder; cdecl; overload;
    {class} function clearCallingIdentity: Int64; cdecl;
    {class} function clearCallingWorkSource: Int64; cdecl;
    ...
    {class} function getCallingUidOrThrow: Integer; cdecl;
    {class} function getCallingUserHandle: JUserHandle; cdecl;
    {class} function getCallingWorkSourceUid: Integer; cdecl;
    {class} procedure joinThreadPool; cdecl;
    {class} procedure restoreCallingIdentity(token: Int64); cdecl;
    {class} procedure restoreCallingWorkSource(token: Int64); cdecl;
    {class} function setCallingWorkSourceUid(workSource: Integer): Int64; cdecl;
  end;
  ...
  JBuildClass = interface(JObjectClass)
    ...
    {class} function _GetODM_SKU: JString; cdecl;
    {class} function _GetPRODUCT: JString; cdecl;
    {class} function _GetRADIO: JString; cdecl;
    {class} function _GetSERIAL: JString; cdecl;
    {class} function _GetSKU: JString; cdecl;
    {class} function _GetSOC_MANUFACTURER: JString; cdecl;
    {class} function _GetSOC_MODEL: JString; cdecl;
    ...
    {class} function getFingerprintedPartitions: JList; cdecl;
    ...
    {class} property ODM_SKU: JString read _GetODM_SKU;
    ...
    {class} property SKU: JString read _GetSKU;
    {class} property SOC_MANUFACTURER: JString read _GetSOC_MANUFACTURER;
    {class} property SOC_MODEL: JString read _GetSOC_MODEL;
  ...
  JBuild_PartitionClass = interface(JObjectClass)
    ['{1C1C0615-9F3A-40B5-BF43-6B19A0F8FDAE}']
    {class} function _GetPARTITION_NAME_SYSTEM: JString; cdecl;
    {class} property PARTITION_NAME_SYSTEM: JString read _GetPARTITION_NAME_SYSTEM;
  end;

  [JavaSignature('android/os/Build$Partition')]
  JBuild_Partition = interface(JObject)
    ['{3AB8A374-0B62-483B-AB76-302F7FA3C84E}']
    function equals(o: JObject): Boolean; cdecl;
    function getBuildTimeMillis: Int64; cdecl;
    function getFingerprint: JString; cdecl;
    function getName: JString; cdecl;
    function hashCode: Integer; cdecl;
  end;
  TJBuild_Partition = class(TJavaGenericImport<JBuild_PartitionClass, JBuild_Partition>) end;
  ...
  JBuild_VERSIONClass = interface(JObjectClass)
    ...
    {class} function _GetMEDIA_PERFORMANCE_CLASS: Integer; cdecl;
    {class} function _GetPREVIEW_SDK_INT: Integer; cdecl;
    {class} function _GetRELEASE: JString; cdecl;
    {class} function _GetRELEASE_OR_CODENAME: JString; cdecl;
    {class} function _GetRELEASE_OR_PREVIEW_DISPLAY: JString; cdecl;
    ...
    {class} property MEDIA_PERFORMANCE_CLASS: Integer read _GetMEDIA_PERFORMANCE_CLASS;
    {class} property PREVIEW_SDK_INT: Integer read _GetPREVIEW_SDK_INT;
    {class} property RELEASE: JString read _GetRELEASE;
    {class} property RELEASE_OR_CODENAME: JString read _GetRELEASE_OR_CODENAME;
    {class} property RELEASE_OR_PREVIEW_DISPLAY: JString read _GetRELEASE_OR_PREVIEW_DISPLAY;
  ...
  JBuild_VERSION_CODESClass = interface(JObjectClass)
    ...
    {class} function _GetO_MR1: Integer; cdecl;
    ...
    {class} function _GetS_V2: Integer; cdecl;
    {class} function _GetTIRAMISU: Integer; cdecl;
    ...
    {class} property O_MR1: Integer read _GetO_MR1;
    ...
    {class} property S_V2: Integer read _GetS_V2;
    {class} property TIRAMISU: Integer read _GetTIRAMISU;
  end;
  ...
  JBundle = interface(JBaseBundle)
    ...
    function getParcelable(key: JString): JParcelable; cdecl; overload;//Deprecated
    function getParcelable(key: JString; clazz: Jlang_Class): JObject; cdecl; overload;
    function getParcelableArray(key: JString): TJavaObjectArray<JParcelable>; cdecl; overload;//Deprecated
    function getParcelableArray(key: JString; clazz: Jlang_Class): TJavaObjectArray<JObject>; cdecl; overload;
    function getParcelableArrayList(key: JString): JArrayList; cdecl; overload;//Deprecated
    function getParcelableArrayList(key: JString; clazz: Jlang_Class): JArrayList; cdecl; overload;
    function getSerializable(key: JString): JSerializable; cdecl; overload;//Deprecated
    function getSerializable(key: JString; clazz: Jlang_Class): JSerializable; cdecl; overload;
    ...
    function getSparseParcelableArray(key: JString): JSparseArray; cdecl; overload;//Deprecated
    function getSparseParcelableArray(key: JString; clazz: Jlang_Class): JSparseArray; cdecl; overload;
  ...
  JCombinedVibrationClass = interface(JObjectClass)
    ['{118F09BF-ECEA-409A-B388-58A6BB789889}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function createParallel(effect: JVibrationEffect): JCombinedVibration; cdecl;
    {class} function startParallel: JCombinedVibration_ParallelCombination; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/os/CombinedVibration')]
  JCombinedVibration = interface(JObject)
    ['{8F715E35-5219-4F9E-9A7A-566A90DD690B}']
    function describeContents: Integer; cdecl;
  end;
  TJCombinedVibration = class(TJavaGenericImport<JCombinedVibrationClass, JCombinedVibration>) end;

  JCombinedVibration_ParallelCombinationClass = interface(JObjectClass)
    ['{7BA3FB19-F553-49B8-9C66-B7EE4AF8E095}']
  end;

  [JavaSignature('android/os/CombinedVibration$ParallelCombination')]
  JCombinedVibration_ParallelCombination = interface(JObject)
    ['{2070F893-8EF3-460B-95AF-FBB3AB592969}']
    function addVibrator(vibratorId: Integer; effect: JVibrationEffect): JCombinedVibration_ParallelCombination; cdecl;
    function combine: JCombinedVibration; cdecl;
  end;
  TJCombinedVibration_ParallelCombination = class(TJavaGenericImport<JCombinedVibration_ParallelCombinationClass, JCombinedVibration_ParallelCombination>) end;
  ...
  JEnvironmentClass = interface(JObjectClass)
    ...
    {class} function _GetDIRECTORY_RECORDINGS: JString; cdecl;
    {class} procedure _SetDIRECTORY_RECORDINGS(Value: JString); cdecl;
    ...
    {class} function getStorageDirectory: JFile; cdecl;
    ...
    {class} function isExternalStorageLegacy: Boolean; cdecl; overload;
    {class} function isExternalStorageLegacy(path: JFile): Boolean; cdecl; overload;
    {class} function isExternalStorageManager: Boolean; cdecl; overload;
    {class} function isExternalStorageManager(path: JFile): Boolean; cdecl; overload;
    ...
    {class} property DIRECTORY_AUDIOBOOKS: JString read _GetDIRECTORY_AUDIOBOOKS write _SetDIRECTORY_AUDIOBOOKS;
    ...
    {class} property DIRECTORY_RECORDINGS: JString read _GetDIRECTORY_RECORDINGS write _SetDIRECTORY_RECORDINGS;
    {class} property DIRECTORY_RINGTONES: JString read _GetDIRECTORY_RINGTONES write _SetDIRECTORY_RINGTONES;
    {class} property DIRECTORY_SCREENSHOTS: JString read _GetDIRECTORY_SCREENSHOTS write _SetDIRECTORY_SCREENSHOTS;
  ...
  JHandlerClass = interface(JObjectClass)
    ...
    {class} function init: JHandler; cdecl; overload;//Deprecated
    {class} function init(callback: JHandler_Callback): JHandler; cdecl; overload;//Deprecated
    ...
    {class} function createAsync(looper: JLooper): JHandler; cdecl; overload;
    {class} function createAsync(looper: JLooper; callback: JHandler_Callback): JHandler; cdecl; overload;
  end;
  ...
  JHandler = interface(JObject)
    ...
    function hasCallbacks(r: JRunnable): Boolean; cdecl;
    ...
    function postDelayed(r: JRunnable; delayMillis: Int64): Boolean; cdecl; overload;
    function postDelayed(r: JRunnable; token: JObject; delayMillis: Int64): Boolean; cdecl; overload;
  ...
  JIBinderClass = interface(IJavaClass)
    ...
    {class} function getSuggestedMaxIpcSizeBytes: Integer; cdecl;
  ...
  JLocaleListClass = interface(JObjectClass)
    ...
    {class} //function isPseudoLocale(locale: JULocale): Boolean; cdecl;
    {class} function matchesLanguageAndScript(supported: JLocale; desired: JLocale): Boolean; cdecl;
  ...
  JLooperClass = interface(JObjectClass)
    ...
    {class} procedure prepareMainLooper; cdecl;//Deprecated
  end;
  ...
  JMemoryFileClass = interface(JObjectClass)
    ['{888BE692-91F5-44BD-A97A-43EA01ED9EF4}']
    {class} function init(name: JString; length: Integer): JMemoryFile; cdecl;
  end;

  [JavaSignature('android/os/MemoryFile')]
  JMemoryFile = interface(JObject)
    ['{BF7447B3-E2AB-4C5F-BD29-2288E55676C5}']
    function allowPurging(allowPurging: Boolean): Boolean; cdecl;//Deprecated
    procedure close; cdecl;
    function getInputStream: JInputStream; cdecl;
    function getOutputStream: JOutputStream; cdecl;
    function isPurgingAllowed: Boolean; cdecl;//Deprecated
    function length: Integer; cdecl;
    function readBytes(buffer: TJavaArray<Byte>; srcOffset: Integer; destOffset: Integer; count: Integer): Integer; cdecl;
    procedure writeBytes(buffer: TJavaArray<Byte>; srcOffset: Integer; destOffset: Integer; count: Integer); cdecl;
  end;
  TJMemoryFile = class(TJavaGenericImport<JMemoryFileClass, JMemoryFile>) end;
  ...
  JOutcomeReceiverClass = interface(IJavaClass)
    ['{948C9628-E25F-42FD-83B7-03059477A669}']
  end;

  [JavaSignature('android/os/OutcomeReceiver')]
  JOutcomeReceiver = interface(IJavaInstance)
    ['{A66FF574-2EC2-4B20-9667-58ACC94EDB0F}']
    procedure onError(error: JThrowable); cdecl;
    procedure onResult(result: JObject); cdecl;
  end;
  TJOutcomeReceiver = class(TJavaGenericImport<JOutcomeReceiverClass, JOutcomeReceiver>) end;
  ...
  JParcelClass = interface(JObjectClass)
    ...
    {class} function obtain: JParcel; cdecl; overload;
    {class} function obtain(binder: JIBinder): JParcel; cdecl; overload;
  ...
  JParcel = interface(JObject)
    ...
    function createInterfaceArray(newArray: JIntFunction; asInterface: JFunction): TJavaObjectArray<JIInterface>; cdecl;
    function createInterfaceArrayList(asInterface: JFunction): JArrayList; cdecl;
    ...
    function createTypedArrayMap(creator: JParcelable_Creator): Jutil_ArrayMap; cdecl;
    function createTypedSparseArray(creator: JParcelable_Creator): JSparseArray; cdecl;
    ...
    procedure enforceNoDataAvail; cdecl;
    function hasFileDescriptors: Boolean; cdecl; overload;
    function hasFileDescriptors(offset: Integer; length: Integer): Boolean; cdecl; overload;
    function marshall: TJavaArray<Byte>; cdecl;
    function readArray(loader: JClassLoader): TJavaObjectArray<JObject>; cdecl; overload;//Deprecated
    function readArray(loader: JClassLoader; clazz: Jlang_Class): TJavaObjectArray<JObject>; cdecl; overload;
    function readArrayList(loader: JClassLoader): JArrayList; cdecl; overload;//Deprecated
    function readArrayList(loader: JClassLoader; clazz: Jlang_Class): JArrayList; cdecl; overload;
    procedure readBinderArray(val: TJavaObjectArray<JIBinder>); cdecl;
    procedure readBinderList(list: JList); cdecl;
    function readBlob: TJavaArray<Byte>; cdecl;
    ...
    procedure readFixedArray(val: JObject); cdecl; overload;
    procedure readFixedArray(val: JObject; asInterface: JFunction); cdecl; overload;
    procedure readFixedArray(val: JObject; c: JParcelable_Creator); cdecl; overload;
    function readFloat: Single; cdecl;
    procedure readFloatArray(val: TJavaArray<Single>); cdecl;
    function readHashMap(loader: JClassLoader): JHashMap; cdecl; overload;//Deprecated
    function readHashMap(loader: JClassLoader; clazzKey: Jlang_Class; clazzValue: Jlang_Class): JHashMap; cdecl; overload;
    function readInt: Integer; cdecl;
    procedure readIntArray(val: TJavaArray<Integer>); cdecl;
    procedure readInterfaceArray(val: TJavaObjectArray<JIInterface>; asInterface: JFunction); cdecl;
    procedure readInterfaceList(list: JList; asInterface: JFunction); cdecl;
    procedure readList(outVal: JList; loader: JClassLoader); cdecl; overload;//Deprecated
    procedure readList(outVal: JList; loader: JClassLoader; clazz: Jlang_Class); cdecl; overload;
    function readLong: Int64; cdecl;
    procedure readLongArray(val: TJavaArray<Int64>); cdecl;
    procedure readMap(outVal: JMap; loader: JClassLoader); cdecl; overload;//Deprecated
    procedure readMap(outVal: JMap; loader: JClassLoader; clazzKey: Jlang_Class; clazzValue: Jlang_Class); cdecl; overload;
    function readParcelable(loader: JClassLoader): JParcelable; cdecl; overload;//Deprecated
    function readParcelable(loader: JClassLoader; clazz: Jlang_Class): JObject; cdecl; overload;
    function readParcelableArray(loader: JClassLoader): TJavaObjectArray<JParcelable>; cdecl; overload;//Deprecated
    function readParcelableArray(loader: JClassLoader; clazz: Jlang_Class): TJavaObjectArray<JObject>; cdecl; overload;
    function readParcelableCreator(loader: JClassLoader): JParcelable_Creator; cdecl; overload;//Deprecated
    function readParcelableCreator(loader: JClassLoader; clazz: Jlang_Class): JParcelable_Creator; cdecl; overload;
    function readParcelableList(list: JList; cl: JClassLoader): JList; cdecl; overload;//Deprecated
    function readParcelableList(list: JList; cl: JClassLoader; clazz: Jlang_Class): JList; cdecl; overload;
    ...
    function readSerializable: JSerializable; cdecl; overload;//Deprecated
    function readSerializable(loader: JClassLoader; clazz: Jlang_Class): JObject; cdecl; overload;
    function readSize: Jutil_Size; cdecl;
    function readSizeF: JSizeF; cdecl;
    function readSparseArray(loader: JClassLoader): JSparseArray; cdecl; overload;//Deprecated
    function readSparseArray(loader: JClassLoader; clazz: Jlang_Class): JSparseArray; cdecl; overload;
    ...
    procedure setPropagateAllowBlocking; cdecl;
    ...
    procedure writeBlob(b: TJavaArray<Byte>); cdecl; overload;
    procedure writeBlob(b: TJavaArray<Byte>; offset: Integer; len: Integer); cdecl; overload;
    ...
    procedure writeInterfaceArray(val: TJavaObjectArray<JIInterface>); cdecl;
    procedure writeInterfaceList(val: JList); cdecl;
    ...
    procedure writeParcelableCreator(p: JParcelable); cdecl;
    procedure writeParcelableList(val: JList; flags: Integer); cdecl;
    ...
    procedure writeTypedArrayMap(val: Jutil_ArrayMap; parcelableFlags: Integer); cdecl;
    procedure writeTypedList(val: JList); cdecl;
    procedure writeTypedObject(val: JParcelable; parcelableFlags: Integer); cdecl;
    procedure writeTypedSparseArray(val: JSparseArray; parcelableFlags: Integer); cdecl;
  ...
  JParcelFileDescriptorClass = interface(JObjectClass)
    ...
    {class} function wrap(pfd: JParcelFileDescriptor; handler: JHandler; listener: JParcelFileDescriptor_OnCloseListener): JParcelFileDescriptor; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  ...
  JPatternMatcherClass = interface(JObjectClass)
    ...
    {class} function _GetPATTERN_SUFFIX: Integer; cdecl;
    ...
    {class} property PATTERN_SUFFIX: Integer read _GetPATTERN_SUFFIX;
  end;
  ...
  JPersistableBundleClass = interface(JBaseBundleClass)
    ...
    {class} function readFromStream(inputStream: JInputStream): JPersistableBundle; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  ...
  JPersistableBundle = interface(JBaseBundle)
    ...
    function toString: JString; cdecl;
    procedure writeToParcel(parcel: JParcel; flags: Integer); cdecl;
    procedure writeToStream(outputStream: JOutputStream); cdecl;
  end;
  ...
  JPowerManagerClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_DEVICE_LIGHT_IDLE_MODE_CHANGED: JString; cdecl;
    {class} function _GetACTION_LOW_POWER_STANDBY_ENABLED_CHANGED: JString; cdecl;
    {class} function _GetACTION_POWER_SAVE_MODE_CHANGED: JString; cdecl;
    {class} function _GetFULL_WAKE_LOCK: Integer; cdecl;
    {class} function _GetLOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF: Integer; cdecl;
    {class} function _GetLOCATION_MODE_FOREGROUND_ONLY: Integer; cdecl;
    {class} function _GetLOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF: Integer; cdecl;
    {class} function _GetLOCATION_MODE_NO_CHANGE: Integer; cdecl;
    {class} function _GetLOCATION_MODE_THROTTLE_REQUESTS_WHEN_SCREEN_OFF: Integer; cdecl;
    ...
    {class} function _GetTHERMAL_STATUS_CRITICAL: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_EMERGENCY: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_LIGHT: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_MODERATE: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_NONE: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_SEVERE: Integer; cdecl;
    {class} function _GetTHERMAL_STATUS_SHUTDOWN: Integer; cdecl;
    ...
    {class} property ACTION_DEVICE_LIGHT_IDLE_MODE_CHANGED: JString read _GetACTION_DEVICE_LIGHT_IDLE_MODE_CHANGED;
    {class} property ACTION_LOW_POWER_STANDBY_ENABLED_CHANGED: JString read _GetACTION_LOW_POWER_STANDBY_ENABLED_CHANGED;
    ...
    {class} property LOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF: Integer read _GetLOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF;
    {class} property LOCATION_MODE_FOREGROUND_ONLY: Integer read _GetLOCATION_MODE_FOREGROUND_ONLY;
    {class} property LOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF: Integer read _GetLOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF;
    {class} property LOCATION_MODE_NO_CHANGE: Integer read _GetLOCATION_MODE_NO_CHANGE;
    {class} property LOCATION_MODE_THROTTLE_REQUESTS_WHEN_SCREEN_OFF: Integer read _GetLOCATION_MODE_THROTTLE_REQUESTS_WHEN_SCREEN_OFF;
    ...
    {class} property THERMAL_STATUS_CRITICAL: Integer read _GetTHERMAL_STATUS_CRITICAL;
    {class} property THERMAL_STATUS_EMERGENCY: Integer read _GetTHERMAL_STATUS_EMERGENCY;
    {class} property THERMAL_STATUS_LIGHT: Integer read _GetTHERMAL_STATUS_LIGHT;
    {class} property THERMAL_STATUS_MODERATE: Integer read _GetTHERMAL_STATUS_MODERATE;
    {class} property THERMAL_STATUS_NONE: Integer read _GetTHERMAL_STATUS_NONE;
    {class} property THERMAL_STATUS_SEVERE: Integer read _GetTHERMAL_STATUS_SEVERE;
    {class} property THERMAL_STATUS_SHUTDOWN: Integer read _GetTHERMAL_STATUS_SHUTDOWN;
  end;

  [JavaSignature('android/os/PowerManager')]
  JPowerManager = interface(JObject)
    ['{53E56DDD-6061-438E-9C19-ECDE3B32FE22}']
    procedure addThermalStatusListener(listener: JPowerManager_OnThermalStatusChangedListener); cdecl; overload;
    procedure addThermalStatusListener(executor: JExecutor; listener: JPowerManager_OnThermalStatusChangedListener); cdecl; overload;
    function getBatteryDischargePrediction: Jtime_Duration; cdecl;
    function getCurrentThermalStatus: Integer; cdecl;
    function getLocationPowerSaveMode: Integer; cdecl;
    function getThermalHeadroom(forecastSeconds: Integer): Single; cdecl;
    procedure goToSleep(time: Int64); cdecl;
    function isBatteryDischargePredictionPersonalized: Boolean; cdecl;
    function isDeviceIdleMode: Boolean; cdecl;
    function isDeviceLightIdleMode: Boolean; cdecl;
    function isIgnoringBatteryOptimizations(packageName: JString): Boolean; cdecl;
    function isInteractive: Boolean; cdecl;
    function isLowPowerStandbyEnabled: Boolean; cdecl;
    function isPowerSaveMode: Boolean; cdecl;
    function isRebootingUserspaceSupported: Boolean; cdecl;
    ...
    procedure removeThermalStatusListener(listener: JPowerManager_OnThermalStatusChangedListener); cdecl;
    procedure userActivity(when: Int64; noChangeLights: Boolean); cdecl;//Deprecated
    procedure wakeUp(time: Int64); cdecl;//Deprecated
  end;
  TJPowerManager = class(TJavaGenericImport<JPowerManagerClass, JPowerManager>) end;

  JPowerManager_OnThermalStatusChangedListenerClass = interface(IJavaClass)
    ['{4E477B38-6485-462C-9004-C1240FE9993B}']
  end;

  [JavaSignature('android/os/PowerManager$OnThermalStatusChangedListener')]
  JPowerManager_OnThermalStatusChangedListener = interface(IJavaInstance)
    ['{EF6B63D8-C202-420B-9583-5A72EF3034A5}']
    procedure onThermalStatusChanged(status: Integer); cdecl;
  end;
  TJPowerManager_OnThermalStatusChangedListener = class(TJavaGenericImport<JPowerManager_OnThermalStatusChangedListenerClass, JPowerManager_OnThermalStatusChangedListener>) end;
  ...
  JPowerManager_WakeLock = interface(JObject)
    ...
    procedure setStateListener(executor: JExecutor; listener: JPowerManager_WakeLockStateListener); cdecl;
  ...
  JPowerManager_WakeLockStateListenerClass = interface(IJavaClass)
    ['{13DC4AA8-03BA-43B0-8139-B371A60ED136}']
  end;

  [JavaSignature('android/os/PowerManager$WakeLockStateListener')]
  JPowerManager_WakeLockStateListener = interface(IJavaInstance)
    ['{DDCBF38B-1F61-4CD0-87DC-37EC24927F18}']
    procedure onStateChanged(enabled: Boolean); cdecl;
  end;
  TJPowerManager_WakeLockStateListener = class(TJavaGenericImport<JPowerManager_WakeLockStateListenerClass, JPowerManager_WakeLockStateListener>) end;
  ...
  JRemoteException = interface(JAndroidException)
    ...
    function rethrowAsRuntimeException: JRuntimeException; cdecl;
    function rethrowFromSystemServer: JRuntimeException; cdecl;
  end;
  ...
  JVibrationAttributesClass = interface(JObjectClass)
    ['{591A75E6-8543-4E83-9F9D-B1151478A972}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function _GetFLAG_BYPASS_INTERRUPTION_POLICY: Integer; cdecl;
    {class} function _GetUSAGE_ACCESSIBILITY: Integer; cdecl;
    {class} function _GetUSAGE_ALARM: Integer; cdecl;
    {class} function _GetUSAGE_CLASS_ALARM: Integer; cdecl;
    {class} function _GetUSAGE_CLASS_FEEDBACK: Integer; cdecl;
    {class} function _GetUSAGE_CLASS_MASK: Integer; cdecl;
    {class} function _GetUSAGE_CLASS_MEDIA: Integer; cdecl;
    {class} function _GetUSAGE_CLASS_UNKNOWN: Integer; cdecl;
    {class} function _GetUSAGE_COMMUNICATION_REQUEST: Integer; cdecl;
    {class} function _GetUSAGE_HARDWARE_FEEDBACK: Integer; cdecl;
    {class} function _GetUSAGE_MEDIA: Integer; cdecl;
    {class} function _GetUSAGE_NOTIFICATION: Integer; cdecl;
    {class} function _GetUSAGE_PHYSICAL_EMULATION: Integer; cdecl;
    {class} function _GetUSAGE_RINGTONE: Integer; cdecl;
    {class} function _GetUSAGE_TOUCH: Integer; cdecl;
    {class} function _GetUSAGE_UNKNOWN: Integer; cdecl;
    {class} function createForUsage(usage: Integer): JVibrationAttributes; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
    {class} property FLAG_BYPASS_INTERRUPTION_POLICY: Integer read _GetFLAG_BYPASS_INTERRUPTION_POLICY;
    {class} property USAGE_ACCESSIBILITY: Integer read _GetUSAGE_ACCESSIBILITY;
    {class} property USAGE_ALARM: Integer read _GetUSAGE_ALARM;
    {class} property USAGE_CLASS_ALARM: Integer read _GetUSAGE_CLASS_ALARM;
    {class} property USAGE_CLASS_FEEDBACK: Integer read _GetUSAGE_CLASS_FEEDBACK;
    {class} property USAGE_CLASS_MASK: Integer read _GetUSAGE_CLASS_MASK;
    {class} property USAGE_CLASS_MEDIA: Integer read _GetUSAGE_CLASS_MEDIA;
    {class} property USAGE_CLASS_UNKNOWN: Integer read _GetUSAGE_CLASS_UNKNOWN;
    {class} property USAGE_COMMUNICATION_REQUEST: Integer read _GetUSAGE_COMMUNICATION_REQUEST;
    {class} property USAGE_HARDWARE_FEEDBACK: Integer read _GetUSAGE_HARDWARE_FEEDBACK;
    ...
    {class} property USAGE_PHYSICAL_EMULATION: Integer read _GetUSAGE_PHYSICAL_EMULATION;
    {class} property USAGE_RINGTONE: Integer read _GetUSAGE_RINGTONE;
    {class} property USAGE_TOUCH: Integer read _GetUSAGE_TOUCH;
    {class} property USAGE_UNKNOWN: Integer read _GetUSAGE_UNKNOWN;
  end;

  [JavaSignature('android/os/VibrationAttributes')]
  JVibrationAttributes = interface(JObject)
    ['{643E38F6-A537-42D9-8317-78249F9920A1}']
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function getFlags: Integer; cdecl;
    function getUsage: Integer; cdecl;
    function getUsageClass: Integer; cdecl;
    function hashCode: Integer; cdecl;
    function isFlagSet(flag: Integer): Boolean; cdecl;
    function toString: JString; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJVibrationAttributes = class(TJavaGenericImport<JVibrationAttributesClass, JVibrationAttributes>) end;
  ...
  JVibrationEffectClass = interface(JObjectClass)
    ...
    {class} function _GetEFFECT_CLICK: Integer; cdecl;
    {class} function _GetEFFECT_DOUBLE_CLICK: Integer; cdecl;
    {class} function _GetEFFECT_HEAVY_CLICK: Integer; cdecl;
    {class} function _GetEFFECT_TICK: Integer; cdecl;
    {class} function createOneShot(milliseconds: Int64; amplitude: Integer): JVibrationEffect; cdecl;
    {class} function createPredefined(effectId: Integer): JVibrationEffect; cdecl;
    ...
    {class} function startComposition: JVibrationEffect_Composition; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
    {class} property DEFAULT_AMPLITUDE: Integer read _GetDEFAULT_AMPLITUDE;
    {class} property EFFECT_CLICK: Integer read _GetEFFECT_CLICK;
    {class} property EFFECT_DOUBLE_CLICK: Integer read _GetEFFECT_DOUBLE_CLICK;
    {class} property EFFECT_HEAVY_CLICK: Integer read _GetEFFECT_HEAVY_CLICK;
    {class} property EFFECT_TICK: Integer read _GetEFFECT_TICK;
  end;
  ...
  JVibrationEffect_CompositionClass = interface(JObjectClass)
    ['{C58A9285-CDCC-4069-B92F-2CA1B9382D00}']
    {class} function _GetPRIMITIVE_CLICK: Integer; cdecl;
    {class} function _GetPRIMITIVE_LOW_TICK: Integer; cdecl;
    {class} function _GetPRIMITIVE_QUICK_FALL: Integer; cdecl;
    {class} function _GetPRIMITIVE_QUICK_RISE: Integer; cdecl;
    {class} function _GetPRIMITIVE_SLOW_RISE: Integer; cdecl;
    {class} function _GetPRIMITIVE_SPIN: Integer; cdecl;
    {class} function _GetPRIMITIVE_THUD: Integer; cdecl;
    {class} function _GetPRIMITIVE_TICK: Integer; cdecl;
    {class} property PRIMITIVE_CLICK: Integer read _GetPRIMITIVE_CLICK;
    {class} property PRIMITIVE_LOW_TICK: Integer read _GetPRIMITIVE_LOW_TICK;
    {class} property PRIMITIVE_QUICK_FALL: Integer read _GetPRIMITIVE_QUICK_FALL;
    {class} property PRIMITIVE_QUICK_RISE: Integer read _GetPRIMITIVE_QUICK_RISE;
    {class} property PRIMITIVE_SLOW_RISE: Integer read _GetPRIMITIVE_SLOW_RISE;
    {class} property PRIMITIVE_SPIN: Integer read _GetPRIMITIVE_SPIN;
    {class} property PRIMITIVE_THUD: Integer read _GetPRIMITIVE_THUD;
    {class} property PRIMITIVE_TICK: Integer read _GetPRIMITIVE_TICK;
  end;

  [JavaSignature('android/os/VibrationEffect$Composition')]
  JVibrationEffect_Composition = interface(JObject)
    ['{20CB37C3-CEAB-4319-9C2C-7EFD90333BEB}']
    function addPrimitive(primitiveId: Integer): JVibrationEffect_Composition; cdecl; overload;
    function addPrimitive(primitiveId: Integer; scale: Single): JVibrationEffect_Composition; cdecl; overload;
    function addPrimitive(primitiveId: Integer; scale: Single; delay: Integer): JVibrationEffect_Composition; cdecl; overload;
    function compose: JVibrationEffect; cdecl;
  end;
  TJVibrationEffect_Composition = class(TJavaGenericImport<JVibrationEffect_CompositionClass, JVibrationEffect_Composition>) end;

  JVibratorClass = interface(JObjectClass)
    ['{00EEB92F-8145-441D-81C3-218E7B271F1B}']
    {class} function _GetVIBRATION_EFFECT_SUPPORT_NO: Integer; cdecl;
    {class} function _GetVIBRATION_EFFECT_SUPPORT_UNKNOWN: Integer; cdecl;
    {class} function _GetVIBRATION_EFFECT_SUPPORT_YES: Integer; cdecl;
    {class} property VIBRATION_EFFECT_SUPPORT_NO: Integer read _GetVIBRATION_EFFECT_SUPPORT_NO;
    {class} property VIBRATION_EFFECT_SUPPORT_UNKNOWN: Integer read _GetVIBRATION_EFFECT_SUPPORT_UNKNOWN;
    {class} property VIBRATION_EFFECT_SUPPORT_YES: Integer read _GetVIBRATION_EFFECT_SUPPORT_YES;
  end;
  ...
  JVibrator = interface(JObject)
    ...
    //procedure vibrate(vibe: JVibrationEffect; attributes: JAudioAttributes); cdecl; overload;//Deprecated
    procedure vibrate(vibe: JVibrationEffect; attributes: JVibrationAttributes); cdecl; overload;
  end;
  TJVibrator = class(TJavaGenericImport<JVibratorClass, JVibrator>) end;

  JVibratorManagerClass = interface(JObjectClass)
    ['{42FF417C-3D9A-487C-AA86-94D1A7D714D3}']
  end;

  [JavaSignature('android/os/VibratorManager')]
  JVibratorManager = interface(JObject)
    ['{51D8FAF2-D797-4664-BE84-A0BF3AF6B0DE}']
    procedure cancel; cdecl;
    function getDefaultVibrator: JVibrator; cdecl;
    function getVibrator(vibratorId: Integer): JVibrator; cdecl;
    function getVibratorIds: TJavaArray<Integer>; cdecl;
    procedure vibrate(effect: JCombinedVibration); cdecl; overload;
    procedure vibrate(effect: JCombinedVibration; attributes: JVibrationAttributes); cdecl; overload;
  end;
  TJVibratorManager = class(TJavaGenericImport<JVibratorManagerClass, JVibratorManager>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JAsyncTask', TypeInfo(Androidapi.JNI.Os.JAsyncTask));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JAsyncTask_Status', TypeInfo(Androidapi.JNI.Os.JAsyncTask_Status));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JBuild_Partition', TypeInfo(Androidapi.JNI.Os.JBuild_Partition));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JCombinedVibration', TypeInfo(Androidapi.JNI.Os.JCombinedVibration));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JCombinedVibration_ParallelCombination', TypeInfo(Androidapi.JNI.Os.JCombinedVibration_ParallelCombination));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JMemoryFile', TypeInfo(Androidapi.JNI.Os.JMemoryFile));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JOutcomeReceiver', TypeInfo(Androidapi.JNI.Os.JOutcomeReceiver));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JPowerManager_OnThermalStatusChangedListener', TypeInfo(Androidapi.JNI.Os.JPowerManager_OnThermalStatusChangedListener));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JPowerManager_WakeLock', TypeInfo(Androidapi.JNI.Os.JPowerManager_WakeLock));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JPowerManager_WakeLockStateListener', TypeInfo(Androidapi.JNI.Os.JPowerManager_WakeLockStateListener));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Os.JVibrationAttributes', TypeInfo(Androidapi.JNI.Os.JVibrationAttributes));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JVibrationEffect', TypeInfo(Androidapi.JNI.Os.JVibrationEffect));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JVibrationEffect_Composition', TypeInfo(Androidapi.JNI.Os.JVibrationEffect_Composition));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JVibrator', TypeInfo(Androidapi.JNI.Os.JVibrator));
  TRegTypes.RegisterType('Androidapi.JNI.Os.JVibratorManager', TypeInfo(Androidapi.JNI.Os.JVibratorManager));
