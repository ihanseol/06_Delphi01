...
procedure TLocalServiceConnection.TJavaServiceConnection.onNullBinding(name: JComponentName);
begin
end;
...
procedure TRemoteServiceConnection.TJavaServiceConnection.onNullBinding(name: JComponentName);
begin
end;
