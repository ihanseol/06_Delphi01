...
// ===== Forward declarations =====
  ...
  JRemoteViews_RemoteCollectionItems = interface;//android.widget.RemoteViews$RemoteCollectionItems
  JRemoteViews_RemoteResponse = interface;//android.widget.RemoteViews$RemoteResponse
  ...
  JToast_Callback = interface;//android.widget.Toast$Callback
  ...
  JInlinePresentationSpec = interface;//android.widget.inline.InlinePresentationSpec
...
// ===== Interface declarations =====
  ...
  JAbsListView = interface(JAdapterView)
    ...
    function getAccessibilityClassName: JCharSequence; cdecl;
    function getBottomEdgeEffectColor: Integer; cdecl;
    ...
    function getTopEdgeEffectColor: Integer; cdecl;
    ...
    function isDrawSelectorOnTop: Boolean; cdecl;
    ...
    function isSelectedChildViewEnabled: Boolean; cdecl;
    ...
    procedure onProvideContentCaptureStructure(structure: JViewStructure; flags: Integer); cdecl;
    ...
    procedure setBottomEdgeEffectColor(color: Integer); cdecl;
    ...
    procedure setSelectedChildViewEnabled(selectedChildViewEnabled: Boolean); cdecl;
    ...
    procedure setTopEdgeEffectColor(color: Integer); cdecl;
  ...
  JTextView = interface(JView)
    ...
    function getAutofillHints: TJavaObjectArray<JString>; cdecl;
    ...
    function getCompoundDrawableTintBlendMode: JBlendMode; cdecl;
    ...
    function getFirstBaselineToTopHeight: Integer; cdecl;
    procedure getFocusedRect(r: JRect); cdecl;
    ...
    function getLastBaselineToBottomHeight: Integer; cdecl;
    ...
    function getLineBreakStyle: Integer; cdecl;
    function getLineBreakWordStyle: Integer; cdecl;
    ...
    function getTextCursorDrawable: JDrawable; cdecl;
    function getTextDirectionHeuristic: JTextDirectionHeuristic; cdecl;
    function getTextLocale: JLocale; cdecl;
    function getTextLocales: JLocaleList; cdecl;
    function getTextMetricsParams: JPrecomputedText_Params; cdecl;
    function getTextScaleX: Single; cdecl;
    function getTextSelectHandle: JDrawable; cdecl;
    function getTextSelectHandleLeft: JDrawable; cdecl;
    function getTextSelectHandleRight: JDrawable; cdecl;
    function getTextSize: Single; cdecl;
    function getTextSizeUnit: Integer; cdecl;
    ...
    function isAllCaps: Boolean; cdecl;
    function isCursorVisible: Boolean; cdecl;
    function isElegantTextHeight: Boolean; cdecl;
    function isFallbackLineSpacing: Boolean; cdecl;
    function isHorizontallyScrollable: Boolean; cdecl;
    function isInputMethodTarget: Boolean; cdecl;
    function isSingleLine: Boolean; cdecl;
    ...
    function onCreateInputConnection(outAttrs: JEditorInfo): JInputConnection; cdecl;
    procedure onCreateViewTranslationRequest(supportedFormats: TJavaArray<Integer>; requestsCollector: JConsumer); cdecl;
    ...
    function onReceiveContent(payload: JContentInfo): JContentInfo; cdecl;
    function onResolvePointerIcon(event: JMotionEvent; pointerIndex: Integer): JPointerIcon; cdecl;
    procedure onRestoreInstanceState(state: JParcelable); cdecl;
    procedure onRtlPropertiesChanged(layoutDirection: Integer); cdecl;
    function onSaveInstanceState: JParcelable; cdecl;
    ...
    procedure setCompoundDrawableTintBlendMode(blendMode: JBlendMode); cdecl;
    ...
    procedure setFallbackLineSpacing(enabled: Boolean); cdecl;
    procedure setFilters(filters: TJavaObjectArray<JInputFilter>); cdecl;
    procedure setFirstBaselineToTopHeight(firstBaselineToTopHeight: Integer); cdecl;
    ...
    procedure setLastBaselineToBottomHeight(lastBaselineToBottomHeight: Integer); cdecl;
    procedure setLetterSpacing(letterSpacing: Single); cdecl;
    procedure setLineBreakStyle(lineBreakStyle: Integer); cdecl;
    procedure setLineBreakWordStyle(lineBreakWordStyle: Integer); cdecl;
    procedure setLineHeight(lineHeight: Integer); cdecl;
    ...
    procedure setTextCursorDrawable(textCursorDrawable: JDrawable); cdecl; overload;
    procedure setTextCursorDrawable(textCursorDrawable: Integer); cdecl; overload;
    ...
    procedure setTextMetricsParams(params: JPrecomputedText_Params); cdecl;
    procedure setTextScaleX(size: Single); cdecl;
    procedure setTextSelectHandle(textSelectHandle: JDrawable); cdecl; overload;
    procedure setTextSelectHandle(textSelectHandle: Integer); cdecl; overload;
    procedure setTextSelectHandleLeft(textSelectHandleLeft: JDrawable); cdecl; overload;
    procedure setTextSelectHandleLeft(textSelectHandleLeft: Integer); cdecl; overload;
    procedure setTextSelectHandleRight(textSelectHandleRight: JDrawable); cdecl; overload;
    procedure setTextSelectHandleRight(textSelectHandleRight: Integer); cdecl; overload;
  ...
  JCompoundButton = interface(JButton)
    ...
    function getButtonTintBlendMode: JBlendMode; cdecl;
    ...
    procedure setButtonIcon(icon: JIcon); cdecl;
    procedure setButtonTintBlendMode(tintMode: JBlendMode); cdecl;
    ...
    procedure setStateDescription(stateDescription: JCharSequence); cdecl;
  ...
  JImageView = interface(JView)
    ...
    procedure animateTransform(matrix: JMatrix); cdecl;
    ...
    function getImageTintBlendMode: JBlendMode; cdecl;
    ...
    procedure setImageTintBlendMode(blendMode: JBlendMode); cdecl;
  ...
  JPopupWindow = interface(JObject)
    ...
    function getEpicenterBounds: JRect; cdecl;
    ...
    function isClipToScreenEnabled: Boolean; cdecl;//Deprecated
    function isClippedToScreen: Boolean; cdecl;
    function isClippingEnabled: Boolean; cdecl;
    function isFocusable: Boolean; cdecl;
    function isLaidOutInScreen: Boolean; cdecl;
    function isLayoutInScreenEnabled: Boolean; cdecl;//Deprecated
    function isOutsideTouchable: Boolean; cdecl;
    function isShowing: Boolean; cdecl;
    function isSplitTouchEnabled: Boolean; cdecl;
    function isTouchModal: Boolean; cdecl;
    ...
    procedure setClipToScreenEnabled(enabled: Boolean); cdecl;//Deprecated
    ...
    procedure setEpicenterBounds(bounds: JRect); cdecl;
    ...
    procedure setIsClippedToScreen(enabled: Boolean); cdecl;
    procedure setIsLaidOutInScreen(enabled: Boolean); cdecl;
    procedure setLayoutInScreenEnabled(enabled: Boolean); cdecl;//Deprecated
    ...
    procedure setTouchModal(touchModal: Boolean); cdecl;
  ...
  JRelativeLayout = interface(JViewGroup)
    ...
    function getBaseline: Integer; cdecl;
    function getGravity: Integer; cdecl;
    function getIgnoreGravity: Integer; cdecl;
    procedure requestLayout; cdecl;
    procedure setGravity(gravity: Integer); cdecl;
    procedure setHorizontalGravity(horizontalGravity: Integer); cdecl;
  ...
  JRemoteViewsClass = interface(JObjectClass)
    ...
    {class} function _GetEXTRA_CHECKED: JString; cdecl;
    {class} function _GetEXTRA_SHARED_ELEMENT_BOUNDS: JString; cdecl;
    {class} function _GetMARGIN_BOTTOM: Integer; cdecl;
    {class} function _GetMARGIN_END: Integer; cdecl;
    {class} function _GetMARGIN_LEFT: Integer; cdecl;
    {class} function _GetMARGIN_RIGHT: Integer; cdecl;
    {class} function _GetMARGIN_START: Integer; cdecl;
    {class} function _GetMARGIN_TOP: Integer; cdecl;
    {class} function init(packageName: JString; layoutId: Integer): JRemoteViews; cdecl; overload;
    {class} function init(packageName: JString; layoutId: Integer; viewId: Integer): JRemoteViews; cdecl; overload;
    {class} function init(landscape: JRemoteViews; portrait: JRemoteViews): JRemoteViews; cdecl; overload;
    {class} function init(remoteViews: JMap): JRemoteViews; cdecl; overload;
    {class} function init(src: JRemoteViews): JRemoteViews; cdecl; overload;
    {class} function init(parcel: JParcel): JRemoteViews; cdecl; overload;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
    {class} property EXTRA_CHECKED: JString read _GetEXTRA_CHECKED;
    {class} property EXTRA_SHARED_ELEMENT_BOUNDS: JString read _GetEXTRA_SHARED_ELEMENT_BOUNDS;
    {class} property MARGIN_BOTTOM: Integer read _GetMARGIN_BOTTOM;
    {class} property MARGIN_END: Integer read _GetMARGIN_END;
    {class} property MARGIN_LEFT: Integer read _GetMARGIN_LEFT;
    {class} property MARGIN_RIGHT: Integer read _GetMARGIN_RIGHT;
    {class} property MARGIN_START: Integer read _GetMARGIN_START;
    {class} property MARGIN_TOP: Integer read _GetMARGIN_TOP;
  end;

  [JavaSignature('android/widget/RemoteViews')]
  JRemoteViews = interface(JObject)
    ['{C4C8FF03-5E94-4821-9401-A3DCA8A1119A}']
    procedure addStableView(viewId: Integer; nestedView: JRemoteViews; stableId: Integer); cdecl;
    ...
    function clone: JRemoteViews; cdecl;//Deprecated
    function describeContents: Integer; cdecl;
    function getLayoutId: Integer; cdecl;
    function getPackage: JString; cdecl;
    function getViewId: Integer; cdecl;
    function onLoadClass(clazz: Jlang_Class): Boolean; cdecl;//Deprecated
    ...
    procedure setBlendMode(viewId: Integer; methodName: JString; value: JBlendMode); cdecl;
    ...
    procedure setCharSequence(viewId: Integer; methodName: JString; value: JCharSequence); cdecl; overload;
    procedure setCharSequence(viewId: Integer; methodName: JString; stringResource: Integer); cdecl; overload;
    procedure setCharSequenceAttr(viewId: Integer; methodName: JString; stringAttribute: Integer); cdecl;
    ...
    procedure setColor(viewId: Integer; methodName: JString; colorResource: Integer); cdecl;
    procedure setColorAttr(viewId: Integer; methodName: JString; colorAttribute: Integer); cdecl;
    procedure setColorInt(viewId: Integer; methodName: JString; notNight: Integer; night: Integer); cdecl;
    procedure setColorStateList(viewId: Integer; methodName: JString; value: JColorStateList); cdecl; overload;
    procedure setColorStateList(viewId: Integer; methodName: JString; notNight: JColorStateList; night: JColorStateList); cdecl; overload;
    procedure setColorStateList(viewId: Integer; methodName: JString; colorResource: Integer); cdecl; overload;
    procedure setColorStateListAttr(viewId: Integer; methodName: JString; colorAttr: Integer); cdecl;
    procedure setCompoundButtonChecked(viewId: Integer; checked: Boolean); cdecl;
    ...
    procedure setFloatDimen(viewId: Integer; methodName: JString; dimenResource: Integer); cdecl; overload;
    procedure setFloatDimen(viewId: Integer; methodName: JString; value: Single; unit_: Integer); cdecl; overload;
    procedure setFloatDimenAttr(viewId: Integer; methodName: JString; dimenAttr: Integer); cdecl;
    procedure setIcon(viewId: Integer; methodName: JString; value: JIcon); cdecl; overload;
    procedure setIcon(viewId: Integer; methodName: JString; notNight: JIcon; night: JIcon); cdecl; overload;
    ...
    procedure setIntDimen(viewId: Integer; methodName: JString; dimenResource: Integer); cdecl; overload;
    procedure setIntDimen(viewId: Integer; methodName: JString; value: Single; unit_: Integer); cdecl; overload;
    procedure setIntDimenAttr(viewId: Integer; methodName: JString; dimenAttr: Integer); cdecl;
    ...
    procedure setLightBackgroundLayoutId(layoutId: Integer); cdecl;
    procedure setLong(viewId: Integer; methodName: JString; value: Int64); cdecl;
    procedure setOnCheckedChangeResponse(viewId: Integer; response: JRemoteViews_RemoteResponse); cdecl;
    ...
    procedure setOnClickResponse(viewId: Integer; response: JRemoteViews_RemoteResponse); cdecl;
    ...
    procedure setRadioGroupChecked(viewId: Integer; checkedId: Integer); cdecl;
    ...
    procedure setRemoteAdapter(viewId: Integer; items: JRemoteViews_RemoteCollectionItems); cdecl; overload;
    ...
    procedure setViewLayoutHeight(viewId: Integer; height: Single; units: Integer); cdecl;
    procedure setViewLayoutHeightAttr(viewId: Integer; heightAttr: Integer); cdecl;
    procedure setViewLayoutHeightDimen(viewId: Integer; heightDimen: Integer); cdecl;
    procedure setViewLayoutMargin(viewId: Integer; type_: Integer; value: Single; units: Integer); cdecl;
    procedure setViewLayoutMarginAttr(viewId: Integer; type_: Integer; attr: Integer); cdecl;
    procedure setViewLayoutMarginDimen(viewId: Integer; type_: Integer; dimen: Integer); cdecl;
    procedure setViewLayoutWidth(viewId: Integer; width: Single; units: Integer); cdecl;
    procedure setViewLayoutWidthAttr(viewId: Integer; widthAttr: Integer); cdecl;
    procedure setViewLayoutWidthDimen(viewId: Integer; widthDimen: Integer); cdecl;
    procedure setViewOutlinePreferredRadius(viewId: Integer; radius: Single; units: Integer); cdecl;
    procedure setViewOutlinePreferredRadiusAttr(viewId: Integer; attrId: Integer); cdecl;
    procedure setViewOutlinePreferredRadiusDimen(viewId: Integer; resId: Integer); cdecl;
    ...
    procedure showNext(viewId: Integer); cdecl;//Deprecated
    procedure showPrevious(viewId: Integer); cdecl;//Deprecated
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJRemoteViews = class(TJavaGenericImport<JRemoteViewsClass, JRemoteViews>) end;

  JRemoteViews_RemoteCollectionItemsClass = interface(JObjectClass)
    ['{97475CCA-2469-4B99-B18E-B3D704D9DD72}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/widget/RemoteViews$RemoteCollectionItems')]
  JRemoteViews_RemoteCollectionItems = interface(JObject)
    ['{9EE17B9A-890E-4624-938A-FBA2AF1B93AF}']
    function describeContents: Integer; cdecl;
    function getItemCount: Integer; cdecl;
    function getItemId(position: Integer): Int64; cdecl;
    function getItemView(position: Integer): JRemoteViews; cdecl;
    function getViewTypeCount: Integer; cdecl;
    function hasStableIds: Boolean; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJRemoteViews_RemoteCollectionItems = class(TJavaGenericImport<JRemoteViews_RemoteCollectionItemsClass, JRemoteViews_RemoteCollectionItems>) end;

  JRemoteViews_RemoteResponseClass = interface(JObjectClass)
    ['{0EFE66E7-7DF2-449F-8045-9DDD211B1A5C}']
    {class} function init: JRemoteViews_RemoteResponse; cdecl;
    {class} function fromFillInIntent(fillIntent: JIntent): JRemoteViews_RemoteResponse; cdecl;
    {class} //function fromPendingIntent(pendingIntent: JPendingIntent): JRemoteViews_RemoteResponse; cdecl;
  end;

  [JavaSignature('android/widget/RemoteViews$RemoteResponse')]
  JRemoteViews_RemoteResponse = interface(JObject)
    ['{3294D4EB-2ACA-4D20-BB2E-41C3A2415E05}']
    function addSharedElement(viewId: Integer; sharedElementName: JString): JRemoteViews_RemoteResponse; cdecl;
  end;
  TJRemoteViews_RemoteResponse = class(TJavaGenericImport<JRemoteViews_RemoteResponseClass, JRemoteViews_RemoteResponse>) end;
  ...
  JScrollView = interface(JFrameLayout)
    ...
    procedure scrollToDescendant(child: JView); cdecl;
    procedure setBottomEdgeEffectColor(color: Integer); cdecl;
    procedure setEdgeEffectColor(color: Integer); cdecl;
  ...
  JSwitch = interface(JCompoundButton)
    ...
    function getThumbTintBlendMode: JBlendMode; cdecl;
    ...
    function getTrackTintBlendMode: JBlendMode; cdecl;
    ...
    procedure setThumbIcon(icon: JIcon); cdecl;
    procedure setThumbResource(resId: Integer); cdecl;
    procedure setThumbTextPadding(pixels: Integer); cdecl;
    procedure setThumbTintBlendMode(blendMode: JBlendMode); cdecl;
    ...
    procedure setTrackIcon(icon: JIcon); cdecl;
    procedure setTrackResource(resId: Integer); cdecl;
    procedure setTrackTintBlendMode(blendMode: JBlendMode); cdecl;
  ...
  JToast_CallbackClass = interface(JObjectClass)
    ['{5B7B430A-3347-4F99-8DDC-C30A57A39A1F}']
    {class} function init: JToast_Callback; cdecl;
  end;

  [JavaSignature('android/widget/Toast$Callback')]
  JToast_Callback = interface(JObject)
    ['{CA966240-3628-4D50-83F5-86B3A3663824}']
    procedure onToastHidden; cdecl;
    procedure onToastShown; cdecl;
  end;
  TJToast_Callback = class(TJavaGenericImport<JToast_CallbackClass, JToast_Callback>) end;
  ...
  JToolbar = interface(JViewGroup)
    ...
    function getCollapseContentDescription: JCharSequence; cdecl;
    function getCollapseIcon: JDrawable; cdecl;
    ...
    procedure onRtlPropertiesChanged(layoutDirection: Integer); cdecl;
    function onTouchEvent(ev: JMotionEvent): Boolean; cdecl;
    procedure setCollapseContentDescription(resId: Integer); cdecl; overload;
    procedure setCollapseContentDescription(description: JCharSequence); cdecl; overload;
    procedure setCollapseIcon(resId: Integer); cdecl; overload;
    procedure setCollapseIcon(icon: JDrawable); cdecl; overload;
  ...
  JInlinePresentationSpecClass = interface(JObjectClass)
    ['{0D2BD85F-6E07-4AE7-882A-2F832C53A8DE}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/widget/inline/InlinePresentationSpec')]
  JInlinePresentationSpec = interface(JObject)
    ['{00A0315A-55BC-4D51-ADA0-352ADAEDD524}']
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function getMaxSize: Jutil_Size; cdecl;
    function getMinSize: Jutil_Size; cdecl;
    function getStyle: JBundle; cdecl;
    function hashCode: Integer; cdecl;
    function toString: JString; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJInlinePresentationSpec = class(TJavaGenericImport<JInlinePresentationSpecClass, JInlinePresentationSpec>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JRemoteViews_RemoteCollectionItems', TypeInfo(Androidapi.JNI.Widget.JRemoteViews_RemoteCollectionItems));
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JRemoteViews_RemoteResponse', TypeInfo(Androidapi.JNI.Widget.JRemoteViews_RemoteResponse));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JToast_Callback', TypeInfo(Androidapi.JNI.Widget.JToast_Callback));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JInlinePresentationSpec', TypeInfo(Androidapi.JNI.Widget.JInlinePresentationSpec));
end;
