...
// ===== Forward declarations =====
  ...
  JBiometricFragmentActivity = interface;//com.embarcadero.firemonkey.biometricauth.BiometricFragmentActivity
  JBiometricFragmentActivityListener = interface;//com.embarcadero.firemonkey.biometricauth.BiometricFragmentActivityListener
  ...
  JBitmapDecodeException = interface;//com.embarcadero.firemonkey.decode.BitmapDecodeException
  JBitmapDecodeRequest = interface;//com.embarcadero.firemonkey.decode.BitmapDecodeRequest
  JBitmapDecodeRequestParams = interface;//com.embarcadero.firemonkey.decode.BitmapDecodeRequestParams
  JBitmapDecodeRequestParams_Builder = interface;//com.embarcadero.firemonkey.decode.BitmapDecodeRequestParams$Builder
  JBitmapDecoder = interface;//com.embarcadero.firemonkey.decode.BitmapDecoder
  ...
  JFileNotCreatedException = interface;//com.embarcadero.firemonkey.medialibrary.FileNotCreatedException
  JPhotoActivityClient = interface;//com.embarcadero.firemonkey.medialibrary.PhotoActivityClient
  JPhotoActivityRequestKind = interface;//com.embarcadero.firemonkey.medialibrary.PhotoActivityRequestKind
  JPhotoActivityResponse = interface;//com.embarcadero.firemonkey.medialibrary.PhotoActivityResponse
  JPhotoActivityResponseListener = interface;//com.embarcadero.firemonkey.medialibrary.PhotoActivityResponseListener
  JPhotoClient = interface;//com.embarcadero.firemonkey.medialibrary.PhotoClient
  JPhotoResponse = interface;//com.embarcadero.firemonkey.medialibrary.PhotoResponse
  JPhotoResponseListener = interface;//com.embarcadero.firemonkey.medialibrary.PhotoResponseListener
  JPickPhotoActivityRequestParams = interface;//com.embarcadero.firemonkey.medialibrary.PickPhotoActivityRequestParams
  JPickPhotoActivityRequestParams_Builder = interface;//com.embarcadero.firemonkey.medialibrary.PickPhotoActivityRequestParams$Builder
  JPickerPresentation = interface;//com.embarcadero.firemonkey.medialibrary.PickerPresentation
  JSavePhotoRequestParams = interface;//com.embarcadero.firemonkey.medialibrary.SavePhotoRequestParams
  JSavePhotoRequestParams_Builder = interface;//com.embarcadero.firemonkey.medialibrary.SavePhotoRequestParams$Builder
  JTakePhotoActivityRequestParams = interface;//com.embarcadero.firemonkey.medialibrary.TakePhotoActivityRequestParams
  JTakePhotoActivityRequestParams_Builder = interface;//com.embarcadero.firemonkey.medialibrary.TakePhotoActivityRequestParams$Builder
  ...
  JForwardingPhoneStateListener = interface;//com.embarcadero.firemonkey.telephony.ForwardingPhoneStateListener
  JForwardingTelephonyCallback = interface;//com.embarcadero.firemonkey.telephony.ForwardingTelephonyCallback
  Jtelephony_ICustomPhoneStateListener = interface;//com.embarcadero.firemonkey.telephony.ICustomPhoneStateListener
  JPhoneDialerListener = interface;//com.embarcadero.firemonkey.telephony.PhoneDialerListener
  ...
  JNativeDispatchException = interface;//com.embarcadero.rtl.NativeDispatchException
  JNativeDispatchHelper = interface;//com.embarcadero.rtl.NativeDispatchHelper
...
// ===== Interface declarations =====
  ...
  JFMXNativeActivity = interface(JNativeActivity)
    ...
    function getPhotoActivityClient: JPhotoActivityClient; cdecl;
    function getPhotoClient: JPhotoClient; cdecl;
  ...
  JBiometricFragmentActivityClass = interface(JFragmentActivityClass)
    ['{8EBA225F-7259-4B49-B1EC-852B313012B0}']
    ...
    {class} function init: JBiometricFragmentActivity; cdecl;
    {class} procedure start(context: JContext; listener: JBiometricFragmentActivityListener); cdecl;
  ...
  [JavaSignature('com/embarcadero/firemonkey/biometricauth/BiometricFragmentActivity')]
  JBiometricFragmentActivity = interface(JFragmentActivity)
    ['{24A30576-525D-44CC-AAE1-919580382D73}']
    procedure authenticate(promptInfo: JBiometricPrompt_PromptInfo); cdecl;
    procedure cancel; cdecl;
    procedure onResume; cdecl;
  end;
  TJBiometricFragmentActivity = class(TJavaGenericImport<JBiometricFragmentActivityClass, JBiometricFragmentActivity>) end;

  JBiometricFragmentActivityListenerClass = interface(IJavaClass)
    ['{D983D83F-983B-45D9-A84B-CCFEAD1F6FCD}']
  end;

  [JavaSignature('com/embarcadero/firemonkey/biometricauth/BiometricFragmentActivityListener')]
  JBiometricFragmentActivityListener = interface(IJavaInstance)
    ['{AAA960B0-4D1F-4335-AD3E-812A00F072C0}']
  ...
  TJBiometricFragmentActivityListener = class(TJavaGenericImport<JBiometricFragmentActivityListenerClass, JBiometricFragmentActivityListener>) end;
  ...
  JBitmapDecodeExceptionClass = interface(JIOExceptionClass)
    ['{6988755F-B0FA-4FF2-9792-34938FFD5454}']
    {class} function init(message: JString): JBitmapDecodeException; cdecl; overload;
    {class} function init(cause: JThrowable): JBitmapDecodeException; cdecl; overload;
  end;

  [JavaSignature('com/embarcadero/firemonkey/decode/BitmapDecodeException')]
  JBitmapDecodeException = interface(JIOException)
    ['{A49EA78E-3407-488E-9889-836BCAED37B0}']
  end;
  TJBitmapDecodeException = class(TJavaGenericImport<JBitmapDecodeExceptionClass, JBitmapDecodeException>) end;

  JBitmapDecodeRequestClass = interface(JObjectClass)
    ['{266B83D3-B3D7-4FFF-8E2E-77F14B43C5D1}']
    {class} function create(uri: Jnet_Uri; params: JBitmapDecodeRequestParams): JBitmapDecodeRequest; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/decode/BitmapDecodeRequest')]
  JBitmapDecodeRequest = interface(JObject)
    ['{C18493B1-1E69-44C4-ACE9-D137F8F5882E}']
  end;
  TJBitmapDecodeRequest = class(TJavaGenericImport<JBitmapDecodeRequestClass, JBitmapDecodeRequest>) end;

  JBitmapDecodeRequestParamsClass = interface(JObjectClass)
    ['{D0ABF70A-D9CA-46A0-B616-E545602D20AC}']
    {class} function newBuilder(context: JContext): JBitmapDecodeRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/decode/BitmapDecodeRequestParams')]
  JBitmapDecodeRequestParams = interface(JObject)
    ['{D62EB9EF-D17F-4C61-81F1-04FC92D902A5}']
  end;
  TJBitmapDecodeRequestParams = class(TJavaGenericImport<JBitmapDecodeRequestParamsClass, JBitmapDecodeRequestParams>) end;

  JBitmapDecodeRequestParams_BuilderClass = interface(JObjectClass)
    ['{85313390-BE95-43BB-B7E8-05E599A16682}']
    {class} function init(context: JContext): JBitmapDecodeRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/decode/BitmapDecodeRequestParams$Builder')]
  JBitmapDecodeRequestParams_Builder = interface(JObject)
    ['{160F8235-99FA-49C6-983D-F9FAE0E9AA95}']
    function build: JBitmapDecodeRequestParams; cdecl;
    function setMaximumSize(maximumSize: Jutil_Size): JBitmapDecodeRequestParams_Builder; cdecl;
  end;
  TJBitmapDecodeRequestParams_Builder = class(TJavaGenericImport<JBitmapDecodeRequestParams_BuilderClass, JBitmapDecodeRequestParams_Builder>) end;

  JBitmapDecoderClass = interface(JObjectClass)
    ['{191D7D50-0CBB-4089-B493-973045647665}']
    {class} function decode(request: JBitmapDecodeRequest): JBitmap; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/decode/BitmapDecoder')]
  JBitmapDecoder = interface(JObject)
    ['{41612BFF-B095-46EC-B151-BC807870B039}']
  end;
  TJBitmapDecoder = class(TJavaGenericImport<JBitmapDecoderClass, JBitmapDecoder>) end;
  ...
  JFMXDialogFactory = interface(JObject)
    ...
    function createInputQueryDialog(activity: JFMXNativeActivity; title: JString; prompts: TJavaObjectArray<JString>; values: TJavaObjectArray<JString>; captions: TJavaObjectArray<JString>): JFMXStandardDialog; cdecl;
    function createMessageDialog(activity: JFMXNativeActivity; msg: JString; dlgType: Integer; captions: TJavaObjectArray<JString>; posButton: Integer; negButton: Integer; neutralButton: Integer): JFMXStandardDialog; cdecl;
  end;
  ...
  JFMXDefaultAlertDialogClass = interface(JFMXDefaultStandardDialogClass)
    ...
    {class} function init(activity: JFMXNativeActivity; msg: JString; dlgType: Integer; captions: TJavaObjectArray<JString>; posButton: Integer; negButton: Integer; neutralButton: Integer): JFMXDefaultAlertDialog; cdecl;
  end;
  ...
  JFMXDefaultInputQueryDialogClass = interface(JFMXDefaultStandardDialogClass)
    ...
    {class} function init(activity: JFMXNativeActivity; title: JString; prompts: TJavaObjectArray<JString>; values: TJavaObjectArray<JString>; captions: TJavaObjectArray<JString>): JFMXDefaultInputQueryDialog; cdecl;
  end;
  ...
  JFileNotCreatedExceptionClass = interface(JIOExceptionClass)
    ['{0899E1C0-87E9-4D3F-AFD3-E3F54A6EC8D0}']
    {class} function init(message: JString): JFileNotCreatedException; cdecl; overload;
    {class} function init(message: JString; cause: JThrowable): JFileNotCreatedException; cdecl; overload;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/FileNotCreatedException')]
  JFileNotCreatedException = interface(JIOException)
    ['{9A532A94-16DF-4B85-83D0-1435C34BCB6F}']
  end;
  TJFileNotCreatedException = class(TJavaGenericImport<JFileNotCreatedExceptionClass, JFileNotCreatedException>) end;

  JPhotoActivityClientClass = interface(JObjectClass)
    ['{060F3285-7A83-41BB-B205-C62B6E27AEAA}']
    {class} function init(activity: JActivity): JPhotoActivityClient; cdecl;
    {class} function isReservedRequestCode(requestCode: Integer): Boolean; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoActivityClient')]
  JPhotoActivityClient = interface(JObject)
    ['{B5E7840F-6DC2-429E-999E-9E4CAD9275CB}']
    procedure handleResult(requestCode: Integer; resultCode: Integer; intent: JIntent); cdecl;
    procedure pickPhoto(requestParams: JPickPhotoActivityRequestParams); cdecl;
    procedure restoreState(in_: JBundle); cdecl;
    procedure saveState(out_: JBundle); cdecl;
    procedure setResponseListener(responseListener: JPhotoActivityResponseListener); cdecl;
    procedure takePhoto(requestParams: JTakePhotoActivityRequestParams); cdecl;
  end;
  TJPhotoActivityClient = class(TJavaGenericImport<JPhotoActivityClientClass, JPhotoActivityClient>) end;

  JPhotoActivityRequestKindClass = interface(JEnumClass)
    ['{BF9406D7-C3A0-4217-AEF2-C97D08FFDD0E}']
    {class} function _GetPICK: JPhotoActivityRequestKind; cdecl;
    {class} function _GetTAKE: JPhotoActivityRequestKind; cdecl;
    {class} function valueOf(name: JString): JPhotoActivityRequestKind; cdecl;
    {class} function values: TJavaObjectArray<JPhotoActivityRequestKind>; cdecl;
    {class} property PICK: JPhotoActivityRequestKind read _GetPICK;
    {class} property TAKE: JPhotoActivityRequestKind read _GetTAKE;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoActivityRequestKind')]
  JPhotoActivityRequestKind = interface(JEnum)
    ['{25AACAF4-7617-4596-8B0E-766825AE4677}']
  end;
  TJPhotoActivityRequestKind = class(TJavaGenericImport<JPhotoActivityRequestKindClass, JPhotoActivityRequestKind>) end;

  JPhotoActivityResponseClass = interface(JObjectClass)
    ['{7440E6BF-1106-413E-AF30-4FC011B35546}']
    {class} function forCancellation(requestKind: JPhotoActivityRequestKind): JPhotoActivityResponse; cdecl;
    {class} function forFailure(requestKind: JPhotoActivityRequestKind; exception: JException): JPhotoActivityResponse; cdecl;
    {class} function forSuccess(requestKind: JPhotoActivityRequestKind; result: JBitmap): JPhotoActivityResponse; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoActivityResponse')]
  JPhotoActivityResponse = interface(JObject)
    ['{8556A7F2-93CB-47A0-8E58-66960EF4FBAF}']
    function getException: JException; cdecl;
    function getRequestKind: JPhotoActivityRequestKind; cdecl;
    function getResult: JBitmap; cdecl;
    function isCancelled: Boolean; cdecl;
    function isSuccessful: Boolean; cdecl;
  end;
  TJPhotoActivityResponse = class(TJavaGenericImport<JPhotoActivityResponseClass, JPhotoActivityResponse>) end;

  JPhotoActivityResponseListenerClass = interface(IJavaClass)
    ['{B4F42267-2B4C-42AE-A79E-D7B34C17E0FE}']
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoActivityResponseListener')]
  JPhotoActivityResponseListener = interface(IJavaInstance)
    ['{C39A48A3-C662-4D61-8D75-8F2F889A1A6F}']
    procedure onResponse(response: JPhotoActivityResponse); cdecl;
  end;
  TJPhotoActivityResponseListener = class(TJavaGenericImport<JPhotoActivityResponseListenerClass, JPhotoActivityResponseListener>) end;

  JPhotoClientClass = interface(JObjectClass)
    ['{09F67622-1ABA-4022-B1A5-5FB66CEAE055}']
    {class} function init(context: JContext): JPhotoClient; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoClient')]
  JPhotoClient = interface(JObject)
    ['{2190142F-2153-40FB-BFE4-C21C2228C766}']
    procedure savePhoto(requestParams: JSavePhotoRequestParams; responseListener: JPhotoResponseListener); cdecl;
  end;
  TJPhotoClient = class(TJavaGenericImport<JPhotoClientClass, JPhotoClient>) end;

  JPhotoResponseClass = interface(JObjectClass)
    ['{A0315480-282F-4C48-87C6-BFC1D7CF84B8}']
    {class} function forFailure(exception: JException): JPhotoResponse; cdecl;
    {class} function forSuccess: JPhotoResponse; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoResponse')]
  JPhotoResponse = interface(JObject)
    ['{AE55C997-718A-4D8D-9A6E-EBB11BBF5E2A}']
    function getException: JException; cdecl;
    function isSuccessful: Boolean; cdecl;
  end;
  TJPhotoResponse = class(TJavaGenericImport<JPhotoResponseClass, JPhotoResponse>) end;

  JPhotoResponseListenerClass = interface(IJavaClass)
    ['{A802867A-F94B-44E8-BB17-1D573221BBFE}']
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PhotoResponseListener')]
  JPhotoResponseListener = interface(IJavaInstance)
    ['{868478C4-C21A-4034-ADE2-CDBAD42C83B8}']
    procedure onResponse(response: JPhotoResponse); cdecl;
  end;
  TJPhotoResponseListener = class(TJavaGenericImport<JPhotoResponseListenerClass, JPhotoResponseListener>) end;

  JPickPhotoActivityRequestParamsClass = interface(JObjectClass)
    ['{B4438BC7-7D55-4A7A-B079-7A11C96BCBE6}']
    {class} function newBuilder: JPickPhotoActivityRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PickPhotoActivityRequestParams')]
  JPickPhotoActivityRequestParams = interface(JObject)
    ['{BE176231-66A4-4B5E-92B7-E7F102C87F28}']
    function getMaximumSize: Jutil_Size; cdecl;
    function getPickerPresentation: JPickerPresentation; cdecl;
  end;
  TJPickPhotoActivityRequestParams = class(TJavaGenericImport<JPickPhotoActivityRequestParamsClass, JPickPhotoActivityRequestParams>) end;

  JPickPhotoActivityRequestParams_BuilderClass = interface(JObjectClass)
    ['{8BCACEBD-03B8-4315-A84C-8E221565F9C6}']
    {class} function init: JPickPhotoActivityRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PickPhotoActivityRequestParams$Builder')]
  JPickPhotoActivityRequestParams_Builder = interface(JObject)
    ['{76D1E478-86DB-42E3-9455-141167BC1420}']
    function build: JPickPhotoActivityRequestParams; cdecl;
    function setMaximumSize(maximumSize: Jutil_Size): JPickPhotoActivityRequestParams_Builder; cdecl;
    function setPickerPresentation(pickerPresentation: JPickerPresentation): JPickPhotoActivityRequestParams_Builder; cdecl;
  end;
  TJPickPhotoActivityRequestParams_Builder = class(TJavaGenericImport<JPickPhotoActivityRequestParams_BuilderClass, JPickPhotoActivityRequestParams_Builder>) end;

  JPickerPresentationClass = interface(JEnumClass)
    ['{548859AD-A879-4ACF-8837-6B6E461DB8E4}']
    {class} function _GetLATEST: JPickerPresentation; cdecl;
    {class} function _GetLEGACY: JPickerPresentation; cdecl;
    {class} function valueOf(name: JString): JPickerPresentation; cdecl;
    {class} function values: TJavaObjectArray<JPickerPresentation>; cdecl;
    {class} property LATEST: JPickerPresentation read _GetLATEST;
    {class} property LEGACY: JPickerPresentation read _GetLEGACY;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/PickerPresentation')]
  JPickerPresentation = interface(JEnum)
    ['{EB9A688F-2F27-4FB3-B029-6FDA6AA36367}']
  end;
  TJPickerPresentation = class(TJavaGenericImport<JPickerPresentationClass, JPickerPresentation>) end;

  JSavePhotoRequestParamsClass = interface(JObjectClass)
    ['{8EF86201-BB5E-4252-AC0F-D417BC78E858}']
    {class} function newBuilder: JSavePhotoRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/SavePhotoRequestParams')]
  JSavePhotoRequestParams = interface(JObject)
    ['{1ED54958-5A2C-4588-9F31-9BE11A3C38E9}']
    function getBitmap: JBitmap; cdecl;
    function shouldRecycle: Boolean; cdecl;
  end;
  TJSavePhotoRequestParams = class(TJavaGenericImport<JSavePhotoRequestParamsClass, JSavePhotoRequestParams>) end;

  JSavePhotoRequestParams_BuilderClass = interface(JObjectClass)
    ['{D2895C35-457A-489A-95B9-F33CBD2D3BF3}']
    {class} function init: JSavePhotoRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/SavePhotoRequestParams$Builder')]
  JSavePhotoRequestParams_Builder = interface(JObject)
    ['{405B42AA-5D5D-4C31-B7C6-2DD7EF6D8B24}']
    function build: JSavePhotoRequestParams; cdecl;
    function setBitmap(bitmap: JBitmap): JSavePhotoRequestParams_Builder; cdecl;
    function setRecycle(recycle: Boolean): JSavePhotoRequestParams_Builder; cdecl;
  end;
  TJSavePhotoRequestParams_Builder = class(TJavaGenericImport<JSavePhotoRequestParams_BuilderClass, JSavePhotoRequestParams_Builder>) end;

  JTakePhotoActivityRequestParamsClass = interface(JObjectClass)
    ['{286A2C41-D8FB-4BC4-9E1E-447BAE5E1AAA}']
    {class} function newBuilder: JTakePhotoActivityRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/TakePhotoActivityRequestParams')]
  JTakePhotoActivityRequestParams = interface(JObject)
    ['{FDB3A9D3-6758-4815-96CA-781EB8B0203F}']
    function getMaximumSize: Jutil_Size; cdecl;
    function isPersistent: Boolean; cdecl;
  end;
  TJTakePhotoActivityRequestParams = class(TJavaGenericImport<JTakePhotoActivityRequestParamsClass, JTakePhotoActivityRequestParams>) end;

  JTakePhotoActivityRequestParams_BuilderClass = interface(JObjectClass)
    ['{1BD310C9-6ADF-450C-988D-3552857DE81B}']
    {class} function init: JTakePhotoActivityRequestParams_Builder; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/medialibrary/TakePhotoActivityRequestParams$Builder')]
  JTakePhotoActivityRequestParams_Builder = interface(JObject)
    ['{0E99E53E-0275-4C87-95BE-2336CC803C78}']
    function build: JTakePhotoActivityRequestParams; cdecl;
    function setMaximumSize(maximumSize: Jutil_Size): JTakePhotoActivityRequestParams_Builder; cdecl;
    function setPersistent(persistent: Boolean): JTakePhotoActivityRequestParams_Builder; cdecl;
  end;
  TJTakePhotoActivityRequestParams_Builder = class(TJavaGenericImport<JTakePhotoActivityRequestParams_BuilderClass, JTakePhotoActivityRequestParams_Builder>) end;
  ...
  Jtelephony_CustomPhoneStateListener = interface(JPhoneStateListener)
    ...
    procedure setListener(listener: Jtelephony_ICustomPhoneStateListener); cdecl;
  end;
  ...
  JForwardingPhoneStateListenerClass = interface(JPhoneStateListenerClass)
    ['{C5E4DBF3-66D1-4BBA-8E80-E318142C395F}']
    {class} function init(delegate: JPhoneDialerListener): JForwardingPhoneStateListener; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/telephony/ForwardingPhoneStateListener')]
  JForwardingPhoneStateListener = interface(JPhoneStateListener)
    ['{02E925CD-9537-480E-8C08-B7F4A8E32B56}']
    procedure onCallStateChanged(state: Integer; phoneNumber: JString); cdecl;
    procedure onServiceStateChanged(serviceState: JServiceState); cdecl;
  end;
  TJForwardingPhoneStateListener = class(TJavaGenericImport<JForwardingPhoneStateListenerClass, JForwardingPhoneStateListener>) end;

  JForwardingTelephonyCallbackClass = interface(JTelephonyCallbackClass)
    ['{1E4936E0-5169-4735-8CBE-DFCAB7B810EF}']
    {class} function init(delegate: JPhoneDialerListener): JForwardingTelephonyCallback; cdecl;
  end;

  [JavaSignature('com/embarcadero/firemonkey/telephony/ForwardingTelephonyCallback')]
  JForwardingTelephonyCallback = interface(JTelephonyCallback)
    ['{62226B6A-D479-458D-BA70-DCC1A4EDA116}']
    procedure onCallStateChanged(state: Integer); cdecl;
    procedure onServiceStateChanged(serviceState: JServiceState); cdecl;
  end;
  TJForwardingTelephonyCallback = class(TJavaGenericImport<JForwardingTelephonyCallbackClass, JForwardingTelephonyCallback>) end;
  ...
  JPhoneDialerListenerClass = interface(IJavaClass)
    ['{64685C2A-546E-400F-9094-7B41786B0691}']
  end;

  [JavaSignature('com/embarcadero/firemonkey/telephony/PhoneDialerListener')]
  JPhoneDialerListener = interface(IJavaInstance)
    ['{5A2E1C2D-3B69-4A1B-A4EA-8024DFB4D114}']
    procedure onCallStateChanged(state: Integer; phoneNumber: JString); cdecl;
    procedure onServiceStateChanged(serviceState: JServiceState); cdecl;
  end;
  TJPhoneDialerListener = class(TJavaGenericImport<JPhoneDialerListenerClass, JPhoneDialerListener>) end;
  ...
  JNativeWebChromeClient = interface(JWebChromeClient)
    ...
    procedure onReceiveResult(requestCode: Integer; resultCode: Integer; intent: JIntent); cdecl;
    procedure onRequestPermissionsResult(requestCode: Integer; permissions: TJavaObjectArray<JString>; grantResults: TJavaArray<Integer>); cdecl;
    function onShowFileChooser(webView: JWebView; filePathCallback: JValueCallback; fileChooserParams: JWebChromeClient_FileChooserParams): Boolean; cdecl;
  end;
  ...
  JNativeDispatchExceptionClass = interface(JRuntimeExceptionClass)
    ['{93D1EBD7-A860-4949-B743-4AABE1B67618}']
    {class} function init(message: JString): JNativeDispatchException; cdecl;
  end;

  [JavaSignature('com/embarcadero/rtl/NativeDispatchException')]
  JNativeDispatchException = interface(JRuntimeException)
    ['{93574B8D-BC61-4E55-93CF-9751501C93C8}']
  end;
  TJNativeDispatchException = class(TJavaGenericImport<JNativeDispatchExceptionClass, JNativeDispatchException>) end;

  JNativeDispatchHelperClass = interface(JObjectClass)
    ['{88F77CD1-E5F2-4416-AC9B-809D363B9D6E}']
    {class} function getMethodSignature(returnType: Jlang_Class; paramTypes: TJavaObjectArray<Jlang_Class>): JString; cdecl;
  end;

  [JavaSignature('com/embarcadero/rtl/NativeDispatchHelper')]
  JNativeDispatchHelper = interface(JObject)
    ['{3B12096E-CB5F-402A-A2E1-39D8328C5176}']
  end;
  TJNativeDispatchHelper = class(TJavaGenericImport<JNativeDispatchHelperClass, JNativeDispatchHelper>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBiometricFragmentActivity', TypeInfo(Androidapi.JNI.Embarcadero.JBiometricFragmentActivity));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBiometricFragmentActivityListener', TypeInfo(Androidapi.JNI.Embarcadero.JBiometricFragmentActivityListener));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBitmapDecodeException', TypeInfo(Androidapi.JNI.Embarcadero.JBitmapDecodeException));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBitmapDecodeRequest', TypeInfo(Androidapi.JNI.Embarcadero.JBitmapDecodeRequest));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBitmapDecodeRequestParams', TypeInfo(Androidapi.JNI.Embarcadero.JBitmapDecodeRequestParams));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBitmapDecodeRequestParams_Builder', TypeInfo(Androidapi.JNI.Embarcadero.JBitmapDecodeRequestParams_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JBitmapDecoder', TypeInfo(Androidapi.JNI.Embarcadero.JBitmapDecoder));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JFileNotCreatedException', TypeInfo(Androidapi.JNI.Embarcadero.JFileNotCreatedException));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoActivityClient', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoActivityClient));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoActivityRequestKind', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoActivityRequestKind));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoActivityResponse', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoActivityResponse));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoActivityResponseListener', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoActivityResponseListener));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoClient', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoClient));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoResponse', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoResponse));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhotoResponseListener', TypeInfo(Androidapi.JNI.Embarcadero.JPhotoResponseListener));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPickPhotoActivityRequestParams', TypeInfo(Androidapi.JNI.Embarcadero.JPickPhotoActivityRequestParams));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPickPhotoActivityRequestParams_Builder', TypeInfo(Androidapi.JNI.Embarcadero.JPickPhotoActivityRequestParams_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPickerPresentation', TypeInfo(Androidapi.JNI.Embarcadero.JPickerPresentation));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JSavePhotoRequestParams', TypeInfo(Androidapi.JNI.Embarcadero.JSavePhotoRequestParams));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JSavePhotoRequestParams_Builder', TypeInfo(Androidapi.JNI.Embarcadero.JSavePhotoRequestParams_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JTakePhotoActivityRequestParams', TypeInfo(Androidapi.JNI.Embarcadero.JTakePhotoActivityRequestParams));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JTakePhotoActivityRequestParams_Builder', TypeInfo(Androidapi.JNI.Embarcadero.JTakePhotoActivityRequestParams_Builder));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JForwardingPhoneStateListener', TypeInfo(Androidapi.JNI.Embarcadero.JForwardingPhoneStateListener));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JForwardingTelephonyCallback', TypeInfo(Androidapi.JNI.Embarcadero.JForwardingTelephonyCallback));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JPhoneDialerListener', TypeInfo(Androidapi.JNI.Embarcadero.JPhoneDialerListener));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JNativeDispatchException', TypeInfo(Androidapi.JNI.Embarcadero.JNativeDispatchException));
  TRegTypes.RegisterType('Androidapi.JNI.Embarcadero.JNativeDispatchHelper', TypeInfo(Androidapi.JNI.Embarcadero.JNativeDispatchHelper));
