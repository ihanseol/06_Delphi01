...
// ===== Forward declarations =====
  ...
  JEGL15 = interface;//android.opengl.EGL15
  ...
  JEGLImage = interface;//android.opengl.EGLImage
  Jopengl_EGLSurface = interface;//android.opengl.EGLSurface
  JEGLSync = interface;//android.opengl.EGLSync
...
// ===== Interface declarations =====
  ...
  JEGL15Class = interface(JObjectClass)
    ['{1723A57D-5A54-4508-8651-A1AC32302581}']
    {class} function _GetEGL_CL_EVENT_HANDLE: Integer; cdecl;
    {class} function _GetEGL_CONDITION_SATISFIED: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_MAJOR_VERSION: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_MINOR_VERSION: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_CORE_PROFILE_BIT: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_DEBUG: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_PROFILE_MASK: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY: Integer; cdecl;
    {class} function _GetEGL_CONTEXT_OPENGL_ROBUST_ACCESS: Integer; cdecl;
    {class} function _GetEGL_FOREVER: Int64; cdecl;
    {class} function _GetEGL_GL_COLORSPACE: Integer; cdecl;
    {class} function _GetEGL_GL_COLORSPACE_LINEAR: Integer; cdecl;
    {class} function _GetEGL_GL_COLORSPACE_SRGB: Integer; cdecl;
    {class} function _GetEGL_GL_RENDERBUFFER: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_2D: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_3D: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_LEVEL: Integer; cdecl;
    {class} function _GetEGL_GL_TEXTURE_ZOFFSET: Integer; cdecl;
    {class} function _GetEGL_IMAGE_PRESERVED: Integer; cdecl;
    {class} function _GetEGL_LOSE_CONTEXT_ON_RESET: Integer; cdecl;
    {class} function _GetEGL_NO_CONTEXT: Jopengl_EGLContext; cdecl;
    {class} function _GetEGL_NO_DISPLAY: Jopengl_EGLDisplay; cdecl;
    {class} function _GetEGL_NO_IMAGE: JEGLImage; cdecl;
    {class} function _GetEGL_NO_RESET_NOTIFICATION: Integer; cdecl;
    {class} function _GetEGL_NO_SURFACE: Jopengl_EGLSurface; cdecl;
    {class} function _GetEGL_NO_SYNC: JEGLSync; cdecl;
    {class} function _GetEGL_OPENGL_ES3_BIT: Integer; cdecl;
    {class} function _GetEGL_PLATFORM_ANDROID_KHR: Integer; cdecl;
    {class} function _GetEGL_SIGNALED: Integer; cdecl;
    {class} function _GetEGL_SYNC_CL_EVENT: Integer; cdecl;
    {class} function _GetEGL_SYNC_CL_EVENT_COMPLETE: Integer; cdecl;
    {class} function _GetEGL_SYNC_CONDITION: Integer; cdecl;
    {class} function _GetEGL_SYNC_FENCE: Integer; cdecl;
    {class} function _GetEGL_SYNC_FLUSH_COMMANDS_BIT: Integer; cdecl;
    {class} function _GetEGL_SYNC_PRIOR_COMMANDS_COMPLETE: Integer; cdecl;
    {class} function _GetEGL_SYNC_STATUS: Integer; cdecl;
    {class} function _GetEGL_SYNC_TYPE: Integer; cdecl;
    {class} function _GetEGL_TIMEOUT_EXPIRED: Integer; cdecl;
    {class} function _GetEGL_UNSIGNALED: Integer; cdecl;
    {class} function eglClientWaitSync(dpy: Jopengl_EGLDisplay; sync: JEGLSync; flags: Integer; timeout: Int64): Integer; cdecl;
    {class} function eglCreateImage(dpy: Jopengl_EGLDisplay; context: Jopengl_EGLContext; target: Integer; buffer: Int64; attrib_list: TJavaArray<Int64>; offset: Integer): JEGLImage; cdecl;
    {class} function eglCreatePlatformPixmapSurface(dpy: Jopengl_EGLDisplay; config: Jopengl_EGLConfig; native_pixmap: JBuffer; attrib_list: TJavaArray<Int64>; offset: Integer): Jopengl_EGLSurface; cdecl;
    {class} function eglCreatePlatformWindowSurface(dpy: Jopengl_EGLDisplay; config: Jopengl_EGLConfig; native_window: JBuffer; attrib_list: TJavaArray<Int64>; offset: Integer): Jopengl_EGLSurface; cdecl;
    {class} function eglCreateSync(dpy: Jopengl_EGLDisplay; type_: Integer; attrib_list: TJavaArray<Int64>; offset: Integer): JEGLSync; cdecl;
    {class} function eglDestroyImage(dpy: Jopengl_EGLDisplay; image: JEGLImage): Boolean; cdecl;
    {class} function eglDestroySync(dpy: Jopengl_EGLDisplay; sync: JEGLSync): Boolean; cdecl;
    {class} function eglGetPlatformDisplay(platform: Integer; native_display: Int64; attrib_list: TJavaArray<Int64>; offset: Integer): Jopengl_EGLDisplay; cdecl;
    {class} function eglGetSyncAttrib(dpy: Jopengl_EGLDisplay; sync: JEGLSync; attribute: Integer; value: TJavaArray<Int64>; offset: Integer): Boolean; cdecl;
    {class} function eglWaitSync(dpy: Jopengl_EGLDisplay; sync: JEGLSync; flags: Integer): Boolean; cdecl;
    {class} property EGL_CL_EVENT_HANDLE: Integer read _GetEGL_CL_EVENT_HANDLE;
    {class} property EGL_CONDITION_SATISFIED: Integer read _GetEGL_CONDITION_SATISFIED;
    {class} property EGL_CONTEXT_MAJOR_VERSION: Integer read _GetEGL_CONTEXT_MAJOR_VERSION;
    {class} property EGL_CONTEXT_MINOR_VERSION: Integer read _GetEGL_CONTEXT_MINOR_VERSION;
    {class} property EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT: Integer read _GetEGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT;
    {class} property EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT: Integer read _GetEGL_CONTEXT_OPENGL_CORE_PROFILE_BIT;
    {class} property EGL_CONTEXT_OPENGL_DEBUG: Integer read _GetEGL_CONTEXT_OPENGL_DEBUG;
    {class} property EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE: Integer read _GetEGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE;
    {class} property EGL_CONTEXT_OPENGL_PROFILE_MASK: Integer read _GetEGL_CONTEXT_OPENGL_PROFILE_MASK;
    {class} property EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY: Integer read _GetEGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY;
    {class} property EGL_CONTEXT_OPENGL_ROBUST_ACCESS: Integer read _GetEGL_CONTEXT_OPENGL_ROBUST_ACCESS;
    {class} property EGL_FOREVER: Int64 read _GetEGL_FOREVER;
    {class} property EGL_GL_COLORSPACE: Integer read _GetEGL_GL_COLORSPACE;
    {class} property EGL_GL_COLORSPACE_LINEAR: Integer read _GetEGL_GL_COLORSPACE_LINEAR;
    {class} property EGL_GL_COLORSPACE_SRGB: Integer read _GetEGL_GL_COLORSPACE_SRGB;
    {class} property EGL_GL_RENDERBUFFER: Integer read _GetEGL_GL_RENDERBUFFER;
    {class} property EGL_GL_TEXTURE_2D: Integer read _GetEGL_GL_TEXTURE_2D;
    {class} property EGL_GL_TEXTURE_3D: Integer read _GetEGL_GL_TEXTURE_3D;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y;
    {class} property EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z: Integer read _GetEGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z;
    {class} property EGL_GL_TEXTURE_LEVEL: Integer read _GetEGL_GL_TEXTURE_LEVEL;
    {class} property EGL_GL_TEXTURE_ZOFFSET: Integer read _GetEGL_GL_TEXTURE_ZOFFSET;
    {class} property EGL_IMAGE_PRESERVED: Integer read _GetEGL_IMAGE_PRESERVED;
    {class} property EGL_LOSE_CONTEXT_ON_RESET: Integer read _GetEGL_LOSE_CONTEXT_ON_RESET;
    {class} property EGL_NO_CONTEXT: Jopengl_EGLContext read _GetEGL_NO_CONTEXT;
    {class} property EGL_NO_DISPLAY: Jopengl_EGLDisplay read _GetEGL_NO_DISPLAY;
    {class} property EGL_NO_IMAGE: JEGLImage read _GetEGL_NO_IMAGE;
    {class} property EGL_NO_RESET_NOTIFICATION: Integer read _GetEGL_NO_RESET_NOTIFICATION;
    {class} property EGL_NO_SURFACE: Jopengl_EGLSurface read _GetEGL_NO_SURFACE;
    {class} property EGL_NO_SYNC: JEGLSync read _GetEGL_NO_SYNC;
    {class} property EGL_OPENGL_ES3_BIT: Integer read _GetEGL_OPENGL_ES3_BIT;
    {class} property EGL_PLATFORM_ANDROID_KHR: Integer read _GetEGL_PLATFORM_ANDROID_KHR;
    {class} property EGL_SIGNALED: Integer read _GetEGL_SIGNALED;
    {class} property EGL_SYNC_CL_EVENT: Integer read _GetEGL_SYNC_CL_EVENT;
    {class} property EGL_SYNC_CL_EVENT_COMPLETE: Integer read _GetEGL_SYNC_CL_EVENT_COMPLETE;
    {class} property EGL_SYNC_CONDITION: Integer read _GetEGL_SYNC_CONDITION;
    {class} property EGL_SYNC_FENCE: Integer read _GetEGL_SYNC_FENCE;
    {class} property EGL_SYNC_FLUSH_COMMANDS_BIT: Integer read _GetEGL_SYNC_FLUSH_COMMANDS_BIT;
    {class} property EGL_SYNC_PRIOR_COMMANDS_COMPLETE: Integer read _GetEGL_SYNC_PRIOR_COMMANDS_COMPLETE;
    {class} property EGL_SYNC_STATUS: Integer read _GetEGL_SYNC_STATUS;
    {class} property EGL_SYNC_TYPE: Integer read _GetEGL_SYNC_TYPE;
    {class} property EGL_TIMEOUT_EXPIRED: Integer read _GetEGL_TIMEOUT_EXPIRED;
    {class} property EGL_UNSIGNALED: Integer read _GetEGL_UNSIGNALED;
  end;

  [JavaSignature('android/opengl/EGL15')]
  JEGL15 = interface(JObject)
    ['{0B8A8301-D82D-41B1-9A29-E62FE66CAD6D}']
  end;
  TJEGL15 = class(TJavaGenericImport<JEGL15Class, JEGL15>) end;
  ...
  JEGLExtClass = interface(JObjectClass)
    ...
    {class} function _GetEGL_NO_NATIVE_FENCE_FD_ANDROID: Integer; cdecl;
    {class} function _GetEGL_OPENGL_ES3_BIT_KHR: Integer; cdecl;
    {class} function _GetEGL_RECORDABLE_ANDROID: Integer; cdecl;
    {class} function _GetEGL_SYNC_NATIVE_FENCE_ANDROID: Integer; cdecl;
    {class} function _GetEGL_SYNC_NATIVE_FENCE_FD_ANDROID: Integer; cdecl;
    {class} function _GetEGL_SYNC_NATIVE_FENCE_SIGNALED_ANDROID: Integer; cdecl;
    {class} function init: JEGLExt; cdecl;
    {class} function eglDupNativeFenceFDANDROID(display: Jopengl_EGLDisplay; sync: JEGLSync): JSyncFence; cdecl;
    ...
    {class} property EGL_NO_NATIVE_FENCE_FD_ANDROID: Integer read _GetEGL_NO_NATIVE_FENCE_FD_ANDROID;
    ...
    {class} property EGL_SYNC_NATIVE_FENCE_ANDROID: Integer read _GetEGL_SYNC_NATIVE_FENCE_ANDROID;
    {class} property EGL_SYNC_NATIVE_FENCE_FD_ANDROID: Integer read _GetEGL_SYNC_NATIVE_FENCE_FD_ANDROID;
    {class} property EGL_SYNC_NATIVE_FENCE_SIGNALED_ANDROID: Integer read _GetEGL_SYNC_NATIVE_FENCE_SIGNALED_ANDROID;
  end;
  ...
  JEGLImageClass = interface(JEGLObjectHandleClass)
    ['{3B31D34F-70A9-4286-9DB6-2D2271DAAC2B}']
  end;

  [JavaSignature('android/opengl/EGLImage')]
  JEGLImage = interface(JEGLObjectHandle)
    ['{21BA7E27-0FBD-4570-A439-DFF547718042}']
    function equals(o: JObject): Boolean; cdecl;
  end;
  TJEGLImage = class(TJavaGenericImport<JEGLImageClass, JEGLImage>) end;
  ...
  JEGLSyncClass = interface(JEGLObjectHandleClass)
    ['{9A7A6C81-371A-4576-95D4-C9D628D4CD40}']
  end;

  [JavaSignature('android/opengl/EGLSync')]
  JEGLSync = interface(JEGLObjectHandle)
    ['{A66F26DE-D83D-4CCE-928C-9C86031AC16A}']
    function equals(o: JObject): Boolean; cdecl;
  end;
  TJEGLSync = class(TJavaGenericImport<JEGLSyncClass, JEGLSync>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.JEGL15', TypeInfo(Androidapi.JNI.OpenGL.JEGL15));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.JEGLImage', TypeInfo(Androidapi.JNI.OpenGL.JEGLImage));
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.Jopengl_EGLSurface', TypeInfo(Androidapi.JNI.OpenGL.Jopengl_EGLSurface));
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.JEGLSync', TypeInfo(Androidapi.JNI.OpenGL.JEGLSync));
