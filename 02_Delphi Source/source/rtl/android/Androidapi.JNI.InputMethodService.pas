...
// ===== Forward declarations =====
  ...
  JKeyButtonRipple_Type = interface;//android.inputmethodservice.navigationbar.KeyButtonRipple$Type
...
// ===== Interface declarations =====
  ...
  JInputMethodServiceClass = interface(JAbstractInputMethodServiceClass)
    ...
    {class} function _GetBACK_DISPOSITION_ADJUST_NOTHING: Integer; cdecl;
    ...
    {class} property BACK_DISPOSITION_ADJUST_NOTHING: Integer read _GetBACK_DISPOSITION_ADJUST_NOTHING;
  ...
  JInputMethodService = interface(JAbstractInputMethodService)
    ...
    procedure finishStylusHandwriting; cdecl;
    ...
    function getInputMethodWindowRecommendedHeight: Integer; cdecl;//Deprecated
    function getLayoutInflater: JLayoutInflater; cdecl;
    function getMaxWidth: Integer; cdecl;
    function getStylusHandwritingWindow: JWindow; cdecl;
    ...
    function onCreateInlineSuggestionsRequest(uiExtras: JBundle): JInlineSuggestionsRequest; cdecl;
    function onCreateInputMethodInterface: JAbstractInputMethodService_AbstractInputMethodImpl; cdecl;
    function onCreateInputMethodSessionInterface: JAbstractInputMethodService_AbstractInputMethodSessionImpl; cdecl;
    ...
    procedure onFinishStylusHandwriting; cdecl;
    function onGenericMotionEvent(event: JMotionEvent): Boolean; cdecl;
    procedure onInitializeInterface; cdecl;
    function onInlineSuggestionsResponse(response: JInlineSuggestionsResponse): Boolean; cdecl;
    ...
    procedure onPrepareStylusHandwriting; cdecl;
    ...
    function onStartStylusHandwriting: Boolean; cdecl;
    procedure onStylusHandwritingMotionEvent(motionEvent: JMotionEvent); cdecl;
    function onTrackballEvent(event: JMotionEvent): Boolean; cdecl;
    ...
    procedure onViewClicked(focusChanged: Boolean); cdecl;//Deprecated
    procedure onWindowHidden; cdecl;
    procedure onWindowShown; cdecl;
    procedure requestHideSelf(flags: Integer); cdecl;
    procedure requestShowSelf(flags: Integer); cdecl;
    ...
    function shouldOfferSwitchingToNextInputMethod: Boolean; cdecl;
    procedure showStatusIcon(iconResId: Integer); cdecl;
    procedure showWindow(showInput: Boolean); cdecl;
    procedure switchInputMethod(id: JString); cdecl; overload;
    procedure switchInputMethod(id: JString; subtype: JInputMethodSubtype); cdecl; overload;
    function switchToNextInputMethod(onlyCurrentIme: Boolean): Boolean; cdecl;
    function switchToPreviousInputMethod: Boolean; cdecl;
  ...
  JInputMethodService_InputMethodSessionImpl = interface(JAbstractInputMethodService_AbstractInputMethodSessionImpl)
    ...
    procedure toggleSoftInput(showFlags: Integer; hideFlags: Integer); cdecl;//Deprecated
  ...
  JKeyButtonRipple_TypeClass = interface(JEnumClass)
    ['{97C5505D-60A1-45DC-B434-7AF5AC92D49B}']
    {class} function _GetOVAL: JKeyButtonRipple_Type; cdecl;
    {class} function _GetROUNDED_RECT: JKeyButtonRipple_Type; cdecl;
    {class} function valueOf(name: JString): JKeyButtonRipple_Type; cdecl;
    {class} function values: TJavaObjectArray<JKeyButtonRipple_Type>; cdecl;
    {class} property OVAL: JKeyButtonRipple_Type read _GetOVAL;
    {class} property ROUNDED_RECT: JKeyButtonRipple_Type read _GetROUNDED_RECT;
  end;

  [JavaSignature('android/inputmethodservice/navigationbar/KeyButtonRipple$Type')]
  JKeyButtonRipple_Type = interface(JEnum)
    ['{68AB367D-09F9-42C3-856A-82325B7ED2DB}']
  end;
  TJKeyButtonRipple_Type = class(TJavaGenericImport<JKeyButtonRipple_TypeClass, JKeyButtonRipple_Type>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.InputMethodService.JKeyButtonRipple_Type', TypeInfo(Androidapi.JNI.InputMethodService.JKeyButtonRipple_Type));
end;
