...
// ===== Forward declarations =====
  ...
  JMapsInitializer_Renderer = interface;//com.google.android.gms.maps.MapsInitializer$Renderer
  JOnMapReadyCallback = interface;//com.google.android.gms.maps.OnMapReadyCallback
  JOnMapsSdkInitializedCallback = interface;//com.google.android.gms.maps.OnMapsSdkInitializedCallback
  ...
  //Jinternal_zzak = interface;//com.google.android.gms.maps.internal.zzak
  //Jinternal_zzam = interface;//com.google.android.gms.maps.internal.zzam
  //Jinternal_zzao = interface;//com.google.android.gms.maps.internal.zzao
  //Jinternal_zzaq = interface;//com.google.android.gms.maps.internal.zzaq
  //Jinternal_zzas = interface;//com.google.android.gms.maps.internal.zzas
  //Jinternal_zzau = interface;//com.google.android.gms.maps.internal.zzau
  //Jinternal_zzaw = interface;//com.google.android.gms.maps.internal.zzaw
  //Jinternal_zzay = interface;//com.google.android.gms.maps.internal.zzay
  //Jinternal_zzba = interface;//com.google.android.gms.maps.internal.zzba
  //Jinternal_zzbc = interface;//com.google.android.gms.maps.internal.zzbc
  //Jinternal_zzbe = interface;//com.google.android.gms.maps.internal.zzbe
  //Jinternal_zzbg = interface;//com.google.android.gms.maps.internal.zzbg
  //Jinternal_zzbi = interface;//com.google.android.gms.maps.internal.zzbi
  //Jinternal_zzbv = interface;//com.google.android.gms.maps.internal.zzbv
  ...
  JStampStyle = interface;//com.google.android.gms.maps.model.StampStyle
  JStrokeStyle = interface;//com.google.android.gms.maps.model.StrokeStyle
  JStrokeStyle_Builder = interface;//com.google.android.gms.maps.model.StrokeStyle$Builder
  Jmodel_StyleSpan = interface;//com.google.android.gms.maps.model.StyleSpan
  ...
  //Jmodel_zzu = interface;//com.google.android.gms.maps.model.zzu
...
// ===== Interface declarations =====
  ...
  JGoogleMapOptions = interface(JAbstractSafeParcelable)
    ...
    function backgroundColor(integer_: JInteger): JGoogleMapOptions; cdecl;
    ...
    function getBackgroundColor: JInteger; cdecl;
    ...
    function getMapId: JString; cdecl;
    ...
    function mapId(string_: JString): JGoogleMapOptions; cdecl;
  ...
  JMapsInitializerClass = interface(JObjectClass)
    ...
    {class} function initialize(context: JContext): Integer; cdecl; overload;
    {class} function initialize(context: JContext; renderer: JMapsInitializer_Renderer; onMapsSdkInitializedCallback: JOnMapsSdkInitializedCallback): Integer; cdecl; overload;
  end;
  ...
  JMapsInitializer_RendererClass = interface(JEnumClass)
    ['{F0DCF78F-24FB-4CD5-B2EF-254E2FEB7D42}']
    {class} function _GetLATEST: JMapsInitializer_Renderer; cdecl;
    {class} function _GetLEGACY: JMapsInitializer_Renderer; cdecl;
    {class} function valueOf(string_: JString): JMapsInitializer_Renderer; cdecl;
    {class} function values: TJavaObjectArray<JMapsInitializer_Renderer>; cdecl;
    {class} property LATEST: JMapsInitializer_Renderer read _GetLATEST;
    {class} property LEGACY: JMapsInitializer_Renderer read _GetLEGACY;
  end;

  [JavaSignature('com/google/android/gms/maps/MapsInitializer$Renderer')]
  JMapsInitializer_Renderer = interface(JEnum)
    ['{8EC81DBC-AA0D-4069-97FA-CAD8B65A0591}']
  end;
  TJMapsInitializer_Renderer = class(TJavaGenericImport<JMapsInitializer_RendererClass, JMapsInitializer_Renderer>) end;
  ...
  JOnMapsSdkInitializedCallbackClass = interface(IJavaClass)
    ['{64D50FB7-E33C-4A19-A4F3-16D9C0C8D211}']
  end;

  [JavaSignature('com/google/android/gms/maps/OnMapsSdkInitializedCallback')]
  JOnMapsSdkInitializedCallback = interface(IJavaInstance)
    ['{D5699C41-1D58-47E8-8864-FB29ED10D299}']
    procedure onMapsSdkInitialized(renderer: JMapsInitializer_Renderer); cdecl;
  end;
  TJOnMapsSdkInitializedCallback = class(TJavaGenericImport<JOnMapsSdkInitializedCallbackClass, JOnMapsSdkInitializedCallback>) end;
  ...
  // com.google.android.gms.maps.internal.zzam
  // com.google.android.gms.maps.internal.zzao
  // com.google.android.gms.maps.internal.zzaq
  // com.google.android.gms.maps.internal.zzas
  // com.google.android.gms.maps.internal.zzau
  ...
  // com.google.android.gms.maps.internal.zzbg
  ...
  JPolyline = interface(JObject)
    ...
    procedure setPoints(list: JList); cdecl;
    procedure setSpans(list: JList); cdecl;
  ...
  JPolylineOptions = interface(JAbstractSafeParcelable)
    ...
    function addAllSpans(iterable: JIterable): JPolylineOptions; cdecl;
    function addSpan(styleSpan: Jmodel_StyleSpan): JPolylineOptions; cdecl; overload;
  ...
  JStampStyleClass = interface(JAbstractSafeParcelableClass)
    ['{B9357D87-F4B1-42D2-87F9-FA4DD71DF1A7}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('com/google/android/gms/maps/model/StampStyle')]
  JStampStyle = interface(JAbstractSafeParcelable)
    ['{D05D569B-BA9E-4C11-8539-9B7E5AFB3E4D}']
    function getStamp: JBitmapDescriptor; cdecl;
    procedure writeToParcel(parcel: JParcel; i: Integer); cdecl;
  end;
  TJStampStyle = class(TJavaGenericImport<JStampStyleClass, JStampStyle>) end;

  JStrokeStyleClass = interface(JAbstractSafeParcelableClass)
    ['{8B97D994-39E6-4837-801A-4115E0054D31}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function colorBuilder(i: Integer): JStrokeStyle_Builder; cdecl;
    {class} function gradientBuilder(i: Integer; i1: Integer): JStrokeStyle_Builder; cdecl;
    {class} function transparentColorBuilder: JStrokeStyle_Builder; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('com/google/android/gms/maps/model/StrokeStyle')]
  JStrokeStyle = interface(JAbstractSafeParcelable)
    ['{0E1A6F21-61FF-47DB-AD2B-0F97A49347C0}']
    function getStamp: JStampStyle; cdecl;
    function isVisible: Boolean; cdecl;
    procedure writeToParcel(parcel: JParcel; i: Integer); cdecl;
  end;
  TJStrokeStyle = class(TJavaGenericImport<JStrokeStyleClass, JStrokeStyle>) end;

  JStrokeStyle_BuilderClass = interface(JObjectClass)
    ['{B36AE6DE-3499-4C8C-9F38-25CB846D8968}']
    {class} function init(strokeStyle: JStrokeStyle): JStrokeStyle_Builder; cdecl; overload;
  end;

  [JavaSignature('com/google/android/gms/maps/model/StrokeStyle$Builder')]
  JStrokeStyle_Builder = interface(JObject)
    ['{5189DA7C-14F2-41D7-B1E3-E719D117F67F}']
    function build: JStrokeStyle; cdecl;
    function stamp(stampStyle: JStampStyle): JStrokeStyle_Builder; cdecl;
  end;
  TJStrokeStyle_Builder = class(TJavaGenericImport<JStrokeStyle_BuilderClass, JStrokeStyle_Builder>) end;

  Jmodel_StyleSpanClass = interface(JAbstractSafeParcelableClass)
    ['{3F812DD6-0F18-45A8-9459-1A30AEE44C00}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function init(strokeStyle: JStrokeStyle): Jmodel_StyleSpan; cdecl; overload;
    {class} function init(i: Integer): Jmodel_StyleSpan; cdecl; overload;
    {class} function init(strokeStyle: JStrokeStyle; d: Double): Jmodel_StyleSpan; cdecl; overload;
    {class} function init(i: Integer; d: Double): Jmodel_StyleSpan; cdecl; overload;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('com/google/android/gms/maps/model/StyleSpan')]
  Jmodel_StyleSpan = interface(JAbstractSafeParcelable)
    ['{F7D49303-2976-4A33-BCE8-5DCD00CD914C}']
    function getSegments: Double; cdecl;
    function getStyle: JStrokeStyle; cdecl;
    procedure writeToParcel(parcel: JParcel; i: Integer); cdecl;
  end;
  TJmodel_StyleSpan = class(TJavaGenericImport<Jmodel_StyleSpanClass, Jmodel_StyleSpan>) end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.JMapsInitializer_Renderer', TypeInfo(Androidapi.JNI.PlayServices.Maps.JMapsInitializer_Renderer));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.JOnMapsSdkInitializedCallback', TypeInfo(Androidapi.JNI.PlayServices.Maps.JOnMapsSdkInitializedCallback));
  ...
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzak', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzak));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzam', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzam));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzao', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzao));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzaq', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzaq));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzas', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzas));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzau', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzau));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzaw', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzaw));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzay', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzay));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzba', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzba));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzbc', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzbc));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzbe', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzbe));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzbg', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzbg));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzbi', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzbi));
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jinternal_zzbv', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jinternal_zzbv));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.JStampStyle', TypeInfo(Androidapi.JNI.PlayServices.Maps.JStampStyle));
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.JStrokeStyle', TypeInfo(Androidapi.JNI.PlayServices.Maps.JStrokeStyle));
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.JStrokeStyle_Builder', TypeInfo(Androidapi.JNI.PlayServices.Maps.JStrokeStyle_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jmodel_StyleSpan', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jmodel_StyleSpan));
  ...
  //TRegTypes.RegisterType('Androidapi.JNI.PlayServices.Maps.Jmodel_zzu', TypeInfo(Androidapi.JNI.PlayServices.Maps.Jmodel_zzu));
end;
