...
type
  ...
  private
    ...
    FJScanCallback: Jle_RTLScanCallback;
    FJScanListener: Jle_RTLScanListener;
    FContext: JContext;
    FJAdapter: JBluetoothAdapter;
  ...
  TScanCallback = class(TJavaLocal, Jle_RTLScanListener)
  private
    [Weak] FAdapter: TAndroidBluetoothLEAdapter;
  public
    constructor Create(const AnAdapter: TAndroidBluetoothLEAdapter);
  ...
  private
    ...
    FJAdvertiseCallback: Jle_RTLAdvertiseCallback;
    FJAdvertiseListener: Jle_RTLAdvertiseListener;
  ...
  private
    ...
    FJGattServerCallback: Jbluetooth_RTLBluetoothGattServerCallback;
    FJGattServerListener: Jbluetooth_RTLBluetoothGattServerListener;
...
//    procedure DoConnectionStateChange(const ADevice: TBluetoothLEDevice; AStatus: Integer; ANewState: Integer); override;
  ...
  // --------------------------------------------------------------------- //
  TAndroidBluetoothGattServerListener = class(TJavaLocal, Jbluetooth_RTLBluetoothGattServerListener)
  protected
  ...
  TAndroidBluetoothAdvertiseListener = class(TJavaLocal, Jle_RTLAdvertiseListener)
  private
    FEvent: TEvent;
    FerrorCode: Integer;
  public
  ...
  // --------------------------------------------------------------------- //
  // --------------------------------------------------------------------- //
  TAndroidBluetoothGattListener = class(TJavaLocal, Jbluetooth_RTLBluetoothGattListener)
  private
  ...
  private
    ...
    FJGattCallback: Jbluetooth_RTLBluetoothGattCallback;
    FJGattListener: Jbluetooth_RTLBluetoothGattListener;
...
begin
  ...
  if TOSVersion.Check(4, 3) then
    ...
    begin
      ...
      FJScanCallback := TJle_RTLScanCallback.JavaClass.init(FJScanListener);
...
begin
  ...
  FJGattServerCallback := TJbluetooth_RTLBluetoothGattServerCallback.JavaClass.init(FJGattServerListener);
  ...
  begin
    ...
    begin
      ...
      if FJGattCallback = nil then
        FJGattCallback := TJbluetooth_RTLBluetoothGattCallback.JavaClass.init(FJGattListener);
...
begin
  ...
  begin
    ...
    FJAdvertiseCallback := TJle_RTLAdvertiseCallback.JavaClass.init(FJAdvertiseListener);
  end;
end;
