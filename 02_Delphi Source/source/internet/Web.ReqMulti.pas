...
{ TMultipartContentParser }
  ...
  TMultipartContentParserHelper = class helper for TMultipartContentParser
  private
    class function GetPartWithContentTypeIsFile: Boolean; static;
    class procedure SetPartWithContentTypeIsFile(AValue: Boolean); static;
  public
    class property PartWithContentTypeIsFile: Boolean read GetPartWithContentTypeIsFile
      write SetPartWithContentTypeIsFile default False;
  end;
...
begin
  ...
  if PartName <> '' then
  begin
    if (PartFileName <> '') or PartWithContentTypeIsFile and (PartContentType <> '') then
    begin
...
var
  FPartWithContentTypeIsFile: Boolean;

class function TMultipartContentParserHelper.GetPartWithContentTypeIsFile: Boolean;
begin
  Result := FPartWithContentTypeIsFile;
end;

class procedure TMultipartContentParserHelper.SetPartWithContentTypeIsFile(AValue: Boolean);
begin
  FPartWithContentTypeIsFile := AValue;
end;

initialization
  TMultipartContentParser.PartWithContentTypeIsFile := False;
