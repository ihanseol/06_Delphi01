...
begin
  if NativeNode = nil then
    ...
    case NativeNode.NodeType of
      ...
      ntDocument_Node: dnWrapper := Tox4DOMDocument.Create(WrapperDocument.WrapperDOMImpl, NativeNode as TDomDocumentXpath, False);
...
begin
  if not Assigned(FOwnerDocument) then
    FOwnerDocument := Tox4DOMDocument.Create(WrapperDocument.WrapperDOMImpl,
...
begin
  ...
  if FWrapperDOMImpl <> nil then
    FWrapperDOMImpl._AddRef;
...
begin
  Result := Tox4DOMImplementation.Create;
end;
