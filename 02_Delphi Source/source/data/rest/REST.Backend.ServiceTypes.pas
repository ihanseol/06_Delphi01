...
type
  ...
  IBackendAuthenticationExportApi = interface;
  ...
  protected
    ...
    function GetAuthenticationExportApi: IBackendAuthenticationExportApi;
  public
  ...
  IBackendAuthenticationExportApi = interface
    ['{CA52E7FB-08D2-40CF-86DE-02F1D9450204}']
    function ExportLogin(const ALogin: TBackendEntityValue): string;
    function ImportLogin(const ALogin: string): TBackendEntityValue;
  end;
...
function TBackendAuthenticationApi.GetAuthenticationExportApi: IBackendAuthenticationExportApi;
begin
  Result := GetAuthenticationApi as IBackendAuthenticationExportApi;
end;

function TBackendAuthenticationApi.ExportLogin(
  const ALogin: TBackendEntityValue): string;
begin
  Result := GetAuthenticationExportApi.ExportLogin(ALogin);
end;

function TBackendAuthenticationApi.ImportLogin(
  const ALogin: string): TBackendEntityValue;
begin
  Result := GetAuthenticationExportApi.ImportLogin(ALogin);
end;
