...
uses System.SysUtils, REST.Backend.KinveyMetaTypes, REST.Backend.Consts, REST.Json;
...
function TKinveyServiceAPIAuth.ExportLogin(
...
function TKinveyServiceAPIAuth.ImportLogin(
