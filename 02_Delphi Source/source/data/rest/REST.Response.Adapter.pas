...
type
  ...
  /// <summary>
  /// TRESTRequestDataSetAdapter allows you to automatically include the data from
  /// a dataset (for example, TFDMemTable) into TRESTRequest component. The data is 
  /// put as JSON into the request body with request content type 'application/json'.
