...
begin
  Execute(sHTTPMethodDelete, AURL, AResponseStream);
end;

procedure TRESTHTTP.Delete(const AURL: string; ASource, AResponseStream: TStream);
begin
  Execute(sHTTPMethodDelete, AURL, ASource, AResponseStream);
end;
...
begin
  Execute(sHTTPMethodGet, AURL, AResponseContent);
end;

procedure TRESTHTTP.Get(const AURL: string; ASource, AResponseContent: TStream);
begin
  Execute(sHTTPMethodGet, AURL, ASource, AResponseContent);
end;
...
function TRESTHTTP.GetMaxRedirects: Integer;
begin
...
function TRESTHTTP.GetSendDataEvent: TSendDataEvent;
begin
  Result := FHTTPClient.OnSendData;
end;

function TRESTHTTP.GetReceiveDataEvent: TReceiveDataEvent;
begin
  Result := FHTTPClient.OnReceiveData;
end;

function TRESTHTTP.GetReceiveDataExEvent: TReceiveDataExEvent;
begin
...
begin
  Execute(sHTTPMethodPatch, AURL, ASource, AResponseContent);
end;
...
procedure TRESTHTTP.SetMaxRedirects(AValue: Integer);
begin
  FHTTPClient.MaxRedirects := AValue;
end;
...
procedure TRESTHTTP.SetReadTimeout(const AValue: integer);
begin
  FHTTPClient.ResponseTimeout := AValue;
end;

procedure TRESTHTTP.SetSendDataEvent(const AValue: TSendDataEvent);
begin
  FHTTPClient.OnSendData := AValue;
end;

procedure TRESTHTTP.SetReceiveDataEvent(const AValue: TReceiveDataEvent);
begin
  FHTTPClient.OnReceiveData := AValue;
end;

procedure TRESTHTTP.SetReceiveDataExEvent(const AValue: TReceiveDataExEvent);
begin
  FHTTPClient.OnReceiveDataEx := AValue;
end;

procedure TRESTHTTP.SetClientCertificatePath(const AValue: string);
begin
  FClientCertificatePath := AValue;
  FClientCertificateStream := nil;
end;

procedure TRESTHTTP.SetClientCertificateStream(const AValue: TStream);
begin
  FClientCertificatePath := '';
  FClientCertificateStream := AValue;
end;
...
begin
  ...
  if ClientCertificatePath <> '' then
    FHTTPRequest.SetClientCertificate(ClientCertificatePath, ClientCertificatePassword)
  else if ClientCertificateStream <> nil then
    FHTTPRequest.SetClientCertificate(ClientCertificateStream, ClientCertificatePassword);
end;
...
begin
  Execute(sHTTPMethodPost, AURL, ASource, AResponseContent);
end;

procedure TRESTHTTP.Put(const AURL: string; ASource, AResponseContent: TStream);
begin
  Execute(sHTTPMethodPut, AURL, ASource, AResponseContent);
end;
