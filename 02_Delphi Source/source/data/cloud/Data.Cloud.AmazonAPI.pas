...
type
  ...
  private
    FOnPreprocessBucketXML: TPreprocessBucketXMLProc;
  ...
  public
    ...
    property OnPreprocessBucketXML: TPreprocessBucketXMLProc
...
begin
  Result := GetConnectionInfo.StorageURL(BucketName, ARegion, Self) + '/' +
    TNetEncoding.URL.Encode(ObjectName, [Ord('#'), Ord('+'), Ord('%')], []);
end;
