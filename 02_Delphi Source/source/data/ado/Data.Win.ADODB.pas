...
{ TCustomADODataSet }
  ...
  /// packets with a DB server to detect is a field auto-incremental. With a 
  /// large SELECT list this may increase time to open a dataset.
  ///</summary>
  TAutoIncFieldsMode = (
    /// <summary>
    ...
    afAll,
    /// <summary>
    /// afFirst - stop detection of auto-incremental fields after first detected field.
    /// </summary>
    afFirst,
    /// <summary>
  ...
  private
    ...
    FAutoIncFieldsMode: TAutoIncFieldsMode;
  ...
  published
    ...
    /// </summary>
    property AutoIncFieldsMode: TAutoIncFieldsMode read FAutoIncFieldsMode
      write FAutoIncFieldsMode default afAll;
    [Default(1)]
  ...
  try
    try
      ...
      if not Assigned(FLookupCursor) then
        FLookupCursor := Recordset.Clone(adLockUnspecified);
      ...
      try
        ...
        if FieldCount = 1 then
          ...
          begin
            if Fields[0].Required or (pfInKey in Fields[0].ProviderFlags) then
              Exit(False);
