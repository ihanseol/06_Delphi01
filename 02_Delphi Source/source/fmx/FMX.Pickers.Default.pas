...
{ TPopupListPicker }
  ...
  strict private
    ...
    function GetListStyleLookup: string;
    procedure SetListStyleLookup(const Value: string);
  protected
    procedure DialogKey(var Key: Word; Shift: TShiftState); override;
  ...
  public
    ...
    property ListStyleLookup: string read GetListStyleLookup write SetListStyleLookup;
...
{ TDefaultListPicker }
  ...
  protected
    ...
    procedure SetListStyleLookup(const Value: string); override;
    procedure AbsoluteTargetRectChanged; override;
  public
    constructor Create(const APickerService: TPickerFactoryService); override;
    destructor Destroy; override;
...
function TPopupListPicker.GetListStyleLookup: string;
begin
...
procedure TPopupListPicker.SetListStyleLookup(const Value: string);
begin
...
begin
  ...
  FPopupDateTimePicker.Placement := PreferredPlacement.ToPlacement;
  FPopupDateTimePicker.AbsoluteTargetRect := AbsoluteTargetRect;
...
procedure TDefaultListPicker.SetListStyleLookup(const Value: string);
begin
  inherited;
  FPopupListPicker.ListStyleLookup := Value;
end;
...
begin
  ...
  FPopupListPicker.Placement := PreferredPlacement.ToPlacement;
  FPopupListPicker.AbsoluteTargetRect := AbsoluteTargetRect;
