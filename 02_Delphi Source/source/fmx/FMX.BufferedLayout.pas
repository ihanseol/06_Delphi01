...
procedure TBufferedScene.ScaleChangedHandler(const Sender: TObject; const Msg: TMessage);
begin
  UpdateBuffer;
end;
...
procedure TBufferedScene.StyleChangedHandler(const Sender: TObject; const Msg: TMessage);
