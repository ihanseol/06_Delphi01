...
uses
  System.Types, FMX.Graphics, FMX.Platform, FMX.Platform.Metrics;

type
  TMacMetricsServices = class(TDefaultPlatformPropertiesService, IFMXDefaultMetricsService, IFMXSystemInformationService,
                              IFMXSystemFontService, IFMXLocaleService, IFMXListingService, IFMXPlatformPropertiesService)
  public const
    DefaultFontSize = 13;
  private
...
uses
  System.SysUtils, System.Rtti, Macapi.Helpers, Macapi.AppKit, Macapi.Foundation, Macapi.CocoaTypes, FMX.Text.TextEditor;
...
constructor TMacMetricsServices.Create;
begin
  inherited;
  { Platform values }
