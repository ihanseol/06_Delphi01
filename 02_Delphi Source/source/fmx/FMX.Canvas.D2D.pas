...
uses
  ...
  FMX.Utils, FMX.Helpers.Win, FMX.FontManager, FMX.FontManager.Win;
...
begin
  ...
  begin
    ...
    if Collection.GetFontFamilyCount > 0 then // this will call the Enumerator ONCE and then cache it
    begin
