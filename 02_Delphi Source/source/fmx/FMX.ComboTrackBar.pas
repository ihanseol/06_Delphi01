...
{ TComboTrackBar }
  ...
  published
    ...
    property ReadOnly;
    property Frequency: Double read GetFrequency write SetFrequency stored ValueStored nodefault;
...
function TComboTrackBar.GetFrequency: Double;
begin
...
procedure TComboTrackBar.SetFrequency(const Value: Double);
begin
