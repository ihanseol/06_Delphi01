...
uses
  ...
  FMX.Forms, FMX.Presentation.Style, FMX.Platform, FMX.Platform.Metrics;
...
begin
  ...
  begin
    FTextUpdating := True;
    try
      if TryTextToValue(Model.Text, TempValue, Model.Value) then
...
type
  TFixedStyledComboTrackBar = class(TStyledComboTrackBar)
  private
...
{ TFixedStyledComboTrackBar }

procedure TFixedStyledComboTrackBar.RecalculateAbsoluteMatrices;
begin
  inherited;
...
initialization
  TPresentationProxyFactory.Current.Register(TComboTrackBar, TControlType.Styled, TStyledPresentationProxy<TFixedStyledComboTrackBar>);
finalization
  TPresentationProxyFactory.Current.Unregister(TComboTrackBar, TControlType.Styled, TStyledPresentationProxy<TFixedStyledComboTrackBar>);
end.
