...
type
  TWinMetricsServices = class(TDefaultPlatformPropertiesService, IFMXDefaultMetricsService, IFMXSystemInformationService,
...
uses
  System.SysUtils, System.DateUtils, Winapi.Windows, FMX.Text.TextEditor;
...
constructor TWinMetricsServices.Create;
begin
  inherited;
  { Platform values }
  SetValue('IME.DisplayMode', TValue.From<TIMEDisplayMode>(TIMEDisplayMode.OverText));
end;
