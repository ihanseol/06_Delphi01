...
const
  ...
  MM_FIRSTWEEKMODE_CHANGED = MM_USER + 5;

type
  TCalFirstWeekMode = (ISO8601, FirstDayOfYear, FirstWeekOf4Days , FirstFullWeekOfYear);
...
{ TCalendarModel }
  ...
  private
    ...
    FFirstWeekMode: TCalFirstWeekMode;
    ...
    procedure SetFirstWeekMode(Value: TCalFirstWeekMode);
  ...
  public
    ...
    property FirstWeekMode: TCalFirstWeekMode read FFirstWeekMode write SetFirstWeekMode;
...
{ TCalendar }
  ...
  private
    ...
    procedure SetFirstDayOfWeek(const Value: TCalDayOfWeek);
    function GetFirstWeekMode: TCalFirstWeekMode;
    procedure SetFirstWeekMode(Value: TCalFirstWeekMode);
  ...
  public
    ...
    /// <summary>Definition of first week of the Year</summary>
...
procedure TCalendarModel.SetFirstWeekMode(Value: TCalFirstWeekMode);
begin
  if FFirstWeekMode <> Value then
  begin
    FFirstWeekMode := Value;
    SendMessage<TCalFirstWeekMode>(MM_FIRSTWEEKMODE_CHANGED, Value);
  end;
end;
...
function TCustomCalendar.GetFirstWeekMode: TCalFirstWeekMode;
begin
  Result := Model.FirstWeekMode;
end;
...
procedure TCustomCalendar.SetFirstWeekMode(Value: TCalFirstWeekMode);
begin
  Model.FirstWeekMode := Value;
end;
