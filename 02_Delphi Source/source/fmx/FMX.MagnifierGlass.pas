...
uses
  System.Math, System.SysUtils, System.Math.Vectors, System.TypInfo, FMX.Forms, FMX.Consts, FMX.BehaviorManager,
...
begin
  ...
  try
    ...
    begin
      ...
      FormChildrenContainer := TLayout.Create(nil);
      try
        ...
        for Child in Form.Children do
          ...
          begin
            ...
            FormChildrenContainer.Scale.Point := TOpenControl(ChildControl).Scale.Point;
            FormChildrenContainer.RotationAngle := TOpenControl(ChildControl).RotationAngle;
            FormChildrenContainer.RotationCenter.Point := TOpenControl(ChildControl).RotationCenter.Point;
            ChildControl.PaintTo(FScreenshot.Canvas, TargetRect, FormChildrenContainer);
          end;
      finally
        FormChildrenContainer.Free;
      end;
    end
    else
...
begin
  ...
  FLoupe.Size.PlatformDefault := False;
end;
