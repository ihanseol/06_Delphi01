...
// constructor of the printer implementation
  System.SysUtils, Macapi.Helpers, Macapi.PrintCore, FMX.Canvas.Mac;
...
const
  CPointsPerInch = 72;
begin
  if (FActivePrinter = -1) or (ActivePrinter.ActiveDPIIndex = -1) then
...
begin
  ...
  begin
    ...
    PrinterDevice := TMacPrinterDevice.Create(CarbonPrinter, Title, Driver, Device, Port);
