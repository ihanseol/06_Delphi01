...
var
  ...
  D: TCaptureDevice;
begin
  if (FDevice = nil) and not (csDesigning in ComponentState) and (TCaptureDeviceManager.Current <> nil) then
  begin
    ...
    if FDevice = nil then
      FDevice := TCaptureDeviceManager.Current.DefaultVideoCaptureDevice;
  end;
  Result := FDevice;
end;
...
begin
  TCameraComponentHelper.Current.RequestPermission(Device,
    ...
    begin
      ...
      begin
        Device.StartCapture;
        Device.OnSampleBufferReady := DoSampleBufferReady;
      end;
    end);
end;
...
begin
  ...
  begin
    Device.StopCapture;
    Device.OnSampleBufferReady := nil;
  end;
end;
