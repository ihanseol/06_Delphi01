...
type
  ...
  TNativeWebViewHelper = class
    ...
    class function NativeViewToSurface(const ANativeView: INativeWebView; const ASurface: TBitmapSurface;
                                       const AScale: Single = 1.0): Boolean;
  end;
...
class function TNativeWebViewHelper.NativeViewToSurface(const ANativeView: INativeWebView;
  const ASurface: TBitmapSurface; const AScale: Single): Boolean;
begin
  ...
  begin
    ...
    Result := FMX.Helpers.Mac.NativeViewToSurface(ANativeView, ASurface, AScale);
end;
