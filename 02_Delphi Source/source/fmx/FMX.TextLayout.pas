...
uses
  System.Types, System.UITypes, System.SysUtils, System.Generics.Collections, System.Messaging, FMX.Types, FMX.Graphics;
...
uses
  System.Math, System.Math.Vectors, FMX.Consts, FMX.Text, FMX.Platform;
...
begin
  FMessageId := TMessageManager.DefaultManager.SubscribeToMessage(TCanvasDestroyMessage, CanvasDestroyListener);
  FCanvas := ACanvas;
...
procedure TTextLayout.CanvasDestroyListener(const Sender: TObject; const M: TMessage);
begin
  FCanvas := nil;
end;
...
class procedure TTextLayoutManager.RegisterTextLayout(const LayoutClass: TTextLayoutClass; const CanvasClass: TCanvasClass);
var
...
class function TTextLayoutManager.TextLayoutByCanvas(const ACanvasClass: TClass): TTextLayoutClass;
var
  CanvasSrv: IFMXCanvasService;
  LayoutClassRec: TTextLayoutRecord;
begin
