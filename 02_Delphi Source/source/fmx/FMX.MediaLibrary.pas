...
{$HPPEMIT LINKUNIT}
uses
  System.Classes, System.Types, System.Messaging, FMX.Types, FMX.Controls, FMX.Graphics;
...
{$REGION 'Image manager services'}
  ...
  /// <summary>Cause behind the failure of an image taking action</summary>
  TTakingFailureCause = (UnknownError, FileNotCreated, FileNotAvailable, DecodeError);

  /// <summary>Supported presentations of the photo picker</summary>
  TPickerPresentation = (Legacy, Latest);

  TOnDidCancelTaking = procedure of object;
  TOnDidFinishTaking = procedure(Image: TBitmap) of object;
  TOnDidFailTaking = procedure(FailureCause: TTakingFailureCause) of object;
  ...
  TParamsPhotoQuery = record
    ...
    /// <summary>Presentation of the photo picker</summary>
    PickerPresentation: TPickerPresentation;
    /// <summary>Callback called when the image taking action succeeds</summary>
    OnDidFinishTaking: TOnDidFinishTaking;
    /// <summary>Callback called when the image taking action is cancelled</summary>
    OnDidCancelTaking: TOnDidCancelTaking;
    /// <summary>Callback called when the image taking action fails</summary>
    OnDidFailTaking: TOnDidFailTaking;
  end;
...
{$REGION 'Share Text, Image/Files, or a combination of these, with the other native services'}
