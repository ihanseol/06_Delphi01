...
uses
  System.Classes, System.Types, System.Rtti, System.UITypes, FMX.Objects, FMX.Types, FMX.StdCtrls, FMX.Edit,
  FMX.ListBox, FMX.Controls, FMX.Pickers, FMX.Graphics;
...
begin
  ...
  if SupportsPlatformService(IFMXPlatformPropertiesService, PropertiesService) then
    DropDownKind := PropertiesService.GetValue('DropDownKind', TValue.From<TDropDownKind>(TDropDownKind.Custom)) // do not localize
                                     .AsType<TDropDownKind>
  else
