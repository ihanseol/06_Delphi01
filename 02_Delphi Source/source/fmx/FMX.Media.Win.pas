...
procedure TWindowsAudioCaptureDevice.InitBaseFilter;
var
  HR: HResult;
begin
  ...
  HR := FMoniker.BindToObject(nil, nil, IID_IBaseFilter, FBaseFilter);
...
procedure TWindowsVideoCaptureDevice.InitBaseFilter;
var
  HR: HResult;
begin
  if FBaseFilter <> nil then
