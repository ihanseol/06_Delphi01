...
begin
  ...
  try
    ...
    Dialog := DialogFactory.createMessageDialog(MainActivity, StringToJString(AMessage), Ord(ADialogType),
                                                LCaptions, PosButton, NegButton, NeutralButton);
...
begin
  ...
  try
    ...
    try
      ...
      try
        DialogFactory := TJFMXDialogFactory.JavaClass.getFactory;
        Dialog := DialogFactory.createInputQueryDialog(MainActivity, StringToJString(ACaption), JavaPrompts,
                                                       JavaDefaultValues, JavaCaptions);
