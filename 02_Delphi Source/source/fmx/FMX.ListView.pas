...
begin
  ...
  FreeAndNil(FHeightSums);
  FreeAndNil(FStroke);
  FreeAndNil(FBrush);
  FreeAndNil(FItemSpaces);
  FreeAndNil(FAniCalc);
  FreeAndNil(FSelectionAlphas);
  FreeAndNil(FDelayedIncidents);

  FreeAndNil(FStyleResources);
  FTimerService := nil;
  FListingService := nil;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if FMouseEventIndex < Adapter.Count then
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if NewIndex < Adapter.Count then
              begin
...
begin
  ...
  FStyleResources.HeaderTextShadowColor := GetColorFromStyle('headertextshadow', TAlphaColorRec.Null);
...
begin
  FreeAndNil(FAppearanceProperties);
  FreeAndNil(FItemAppearanceObjects);
  FreeAndNil(FItemAppearanceProperties);
  FreeAndNil(FItemEditAppearanceProperties);
  FreeAndNil(FHeaderAppearanceProperties);
  FreeAndNil(FFooterAppearanceProperties);
  SetAdapter(nil);
  FreeAndNil(FAppearanceViewItems);
  inherited;
end;
