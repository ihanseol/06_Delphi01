...
begin
  ...
  Primary := ANativeDisplay.getDisplayId = TJDisplay.JavaClass.DEFAULT_DISPLAY;

  if Primary and (Scale < 1) then
    Scale := Max(1, TAndroidHelper.Context.getResources.getDisplayMetrics.density);
