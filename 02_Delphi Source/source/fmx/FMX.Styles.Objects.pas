...
begin
  FreeAndNil(FTouchAnimation);
  FreeAndNil(FSourceLink);
  FreeAndNil(FActiveLink);
  FreeAndNil(FActiveAnimation);
  inherited;
end;
...
begin
  FreeAndNil(FPadding);
  FreeAndNil(FTouchAnimation);
  FreeAndNil(FTouchAnimationObject);
  FreeAndNil(FLink);
  inherited;
end;
...
begin
  FreeAndNil(FInactiveLink);
  FreeAndNil(FInactiveAnimation);
  inherited;
end;
...
begin
  if FInactive and (FCurrent <> TButtonAnimation.Hot) then
...
procedure TSystemButtonObject.StartTriggerAnimation(const AInstance: TFmxObject; const ATrigger: string);
begin
  inherited;
  FInactiveAnimation.StartTrigger(AInstance, ATrigger);
end;
...
begin
  FreeAndNil(FCurrentShadow);
  FreeAndNil(FShadow);
  FreeAndNil(FSavedShadow);
  inherited;
end;
