...
type
  ...
  private
    ...
    procedure MMHideSelectionOnExitChanged(var Message: TDispatchMessage); message MM_EDIT_HIDESELECTIONONEXIT_CHANGED;
    { Windows messages }
...
procedure TWinNativeEdit.MMHideSelectionOnExitChanged(var Message: TDispatchMessage);
begin
  RecreateWnd;
end;
