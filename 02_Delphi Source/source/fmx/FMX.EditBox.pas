...
{ TCustomEditBox }
  ...
  private
    ...
    function GetCurrentIncrement: Double;
    procedure SetHorzIncrement(const Value: Double);
  ...
  public
    ...
    property CurrentIncrement: Double read GetCurrentIncrement;
    ...
    property HorzIncrement: Double read FHorzIncrement write SetHorzIncrement stored HorzIncrementStored nodefault;
  ...
  private
    ...
    procedure SetHorzIncrement(const Value: Double);
    function GetHorzIncrement: Double;
  ...
  public
    ...
    procedure ValueInc;
    procedure ValueDec;
    property HorzIncrement: Double read GetHorzIncrement write SetHorzIncrement stored HorzIncrementStored nodefault;
...
function TCustomEditBox.GetHorzIncrement: Double;
begin
...
procedure TCustomEditBox.SetHorzIncrement(const Value: Double);
begin
...
function TEditBoxModel.GetCurrentIncrement: Double;
begin
...
procedure TEditBoxModel.SetHorzIncrement(const Value: Double);
var
  LValue: Double;
begin
  LValue := Max(0, Value);
