...
begin
  ...
  begin
    ...
    try
      ...
      LCanvas.Clear(0);
      LCanvas.SetMatrix(TMatrix.CreateScaling(1 / Dest.BitmapScale, 1 / Dest.BitmapScale));
      LCanvas.DrawTexture(CopyRect, TRectF.Create(0, 0, CopyRect.Width, CopyRect.Height), $FFFFFFFF, Texture);
    finally
