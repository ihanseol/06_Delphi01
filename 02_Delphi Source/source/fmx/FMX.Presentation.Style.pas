...
type
  ...
  protected
    ...
    procedure DoFreeStyle; override;
...
procedure TStyledPresentation.DoFreeStyle;
begin
  inherited;
  if Assigned(PresentedControl.OnFreeStyle) then
    PresentedControl.OnFreeStyle(PresentedControl);
end;
