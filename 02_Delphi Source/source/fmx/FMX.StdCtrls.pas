...
begin
  ...
  if SupportsPlatformService(IFMXPlatformPropertiesService, PropertiesService) then
    Trimming := PropertiesService.GetValue('Trimming', TValue.From<TTextTrimming>(Trimming)) // do not localize
...
begin
  ...
  if SupportsPlatformService(IFMXPlatformPropertiesService, PropertiesService) then
    Trimming := PropertiesService.GetValue('Trimming', TValue.From<TTextTrimming>(TTextTrimming.None))
                                 .AsType<TTextTrimming>
  else
...
procedure TSpeedButton.RestoreButtonState;
begin
...
function ValueToPos(MinValue, MaxValue, ViewportSize: Double; ThumbSize, TrackSize, Value: Single; IgnoreViewportSize: Boolean): Single;
var
  ValRel: Double;
begin
  Result := ThumbSize / 2;
...
function PosToValue(MinValue, MaxValue, ViewportSize: Double; ThumbSize, TrackSize, Pos: Single; IgnoreViewportSize: Boolean): Double;
var
  ValRel: Double;
begin
  Result := MinValue;
...
function TThumb.PointToValue(X, Y: Single): Double;
var
  P: TPointF;
begin
  Result := 0;
...
function TCustomTrack.GetMax: Double;
begin
  Result := FValueRange.Max;
end;

procedure TCustomTrack.SetMax(const Value: Double);
begin
  FValueRange.Max := Value;
end;

procedure TCustomTrack.SetMin(const Value: Double);
begin
  FValueRange.Min := Value;
end;

function TCustomTrack.GetMin: Double;
begin
  Result := FValueRange.Min;
end;

procedure TCustomTrack.SetFrequency(const Value: Double);
begin
  FValueRange.Frequency := Value;
end;

function TCustomTrack.GetFrequency: Double;
begin
  Result := FValueRange.Frequency;
end;

function TCustomTrack.GetValue: Double;
begin
  Result := FValueRange.Value;
end;

procedure TCustomTrack.SetValue(Value: Double);
begin
  FValueRange.Value := Value;
end;

function TCustomTrack.GetViewportSize: Double;
begin
  Result := FValueRange.ViewportSize;
end;

procedure TCustomTrack.SetViewportSize(const Value: Double);
begin
...
procedure TCustomTrack.ActionChange(Sender: TBasicAction; CheckDefaults: Boolean);
begin
  if Sender is TValueRangeAction then
  begin
    if (not CheckDefaults) or (FValueRange.IsEmpty) then
...
procedure TCustomTrack.SetNewValue(const LValue: Double);
begin
...
function TScrollBar.GetMax: Double;
begin
  Result := FValueRange.Max;
end;

function TScrollBar.GetMin: Double;
begin
  Result := FValueRange.Min;
end;

function TScrollBar.GetValue: Double;
begin
  Result := FValueRange.Value;
end;

function TScrollBar.GetViewportSize: Double;
begin
  Result := FValueRange.ViewportSize;
end;

procedure TScrollBar.SetMax(const Value: Double);
begin
  FValueRange.Max := Value;
end;

procedure TScrollBar.SetMin(const Value: Double);
begin
  FValueRange.Min := Value;
end;

procedure TScrollBar.SetValue(const Value: Double);
begin
  FValueRange.Value := Value;
end;

procedure TScrollBar.SetViewportSize(const Value: Double);
begin
  FValueRange.ViewPortSize := Value;
end;
...
function TScrollBar.GetSmallChange: Double;
begin
  Result := FSmallChange;
end;

procedure TScrollBar.SetSmallChange(const Value: Double);
begin
  FSmallChange := Value;
  if FTrack <> nil then
    FTrack.SmallChange := FSmallChange;
...
function TArcDial.GetFrequency: Double;
begin
...
procedure TArcDial.SetFrequency(const Value: Double);
begin
...
function TArcDial.GetValue: Double;
begin
  Result := (FValueRange.RelativeValue * 360) - 180;
end;

procedure TArcDial.SetValue(const Value: Double);
var
  Tmp: Double;
begin
  Tmp := (Value - 180) / 360;
