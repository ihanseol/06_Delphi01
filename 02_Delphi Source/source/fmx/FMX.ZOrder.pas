...
type
  ...
  protected
    ...
    function FindPreviousSiblingView(const AControl: TFmxObject; out AView: T): Boolean;
...
function TCustomZOrderManager<T>.FindPreviousSiblingView(const AControl: TFmxObject; out AView: T): Boolean;
var
  I: Integer;
  Parent: TFmxObject;
  ChildControl: TControl;
begin
  ...
  if not Result and (AControl.Parent <> nil) then
    Result := FindPreviousSiblingView(AControl.Parent, AView);
end;
