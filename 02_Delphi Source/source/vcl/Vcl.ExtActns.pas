...
{ TRichEditModifyingAction }

  TRichEditModifyingAction = class(TRichEditAction)
  public
    function HandlesTarget(Target: TObject): Boolean; override;
  end;
...
{ TRichEditBold }
  ...
  TRichEditBold = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditUnderline }
  ...
  TRichEditUnderline = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditStrikeOut }
  ...
  TRichEditStrikeOut = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditBullets }
  ...
  TRichEditBullets = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditAlignLeft }
  ...
  TRichEditAlignLeft = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditAlignRight }
  ...
  TRichEditAlignRight = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditAlignCenter }
  ...
  TRichEditAlignCenter = class(TRichEditModifyingAction)
  public
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
  end;
...
{ TRichEditSpellCheck }
  ...
  TRichEditSpellCheck = class(TRichEditModifyingAction)
  public
    constructor Create(AOwner: TComponent); override;
    procedure ExecuteTarget(Target: TObject); override;
    procedure UpdateTarget(Target: TObject); override;
...
function TRichEditModifyingAction.HandlesTarget(Target: TObject): Boolean;
begin
  Result := inherited HandlesTarget(Target) and not TCustomRichEdit(Target).ReadOnly;
end;
...
constructor TRichEditSpellCheck.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  AutoCheck := False;
end;

procedure TRichEditSpellCheck.ExecuteTarget(Target: TObject);
begin
  if Target is TCustomRichEdit then
    TCustomRichEdit(Target).ShowSpellCheckMenu;
end;

procedure TRichEditSpellCheck.UpdateTarget(Target: TObject);
begin
  Enabled := (Target is TCustomRichEdit) and TCustomRichEdit(Target).SpellChecking;
end;
