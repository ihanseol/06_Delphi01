...
begin
  ...
  LBoldFont := Assigned(ActionClient) and ActionClient.Default;
  if (PPI <> Screen.PixelsPerInch) or LBoldFont then
...
begin
  ...
  Canvas.Font.ScaleForDPI(GetDevicePPI);
...
begin
  ...
  begin
    ...
    try
      TempFont.Assign(Screen.MenuFont);
      TempFont.ScaleForDPI(Menu.GetDevicePPI);
