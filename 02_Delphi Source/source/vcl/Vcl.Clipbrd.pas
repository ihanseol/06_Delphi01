...
type
  ...
  private
    ...
    function GetFormats(Index: Integer): UINT;
    procedure SetAsText(const Value: string);
  protected
    procedure Adding; virtual;
    procedure AssignTo(Dest: TPersistent); override;
    procedure WndProc(var Message: TMessage); virtual;
    procedure MainWndProc(var Message: TMessage);
{$IF DEFINED(CLR)}
    procedure SetBuffer(Format: UINT; Buffer: TBytes; Size: NativeInt);
{$ELSE}
    procedure SetBuffer(Format: UINT; var Buffer; Size: NativeInt);
{$ENDIF}
  ...
  public
    ...
    function GetAsHandle(Format: UINT): THandle;
    function HasFormat(Format: UINT): Boolean;
    procedure Open; virtual;
    procedure SetComponent(Component: TComponent);
    procedure SetAsHandle(Format: UINT; Value: THandle);
{$IF DEFINED(CLR)}
...
{$ENDIF}
    ...
    property Formats[Index: Integer]: UINT read GetFormats;
  end;
...
{$IF DEFINED(CLR)}
procedure TClipboard.SetBuffer(Format: UINT; Buffer: TBytes; Size: NativeInt);
var
  DataPtr: IntPtr;
{$ELSE}
procedure TClipboard.SetBuffer(Format: UINT; var Buffer; Size: NativeInt);
var
  DataPtr: Pointer;
{$ENDIF}
  Data: THandle;
...
function TClipboard.GetAsHandle(Format: UINT): THandle;
begin
  Open;
  try
...
procedure TClipboard.SetAsHandle(Format: UINT; Value: THandle);
begin
  Open;
  try
    Adding;
...
function TClipboard.GetFormats(Index: Integer): UINT;
begin
  Open;
  try
...
function TClipboard.HasFormat(Format: UINT): Boolean;
