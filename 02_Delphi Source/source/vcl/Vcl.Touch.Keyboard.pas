...
uses
  System.SysUtils, Vcl.GraphUtil, Winapi.UxTheme, Vcl.Consts, Vcl.Forms, Vcl.Themes;
...
begin
  ...
  try
    ...
    try
      ...
      LCanvas.Font.ChangeScale(FParent.CurrentPPI, Screen.PixelsPerInch, True);
...
var
  ...
  LColor, LBaseColor, LGradStart, LGradEnd: TColor;
begin
  ...
  try
    ...
    try
      ...
      try
        ...
        LBaseColor := Color;
        LGradStart := GradientStart;
        LGradEnd := GradientEnd;
        ...
        if DrawingStyle = TDrawingStyle.dsGradient then
          GradientFillCanvas(LCanvas, LGradStart, LGradEnd, ClientRect, gdVertical)
        else
        begin
          LCanvas.Brush.Color := LBaseColor;
