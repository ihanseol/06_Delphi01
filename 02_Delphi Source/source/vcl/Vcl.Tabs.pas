...
begin
  inherited Create(AOwner);
  ControlStyle := [csCaptureMouse, csDoubleClicks, csOpaque, csPannable, csGestures, csOverrideStylePaint];
  Width := 185;
  Height := 21;
...
begin
  ...
  begin
    ...
    try
      ...
      Result := Min(ScaleValue(cIDETabsMaxWidth), ScaleValue(2 * cTabSetMargin) + Canvas.TextWidth(Tabs[Index]));
    finally
