...
begin
  ...
  begin
    ...
    if Assigned(FDefaultWebNode) and (FDefaultWebNode.WSDLView = FWSDLView) then
      FDefaultWebNode.WSDLView := nil;
    FWSDLView.Free;
  end;
...
begin
  ...
  begin
    ...
    if FHTTPWebNode <> FDefaultWebNode then
    begin
      if FHTTPWebNode.WSDLView = FWSDLView then
        FHTTPWebNode.WSDLView := nil;
