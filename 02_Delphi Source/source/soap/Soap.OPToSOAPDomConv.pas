...
begin
  ...
  begin
    ...
    begin
      ...
      Attachment.CacheFilePersist := True;
    end
    ...
    begin
      ...
      SourceString := Attachment.SourceString;
    ContentType := Attachment.ContentType;
    Encoding := Attachment.Encoding;
  end;

  FAttachments.Add(Attach);
  FAttachments.Extract(Attachment);

  Attach.DataContext := Nil;
  if (GetRemotableDataContext <> nil) and (Attachment.DataContext = nil) then
  begin
    TDataContext(GetRemotableDataContext).AddObjectToDestroy(Attachment);
    Attachment.DataContext := TDataContext(GetRemotableDataContext);
  end;
end;
