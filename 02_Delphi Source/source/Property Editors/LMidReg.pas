...
uses DBClientActns, ActnList, DBClientActnRes, StrEdit;
  ...
  begin
    ...
    case FLookup[Index] of
      ...
      TCommand.cmdCreate: begin
           if not DataSet.Active and (DataSet.Fields.Count > 0) then
           begin
...
{$ENDIF}
  ...
  RegisterPropertyEditor(TypeInfo(WideString), TCustomClientDataSet, 'CommandText', TLongWideStringProperty);
