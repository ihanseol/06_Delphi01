...
uses
  ...
  Vcl.Themes, IDETheme.Utils, ToolsAPI.UI;
...
begin
  ...
  if UnusedColor = clNone then
    (BorlandIDEServices as INTAIDEUIServices).MessageDlg(sNoUnusedColors, mtWarning, [mbOk], 0);
...
begin
  ...
  begin
    ...
    Shape1.Pen.Color := TIDEStyleUtilsService.GetGrayBlendColor(LStyle);
...
begin
  if ThemeProperties <> nil then
    Shape1.Pen.Width := 1; // allow to show a dotted outline in High DPI
end;
