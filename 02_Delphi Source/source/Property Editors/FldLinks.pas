...
{$IFDEF MSWINDOWS}
  uses Dialogs, DBConsts, LibHelp, TypInfo, DsnDBCst, BrandingAPI, ToolsAPI, ToolsAPI.UI;
{$ENDIF}
{$IFDEF LINUX}
  ...
  begin
    ...
    begin
      ...
      begin
        if Gap then
        begin
          (BorlandIDEServices as INTAIDEUIServices).MessageDlg(Format(SLinkDesigner,
