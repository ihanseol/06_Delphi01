...
type
  ...
  private
    ...
    procedure IDEThemeChanged(Sender: TObject);
  protected
...
begin
  ...
  EvIDEThemeChanged.Add(IDEThemeChanged);
  FItemIdList := TList.Create;
  CollectionEditorsList.Add(Self);
end;

procedure TCollectionEditor.IDEThemeChanged(Sender: TObject);
begin
  IDEThemeManager.RegisterFormClass(TCollectionEditor);
  ThemeProperties.ApplyTheme(Self);
end;
...
begin
  EvIDEThemeChanged.Remove(IDEThemeChanged);
  FItemIdList.Free;
  if CollectionEditorsList <> nil then
