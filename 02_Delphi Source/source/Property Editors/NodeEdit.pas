...
begin
  var LPPI := TIDEHighDPIService.GetFormDPI(nil).CurrentPPI;
  ScaleForPPI(LPPI);
...
begin
  SavedWidth := TIDEHighDPIService.ConvertToDefaultPPI(Self, Width);
  SavedHeight := TIDEHighDPIService.ConvertToDefaultPPI(Self, Height);
  SavedLeft := TIDEHighDPIService.ConvertToDefaultPPI(Self, Left);
  SavedTop := TIDEHighDPIService.ConvertToDefaultPPI(Self, Top);
end;
